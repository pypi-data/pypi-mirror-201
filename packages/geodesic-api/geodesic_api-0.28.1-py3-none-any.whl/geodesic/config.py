...
class ClusterConfig:
    ...
    def send_headers(self, url: str) -> bool:
        """
        Given a url determine whether to send auth headers. It returns true if the url contains
        the configured host, or a host in the overrides.
        """
...
def get_config() -> ClusterConfig:
    ...
    Returns:
        :class:`ClusterConfig` for the current active cluster.
    """
    os.makedirs(_config_dir, exist_ok=True)
