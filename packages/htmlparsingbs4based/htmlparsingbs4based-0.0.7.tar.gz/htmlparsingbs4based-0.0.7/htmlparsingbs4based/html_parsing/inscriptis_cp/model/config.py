...
from inscriptis_cp.css_profiles import CSS_PROFILES
from inscriptis_cp.annotation.parser import AnnotationModel
from inscriptis_cp.model.attribute import Attribute
from inscriptis_cp.model.html_element import HtmlElement
...
class ParserConfig:
    ...
    def __init__(self, css: Dict[str, HtmlElement] = None,
        ...
        self.display_tables = display_tables
        self.display_anchors = display_anchors
        self.show_tag_name = show_tag_name
