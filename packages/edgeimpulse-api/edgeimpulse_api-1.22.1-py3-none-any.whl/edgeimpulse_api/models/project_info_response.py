...
class ProjectInfoResponse(BaseModel):
    ...
    data_summary_processed_data: ProjectDataSummary = Field(..., alias="dataSummaryProcessedData")
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of data_summary_processed_data
        if self.data_summary_processed_data:
            _dict['dataSummaryProcessedData'] = self.data_summary_processed_data.to_dict()
    ...
    def from_dict(cls, obj: dict) -> ProjectInfoResponse:
        ...
        if type(obj) is not dict:
            return ProjectInfoResponse.parse_obj(obj)

        _obj = ProjectInfoResponse.parse_obj({
            ...
            "data_summary_processed_data": ProjectDataSummary.from_dict(obj.get("dataSummaryProcessedData")) if obj.get("dataSummaryProcessedData") is not None else None,
