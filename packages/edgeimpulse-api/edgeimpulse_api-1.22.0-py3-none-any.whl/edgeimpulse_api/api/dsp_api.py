...
class DSPApi(object):
    ...
    @validate_arguments
    def run_dsp_sample_slice(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], dsp_id : Annotated[StrictInt, Field(..., description="DSP Block ID, use the impulse functions to retrieve the ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], slice_start : Annotated[StrictInt, Field(..., description="Begin index of the slice")], slice_end : Annotated[StrictInt, Field(..., description="End index of the slice")], dsp_run_request_without_features : DspRunRequestWithoutFeatures, **kwargs) -> DspRunResponseWithSample:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._run_dsp_sample_slice_with_http_info(project_id, dsp_id, sample_id, slice_start, slice_end, dsp_run_request_without_features, **kwargs)  # noqa: E501

    @validate_arguments
    def _run_dsp_sample_slice_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], dsp_id : Annotated[StrictInt, Field(..., description="DSP Block ID, use the impulse functions to retrieve the ID")], sample_id : Annotated[StrictInt, Field(..., description="Sample ID")], slice_start : Annotated[StrictInt, Field(..., description="Begin index of the slice")], slice_end : Annotated[StrictInt, Field(..., description="End index of the slice")], dsp_run_request_without_features : DspRunRequestWithoutFeatures, **kwargs):  # noqa: E501
        """Get processed sample (slice) 
