...
class OrganizationsApi(object):
    ...
    @validate_arguments
    def get_organization_metrics(self, organization_id : Annotated[StrictInt, Field(..., description="Organization ID")], **kwargs) -> OrganizationMetricsResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_organization_metrics_with_http_info(organization_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_organization_metrics_with_http_info(self, organization_id : Annotated[StrictInt, Field(..., description="Organization ID")], **kwargs):  # noqa: E501
        """Organization metrics 
