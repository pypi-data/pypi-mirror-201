...
class ProjectsApi(object):
    ...
    @validate_arguments
    def add_collaborator(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], add_collaborator_request : AddCollaboratorRequest, **kwargs) -> GenericApiResponse:  # noqa: E501
        """Add collaborator
    ...
    @validate_arguments
    def add_project_api_key(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], add_api_key_request : AddApiKeyRequest, **kwargs) -> GenericApiResponse:  # noqa: E501
        """Add API key
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._add_project_api_key_with_http_info(project_id, add_api_key_request, **kwargs)  # noqa: E501

    @validate_arguments
    def _add_project_api_key_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], add_api_key_request : AddApiKeyRequest, **kwargs):  # noqa: E501
        """Add API key 
        ...
        # process the body parameter
        _body_params = None
        if _params['add_api_key_request']:
            _body_params = _params['add_api_key_request']
    ...
    @validate_arguments
    def add_project_hmac_key(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], add_hmac_key_request : AddHmacKeyRequest, **kwargs) -> GenericApiResponse:  # noqa: E501
        """Add HMAC key
    ...
    @validate_arguments
    def get_project_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> ProjectInfoResponse:  # noqa: E501
        """Project information
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._get_project_info_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_project_info_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Project information 
    ...
    @validate_arguments
    def list_downloads(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs) -> ProjectDownloadsResponse:  # noqa: E501
        """Get downloads
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._list_downloads_with_http_info(project_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _list_downloads_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], **kwargs):  # noqa: E501
        """Get downloads 
    ...
    @validate_arguments
    def list_public_projects(self, limit : Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None, offset : Annotated[Optional[StrictInt], Field(description="Offset in results, can be used in conjunction with LimitResultsParameter to implement paging.")] = None, project : Annotated[Optional[StrictStr], Field(description="Only include projects that contain this string")] = None, **kwargs) -> ListPublicProjectsResponse:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._list_public_projects_with_http_info(limit, offset, project, **kwargs)  # noqa: E501
