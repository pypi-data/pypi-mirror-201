...
import edgeimpulse_api.models
from edgeimpulse_api import rest
from edgeimpulse_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(edgeimpulse_api.models, klass)
