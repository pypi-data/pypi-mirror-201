...
class CryonirspLinearityTaskBase(WorkflowTaskBase, InputDatasetMixin, ABC):
    """
    Task class for base CryoNIRSP Linearization tasks.
...
class CryonirspTaskBase(
    ...
    """
    Task class for base CryoNIRSP tasks.
