...
def test_parse_cryonirsp_linearized_data_constants(parse_linearized_valid_task, mocker):
    ...
    if parse_linearized_valid_task.constants._db_dict["ARM_ID"] == "CI":
        assert parse_linearized_valid_task.constants._db_dict["SPECTRAL_LINE"] == "Fe XIII"
    elif parse_linearized_valid_task.constants._db_dict["ARM_ID"] == "SP":
        assert parse_linearized_valid_task.constants._db_dict["SPECTRAL_LINE"] == "He I, Fe XIII"
