...
def compute_beam_boundaries_task(
    ...
    with BeamBoundariesCalibration(
...
def test_compute_beam_boundaries_task(compute_beam_boundaries_task):
    """
    Given: An BeamBoundariesCalibration task
    ...
    if arm_id == "SP":
        ...
        beam_1_boundary = np.array([8, 94, 5, 91])
