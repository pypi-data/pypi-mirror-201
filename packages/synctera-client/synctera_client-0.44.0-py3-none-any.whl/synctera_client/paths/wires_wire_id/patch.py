...
# Path params
WireIdSchema = schemas.UUIDSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'wire_id': typing.Union[WireIdSchema, str, uuid.UUID, ],
    }
)
...
request_path_wire_id = api_client.PathParameter(
    name="wire_id",
...
# body param
SchemaForRequestBodyApplicationJson = UpdateTransfer


request_body_update_transfer = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = Wire
...
class BaseApi(api_client.Api):
    ...
    def _cancel_wire_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_transfer.serialize(body, content_type)
