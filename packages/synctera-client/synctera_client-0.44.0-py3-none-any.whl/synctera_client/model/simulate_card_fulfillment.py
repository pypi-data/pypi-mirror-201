...
class SimulateCardFulfillment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["card_fulfillment_status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["card_fulfillment_status", ], str]):
