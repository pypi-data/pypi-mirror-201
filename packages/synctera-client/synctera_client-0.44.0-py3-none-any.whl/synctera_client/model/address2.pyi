...
class Address2(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address_line_1", "address_line_2", "city", "country_code", "postal_code", "state", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address_line_1", "address_line_2", "city", "country_code", "postal_code", "state", ], str]):
