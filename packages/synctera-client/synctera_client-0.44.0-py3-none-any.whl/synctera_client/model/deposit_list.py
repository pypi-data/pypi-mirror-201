...
class DepositList(
    ...
    class MetaOapg:
        ...
        class all_of_0(
                ...
                class properties:
                    ...
                    class deposits(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['DepositGet']:
                                return DepositGet
                    
                        def __new__(
                            cls,
                            _arg: typing.Union[typing.Tuple['DepositGet'], typing.List['DepositGet']],
                        ...
                        def __getitem__(self, i: int) -> 'DepositGet':
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["deposits", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["deposits", ], str]):
