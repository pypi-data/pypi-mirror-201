...
class DeleteResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "resource", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "resource", ], str]):
