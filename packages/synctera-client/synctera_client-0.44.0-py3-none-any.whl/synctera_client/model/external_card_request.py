...
class ExternalCardRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["customer_id", "name", "token", "business_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["customer_id", "name", "token", "business_id", ], str]):
