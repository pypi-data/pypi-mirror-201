...
class PatchPersonalId(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id_type", "country_code", "identifier", "tenant", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["id_type"]) -> 'PersonalIdType': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id_type", "country_code", "identifier", "tenant", ], str]):
