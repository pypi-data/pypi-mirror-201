...
# body param
SchemaForRequestBodyApplicationJson = WireRequest


request_body_wire_request = api_client.RequestBody(
    content={
...
SchemaFor201ResponseBodyApplicationJson = Wire
...
class BaseApi(api_client.Api):
    ...
    def _create_wire_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_wire_request.serialize(body, content_type)
