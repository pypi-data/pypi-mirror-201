...
class PatchBusinessBusinessOwnerRelationship(
        ...
        class all_of_0(
            ...
            class MetaOapg:
                ...
                class properties:
                    ...
                    @staticmethod
                    def additional_data() -> typing.Type['AdditionalOwnerData']:
                        return AdditionalOwnerData
                    creation_time = schemas.DateTimeSchema
                    from_business_id = schemas.UUIDSchema
            ...
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["additional_data"]) -> 'AdditionalOwnerData': ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["creation_time"]) -> MetaOapg.properties.creation_time: ...
            
            @typing.overload
            def __getitem__(self, name: typing_extensions.Literal["from_business_id"]) -> MetaOapg.properties.from_business_id: ...
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["additional_data", "creation_time", "from_business_id", "id", "last_updated_time", "metadata", "relationship_type", "to_business_id", ], str]):
                # dict_instance[name] accessor
                return super().__getitem__(name)
            
            
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["additional_data"]) -> typing.Union['AdditionalOwnerData', schemas.Unset]: ...
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["from_business_id"]) -> typing.Union[MetaOapg.properties.from_business_id, schemas.Unset]: ...
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["additional_data", "creation_time", "from_business_id", "id", "last_updated_time", "metadata", "relationship_type", "to_business_id", ], str]):
            ...
            def __new__(
                ...
                *_args: typing.Union[dict, frozendict.frozendict, ],
                ...
                additional_data: typing.Union['AdditionalOwnerData', schemas.Unset] = schemas.unset,
                creation_time: typing.Union[MetaOapg.properties.creation_time, str, datetime, schemas.Unset] = schemas.unset,
                from_business_id: typing.Union[MetaOapg.properties.from_business_id, str, uuid.UUID, schemas.Unset] = schemas.unset,
