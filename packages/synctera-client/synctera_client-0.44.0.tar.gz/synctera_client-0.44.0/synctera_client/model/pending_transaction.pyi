...
class PendingTransaction(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['PendingTransactionData']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'PendingTransactionData': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_id", "account_no", "created", "data", "id", "idemkey", "reference_id", "tenant", "updated", "uuid", "offset_account_id", "offset_account_no", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'PendingTransactionData': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_id", "account_no", "created", "data", "id", "idemkey", "reference_id", "tenant", "updated", "uuid", "offset_account_id", "offset_account_no", ], str]):
