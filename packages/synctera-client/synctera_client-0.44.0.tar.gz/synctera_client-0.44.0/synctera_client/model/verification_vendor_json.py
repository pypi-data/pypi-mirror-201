...
class VerificationVendorJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content_type", "json", "vendor", "details", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content_type", "json", "vendor", "details", ], str]):
