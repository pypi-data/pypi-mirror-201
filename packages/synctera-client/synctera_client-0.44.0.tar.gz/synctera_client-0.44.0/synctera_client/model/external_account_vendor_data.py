...
class ExternalAccountVendorData(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["account_number_mask", "institution_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["account_number_mask", "institution_id", ], str]):
