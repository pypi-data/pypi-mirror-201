        ...
        class properties:
            ...
            class result(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['PostedTransaction']:
                        return PostedTransaction
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['PostedTransaction'], typing.List['PostedTransaction']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'result':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'PostedTransaction':
