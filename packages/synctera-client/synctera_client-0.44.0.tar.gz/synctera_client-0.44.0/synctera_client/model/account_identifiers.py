...
class AccountIdentifiers(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["number", "iban", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["number", "iban", ], str]):
