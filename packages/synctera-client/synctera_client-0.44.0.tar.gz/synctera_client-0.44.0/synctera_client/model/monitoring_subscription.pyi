...
class MonitoringSubscription(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["business_id", "creation_time", "id", "last_updated_time", "metadata", "person_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["business_id", "creation_time", "id", "last_updated_time", "metadata", "person_id", ], str]):
