...
class ResponsePersonalIdWCust(
    ...
    class MetaOapg:
        ...
        class all_of_3(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["tenant", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tenant", ], str]):
    ...
    country_code: schemas.AnyTypeSchema
    identifier: schemas.AnyTypeSchema
    id_type: schemas.AnyTypeSchema
    id: schemas.AnyTypeSchema
    system_provided: schemas.AnyTypeSchema
    customer_id: schemas.AnyTypeSchema
    tenant: schemas.AnyTypeSchema
