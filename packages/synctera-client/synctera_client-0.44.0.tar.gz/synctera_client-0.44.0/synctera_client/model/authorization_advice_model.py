...
class AuthorizationAdviceModel(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "original_transaction_id", "network_fees", "transaction_options", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "original_transaction_id", "network_fees", "transaction_options", ], str]):
