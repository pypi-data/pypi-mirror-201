...
class CustomerServiceDetails(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def address() -> typing.Type['Address2']:
                return Address2
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["address"]) -> 'Address2': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address", "email", "phone_number", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["address"]) -> typing.Union['Address2', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address", "email", "phone_number", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        address: typing.Union['Address2', schemas.Unset] = schemas.unset,
