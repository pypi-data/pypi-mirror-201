...
class ClientToken(
    ...
    class MetaOapg:
        ...
        class properties:
            client_token = schemas.StrSchema
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_token", ], str]):
