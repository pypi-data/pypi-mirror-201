...
class FulfillmentDetails(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ship_date", "shipping_method", "tracking_number", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ship_date", "shipping_method", "tracking_number", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ship_date: typing.Union[MetaOapg.properties.ship_date, str, date, schemas.Unset] = schemas.unset,
