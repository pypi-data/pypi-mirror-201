...
class AccountLineOfCredit(
    ...
    class MetaOapg:
        ...
        class all_of_1(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["chargeoff_period", "credit_limit", "delinquency_period", "grace_period", "interest_product_id", "minimum_payment", "note", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["chargeoff_period", "credit_limit", "delinquency_period", "grace_period", "interest_product_id", "minimum_payment", "note", ], str]):
