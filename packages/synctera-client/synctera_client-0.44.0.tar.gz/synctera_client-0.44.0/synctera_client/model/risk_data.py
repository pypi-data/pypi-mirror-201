...
class RiskData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["client_ip", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["client_ip", ], str]):
