...
class MonitoringSubscriptionList(
                ...
                class properties:
                    ...
                    class subscriptions(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['MonitoringSubscription']:
                                return MonitoringSubscription
                    
                        def __new__(
                            cls,
                            _arg: typing.Union[typing.Tuple['MonitoringSubscription'], typing.List['MonitoringSubscription']],
                        ...
                        def __getitem__(self, i: int) -> 'MonitoringSubscription':
