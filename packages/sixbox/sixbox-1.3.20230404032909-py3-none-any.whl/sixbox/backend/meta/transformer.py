...
class Transform:
    ...
    def to_automation(automation):
        from sixbox.backend.models.automation import Automation
        if not automation:
    ...
    def to_automation_member(member):
        from sixbox.backend.models.automation import AutomationMember
        if not member:
    ...
    def to_automation_package(package):
        from sixbox.backend.models.automation import AutomationPackage
        if not package:
