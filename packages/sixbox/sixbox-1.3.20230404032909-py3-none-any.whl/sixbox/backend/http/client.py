...
from sixbox.backend import __version__
from sixbox.backend.errors import SbgError, URITooLong
from sixbox.backend.config import Config, format_proxies
from sixbox.backend.models.enums import RequestParameters
from sixbox.backend.decorators import check_for_error, throttle
from sixbox.backend.http.error_handlers import maintenance_sleeper
...
class HttpClient:
    ...
    def __init__(
        ...
        self.headers = {
            ...
            'User-Agent': (
                'sixbox-python/{version} ({os}, Python/{python}; '
