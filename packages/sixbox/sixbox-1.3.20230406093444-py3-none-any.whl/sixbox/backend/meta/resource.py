...
from sixbox.backend.errors import SbgError, NonJSONResponseError
from sixbox.backend.meta.fields import Field
from sixbox.backend.meta.data import DataContainer
...
class Resource(metaclass=ResourceMeta):
    ...
    def get(cls, id, api=None):
        ...
        :param api: sixbox.backend.Api instance.
