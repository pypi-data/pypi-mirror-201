...
from sixbox.backend.http.client import HttpClient

from sixbox.backend.models.pipe import App
from sixbox.backend.models.case import Case
from sixbox.backend.models.file import File

from sixbox.backend.models.task import Task
from sixbox.backend.models.team import Team
...
from sixbox.backend.models.actions import Actions
...
from sixbox.backend.models.rate_limit import RateLimit
from sixbox.backend.models.storage_export import Export
from sixbox.backend.models.storage_import import Import
from sixbox.backend.models.enums import RequestParameters
from sixbox.backend.models.billing_group import BillingGroup
...
class Api(HttpClient):
    ...
    def __init__(
        ...
        if not debug and url and url.startswith('http:'):
            ...
            # )
            warnings.warn('You are using http, we recommand https for api requests...')
        super().__init__(
