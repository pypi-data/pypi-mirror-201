...
class DynamicsInitialization():
    ...
    def markerOffsets(self, arg0: typing.Dict[str, numpy.ndarray[numpy.float64, _Shape[3, 1]]]) -> None:
        pass
    @property
    def missingGRFReason(self) -> typing.List[typing.List[dart::biomechanics::MissingGRFReason]]:
        """
        :type: typing.List[typing.List[dart::biomechanics::MissingGRFReason]]
        """
    @missingGRFReason.setter
    def missingGRFReason(self, arg0: typing.List[typing.List[dart::biomechanics::MissingGRFReason]]) -> None:
        pass
    @property
