...
def test_components():
    ...
    metadata_df.at[metadata_df['Name'] == 'Area A_Compressor Power', 'Freezer'] = 'Freezer 1'
    metadata_df.at[metadata_df['Name'] == 'Area B_Compressor Power', 'Refrigerator'] = 'Refrigerator 1'
    metadata_df.at[metadata_df['Name'] == 'Area B_Compressor Power', 'Freezer'] = 'Freezer 2'
    ...
    metadata_df.at[metadata_df['Name'] == 'Area C_Compressor Power', 'Freezer'] = 'Freezer 3'
    metadata_df.at[metadata_df['Name'] == 'Area D_Compressor Power', 'Refrigerator'] = 'Refrigerator 2'
    metadata_df.at[metadata_df['Name'] == 'Area D_Compressor Power', 'Freezer'] = 'Freezer 4'
...
def test_reaching_up_and_down():
    ...
    search_results_df = search_results_df[search_results_df['Type'] == 'CalculatedScalar']

    assertions = [
        ('Continent >> Country', 'Asset 1', 'For My Child', 'CalculatedScalar'),
        ('Continent >> Country >> Asset 1', 'Child 1', 'From My Parent', 'CalculatedScalar'),
        ('Continent >> Country >> Asset 1 >> Child 1', 'Grandchild 1', 'My Simple Scalar', 'CalculatedScalar'),
        ...
        ('Continent >> Country >> Asset 1 >> Child 1 >> Grandchild 1', 'GreatGrandchild 2', 'My Height',
         'CalculatedScalar'),
        ('Continent >> Country >> Asset 1 >> Child 1', 'Grandchild 2', 'My Simple Scalar', 'CalculatedScalar'),
        ...
        ('Continent >> Country >> Asset 1 >> Child 2', 'Grandchild 1', 'My Simple Scalar', 'CalculatedScalar'),
        ...
        ('Continent >> Country >> Asset 1 >> Child 2 >> Grandchild 1', 'GreatGrandchild 2', 'My Height',
         'CalculatedScalar'),
        ('Continent >> Country >> Asset 1 >> Child 2', 'Grandchild 2', 'My Simple Scalar', 'CalculatedScalar'),
...
def test_workbook_build_no_date_ranges():
    ...
    assert len(doc.document.date_ranges) == 0
