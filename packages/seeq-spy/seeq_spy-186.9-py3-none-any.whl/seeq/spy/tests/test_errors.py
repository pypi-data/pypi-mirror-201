...
class MockIPython(contextlib.AbstractContextManager):
    def __init__(self, shell: InteractiveShell):
        self._errors_dot_py_context = patch('seeq.spy._errors.get_ipython')
        self._datalab_dot_py_context = patch('seeq.spy._datalab.get_ipython')
        self.shell = shell
...
def test_show_stacktrace_button():
    ...
    assert 'test_errors.py in raise_index_error' in output
