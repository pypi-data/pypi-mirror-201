import os
import pymssql
RABBITMQ_USERNAME = 'default_user_TN9rDBqjZL-UFzO1JdM' #os.environ.get('RABBITMQ_USERNAME')
RABBITMQ_PASSWORD = 'CcCWwPpEXEcyDryvqnZ9_JYUG9YKBkrb' #os.environ.get('RABBITMQ_PASSWORD')
