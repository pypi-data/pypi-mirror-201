...
def lazy_import():
    ...
    globals()['OrderCompatibilities'] = OrderCompatibilities
...
class Order(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, demands, *args, **kwargs):  
        """Order - a model defined in OpenAPI

        Args:
            key (str): Order key, unique identifier.
        ...
        Keyword Args:
            ...
            cargos ([Cargo]): Cargo list. Can contain one cargo for `DROP`, a list for `PICKUP`, should be empty for `WORK`. . [optional] if omitted the server will use the default value of []  
            compatibilities (OrderCompatibilities): [optional]  
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, demands, *args, **kwargs):  
        """Order - a model defined in OpenAPI
