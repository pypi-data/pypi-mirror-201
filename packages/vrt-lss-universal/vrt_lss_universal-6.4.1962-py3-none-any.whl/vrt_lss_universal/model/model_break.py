...
class ModelBreak(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'max_work_duration_sum': (TimeDuration,),  
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, max_work_duration_sum, duration, *args, **kwargs):  
    ...
    @convert_js_args_to_python_args
    def __init__(self, max_work_duration_sum, duration, *args, **kwargs):  
        """ModelBreak - a model defined in OpenAPI
