...
class ReplanTask(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, locations, orders, performers, transports, trips, *args, **kwargs):  
        """ReplanTask - a model defined in OpenAPI

        Args:
            locations ([Location]): List of locations used for orders and shifts.
            orders ([Order]): Orders list.
            performers ([Performer]): Available performers list.
            transports ([Transport]): Available transports list.
            trips ([Trip]): Existing routes.
        ...
        Keyword Args:
            ...
            hardlinks ([Hardlink]): Assignments list.. [optional] if omitted the server will use the default value of []  
    ...
    @convert_js_args_to_python_args
    def __init__(self, locations, orders, performers, transports, trips, *args, **kwargs):  
        """ReplanTask - a model defined in OpenAPI
