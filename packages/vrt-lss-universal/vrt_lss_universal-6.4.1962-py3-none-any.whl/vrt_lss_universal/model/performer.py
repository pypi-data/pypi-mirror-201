...
def lazy_import():
    ...
    globals()['PerformerCompatibilities'] = PerformerCompatibilities
    globals()['PerformerLimits'] = PerformerLimits
    globals()['PerformerShift'] = PerformerShift
...
class Performer(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'key': (str,),  
            'shifts': ([PerformerShift],),  
            'own_transport_type': (TransportType,),  
            'compatibilities': (PerformerCompatibilities,),  
            'limits': (PerformerLimits,),  
    ...
    def _from_openapi_data(cls, key, shifts, *args, **kwargs):  
        ...
        Args:
            key (str): Performer's key, unique identifier.
            shifts ([PerformerShift]): List of working shifts of performer.
        ...
        Keyword Args:
            ...
            own_transport_type (TransportType): [optional]  
            compatibilities (PerformerCompatibilities): [optional]  
            limits (PerformerLimits): [optional]  
