...
def lazy_import():
    ...
    globals()['BoxCompatibilities'] = BoxCompatibilities
    globals()['BoxLimits'] = BoxLimits
...
class Box(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'key': (str,),  
            'capacity': (Capacity,),  
            'compatibilities': (BoxCompatibilities,),  
            'limits': (BoxLimits,),  
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, *args, **kwargs):  
        """Box - a model defined in OpenAPI

        Args:
            key (str): Unique compartment key used to identify the cargo placement in compartments.
        ...
        Keyword Args:
            ...
            compatibilities (BoxCompatibilities): [optional]  
            limits (BoxLimits): [optional]  
        """
