...
class Measurements(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, driving_time, waiting_time, break_time, working_time, arriving_time, departure_time, total_time, distance, time_window, *args, **kwargs):  
    ...
    @convert_js_args_to_python_args
    def __init__(self, driving_time, waiting_time, break_time, working_time, arriving_time, departure_time, total_time, distance, time_window, *args, **kwargs):  
        """Measurements - a model defined in OpenAPI
