...
def lazy_import():
    ...
    globals()['Trip'] = Trip
    globals()['UnplannedItems'] = UnplannedItems
...
class PlanResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tracedata, statistics, progress, info, *args, **kwargs):  
        ...
        Keyword Args:
            trips ([Trip]): Schedule of trips assigned to performers.. defaults to []  
            ...
            unplanned_items (UnplannedItems): [optional]  
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, tracedata, statistics, progress, info, *args, **kwargs):  
        """PlanResult - a model defined in OpenAPI
