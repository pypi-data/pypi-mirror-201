...
def lazy_import():
    ...
    globals()['AssignedPerformer'] = AssignedPerformer
    globals()['AssignedTransport'] = AssignedTransport
    globals()['Attributes'] = Attributes
    globals()['TripState'] = TripState
...
class Trip(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, performer, transport, states, *args, **kwargs):  
        """Trip - a model defined in OpenAPI

        Args:
            key (str): Unique trip identifier.
            performer (AssignedPerformer):
            transport (AssignedTransport):
            states ([TripState]): List of performer's states.
        ...
        Keyword Args:
            ...
            waitlist (TripWaitlist): [optional]  
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, performer, transport, states, *args, **kwargs):  
        """Trip - a model defined in OpenAPI
