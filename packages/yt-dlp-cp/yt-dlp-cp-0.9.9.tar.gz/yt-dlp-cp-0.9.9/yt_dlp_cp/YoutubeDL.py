...
class YoutubeDL:
    ...
    postprocessors:    A list of dictionaries, each with an entry
                       * key:  The name of the postprocessor. See
                               yt_dlp_cp/postprocessor/__init__.py for a list.
    ...
    the downloader (see yt_dlp_cp/downloader/common.py):
    ...
    def extract_info(self, url, download=False, ie_key=None, extra_info=None,
    ...
    def process_ie_result(self, ie_result, download=False, extra_info=None):
        """
    ...
    def _default_format_spec(self, info_dict, download=False):
    ...
    def process_video_result(self, info_dict, download=False):
    ...
    def download(self, url_list):
        ...
        for url in url_list:
            res = self.__download_wrapper(self.extract_info)(
    ...
    def download_with_info_file(self, info_filename):
        ...
        for info in infos:
            try:
                self.__download_wrapper(self.process_ie_result)(info, download=False)
