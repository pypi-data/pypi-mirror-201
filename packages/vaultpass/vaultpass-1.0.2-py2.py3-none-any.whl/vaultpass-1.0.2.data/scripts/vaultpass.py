...
def get_cyberark_auth_header(username: str, password: str):
	print('>> Authenticating to CyberArk ... <<')
	print()
	...
	try:	
		...
		print('Error ...')
		print('Message: There was an error retrieving the CyberArk authentication token.')
		print()
