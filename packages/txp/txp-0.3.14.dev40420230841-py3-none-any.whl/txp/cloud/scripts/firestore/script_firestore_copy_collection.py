...
if __name__ == '__main__':
    ...
    # get collection
    collection = db.collection(f'{collection_name}/laboratorio_showroom_manual_script/devices').get()

    for doc in collection:
        db.collection(f'{collection_name}/heinz_manual_script/devices').document(doc.id).set(doc.to_dict())
