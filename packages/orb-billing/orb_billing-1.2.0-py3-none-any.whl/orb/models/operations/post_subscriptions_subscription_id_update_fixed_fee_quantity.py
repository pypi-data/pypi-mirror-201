...
class PostSubscriptionsSubscriptionIDUpdateFixedFeeQuantityRequest:
    ...
    request_body: Optional[PostSubscriptionsSubscriptionIDUpdateFixedFeeQuantityRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
