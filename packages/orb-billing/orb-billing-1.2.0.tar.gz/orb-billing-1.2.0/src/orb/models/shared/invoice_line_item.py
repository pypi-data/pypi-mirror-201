...
class InvoiceLineItemSubLineItemsTypeEnum(str, Enum):
...
class InvoiceLineItemSubLineItems:
    ...
    type: InvoiceLineItemSubLineItemsTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
    r"""An identifier for a sub line item that is specific to a pricing model."""  
...
class InvoiceLineItem:
    ...
    grouping: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('grouping') }})
