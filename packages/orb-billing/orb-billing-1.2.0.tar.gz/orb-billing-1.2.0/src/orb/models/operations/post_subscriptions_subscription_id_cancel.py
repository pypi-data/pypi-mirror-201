...
class PostSubscriptionsSubscriptionIDCancelRequestBody:
    ...
    cancel_option: PostSubscriptionsSubscriptionIDCancelRequestBodyCancelOptionEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cancel_option') }})
    r"""Determines the timing of subscription cancellation"""  
...
class PostSubscriptionsSubscriptionIDCancelRequest:
    ...
    request_body: Optional[PostSubscriptionsSubscriptionIDCancelRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})  
