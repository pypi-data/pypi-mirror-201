...
class PostCustomersCustomerIDBalanceTransactionsRequestBodyTypeEnum(str, Enum):
    INCREMENT = 'increment'
    DECREMENT = 'decrement'
...
class PostCustomersCustomerIDBalanceTransactionsRequestBody:
    ...
    type: PostCustomersCustomerIDBalanceTransactionsRequestBodyTypeEnum = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})  
