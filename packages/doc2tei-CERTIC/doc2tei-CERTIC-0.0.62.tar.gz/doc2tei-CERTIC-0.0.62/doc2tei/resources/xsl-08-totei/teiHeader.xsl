...
<!--
                    <xsl:if test="$source='OpenEdition' and current-group()/.[@text:style-name='TEI_authority_biography']">
                        <note type="biography">
                          <xsl:apply-templates select="current-group()/.[@text:style-name='TEI_authority_biography']"/>
                        </note>
                    </xsl:if>
-->
...
<!-- blocs <ab> Métopes [todo] -->
            ...
            <ab type="site" subtype="openedition">
                <bibl>
                    ...
                    <idno type="documentnumber"><xsl:value-of select="//text:p[@text:style-name='TEI_document_number']"/></idno>
                    <idno type="DOI"></idno>
                    <idno type="URL"></idno>
                    <availability><licence></licence></availability>
                </bibl>
