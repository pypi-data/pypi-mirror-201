...
<xsl:template match="tei:publicationStmt">
    <publicationStmt>
        ...
        <xsl:if test="//tei:ab[@subtype='openedition']/tei:bibl/tei:idno[@type='documentnumber'] !=''">
            <xsl:copy-of select="//tei:ab[@subtype='openedition']/tei:bibl/tei:idno[@type='documentnumber']"/>
        </xsl:if>
<!--    <availability>
            <licence></licence>
        </availability>-->
...
<!-- ordonner les éléments dans les blocs figure ? 
