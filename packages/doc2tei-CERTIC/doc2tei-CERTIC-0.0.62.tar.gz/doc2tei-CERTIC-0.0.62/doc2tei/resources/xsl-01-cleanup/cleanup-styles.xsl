        ...
        <!-- enrichissements typo traitement de texte (l'application de styles de caractères ne génère pas de raccourcis de styles)-->
            ...
            <xsl:when test="matches(@text:style-name,'[T]\d{1,2}')">
                <xsl:choose>
                    ...
                    <xsl:when test="//style:style[@style:name=$currentStyle]/style:text-properties/(@fo:font-style|@fo:font-variant|@fo:font-weight|@style:text-position|@style:text-underline-style|@style:text-line-through-style)">
                    <xsl:element name="text:span">
            ...
            <xsl:when test="starts-with(@text:style-name,'apple') or starts-with(@text:style-name,'Internet_') or starts-with(@text:style-name,'Placeho')  or starts-with(@text:style-name,'fontstyle') or (@text:style-name='st') or (@text:style-name='text')  or (@text:style-name='Strong') or (@text:style-name='Aucun')">
                <xsl:apply-templates/>
            </xsl:when>
    ...
    <xsl:when test="$currentElementName='text:h' or ($currentElementName='text:p' and @text:outline-level)">
        <xsl:element name="text:h">
            ...
            <xsl:if test="//style:style[@style:name=$currentStyle][child::style:paragraph-properties[@style:writing-mode='rl-tb']]">
                ...
                <xsl:attribute name="text:style-name">#rtl</xsl:attribute>
             </xsl:if>
            <xsl:choose>
...
<!-- surcharge pour affecter un niveau de titre pour les références bibliographiques d'ouvrage recensé -->
...
-->
    ...
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_floatingText_5f_start'"><start type="floatingText"/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_floatingText_5f_end'"><end type="floatingText"/></xsl:when>
    <!-- début et fin de citations -->
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_quote_5f_start'"><start type="cit"/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_quote_5f_end'"><end type="cit"/></xsl:when>
    <!-- début et fin de code -->
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_code_5f_start'"><start type="code"/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_code_5f_end'"><end type="code"/></xsl:when>
    <!-- début et fin de figure -->
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_figure_5f_start'"><start type="figure"/></xsl:when>
    <xsl:when test="$currentElementName='text:p' and @text:style-name='TEI_5f_figure_5f_end'"><end  type="figure"/></xsl:when>
