...
class Rigging(Slots):
	...
	def __init__(self, *args, **kwargs):
		...
		tb000.ctxMenu.add('QCheckBox', setText='Joints', setObjectName='chk000', setChecked=True, setToolTip='Display Joints.')
		tb000.ctxMenu.add('QCheckBox', setText='IK', setObjectName='chk001', setChecked=True, setToolTip='Display IK.')
		tb000.ctxMenu.add('QCheckBox', setText='IK\\FK', setObjectName='chk002', setChecked=True, setToolTip='Display IK\\FK.')
		tb000.ctxMenu.add('QDoubleSpinBox', setPrefix='Tolerance: ', setObjectName='s000', setMinMax_='0.00-10 step.5', setValue=1.0, setToolTip='Global Display Scale for the selected type.')
		self.chk000() #init scale joint value

		tb001 = self.sb.rigging.tb001
		tb001.ctxMenu.add('QCheckBox', setText='Align world', setObjectName='chk003', setToolTip='Align joints with the worlds transform.')

		tb002 = self.sb.rigging.tb002
		tb002.ctxMenu.add('QCheckBox', setText='Template Child', setObjectName='chk004', setChecked=False, setToolTip='Template child object(s) after parenting.')		
		...
		tb003.ctxMenu.add('QCheckBox', setText='Bake Child Pivot', setObjectName='chk011', setChecked=True, setToolTip='Bake pivot positions on the child object.')
		...
		tb004.ctxMenu.add('QCheckBox', setText='Scale', setObjectName='chk014', setChecked=False, setToolTip='')
		self.sb.connect((tb004.ctxMenu.chk012, tb004.ctxMenu.chk013, tb004.ctxMenu.chk014), 'toggled', 
