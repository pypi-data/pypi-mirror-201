...
def setup_arg_parsing():
    ...
    env_parser.add_argument('--secure', default=True, help='Whether or not to verify SSL cert')
    ...
    parser_addazureadmintegration = subparsers.add_parser('addazureasmintegration', parents=[env_parser,discp_parser], formatter_class=argparse.ArgumentDefaultsHelpFormatter, help="Install a new Azure ADM integration")
    parser_addazureadmintegration.add_argument('--azname', required=True, help='displayName for the integration')
    parser_addazureadmintegration.add_argument('--azsub', required=True, help='Azure Subscription ID')
    parser_addazureadmintegration.add_argument('--azcert', required=True, help='Azure Management Certificate')
    parser_addazureadmintegration.add_argument('--azkspw', required=True, help='Azure Keystore Password')
