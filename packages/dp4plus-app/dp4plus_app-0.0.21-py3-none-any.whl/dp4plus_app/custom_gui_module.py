...
def download(): 
    ...
    def copy_and_exit():
        ...
        shutil.copy((Path(__file__).parent / "nmr_custom"/'custom_molecules_set.docx').as_posix(), 
                    dst_folder)
        shutil.copy((Path(__file__).parent / "nmr_custom"/'custom_wtl.xlsx').as_posix(), 
                    dst_folder)
...
def check_and_run():
    ...
    #----------------------------------------------------------------    
    #check inputs 
    l_end = tk.Label(custom_app, width = 40, anchor='w')
    ...
    def save_level():
        ...
        tk.Label(custom_app, width = 40, text = 'Processing . . .',
                 anchor='w').grid(row=4,column=1, columnspan= 2,sticky="nsew" )
