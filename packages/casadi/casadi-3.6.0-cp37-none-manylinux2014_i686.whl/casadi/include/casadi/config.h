...
#define CASADI_GIT_REVISION "b40629b2bd87661eb74fef60ab4f0b4a4b366417"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-1712.b40629b2b"  // NOLINT(whitespace/line_length)
...
#define CASADI_COMPILER_FLAGS " -pthread    -DUSE_CXX11 -DHAVE_MKSTEMPS -DCASADI_WITH_THREAD -DWITH_DEEPBIND -DCASADI_VERSION=31 -D_USE_MATH_DEFINES -D_SCL_SECURE_NO_WARNINGS -DWITH_DL -DWITH_FMU -DWITH_DEPRECATED_FEATURES"  // NOLINT(whitespace/line_length)
