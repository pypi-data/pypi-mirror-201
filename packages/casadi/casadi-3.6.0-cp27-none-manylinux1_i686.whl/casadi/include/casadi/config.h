...
#define CASADI_COMPILER_FLAGS " -std=c++11 -pthread    -DUSE_CXX11 -DHAVE_SIMPLE_MKSTEMPS -DCASADI_WITH_THREAD -DWITH_DEEPBIND -DCASADI_VERSION=31 -D_USE_MATH_DEFINES -D_SCL_SECURE_NO_WARNINGS -DWITH_DL -DWITH_FMU -DWITH_DEPRECATED_FEATURES"  // NOLINT(whitespace/line_length)
