...
class UserApi(object):
    ...
    def get_logged_user(
        ...
        **kwargs
        ...
        """Get current logged-in user for session  # noqa: E501

        Returns a user or null  # noqa: E501
    ...
    def get_user_by_username(
        ...
        **kwargs
        ...
        >>> thread = api.get_user_by_username(name, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['name'] = \
            name
        return self.get_user_by_username_endpoint.call_with_http_info(**kwargs)
