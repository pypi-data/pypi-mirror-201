...
if __name__ == '__main__':
    ...
    #
    # print(FilePlugin.image_convert_base64('text.png'))
    ...
    str="['aa','bb']"
    data = [
        {'id': '1',Constant.CASE_TITLE:'aa'},
        {'id': '1', Constant.CASE_TITLE: 'aa'},
        {'id': '1', Constant.CASE_TITLE: 'bb'},
    ]
    data_list_new = []
    for temp in data:
        if temp[Constant.CASE_TITLE] in str:
            data_list_new.append(temp)
    print(temp)

    # data1 = FilePlugin.load_file('calculateFee.json',_replace=False)
    # response = APIDriver.http_request('http://172.20.29.51:8380/mu/ssv/service/rest-ssv/tripReceive','post','data',data=data1)
