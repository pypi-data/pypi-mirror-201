...
enum : int {
    ...
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 433,
    ...
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 434,
    ...
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 435,
    SBK_QLOCALE_IDX                                          = 175,
    ...
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 307,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 305,
    SBK_QTIMEZONE_IDX                                        = 304,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 306,
    SBK_QTIMER_IDX                                           = 308,
    SBK_QTIMEREVENT_IDX                                      = 309,
    SBK_QTRANSLATOR_IDX                                      = 310,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 311,
    SBK_QURL_PARSINGMODE_IDX                                 = 315,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 316,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 314,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 120,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 317,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 122,
    SBK_QURL_ACEPROCESSINGOPTION_IDX                         = 313,
    SBK_QFLAGS_QURL_ACEPROCESSINGOPTION_IDX                  = 119,
    SBK_QURL_IDX                                             = 312,
    SBK_QURLQUERY_IDX                                        = 318,
    SBK_QUUID_VARIANT_IDX                                    = 321,
    SBK_QUUID_VERSION_IDX                                    = 322,
    SBK_QUUID_STRINGFORMAT_IDX                               = 320,
    SBK_QUUID_IDX                                            = 319,
    SBK_QVARIANTANIMATION_IDX                                = 323,
    SBK_QVERSIONNUMBER_IDX                                   = 324,
    SBK_QWAITCONDITION_IDX                                   = 325,
    ...
    SBK_QT_GLOBALCOLOR_IDX                                   = 373,
    SBK_QT_COLORSCHEME_IDX                                   = 352,
    SBK_QT_MOUSEBUTTON_IDX                                   = 389,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 136,
    SBK_QT_ORIENTATION_IDX                                   = 394,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 138,
    SBK_QT_FOCUSPOLICY_IDX                                   = 368,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 408,
    SBK_QT_SORTORDER_IDX                                     = 406,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 407,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 140,
    SBK_QT_TILERULE_IDX                                      = 413,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 339,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 123,
    SBK_QT_TEXTFLAG_IDX                                      = 410,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 409,
    SBK_QT_WHITESPACEMODE_IDX                                = 422,
    SBK_QT_HITTESTACCURACY_IDX                               = 375,
    SBK_QT_WINDOWTYPE_IDX                                    = 427,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 145,
    SBK_QT_WINDOWSTATE_IDX                                   = 426,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 144,
    SBK_QT_APPLICATIONSTATE_IDX                              = 342,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 124,
    SBK_QT_SCREENORIENTATION_IDX                             = 400,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 139,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 423,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 341,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 376,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 130,
    SBK_QT_BGMODE_IDX                                        = 346,
    SBK_QT_KEY_IDX                                           = 383,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 384,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 134,
    SBK_QT_MODIFIER_IDX                                      = 388,
    SBK_QT_ARROWTYPE_IDX                                     = 343,
    SBK_QT_PENSTYLE_IDX                                      = 397,
    SBK_QT_PENCAPSTYLE_IDX                                   = 395,
    SBK_QT_PENJOINSTYLE_IDX                                  = 396,
    SBK_QT_BRUSHSTYLE_IDX                                    = 347,
    SBK_QT_SIZEMODE_IDX                                      = 405,
    SBK_QT_UIEFFECT_IDX                                      = 421,
    SBK_QT_CURSORSHAPE_IDX                                   = 357,
    SBK_QT_TEXTFORMAT_IDX                                    = 411,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 344,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 360,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 125,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 361,
    SBK_QT_TOOLBARAREA_IDX                                   = 416,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 142,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 417,
    SBK_QT_DATEFORMAT_IDX                                    = 358,
    SBK_QT_TIMESPEC_IDX                                      = 414,
    SBK_QT_DAYOFWEEK_IDX                                     = 359,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 401,
    SBK_QT_CASESENSITIVITY_IDX                               = 348,
    SBK_QT_CORNER_IDX                                        = 356,
    SBK_QT_EDGE_IDX                                          = 363,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 127,
    SBK_QT_CONNECTIONTYPE_IDX                                = 353,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 403,
    SBK_QT_FILLRULE_IDX                                      = 366,
    SBK_QT_MASKMODE_IDX                                      = 386,
    SBK_QT_CLIPOPERATION_IDX                                 = 351,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 381,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 382,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 420,
    SBK_QT_AXIS_IDX                                          = 345,
    SBK_QT_FOCUSREASON_IDX                                   = 369,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 354,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 378,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 132,
    SBK_QT_INPUTMETHODHINT_IDX                               = 377,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 131,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 364,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 418,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 385,
    SBK_QT_ANCHORPOINT_IDX                                   = 340,
    SBK_QT_FINDCHILDOPTION_IDX                               = 367,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 128,
    SBK_QT_DROPACTION_IDX                                    = 362,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 126,
    SBK_QT_CHECKSTATE_IDX                                    = 349,
    SBK_QT_ITEMDATAROLE_IDX                                  = 379,
    SBK_QT_ITEMFLAG_IDX                                      = 380,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 133,
    SBK_QT_MATCHFLAG_IDX                                     = 387,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 135,
    SBK_QT_WINDOWMODALITY_IDX                                = 425,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 412,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 141,
    SBK_QT_EVENTPRIORITY_IDX                                 = 365,
    SBK_QT_SIZEHINT_IDX                                      = 404,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 424,
    SBK_QT_COORDINATESYSTEM_IDX                              = 355,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 419,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 143,
    SBK_QT_GESTURESTATE_IDX                                  = 371,
    SBK_QT_GESTURETYPE_IDX                                   = 372,
    SBK_QT_GESTUREFLAG_IDX                                   = 370,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 129,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 392,
    SBK_QT_NAVIGATIONMODE_IDX                                = 393,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 437,
    SBK_QT_TIMERTYPE_IDX                                     = 415,
    SBK_QT_SCROLLPHASE_IDX                                   = 402,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 391,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 390,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 137,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 350,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 374,
    SBK_QT_PERMISSIONSTATUS_IDX                              = 398,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 399,
    SBK_QtCoreQT_IDX                                         = 338,
    SBK_QTCOREHELPER_QGENERICARGUMENTHOLDER_IDX              = 429,
    SBK_QTCOREHELPER_QGENERICRETURNARGUMENTHOLDER_IDX        = 430,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 431,
    SBK_QCBORKNOWNTAGS_IDX                                   = 31,
    SBK_QCBORSIMPLETYPE_IDX                                  = 34,
    SBK_QCBORTAG_IDX                                         = 41,
    SBK_QTMSGTYPE_IDX                                        = 432,
    SBK_QtCore_IDX_COUNT                                     = 438
};
