...
enum : int {
    ...
    SBK_QTWIDGETS_QPAIR_QREAL_QPOINTF_IDX                    = 31, // QPair<qreal,QPointF >
    SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QPOINTF_IDX              = 32, // QList<QPair< qreal,QPointF > >
    SBK_QTWIDGETS_QPAIR_QREAL_QREAL_IDX                      = 33, // QPair<qreal,qreal >
    SBK_QTWIDGETS_QLIST_QPAIR_QREAL_QREAL_IDX                = 34, // QList<QPair< qreal,qreal > >
