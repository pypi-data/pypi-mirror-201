...
def qmlRegisterSingletonInstance(type_obj: type, uri: bytes, version_major: int, version_minor: int, qml_name: bytes, callback: object) -> int: ...
@overload
def qmlRegisterSingletonType(type_obj: type, uri: bytes, version_major: int, version_minor: int, qml_name: bytes) -> int: ...
@overload
def qmlRegisterSingletonType(type_obj: type, uri: bytes, version_major: int, version_minor: int, qml_name: bytes, callback: object) -> int: ...
@overload
def qmlRegisterSingletonType(uri: bytes, version_major: int, version_minor: int, qml_name: bytes, callback: object) -> int: ...
@overload
...
@overload
def qmlRegisterType(type_obj: type, uri: bytes, version_major: int, version_minor: int, qml_name: bytes) -> int: ...
@overload
...
def qmlRegisterUncreatableType(type_obj: type, uri: bytes, version_major: int, version_minor: int, qml_name: bytes, message: bytes) -> int: ...
