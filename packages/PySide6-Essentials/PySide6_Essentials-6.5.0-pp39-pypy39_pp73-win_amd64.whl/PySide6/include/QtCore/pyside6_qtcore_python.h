...
enum : int {
    ...
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 20, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 21, // QList<QPair< QString,QString > >
    ...
    SBK_QTCORE_QPAIR_QINT64_UNSIGNEDINT_IDX                  = 35, // QPair<qint64,unsigned int >
