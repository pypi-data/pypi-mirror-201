...
class GatherOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, indices, gather_dims, *, unique=None, loc=None, ip=None):
    ...
    attributes["gather_dims"] = gather_dims
...
class PackOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, dest, inner_dims_pos, inner_tiles, static_inner_tiles, *, padding_value=None, outer_dims_perm=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if outer_dims_perm is not None: attributes["outer_dims_perm"] = outer_dims_perm
    attributes["inner_dims_pos"] = inner_dims_pos
...
class ScatterOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, dest, indices, scatter_dims, *, unique=None, loc=None, ip=None):
    ...
    operands.append(_get_op_result_or_value(dest))
    operands.append(_get_op_result_or_value(indices))
    attributes["scatter_dims"] = scatter_dims
    if bool(unique): attributes["unique"] = _ods_ir.UnitAttr.get(
      _ods_get_default_loc_context(loc))
    results.append(result)
    _ods_successors = None
...
class UnPackOp(_ods_ir.OpView):
  ...
  def __init__(self, result, source, dest, inner_dims_pos, inner_tiles, static_inner_tiles, *, outer_dims_perm=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
