...
class KubernetesJobOperator(KubernetesJobOperatorDefaultsBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # 添加callable
        #assert python_callable is None or isinstance(python_callable, callable), ValueError("python_callable must be a callable or None")
    ...
    def execute(self, context):
        ...
        logging.info("测试context: " + context.__str__())
        logging.info("context.conf: " + context.get("conf").__str__())
        logging.info("context.dag_run: " + context.get("dag_run").__str__())
        logging.info("context.params: " + context.get("params").__str__())
        logging.info("context.task: " + context.get("task").__str__())
        logging.info("task: " + self.task_id)
        logging.info("envs: " + self.envs.__str__())
        params = context.get("params")
        logging.info("envs: " + params.get(self.task_id).__str__())
        self.envs = params.get(self.task_id)


        # self.envs = self.python_callable(context)
        # logging.info("测试env: " + self.envs.__str__())
        try:
