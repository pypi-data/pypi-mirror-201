...
from rebotics_sdk.providers import ReboticsBaseProvider, remote_service, PageResult
...
class FVMProvider(ReboticsBaseProvider):
    ...
    def upload_file(self, file_io, filename):
        file_io.seek(0)
    ...
    def download(self, url, destination=None, progress_bar=False):
        ...
        return remote_loaders.process_file_response(response, destination, progress_bar)
