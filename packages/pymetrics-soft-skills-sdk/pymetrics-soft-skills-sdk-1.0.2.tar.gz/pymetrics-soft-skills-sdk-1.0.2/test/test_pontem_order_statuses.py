...
from openapi_client.models.pontem_order_statuses import PontemOrderStatuses  # noqa: E501
from openapi_client.rest import ApiException

class TestPontemOrderStatuses(unittest.TestCase):
    """PontemOrderStatuses unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PontemOrderStatuses
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.pontem_order_statuses.PontemOrderStatuses()  # noqa: E501
        if include_optional :
            return PontemOrderStatuses(
            )
        else :
            return PontemOrderStatuses(
        )

    def testPontemOrderStatuses(self):
        """Test PontemOrderStatuses"""
