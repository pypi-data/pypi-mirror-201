...
from openapi_client.models.mercury_candidate import MercuryCandidate  # noqa: E501
from openapi_client.rest import ApiException

class TestMercuryCandidate(unittest.TestCase):
    """MercuryCandidate unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MercuryCandidate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.mercury_candidate.MercuryCandidate()  # noqa: E501
        if include_optional :
            return MercuryCandidate(
                first_name = '', 
                last_name = '', 
                email = '', 
                external_id = ''
