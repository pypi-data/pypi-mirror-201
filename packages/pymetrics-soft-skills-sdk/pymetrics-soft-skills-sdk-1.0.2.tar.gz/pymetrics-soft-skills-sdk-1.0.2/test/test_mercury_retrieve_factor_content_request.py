...
from openapi_client.models.mercury_retrieve_factor_content_request import MercuryRetrieveFactorContentRequest  # noqa: E501
from openapi_client.rest import ApiException

class TestMercuryRetrieveFactorContentRequest(unittest.TestCase):
    """MercuryRetrieveFactorContentRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MercuryRetrieveFactorContentRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.mercury_retrieve_factor_content_request.MercuryRetrieveFactorContentRequest()  # noqa: E501
        if include_optional :
            return MercuryRetrieveFactorContentRequest(
                uuid = ''
            )
        else :
            return MercuryRetrieveFactorContentRequest(
    ...
    def testMercuryRetrieveFactorContentRequest(self):
        """Test MercuryRetrieveFactorContentRequest"""
