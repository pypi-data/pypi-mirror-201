...
from openapi_client.models.pontem_report_types import PontemReportTypes  # noqa: E501
from openapi_client.rest import ApiException

class TestPontemReportTypes(unittest.TestCase):
    """PontemReportTypes unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PontemReportTypes
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.pontem_report_types.PontemReportTypes()  # noqa: E501
        if include_optional :
            return PontemReportTypes(
            )
        else :
            return PontemReportTypes(
        )

    def testPontemReportTypes(self):
        """Test PontemReportTypes"""
