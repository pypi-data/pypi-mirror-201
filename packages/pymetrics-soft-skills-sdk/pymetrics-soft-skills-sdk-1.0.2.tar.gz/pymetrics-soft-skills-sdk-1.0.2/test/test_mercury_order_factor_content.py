...
from openapi_client.models.mercury_order_factor_content import MercuryOrderFactorContent  # noqa: E501
from openapi_client.rest import ApiException

class TestMercuryOrderFactorContent(unittest.TestCase):
    """MercuryOrderFactorContent unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test MercuryOrderFactorContent
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.mercury_order_factor_content.MercuryOrderFactorContent()  # noqa: E501
        if include_optional :
            return MercuryOrderFactorContent(
                order = openapi_client.models.mercury_order_metadata.MercuryOrderMetadata(
                    id = '', 
                    status = 'Rejected', 
                    assessment_id = '', 
                    implementation_id = '', ), 
                factors = [
                    openapi_client.models.mercury_factor_content.MercuryFactorContent(
                        name = '', 
                        definition = '', 
                        quadrant = '', 
                        model_directions = [
                            openapi_client.models.mercury_model_direction.MercuryModelDirection(
                        ...
                        high_label = '', 
                        low_label = '', 
                        development_report_factor_content = openapi_client.models.mercury_development_report_content.MercuryDevelopmentReportContent(
                            results = '', 
                            strengths = '', 
                            maximize_strengths = [
                                ''
    ...
    def testMercuryOrderFactorContent(self):
        """Test MercuryOrderFactorContent"""
