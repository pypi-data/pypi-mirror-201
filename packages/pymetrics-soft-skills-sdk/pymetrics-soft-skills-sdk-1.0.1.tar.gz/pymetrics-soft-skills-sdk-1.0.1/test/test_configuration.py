...
from openapi_client.models.configuration import Configuration  # noqa: E501
...
class TestConfiguration(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.configuration.Configuration()  # noqa: E501
        if include_optional :
            return Configuration(
                assessments = [
                    openapi_client.models.mercury_assessment.MercuryAssessment(
                        id = '', 
                        type = 'games', 
                        description = '', )
                    ]
