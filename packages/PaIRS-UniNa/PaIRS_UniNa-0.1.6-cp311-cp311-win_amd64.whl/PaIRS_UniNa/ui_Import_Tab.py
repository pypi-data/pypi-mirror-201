...
"padding: 2px;")
        ...
        self.label_list.setMinimumSize(QSize(180, 20))
        ...
        self.check_TR_sequence.setLayoutDirection(Qt.RightToLeft)
        self.check_TR_sequence.setStyleSheet(u"border: none\n"
"")

        self.horizontalLayout_6.addWidget(self.check_TR_sequence)

        self.hs_TR = QSpacerItem(100, 26, QSizePolicy.Expanding, QSizePolicy.Minimum)

        self.horizontalLayout_6.addItem(self.hs_TR)
        ...
        self.check_subtract.setMinimumSize(QSize(200, 0))
        self.check_subtract.setMaximumSize(QSize(200, 16777215))
