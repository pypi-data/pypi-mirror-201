...
#*************************************************** Removal
    def removeFromCurrentTree(self,*args):
        ...
        if indTree==-1 and not self.FlagFastDelete:
            ...
            flag=self.questionDialog(WarningMessage)
        else:
            flag=True
        if indTree==1:
...
#*************************************************** Cleaning
    def cleanTreeQueue(self,*args):
        ...
        if self.questionDialog(WarningMessage):
...
#*************************************************** Example
    ...
    def setButtonPlay(self,flag):
        self.FlagPlay=flag
        if flag:
            self.ui.button_min.setIcon(self.icon_run_piv)
            self.ui.button_PIV.setIcon(self.icon_run_piv)
        else:
            self.ui.button_min.setIcon(self.icon_add)
            self.ui.button_PIV.setIcon(self.icon_add)
    """
