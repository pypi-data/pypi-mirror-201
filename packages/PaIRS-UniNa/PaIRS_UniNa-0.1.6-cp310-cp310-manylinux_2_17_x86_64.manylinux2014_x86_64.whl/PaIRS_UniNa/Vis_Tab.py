...
#*************************************************** From Parameters to UI
    ...
    def setCombos(self):
        ...
        if len(self.VISpar.combo_items):
            i=self.VISpar.combo_items.index(self.namesPIV.combo_list[self.VISpar.MapVar_type])
        else: i=-1
    ...
    def showImg(self):
        fields=['MapVar_type','flagMIN','nfield','vmin','vmax']
        ...
        if flagImg:
            ...
            self.ui.plot.fig.get_axes()[1].set_title("I")
        ...
        flagImg=flagImg or flagXLim or flagIW
        if flagImg: 
            self.ui.plot.draw()
    ...
    def showVecField(self,flagVecField):
        if flagVecField:
            ...
            if self.stream!=None:
                ...
                for art in self.ui.plot.axes.get_children():
