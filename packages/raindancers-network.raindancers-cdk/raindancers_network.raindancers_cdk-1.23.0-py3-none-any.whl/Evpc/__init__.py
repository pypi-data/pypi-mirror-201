...
class AddAwsServiceEndPointsProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AddAwsServiceEndPointsProps.__init__)
...
class AssignmentOptions:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(AssignmentOptions.__init__)
...
class AssociateSharedResolverRule(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AssociateSharedResolverRule.__init__)
...
class AssociateSharedResolverRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(AssociateSharedResolverRuleProps.__init__)
...
@jsii.data_type(
    jsii_type="raindancers-network.CentralAccount",
    jsii_struct_bases=[],
    name_mapping={"account_id": "accountId", "role_arn": "roleArn"},
)
class CentralAccount:
    def __init__(self, *, account_id: builtins.str, role_arn: builtins.str) -> None:
        '''
        :param account_id: 
        :param role_arn: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CentralAccount.__init__)
...
class CentralAccountAssnRole(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CentralAccountAssnRole.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def assn_role(self) -> aws_cdk.aws_iam.Role:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_iam.Role, jsii.get(self, "assnRole"))
...
class CentralAccountAssnRoleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CentralAccountAssnRoleProps.__init__)
...
class CentralResolverRules(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CentralResolverRules.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = CentralResolverRulesProps(domains=domains, resolvers=resolvers)
...
@jsii.data_type(
    ...
    jsii_struct_bases=[],
    name_mapping={"domains": "domains", "resolvers": "resolvers"},
)
class CentralResolverRulesProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CentralResolverRulesProps.__init__)
...
class ConditionalForwarder(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        forwarding_rules: typing.Sequence[typing.Union["OutboundForwardingRule", typing.Dict[str, typing.Any]]],
        inbound_resolver_targets: typing.Sequence[typing.Union[aws_cdk.aws_route53resolver.CfnResolverRule.TargetAddressProperty, typing.Dict[str, typing.Any]]],
        outbound_resolver: aws_cdk.aws_route53resolver.CfnResolverEndpoint,
        vpc: aws_cdk.aws_ec2.Vpc,
    ) -> None:
        '''
        :param scope: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ConditionalForwarder.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ConditionalForwarderProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ConditionalForwarderProps.__init__)
    ...
    def inbound_resolver_targets(
        ...
        return typing.cast(typing.List[aws_cdk.aws_route53resolver.CfnResolverRule.TargetAddressProperty], result)
    ...
    def outbound_resolver(self) -> aws_cdk.aws_route53resolver.CfnResolverEndpoint:
        ...
        return typing.cast(aws_cdk.aws_route53resolver.CfnResolverEndpoint, result)
...
class CrowdStrikeExtendedEndpoint(
    ...
    def __init__(
        ...
        *,
        ...
        peering_vpc: typing.Optional[typing.Union["VpcRegionId", typing.Dict[str, typing.Any]]] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrowdStrikeExtendedEndpoint.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class CrowdStrikeExtendedEndpointProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(CrowdStrikeExtendedEndpointProps.__init__)
...
class CrowdStrikeNLB(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrowdStrikeNLB.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class CrowdStrikeNLBProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrowdStrikeNLBProps.__init__)
...
class CrowdStrikePrivateLinkEndpoint(
    ...
    def __init__(
        ...
        *,
        ...
        subnets: typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]],
        vpc: aws_cdk.aws_ec2.Vpc,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(CrowdStrikePrivateLinkEndpoint.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def download(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CrowdStrikePrivateLinkEndpoint, "download").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def downloadhosted_zone(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CrowdStrikePrivateLinkEndpoint, "downloadhosted_zone").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def downloadhosted_zone_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CrowdStrikePrivateLinkEndpoint, "downloadhosted_zone_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def proxy(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CrowdStrikePrivateLinkEndpoint, "proxy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def proxyhosted_zone(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CrowdStrikePrivateLinkEndpoint, "proxyhosted_zone").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def proxyhosted_zone_name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(CrowdStrikePrivateLinkEndpoint, "proxyhosted_zone_name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class CrowdStrikePrivateLinkEndpointProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(CrowdStrikePrivateLinkEndpointProps.__init__)
    ...
    @builtins.property
    def subnets(self) -> aws_cdk.aws_ec2.SubnetSelection:
        '''
        :stability: experimental
        '''
...
class CrowdStrikeServices:
    def __init__(
        ...
        *,
        ...
        download_server: typing.Union["Endpoint", typing.Dict[str, typing.Any]],
        sensor_proxy: typing.Union["Endpoint", typing.Dict[str, typing.Any]],
    ) -> None:
        '''
        :param aws_region: 
        ...
        if __debug__:
            type_hints = typing.get_type_hints(CrowdStrikeServices.__init__)
...
class DataLakeBucket(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="raindancers-network.DataLakeBucket",
):
    '''
    :stability: experimental
    '''
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataLakeBucket.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = DataLakeBucketProps(name=name)
    ...
    def bucket(self, value: aws_cdk.aws_s3.Bucket) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DataLakeBucket, "bucket").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "bucket", value)


@jsii.data_type(
    jsii_type="raindancers-network.DataLakeBucketProps",
    jsii_struct_bases=[],
...
class DataLakeBucketProps:
    def __init__(self, *, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DataLakeBucketProps.__init__)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
        self._values: typing.Dict[str, typing.Any] = {
            "name": name,
        }
...
class DatalakeUserPolicy(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="raindancers-network.DatalakeUserPolicy",
):
    '''
    :stability: experimental
    '''
    ...
    def __init__(self, scope: constructs.Construct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DatalakeUserPolicy.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def managed_policy(self) -> aws_cdk.aws_iam.ManagedPolicy:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_iam.ManagedPolicy, jsii.get(self, "managedPolicy"))

    @managed_policy.setter
    def managed_policy(self, value: aws_cdk.aws_iam.ManagedPolicy) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DatalakeUserPolicy, "managed_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "managedPolicy", value)
...
class DynamicTagResourceGroup(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DynamicTagResourceGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def name(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(DynamicTagResourceGroup, "name").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class DynamicTagResourceGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DynamicTagResourceGroupProps.__init__)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
        self._values: typing.Dict[str, typing.Any] = {
            "name": name,
...
class DynamicTagResourceGroupSet:
    def __init__(self, *, arn: builtins.str, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(DynamicTagResourceGroupSet.__init__)
...
class ESubnetGroup:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ESubnetGroup.__init__)
...
class ESubnetGroupProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ESubnetGroupProps.__init__)
            check_type(argname="argument cidr_mask", value=cidr_mask, expected_type=type_hints["cidr_mask"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument subnet_type", value=subnet_type, expected_type=type_hints["subnet_type"])
        self._values: typing.Dict[str, typing.Any] = {
...
class EnforceImdsv2(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        instances: typing.Union[aws_cdk.aws_ec2.Instance, typing.Sequence[aws_cdk.aws_ec2.Instance]],
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnforceImdsv2.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class EnforceImdsv2Props:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnforceImdsv2Props.__init__)
    ...
    def instances(
        self,
    ) -> typing.Union[aws_cdk.aws_ec2.Instance, typing.List[aws_cdk.aws_ec2.Instance]]:
        ...
        return typing.cast(typing.Union[aws_cdk.aws_ec2.Instance, typing.List[aws_cdk.aws_ec2.Instance]], result)
...
class EnterpriseVpc(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        evpc: typing.Optional[typing.Union["EvpcProps", typing.Dict[str, typing.Any]]] = None,
    ...
    def add_central_resolver_rules(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.add_central_resolver_rules)
            check_type(argname="argument domains", value=domains, expected_type=type_hints["domains"])
        return typing.cast(None, jsii.invoke(self, "addCentralResolverRules", [domains]))
    ...
    def add_conditional_fowarding_rules(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.add_conditional_fowarding_rules)
            check_type(argname="argument forwarding_rules", value=forwarding_rules, expected_type=type_hints["forwarding_rules"])
    ...
    def add_cross_account_r53_association_role(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.add_cross_account_r53_association_role)
    ...
    def add_network_firewall(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.add_network_firewall)
    ...
    def add_private_hosted_zone(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.add_private_hosted_zone)
            check_type(argname="argument zonename", value=zonename, expected_type=type_hints["zonename"])
        return typing.cast(aws_cdk.aws_route53.HostedZone, jsii.invoke(self, "addPrivateHostedZone", [zonename]))
    ...
    def add_r53_resolvers(self, subnet: "SubnetGroup") -> "R53Resolverendpoints":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.add_r53_resolvers)
            check_type(argname="argument subnet", value=subnet, expected_type=type_hints["subnet"])
    ...
    @jsii.member(jsii_name="addSubnet")
    def add_subnet(
        self,
        name: builtins.str,
        subnet_type: aws_cdk.aws_ec2.SubnetType,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.add_subnet)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument subnet_type", value=subnet_type, expected_type=type_hints["subnet_type"])
            check_type(argname="argument cidr_mask", value=cidr_mask, expected_type=type_hints["cidr_mask"])
        return typing.cast("SubnetGroup", jsii.invoke(self, "addSubnet", [name, subnet_type, cidr_mask]))
    ...
    def create_and_share_subnet_prefix_list(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.create_and_share_subnet_prefix_list)
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
            check_type(argname="argument subnets", value=subnets, expected_type=type_hints["subnets"])
            check_type(argname="argument org_arn", value=org_arn, expected_type=type_hints["org_arn"])
        return typing.cast(aws_cdk.aws_ec2.CfnPrefixList, jsii.invoke(self, "createAndShareSubnetPrefixList", [name, subnets, org_arn]))
    ...
    def router(
        self,
        router_groups: typing.Sequence[typing.Union["RouterGroup", typing.Dict[str, typing.Any]]],
    ) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpc.router)
    ...
    def subnet_configuration(self, value: typing.List["SubnetGroup"]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EnterpriseVpc, "subnet_configuration").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def firewall_arn(self, value: typing.Optional[builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EnterpriseVpc, "firewall_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def r53endpoint_resolvers(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(EnterpriseVpc, "r53endpoint_resolvers").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class EnterpriseVpcLambda(
    ...
    def __init__(self, scope: constructs.Construct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseVpcLambda.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        jsii.create(self.__class__, self, [scope, id])
...
class EnterpriseZone(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        central_account: typing.Union[CentralAccount, typing.Dict[str, typing.Any]],
        enterprise_domain_name: builtins.str,
        local_vpc: aws_cdk.aws_ec2.Vpc,
        remote_vpc: typing.Sequence[typing.Union["RemoteVpc", typing.Dict[str, typing.Any]]],
    ) -> None:
        '''
        :param scope: -
        :param id: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseZone.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def private_zone(self) -> aws_cdk.aws_route53.PrivateHostedZone:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_route53.PrivateHostedZone, jsii.get(self, "privateZone"))
...
class EnterpriseZoneProps:
    def __init__(
        ...
        *,
        ...
        :stability: experimental
        '''
        if isinstance(central_account, dict):
            central_account = CentralAccount(**central_account)
        if __debug__:
            type_hints = typing.get_type_hints(EnterpriseZoneProps.__init__)
            check_type(argname="argument central_account", value=central_account, expected_type=type_hints["central_account"])
            ...
            check_type(argname="argument remote_vpc", value=remote_vpc, expected_type=type_hints["remote_vpc"])
        self._values: typing.Dict[str, typing.Any] = {
            "central_account": central_account,
            "enterprise_domain_name": enterprise_domain_name,
            "local_vpc": local_vpc,
    ...
    @builtins.property
    def central_account(self) -> CentralAccount:
        '''
        :stability: experimental
        '''
        result = self._values.get("central_account")
        assert result is not None, "Required property 'central_account' is missing"
        return typing.cast(CentralAccount, result)
    ...
    @builtins.property
    def local_vpc(self) -> aws_cdk.aws_ec2.Vpc:
        '''
        :stability: experimental
        '''
    ...
    @builtins.property
    def remote_vpc(self) -> typing.List["RemoteVpc"]:
        '''
        :stability: experimental
        '''
        result = self._values.get("remote_vpc")
        assert result is not None, "Required property 'remote_vpc' is missing"
        return typing.cast(typing.List["RemoteVpc"], result)
...
class FQDNStatefulRule(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FQDNStatefulRule.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def prefix_list_set(self, value: typing.List["PrefixListSetInterface"]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(FQDNStatefulRule, "prefix_list_set").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def resource_group_sets(
        ...
        if __debug__:
            type_hints = typing.get_type_hints(getattr(FQDNStatefulRule, "resource_group_sets").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def uuid(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(FQDNStatefulRule, "uuid").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class FindPrefixList(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FindPrefixList.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def prefix_list_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(FindPrefixList, "prefix_list_id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class FindPrefixListProps:
    def __init__(self, *, prefix_list_name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FindPrefixListProps.__init__)
...
class ForwardingRules(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ForwardingRules.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class ForwardingRulesProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ForwardingRulesProps.__init__)
            check_type(argname="argument domains", value=domains, expected_type=type_hints["domains"])
...
class LakeFormationWorkFlowRole(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="raindancers-network.LakeFormationWorkFlowRole",
):
    '''
    :stability: experimental
    '''
    ...
    def __init__(self, scope: constructs.Construct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(LakeFormationWorkFlowRole.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        jsii.create(self.__class__, self, [scope, id])
    ...
    def role(self, value: aws_cdk.aws_iam.Role) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(LakeFormationWorkFlowRole, "role").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class NWFWRulesEngine:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(NWFWRulesEngine.__init__)
...
class PowerBIGateway:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PowerBIGateway.__init__)
    ...
    @builtins.property
    def instancetype(self) -> aws_cdk.aws_ec2.InstanceType:
        '''
        :stability: experimental
        '''
...
class PowerBIGatewayZoo(
    ...
    def __init__(
        ...
        *,
        ...
        gateways: typing.Sequence[typing.Union[PowerBIGateway, typing.Dict[str, typing.Any]]],
        initscript: builtins.str,
        r53zone_id: builtins.str,
        subnet: typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]],
        vpc: typing.Union[aws_cdk.aws_ec2.IVpc, aws_cdk.aws_ec2.Vpc],
        analytics_reporting: typing.Optional[builtins.bool] = None,
        cross_region_references: typing.Optional[builtins.bool] = None,
        description: typing.Optional[builtins.str] = None,
        env: typing.Optional[typing.Union[aws_cdk.Environment, typing.Dict[str, typing.Any]]] = None,
        permissions_boundary: typing.Optional[aws_cdk.PermissionsBoundary] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PowerBIGatewayZoo.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class PowerBIGatewayZooProps(aws_cdk.StackProps):
    def __init__(
        self,
        *,
        analytics_reporting: typing.Optional[builtins.bool] = None,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(PowerBIGatewayZooProps.__init__)
    ...
    @builtins.property
    def permissions_boundary(self) -> typing.Optional[aws_cdk.PermissionsBoundary]:
        '''Options for applying a permissions boundary to all IAM Roles and Users created within this Stage.

        :default: - no permissions boundary is applied
        '''
        result = self._values.get("permissions_boundary")
        return typing.cast(typing.Optional[aws_cdk.PermissionsBoundary], result)
    ...
    @builtins.property
    def vpc(self) -> typing.Union[aws_cdk.aws_ec2.IVpc, aws_cdk.aws_ec2.Vpc]:
        '''
        :stability: experimental
        '''
        result = self._values.get("vpc")
        assert result is not None, "Required property 'vpc' is missing"
        return typing.cast(typing.Union[aws_cdk.aws_ec2.IVpc, aws_cdk.aws_ec2.Vpc], result)
...
class PowerBiGateway(
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        cfg_secret: typing.Union[aws_cdk.aws_secretsmanager.ISecret, aws_cdk.aws_secretsmanager.Secret],
        hostname: builtins.str,
        initscript: builtins.str,
        instance_type: aws_cdk.aws_ec2.InstanceType,
        machine_image: aws_cdk.aws_ec2.WindowsImage,
        power_b_igateway_setup_script: typing.Union[aws_cdk.aws_ec2.S3DownloadOptions, typing.Dict[str, typing.Any]],
        subnet: typing.Union[aws_cdk.aws_ec2.SubnetSelection, typing.Dict[str, typing.Any]],
        vpc: typing.Union[aws_cdk.aws_ec2.IVpc, aws_cdk.aws_ec2.Vpc],
        zone: typing.Union[aws_cdk.aws_route53.IPrivateHostedZone, aws_cdk.aws_route53.PrivateHostedZone],
    ) -> None:
        '''
        :param scope: -
        :param id: -
    ...
    def add_egress_rule(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PowerBiGateway.add_egress_rule)
...
class PowerBiGatewayProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(power_b_igateway_setup_script, dict):
            power_b_igateway_setup_script = aws_cdk.aws_ec2.S3DownloadOptions(**power_b_igateway_setup_script)
        if isinstance(subnet, dict):
            subnet = aws_cdk.aws_ec2.SubnetSelection(**subnet)
        if __debug__:
            type_hints = typing.get_type_hints(PowerBiGatewayProps.__init__)
    ...
    def cfg_secret(
        self,
    ) -> typing.Union[aws_cdk.aws_secretsmanager.ISecret, aws_cdk.aws_secretsmanager.Secret]:
        '''
        :stability: experimental
        '''
        result = self._values.get("cfg_secret")
        assert result is not None, "Required property 'cfg_secret' is missing"
        return typing.cast(typing.Union[aws_cdk.aws_secretsmanager.ISecret, aws_cdk.aws_secretsmanager.Secret], result)
    ...
    @builtins.property
    def machine_image(self) -> aws_cdk.aws_ec2.WindowsImage:
        '''
        :stability: experimental
        '''
        result = self._values.get("machine_image")
        assert result is not None, "Required property 'machine_image' is missing"
        return typing.cast(aws_cdk.aws_ec2.WindowsImage, result)

    @builtins.property
    def power_b_igateway_setup_script(self) -> aws_cdk.aws_ec2.S3DownloadOptions:
        '''
        :stability: experimental
        '''
        ...
        return typing.cast(aws_cdk.aws_ec2.S3DownloadOptions, result)
    ...
    def zone(
        self,
    ) -> typing.Union[aws_cdk.aws_route53.IPrivateHostedZone, aws_cdk.aws_route53.PrivateHostedZone]:
        '''
        :stability: experimental
        '''
        result = self._values.get("zone")
        assert result is not None, "Required property 'zone' is missing"
        return typing.cast(typing.Union[aws_cdk.aws_route53.IPrivateHostedZone, aws_cdk.aws_route53.PrivateHostedZone], result)
...
class PrefixCidr:
    def __init__(self, *, cidr: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrefixCidr.__init__)
            check_type(argname="argument cidr", value=cidr, expected_type=type_hints["cidr"])
        self._values: typing.Dict[str, typing.Any] = {
            "cidr": cidr,
        }
...
class PrefixList(
    ...
    def add_ec2_instance(self, props: aws_cdk.aws_ec2.Instance) -> None:
        '''
        :param props: -
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrefixList.add_ec2_instance)
            check_type(argname="argument props", value=props, expected_type=type_hints["props"])
        return typing.cast(None, jsii.invoke(self, "addEC2Instance", [props]))

    @builtins.property
    @jsii.member(jsii_name="prefixlist")
    def prefixlist(self) -> aws_cdk.aws_ec2.CfnPrefixList:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_ec2.CfnPrefixList, jsii.get(self, "prefixlist"))
...
class PrefixListEntry:
    def __init__(self, *, cidr: builtins.str, description: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrefixListEntry.__init__)
            check_type(argname="argument cidr", value=cidr, expected_type=type_hints["cidr"])
            check_type(argname="argument description", value=description, expected_type=type_hints["description"])
        self._values: typing.Dict[str, typing.Any] = {
            "cidr": cidr,
...
class PrefixListSetInterface:
    def __init__(self, *, arn: builtins.str, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrefixListSetInterface.__init__)
            check_type(argname="argument arn", value=arn, expected_type=type_hints["arn"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
        self._values: typing.Dict[str, typing.Any] = {
            "arn": arn,
...
class PrivateRedshiftCluster(
    ...
    def __init__(
        ...
        *,
        ...
        defaultrole: aws_cdk.aws_iam.Role,
        logging: typing.Union[aws_cdk.aws_redshift_alpha.LoggingProperties, typing.Dict[str, typing.Any]],
        master_user: builtins.str,
        subnet_group: aws_cdk.aws_redshift_alpha.ClusterSubnetGroup,
        vpc: typing.Union[aws_cdk.aws_ec2.IVpc, aws_cdk.aws_ec2.Vpc],
        default_db_name: typing.Optional[builtins.str] = None,
        nodes: typing.Optional[jsii.Number] = None,
        node_type: typing.Optional[aws_cdk.aws_redshift_alpha.NodeType] = None,
        parameter_group: typing.Optional[aws_cdk.aws_redshift_alpha.ClusterParameterGroup] = None,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrivateRedshiftCluster.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def add_database(self, database_name: builtins.str) -> "RedShiftDatabase":
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(PrivateRedshiftCluster.add_database)
    ...
    def cluster(self) -> aws_cdk.aws_redshift_alpha.Cluster:
        ...
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_redshift_alpha.Cluster, jsii.get(self, "cluster"))

    @builtins.property
    @jsii.member(jsii_name="clusterParameters")
    def cluster_parameters(self) -> aws_cdk.aws_redshift_alpha.ClusterParameterGroup:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_redshift_alpha.ClusterParameterGroup, jsii.get(self, "clusterParameters"))

    @builtins.property
    @jsii.member(jsii_name="clusterSecurityGroup")
    def cluster_security_group(self) -> aws_cdk.aws_ec2.SecurityGroup:
        '''
        :stability: experimental
        '''
        return typing.cast(aws_cdk.aws_ec2.SecurityGroup, jsii.get(self, "clusterSecurityGroup"))
...
class RedShiftDatabase(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RedShiftDatabase.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def execute_sql_statement(
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RedShiftDatabase.execute_sql_statement)
...
class RedShiftDatabaseProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RedShiftDatabaseProps.__init__)
...
class RedshiftClusterProps:
    def __init__(
        ...
        *,
        ...
        if isinstance(logging, dict):
            logging = aws_cdk.aws_redshift_alpha.LoggingProperties(**logging)
        if __debug__:
            type_hints = typing.get_type_hints(RedshiftClusterProps.__init__)
    ...
    @builtins.property
    def defaultrole(self) -> aws_cdk.aws_iam.Role:
        '''
        :stability: experimental
        '''
    ...
    @builtins.property
    def logging(self) -> aws_cdk.aws_redshift_alpha.LoggingProperties:
        '''
        :stability: experimental
        '''
        result = self._values.get("logging")
        assert result is not None, "Required property 'logging' is missing"
        return typing.cast(aws_cdk.aws_redshift_alpha.LoggingProperties, result)
    ...
    @builtins.property
    def subnet_group(self) -> aws_cdk.aws_redshift_alpha.ClusterSubnetGroup:
        '''
        :stability: experimental
        '''
        result = self._values.get("subnet_group")
        assert result is not None, "Required property 'subnet_group' is missing"
        return typing.cast(aws_cdk.aws_redshift_alpha.ClusterSubnetGroup, result)
    ...
    @builtins.property
    def node_type(self) -> typing.Optional[aws_cdk.aws_redshift_alpha.NodeType]:
        '''
        :stability: experimental
        '''
        result = self._values.get("node_type")
        return typing.cast(typing.Optional[aws_cdk.aws_redshift_alpha.NodeType], result)

    @builtins.property
    def parameter_group(
        self,
    ) -> typing.Optional[aws_cdk.aws_redshift_alpha.ClusterParameterGroup]:
        '''
        :stability: experimental
        '''
        result = self._values.get("parameter_group")
        return typing.cast(typing.Optional[aws_cdk.aws_redshift_alpha.ClusterParameterGroup], result)
...
class ReferenceSet:
    def __init__(self, *, arn: builtins.str, name: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ReferenceSet.__init__)
            check_type(argname="argument arn", value=arn, expected_type=type_hints["arn"])
            check_type(argname="argument name", value=name, expected_type=type_hints["name"])
        self._values: typing.Dict[str, typing.Any] = {
            "arn": arn,
...
@jsii.data_type(
    jsii_type="raindancers-network.RemoteVpc",
    jsii_struct_bases=[],
...
class RemoteVpc:
    def __init__(self, *, vpc_id: builtins.str, vpc_region: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RemoteVpc.__init__)
...
class ResolveSubnetGroupName(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ResolveSubnetGroupName.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def subnet_selection(self, value: aws_cdk.aws_ec2.SubnetSelection) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(ResolveSubnetGroupName, "subnet_selection").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class ResolveSubnetGroupNameProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(ResolveSubnetGroupNameProps.__init__)
...
class RouterGroup:
    def __init__(
        self,
        *,
        routes: typing.Sequence[typing.Union[Route, typing.Dict[str, typing.Any]]],
        subnet_group: "SubnetGroup",
    ) -> None:
        '''
        :param routes: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(RouterGroup.__init__)
...
class SSOLakeFormationAdministrator(
    constructs.Construct,
    metaclass=jsii.JSIIMeta,
    jsii_type="raindancers-network.SSOLakeFormationAdministrator",
):
    '''
    :stability: experimental
    '''
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        work_flow_role: aws_cdk.aws_iam.Role,
    ) -> None:
        '''
        :param scope: -
        :param id: -
        :param work_flow_role: 

        :stability: experimental
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SSOLakeFormationAdministrator.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        props = SSOLakeFormationAdministratorProps(work_flow_role=work_flow_role)
    ...
    def managed_policy(self, value: aws_cdk.aws_iam.ManagedPolicy) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SSOLakeFormationAdministrator, "managed_policy").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "managedPolicy", value)


@jsii.data_type(
    jsii_type="raindancers-network.SSOLakeFormationAdministratorProps",
    jsii_struct_bases=[],
    name_mapping={"work_flow_role": "workFlowRole"},
)
class SSOLakeFormationAdministratorProps:
    def __init__(self, *, work_flow_role: aws_cdk.aws_iam.Role) -> None:
        '''(experimental) This Policy gets used inside a permissions set for SSO.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SSOLakeFormationAdministratorProps.__init__)
            check_type(argname="argument work_flow_role", value=work_flow_role, expected_type=type_hints["work_flow_role"])
        self._values: typing.Dict[str, typing.Any] = {
            "work_flow_role": work_flow_role,
        }

    @builtins.property
    def work_flow_role(self) -> aws_cdk.aws_iam.Role:
        '''
        :stability: experimental
        '''
        result = self._values.get("work_flow_role")
        assert result is not None, "Required property 'work_flow_role' is missing"
        return typing.cast(aws_cdk.aws_iam.Role, result)
    ...
    def __repr__(self) -> str:
        return "SSOLakeFormationAdministratorProps(%s)" % ", ".join(
            k + "=" + repr(v) for k, v in self._values.items()
        )
...
class StatefulRuleDatabase(
    ...
    def __init__(self, scope: constructs.Construct, id: builtins.str) -> None:
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(StatefulRuleDatabase.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
        jsii.create(self.__class__, self, [scope, id])
...
class SubnetGroup(
    ...
    def subnet(self, value: ESubnetGroup) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SubnetGroup, "subnet").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SuricataRuleGroup(
    ...
    def __init__(
        ...
        *,
        ...
        network_firewall_engine: typing.Union[NWFWRulesEngine, typing.Dict[str, typing.Any]],
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SuricataRuleGroup.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
    ...
    def rule_group_arn(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(SuricataRuleGroup, "rule_group_arn").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
...
class SuricataRuleGroupProps:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(SuricataRuleGroupProps.__init__)
...
class SuricataRuleProps:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(SuricataRuleProps.__init__)
            check_type(argname="argument action", value=action, expected_type=type_hints["action"])
            check_type(argname="argument destination", value=destination, expected_type=type_hints["destination"])
...
class TagFilter:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(TagFilter.__init__)
            check_type(argname="argument key", value=key, expected_type=type_hints["key"])
...
class UpdateSSMAgent(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UpdateSSMAgent.__init__)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
            check_type(argname="argument id", value=id, expected_type=type_hints["id"])
...
class UpdateSSMAgentProps:
    def __init__(self, *, instance: aws_cdk.aws_ec2.Instance) -> None:
        '''
        :param instance: (experimental) The EC2 Instance that will be udpated.
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(UpdateSSMAgentProps.__init__)
...
class VpcRegionId:
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(VpcRegionId.__init__)
...
class FQDNStatefulRuleProps(SuricataRuleProps):
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(FQDNStatefulRuleProps.__init__)
            check_type(argname="argument action", value=action, expected_type=type_hints["action"])
            check_type(argname="argument destination", value=destination, expected_type=type_hints["destination"])
            check_type(argname="argument dest_port", value=dest_port, expected_type=type_hints["dest_port"])
            check_type(argname="argument direction", value=direction, expected_type=type_hints["direction"])
...
__all__ = [
    ...
    "RouterGroup",
    "RuleGroupType",
    "SSOLakeFormationAdministrator",
    "SSOLakeFormationAdministratorProps",
    "SampleConfig",
    "Segment",
    "SegmentAction",
    "SegmentActionMode",
