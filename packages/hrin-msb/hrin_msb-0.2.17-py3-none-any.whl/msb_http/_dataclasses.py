...
class ApiRequestData:
	...
	def request_url(self):
		_host = self._api_host.rstrip("/")
		return f"{_host}/{self._api_endpoint}".rstrip("/")
...
class ApiResponseWrapper:
	...
	def to_json(self) -> dict:
		if self.response.headers.get(const_http.HEADER_NAME_CONTENT_TYPE) == const_http.CONTENT_TYPE_APPLICATION_JSON:
