...
MINOR = 4  # Change this if the functionality has changed, but we are still backwards compatible with previous MINOR versions. Set PATCH to 0
...
setup(
    ...
    version=VERSION,
    description="A package that assists with logging data from a test and writing it to a database like InfluxDB.",
    long_description=README,
    long_description_content_type="text/markdown",
    url="https://bitbucket.org/dataductus/influxdb-datalogger",
    author="Chloe Holst",
