...
# default: True
JSONSchemaItem = TypedDict('JSONSchemaItem', {
    ...
    'dependencies': Dict[str, Union["_CoreSchemaMetaSchemaObjectDependenciesAdditionalpropertiesAnyof0", "_CoreSchemaMetaSchemaObjectRequired"]],
    # WARNING: Forward references may not be supported.
    # See: https://github.com/camptocamp/jsonschema-gentypes/issues/9
...
_CoreSchemaMetaSchemaObjectMinlength = Union["_CoreSchemaMetaSchemaObjectMaxlength", "_CoreSchemaMetaSchemaObjectMinlengthAllof1"]
"""
...
_CoreSchemaMetaSchemaObjectTypeAnyof0 = Union[Literal["array"], Literal["boolean"], Literal["integer"], Literal["null"], Literal["number"], Literal["object"], Literal["string"]]
