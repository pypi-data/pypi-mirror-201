...
def industry_sw_list():
    ...
    industry=pd.DataFrame([
        ...
        #手工添加
        ['H','850813','半导体材料'],['H','850814','数字芯片设计'],['H','850815','模拟芯片设计'], 
        ['H','850817','集成电路封测'],['H','850818','半导体设备'],['H','850822','印刷电路板'], 
        ['H','850823','被动元件'],['H','850831','面板'],['H','850832','LED'], 
        ['H','850833','光学元件'],['H','850841','其他电子III'],['H','850853','品牌消费电子'], 
        ['H','850854','消费电子零部件及组装'],['H','850861','电子化学品III'],['H','850912','商用载货车'],
        ['H','850913','商用载客车'],['H','850922','车身附件及饰件'],
...
def industry_sw_list_all():
    ...
    功能：输出申万指数所有代码df。
    输入：
    输出：df，包括市场表征指数F，一级行业指数I，二级行业T，风格指数S
    """
    import pandas as pd
    import akshare as ak
