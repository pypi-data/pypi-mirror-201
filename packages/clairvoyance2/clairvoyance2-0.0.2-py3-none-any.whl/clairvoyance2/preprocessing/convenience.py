...
class ExtractTC(TransformerModel):
    ...
    def _extract(self, temporal_covariates: TimeSeriesSamples) -> Tuple[TimeSeriesSamples, Optional[TimeSeriesSamples]]:
...
class StaticFeaturesConcatenator(TransformerModel):
    ...
    def _transform(self, data: Dataset, **kwargs) -> Dataset:
        ...
        if (
            ...
            or python_type_from_np_pd_dtype(data.static_covariates.df.columns.dtype) == object
        ):
