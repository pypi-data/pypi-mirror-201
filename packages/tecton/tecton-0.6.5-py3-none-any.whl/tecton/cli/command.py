    ...
    def __init__(self, *args, callback, requires_auth=True, uses_workspace=False, **kwargs):
        ...
        def wrapper(ctx, *cbargs, **cbkwargs):
            ...
            if cluster_configured:
                ...
                try:
                    invoke_response = ctx.invoke(callback, *cbargs, **cbkwargs)
                    if isinstance(invoke_response, StateUpdateResponse):
                        state_update_event = invoke_response.state_update_event_metrics
