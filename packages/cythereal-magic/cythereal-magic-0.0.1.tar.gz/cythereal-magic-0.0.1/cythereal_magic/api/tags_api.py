...
class TagsApi(object):
    ...
    def bulk_tag_operation(self, **kwargs):  # noqa: E501
        """Lists information on a bulk selection of tags  # noqa: E501

           Lists information on a bulk selection of tags           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bulk_tag_operation(async_req=True)
        >>> result = thread.get()
        ...
        :param object update_mask: REQUIRED for `PATCH` methods. Comma separated string containing a list of keys to update based on the request body.  REGEX: `^(([\\w]+,?)*|\\*)$`
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.bulk_tag_operation_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.bulk_tag_operation_with_http_info(**kwargs)  # noqa: E501
            return data

    def bulk_tag_operation_with_http_info(self, **kwargs):  # noqa: E501
        """Lists information on a bulk selection of tags  # noqa: E501

           Lists information on a bulk selection of tags           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bulk_tag_operation_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'action', 'expand_mask', 'force', 'read_mask', 'strict', 'update_mask']  # noqa: E501
    ...
    def delete_tags(self, **kwargs):  # noqa: E501
        """Delete selected tags  # noqa: E501
    ...
    def delete_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'force', 'filters', 'force2', 'order_by', 'page_count', 'page_size', 'skip_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_tag_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'explain', 'format', 'download', 'filename', 'read_mask']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'expand_mask', 'filters', 'order_by', 'read_mask', 'page_count', 'page_size', 'skip_count']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def remove_tags(self, id, **kwargs):  # noqa: E501
        """Removes all user tags from a file  # noqa: E501
    ...
    def update_tags(self, **kwargs):  # noqa: E501
        ...
        :param object page_size:
        :param object skip_count:
        :param object update_mask2: REQUIRED for `PATCH` methods. Comma separated string containing a list of keys to update based on the request body.  REGEX: `^(([\\w]+,?)*|\\*)$`
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def update_tags_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'update_mask', 'filters', 'order_by', 'page_count', 'page_size', 'skip_count', 'update_mask2']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'skip_count' in params:
            query_params.append(('skip_count', params['skip_count']))  # noqa: E501
        if 'update_mask2' in params:
            query_params.append(('update_mask', params['update_mask2']))  # noqa: E501
