...
class YaraApi(object):
    ...
    def create_yara(self, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.create_yara_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.create_yara_with_http_info(**kwargs)  # noqa: E501
            return data

    def create_yara_with_http_info(self, **kwargs):  # noqa: E501
        """Create Yara Rule based on specific file hashes  # noqa: E501

           Create Yara Rule based on specific file hashes           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_yara_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'strict']  # noqa: E501
    ...
    def yara_procedure_matches(self, binary_id, **kwargs):  # noqa: E501
        """Get similar binaries based off of potential yara procedure matches  # noqa: E501

        Get similar binaries based off of potential yara procedure matches  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.yara_procedure_matches(binary_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.yara_procedure_matches_with_http_info(binary_id, **kwargs)  # noqa: E501
        else:
            (data) = self.yara_procedure_matches_with_http_info(binary_id, **kwargs)  # noqa: E501
            return data

    def yara_procedure_matches_with_http_info(self, binary_id, **kwargs):  # noqa: E501
        """Get similar binaries based off of potential yara procedure matches  # noqa: E501

        Get similar binaries based off of potential yara procedure matches  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.yara_procedure_matches_with_http_info(binary_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['binary_id', 'explain', 'format', 'download', 'filename', 'read_mask', 'expand_mask', 'strict']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method yara_procedure_matches" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('binary_id' not in params or
            ...
            raise ValueError("Missing the required parameter `binary_id` when calling `yara_procedure_matches`")  # noqa: E501
