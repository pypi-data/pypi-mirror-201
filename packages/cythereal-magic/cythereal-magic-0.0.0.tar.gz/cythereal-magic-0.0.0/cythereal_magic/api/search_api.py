...
class SearchApi(object):
    ...
    def count_search_results(self, **kwargs):  # noqa: E501
        """Returns total count of results via search  # noqa: E501

           Returns total count of results via search           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_search_results(async_req=True)
        >>> result = thread.get()
        ...
        :param object query: Search query to look for
        :return: None
        ...
        if kwargs.get('async_req'):
            return self.count_search_results_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.count_search_results_with_http_info(**kwargs)  # noqa: E501
            return data

    def count_search_results_with_http_info(self, **kwargs):  # noqa: E501
        """Returns total count of results via search  # noqa: E501

           Returns total count of results via search           # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.count_search_results_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'query']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method count_search_results" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def search_files(self, **kwargs):  # noqa: E501
        """Returns files found via search  # noqa: E501
        ...
        :param object download:  Determines whether to download the response. (Content-Disposition:\"attachment\" vs \"inline\") 
        :param object filename: If download is True, this sets the name of the file. (Content-Disposition:\"attachment; filename=`filename`\")
        :param object search_exact: Whether an exact match is required in a search
        :param object search_query: Search query to look for
        :param object search_type: Value type with which to search
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def search_files_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['explain', 'format', 'download', 'filename', 'search_exact', 'search_query', 'search_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'filename' in params:
            query_params.append(('filename', params['filename']))  # noqa: E501
        if 'search_exact' in params:
            query_params.append(('search_exact', params['search_exact']))  # noqa: E501
