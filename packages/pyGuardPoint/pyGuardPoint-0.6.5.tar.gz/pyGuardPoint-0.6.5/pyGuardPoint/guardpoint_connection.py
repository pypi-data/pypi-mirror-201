...
class GuardPointConnection:
    ...
    def __init__(self, url_components, auth, user, pwd, key, token=None):
        ...
        self.baseurl = f"{url_components['scheme']}://{url_components['netloc']}:{url_components['port']}"
        if token:
        ...
        if url_components['scheme'] == 'https':
            self.connection = http.client.HTTPSConnection(host=url_components['netloc'], port=url_components['port'])
        elif url_components['scheme'] == 'http':
            self.connection = http.client.HTTPConnection(host=url_components['netloc'], port=url_components['port'])
        else:
