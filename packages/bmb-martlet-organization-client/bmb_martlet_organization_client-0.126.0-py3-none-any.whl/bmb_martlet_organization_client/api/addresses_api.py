...
class AddressesApi(object):
    ...
    def insert_note(self, body, address_id, **kwargs):  # noqa: E501
        """Add a note for a message connected with this address  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.insert_note(body, address_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.insert_note_with_http_info(body, address_id, **kwargs)  # noqa: E501
        else:
            (data) = self.insert_note_with_http_info(body, address_id, **kwargs)  # noqa: E501
            return data

    def insert_note_with_http_info(self, body, address_id, **kwargs):  # noqa: E501
        """Add a note for a message connected with this address  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.insert_note_with_http_info(body, address_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `insert_note`")  # noqa: E501
        # verify the required parameter 'address_id' is set
        if ('address_id' not in params or
                params['address_id'] is None):
            raise ValueError("Missing the required parameter `address_id` when calling `insert_note`")  # noqa: E501
