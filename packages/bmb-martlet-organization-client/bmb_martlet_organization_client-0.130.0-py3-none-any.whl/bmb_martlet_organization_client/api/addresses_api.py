...
class AddressesApi(object):
    ...
    def get_message(self, organization_id, address_id, message_id, **kwargs):  # noqa: E501
        """get a single message  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_message(organization_id, address_id, message_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_message_with_http_info(organization_id, address_id, message_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_message_with_http_info(organization_id, address_id, message_id, **kwargs)  # noqa: E501
            return data

    def get_message_with_http_info(self, organization_id, address_id, message_id, **kwargs):  # noqa: E501
        """get a single message  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_message_with_http_info(organization_id, address_id, message_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('organization_id' not in params or
                params['organization_id'] is None):
            raise ValueError("Missing the required parameter `organization_id` when calling `get_message`")  # noqa: E501
        # verify the required parameter 'address_id' is set
        if ('address_id' not in params or
                params['address_id'] is None):
    ...
    def list_accepted_messages(self, address_id, **kwargs):  # noqa: E501
        """Get a report of all message acceptances send from this address  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_accepted_messages(address_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_accepted_messages_with_http_info(address_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_accepted_messages_with_http_info(address_id, **kwargs)  # noqa: E501
            return data

    def list_accepted_messages_with_http_info(self, address_id, **kwargs):  # noqa: E501
        """Get a report of all message acceptances send from this address  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_accepted_messages_with_http_info(address_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_accepted_messages" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'address_id' is set
        if ('address_id' not in params or
                params['address_id'] is None):
            raise ValueError("Missing the required parameter `address_id` when calling `list_accepted_messages`")  # noqa: E501
    ...
    def submit_message(self, body, **kwargs):  # noqa: E501
        """Make a message submission  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.submit_message(body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.submit_message_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.submit_message_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def submit_message_with_http_info(self, body, **kwargs):  # noqa: E501
        """Make a message submission  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.submit_message_with_http_info(body, async_req=True)
        >>> result = thread.get()
