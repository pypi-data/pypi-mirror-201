...
from .jobs.connected_workspaces import ConnectSlackAccount, ConnectSlackAccountJobData
...
jobs_map = {
    ...
    "ConnectSlackAccountJob": ConnectSlackAccount,
