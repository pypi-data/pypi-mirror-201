...
def test_dupa():
    ...
    # w = openbis_instance.get_sample('20230404105242539-173')
    # data = w.__dict__["data"]
    # props = w.props()
    # parents = w.get_parents()
    sample = openbis_instance.get_sample('20230404152418467-24')

    # sample.props.namp2 = 'aaa1234'
    sample.save()
