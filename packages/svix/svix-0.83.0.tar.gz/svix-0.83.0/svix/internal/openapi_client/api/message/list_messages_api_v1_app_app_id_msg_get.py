...
def sync_detailed(
    ...
    *,
    ...
    iterator is passed.
    The `after` parameter lets you filter all items created after a certain date and is ignored if an
    iterator is passed.
    ...
    Args:
        ...
        iterator (Union[Unset, None, str]):  Example: msg_1srOrx2ZWZBpBUvZwXKQmoEYga2.
