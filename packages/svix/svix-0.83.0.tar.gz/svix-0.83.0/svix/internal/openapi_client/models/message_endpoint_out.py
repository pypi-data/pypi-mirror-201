...
from ..models.message_endpoint_out_metadata import MessageEndpointOutMetadata
...
class MessageEndpointOut:
    ...
    Attributes:
        ...
        metadata (Union[Unset, None, MessageEndpointOutMetadata]):
    ...
    metadata: Union[Unset, None, MessageEndpointOutMetadata] = UNSET
