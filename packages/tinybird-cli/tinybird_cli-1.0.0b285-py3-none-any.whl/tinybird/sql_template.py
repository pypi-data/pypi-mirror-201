...
from .tornado_template import Template, SecurityException
...
def transform_type(tester, transform, placeholder=None, required=None, description=None, enum=None, example=None, format=None):
    def _f(x, default=None, defined=True, required=None, description=None, enum=None, example=None, format=None):
        if type(x) == Placeholder:
            ...
            if x is None:
                if defined:
                    raise SQLTemplateException("invalid parameter")
                else:
                    return None
        if tester == 'String':
            if x is not None:
            ...
            return transform(x)
        raise SQLTemplateException(f"Error validating '{x}' to type {tester}", documentation='/cli/advanced-templates.html')
    return _f
...
def _and(*args, **kwargs):
    ...
    def _op(k):
        ...
        if len(tk) == 1:
            ...
            raise SQLTemplateException(f"operand {tk[1]} not supported", documentation='/cli/advanced-templates.html#sql_and')
...
class Placeholder:
    ...
    def __call__(self, *args, **kwargs):
        raise SQLTemplateException(f"'{self.name}' is not a valid function, line {self.line}", documentation='/cli/advanced-templates.html')
...
def columns(x, default=None, fn=None):
    if x is None or type(x) == Placeholder:
        if default is None:
            raise SQLTemplateException("Missing columns() default value, use `columns(column_names, 'default_column_name')`", documentation='/cli/advanced-templates.html#columns')
        x = default

    try:
        _columns = [c.strip() for c in x.split(',')]
    except AttributeError:
        raise SQLTemplateException("The 'columns' function expects a String not an Array", documentation='/cli/advanced-templates.html#columns')
...
def column(x, default=None):
    if x is None or type(x) == Placeholder:
        if default is None:
            raise SQLTemplateException("Missing column() default value, use `column(column_name, 'default_column_name')`", documentation='/cli/advanced-templates.html#column')
        x = default
                ...
                if _type in testers:
                    if testers[_type](str(t)):
                        ...
                        raise SQLTemplateException(
                            f"Error validating {x}[{i}]({t}) to type {_type}", documentation='/cli/advanced-templates.html')
                else:
                    values.append(expression_wrapper(
                        types.get(_type, lambda x: x)(t), f'{x}[{i}]'))
            return Expression(f"[{','.join(map(str, values))}]")
        except AttributeError:
            raise SQLTemplateException('transform type function Array is not well defined', documentation='/cli/advanced-templates.html')
    return _f
...
def split_to_array(x, default='', separator: str = ','):
    try:
        ...
        raise SQLTemplateException('First argument of split_to_array has to be a value that can be split to a list of elements, but found a PlaceHolder with no value instead', documentation='/cli/advanced-templates.html#split_to_array')
...
def day_diff(d0, d1, default=None):
    ...
    try:
        ...
        raise SQLTemplateException(
            'invalid date format in function `day_diff`, it must be ISO format date YYYY-MM-DD, e.g. 2018-09-26. For other fotmats, try `date_diff_in_days`', documentation='/cli/advanced-templates.html#date_diff_in_days')
...
def date_diff_in_days(d0, d1, date_format: str = '%Y-%m-%d', default=None):
    ...
    try:
        ...
        raise SQLTemplateException(
            'invalid date format in function `date_diff_in_days`, it must be ISO format date YYYY-MM-DD, e.g. 2018-09-26', documentation='/cli/advanced-templates.html#date_diff_in_days')


def date_diff_in_hours(d0: str, d1: str, date_format: str = '%Y-%m-%d %H:%M:%S', default=None):
    """
    ...
    try:
        ...
        raise SQLTemplateException(
            'invalid date_format in function `date_diff_in_hours`, defaults to YYYY-MM-DD hh:mm:ss. Or %Y-%m-%d %H:%M:%S [.ssssss]Z, e.g. ms: 2022-12-19T18:42:22.591Z s:2022-12-19T18:42:22Z', documentation='/cli/advanced-templates.html#date_diff_in_hours')


def date_diff_in_minutes(d0: str, d1: str, date_format: str = '%Y-%m-%d %H:%M:%S', default=None):
    """
    ...
    try:
        ...
        raise SQLTemplateException(
            'invalid date_format in function `date_diff_in_seconds`, defaults to YYYY-MM-DD hh:mm:ss. Or %Y-%m-%d %H:%M:%S [.ssssss]Z, e.g. ms: 2022-12-19T18:42:22.591Z s:2022-12-19T18:42:22Z', documentation='/cli/advanced-templates.html#date_diff_in_minutes')


def date_diff_in_seconds(d0: str, d1: str, date_format: str = '%Y-%m-%d %H:%M:%S', default=None):
    """
    ...
    try:
        ...
        raise SQLTemplateException(
            'invalid date_format in function `date_diff_in_seconds`, defaults to YYYY-MM-DD hh:mm:ss. Or %Y-%m-%d %H:%M:%S [.ssssss]Z, e.g. ms: 2022-12-19T18:42:22.591Z s:2022-12-19T18:42:22Z', documentation='/cli/advanced-templates.html#date_diff_in_seconds')
...
def __date_diff(d0, d1, date_format: str = '%Y-%m-%d %H:%M:%S', unit: str = 'seconds', default=None):
    ...
    try:
        if unit == 'days':
            return int(abs((datetime.strptime(d1, date_format) - datetime.strptime(d0, date_format)).total_seconds()) / 86400)
        elif unit == 'hours':
            return int(abs((datetime.strptime(d1, date_format) - datetime.strptime(d0, date_format)).total_seconds()) / 3600)
        elif unit == 'minutes':
            return int(abs((datetime.strptime(d1, date_format) - datetime.strptime(d0, date_format)).total_seconds()) / 60)
        else:
...
def get_transform_types(placeholders=None):
    ...
    types = {
        ...
        'DateTime64': transform_type('DateTime64', str, placeholders.get('DateTime64', None), required=None, description=None, enum=None, example=None, format=None),
        ...
        'Float32': transform_type('Float32', lambda x: Float(x, 'Float32'), placeholders.get('Float32', None), required=None, description=None, enum=None, example=None, format=None),
        'Float64': transform_type('Float64', lambda x: Float(x, 'Float64'), placeholders.get('Float64', None), required=None, description=None, enum=None, example=None, format=None),
        ...
        'Int8': transform_type('Int8', lambda x: Integer(x, 'Int8'), placeholders.get('Int8', None), required=None, description=None, enum=None, example=None, format=None),
        'Int16': transform_type('Int16', lambda x: Integer(x, 'Int16'), placeholders.get('Int16', None), required=None, description=None, enum=None, example=None, format=None),
        'Int32': transform_type('Int32', lambda x: Integer(x, 'Int32'), placeholders.get('Int32', None), required=None, description=None, enum=None, example=None, format=None),
        'Int64': transform_type('Int64', lambda x: Integer(x, 'Int64'), placeholders.get('Int64', None), required=None, description=None, enum=None, example=None, format=None),
        'Int128': transform_type('Int128', lambda x: Integer(x, 'Int128'), placeholders.get('Int128', None), required=None, description=None, enum=None, example=None, format=None),
        'Int256': transform_type('Int256', lambda x: Integer(x, 'Int256'), placeholders.get('Int256', None), required=None, description=None, enum=None, example=None, format=None),
        'UInt8': transform_type('UInt8', lambda x: Integer(x, 'UInt8'), placeholders.get('UInt8', None), required=None, description=None, enum=None, example=None, format=None),
        'UInt16': transform_type('UInt16', lambda x: Integer(x, 'UInt16'), placeholders.get('UInt16', None), required=None, description=None, enum=None, example=None, format=None),
        'UInt32': transform_type('UInt32', lambda x: Integer(x, 'UInt32'), placeholders.get('UInt32', None), required=None, description=None, enum=None, example=None, format=None),
        'UInt64': transform_type('UInt64', lambda x: Integer(x, 'UInt64'), placeholders.get('UInt64', None), required=None, description=None, enum=None, example=None, format=None),
        'UInt128': transform_type('UInt128', lambda x: Integer(x, 'UInt128'), placeholders.get('UInt128', None), required=None, description=None, enum=None, example=None, format=None),
        'UInt256': transform_type('UInt256', lambda x: Integer(x, 'UInt256'), placeholders.get('UInt256', None), required=None, description=None, enum=None, example=None, format=None),
        'Symbol': symbol,
        'Column': symbol,
    ...
    types['Array'] = array_type({
        ...
        'Int128': transform_type('Int128', int, placeholders.get('Int128', None), required=None, description=None, enum=None, example=None, format=None),
        'Int256': transform_type('Int256', int, placeholders.get('Int256', None), required=None, description=None, enum=None, example=None, format=None),
        ...
        'UInt128': transform_type('UInt128', int, placeholders.get('UInt128', None), required=None, description=None, enum=None, example=None, format=None),
        'UInt256': transform_type('UInt256', int, placeholders.get('UInt256', None), required=None, description=None, enum=None, example=None, format=None),
        'Symbol': symbol,
        'Column': symbol,
        'String': transform_type('String', str, placeholder='__placeholder__', required=None, description=None, enum=None, example=None, format=None)
    })
...
def expression_wrapper(x, name):
    if type(x) in (unicode_type, bytes, str):
        ...
        return "-- {x} \n"
    if x is None:
        raise SQLTemplateException(f'expression "{name}" evaluated to null', documentation='/cli/advanced-templates.html')
    return x
...
def get_var_data(content):  # noqa: C901
    def node_to_value(x):
        if type(x) in (ast.Bytes, ast.Str):
            ...
            return x.value
        elif type(x) == ast.UnaryOp and type(x.operand) == ast.Constant:
                    ...
                    if func == 'defined':
                        ...
                        if len(args) and args[0] is not None:
                            ...
                            try:
                                ...
                                logging.exception(f"pipe parsing problem {content}:  {e}")
                except Exception as e:
...
def render_sql_template(sql: str, variables: dict = None, test_mode: bool = False, name: Optional[str] = None) -> Tuple[str, dict]:
    """
    ...
    try:
        ...
        if 'length' in v and not v['length']:
            ...
            raise SQLTemplateException('one of the transform type functions is missing an argument', documentation='/cli/advanced-templates.html#transform-types-functions')
        elif 'not callable' in str(e) or 'unhashable type' in str(e):
            raise SQLTemplateException('wrong syntax, you might be using a not valid function inside a control block', documentation='/cli/advanced-templates.html')
        raise e
