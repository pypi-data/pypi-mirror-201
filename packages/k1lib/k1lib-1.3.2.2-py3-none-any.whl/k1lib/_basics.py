...
"""
        return graphviz.Digraph(graph_attr={"rankdir":direction})
    def graph(direction="TB"):
        """Convenience method for creating a new graphviz Graph. See also: :meth:`digraph`"""
        return graphviz.Graph(graph_attr={"rankdir":direction, "overlap": "false"})
except ImportError:
