...
class ImageAnalysisOption(VisionOption):
    ...
    MODEL_NAME = 6
    """
    Optional string property holding the name of the custom-trained model to be used for
    Image Analysis. Defaults to an empty string, which indicates the standard model is used.
    """
