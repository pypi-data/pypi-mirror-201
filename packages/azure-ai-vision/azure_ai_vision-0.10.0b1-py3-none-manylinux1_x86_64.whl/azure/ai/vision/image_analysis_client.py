...
class ImageAnalysisOptions():
    ...
    def model_name(self) -> str:
        ...
        """
        return self.properties.get_property_by_id(ImageAnalysisOption.MODEL_NAME, "")
    ...
    def model_name(self, name: str):
        ...
        """
        self.properties.set_property_by_id(ImageAnalysisOption.MODEL_NAME, name)
...
class ImageAnalysisResultDetails():
    ...
    def json_result(self) -> str:
        ...
        """
        return self.properties.get_property_by_id(ImageAnalysisResultOption.JSON, "")
