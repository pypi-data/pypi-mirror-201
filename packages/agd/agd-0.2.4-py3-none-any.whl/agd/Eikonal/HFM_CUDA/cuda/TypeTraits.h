...
// weightpos
#ifndef flow_weightpos_macro
#define flow_weightpos_macro false
#endif

#if flow_weightpos_macro
#define FLOW_WEIGHTPOS(...) __VA_ARGS__
#else
#define FLOW_WEIGHTPOS(...)
#endif
...
#define flow_macro (flow_weights_macro || flow_weightsum_macro || flow_weightpos_macro \
