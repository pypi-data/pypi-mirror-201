...
class _BaseSink:
    ...
    def __init__(self, buffer_maxsize=0xffff):
...
class QueuedFileSink(_BaseSink, FileSink):
    ...
    def __init__(self, path, *, buffer_maxsize=0xffff, **kwargs):
        ...
        _BaseSink.__init__(self, buffer_maxsize)
...
class KafkaSink(_BaseSink):
    ...
    def __init__(self, servers, topic, *, buffer_maxsize=0xffff, **kwargs):

        super().__init__(buffer_maxsize)
