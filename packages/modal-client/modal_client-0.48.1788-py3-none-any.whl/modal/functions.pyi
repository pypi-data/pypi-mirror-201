...
class _FunctionCall(modal.object._Handle):
    ...
    async def get_call_graph(self) -> typing.List[modal._call_graph.InputInfo]:
        ...
...
class FunctionCall(modal.object.Handle):
    ...
    def get_call_graph(self) -> typing.List[modal._call_graph.InputInfo]:
        ...
...
class AioFunctionCall(modal.object.AioHandle):
    ...
    async def get_call_graph(self, *args, **kwargs) -> typing.List[modal._call_graph.InputInfo]:
        ...
