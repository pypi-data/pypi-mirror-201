...
"""
    ...
    replacements = [
        {"input_file":"config/utah_service_config_fs.pp_json", 
        "replacements":[
            {"old_value":"utah.arches.web_blueprints.myapp", "new_value":"%s.%s.flask_blueprint" % (args.org_abbr, args.app_abbr)}
        ]},
        {"input_file":"config/utah_service_config_mongo.pp_json", 
        "replacements":[
            {"old_value":"utah.arches.web_blueprints.myapp", "new_value":"%s.%s.flask_blueprint" % (args.org_abbr, args.app_abbr)}
        ]},
    ...
    # --------------------------------------------------------------------------------
    shutil.copyfile(python_project_path + "/utah/arches/web_blueprints/myapp.py", "%s/%s/%s/flask_blueprint.py" % (args.output_dir, args.org_abbr, args.app_abbr))
    ...
    shutil.copyfile("%s/config/utah_service_config_fs.pp_json" % args.output_dir, "%s/config/utah_service_config.pp_json" % args.output_dir)
