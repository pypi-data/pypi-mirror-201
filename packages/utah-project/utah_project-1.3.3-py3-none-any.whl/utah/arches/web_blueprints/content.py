...
class LayoutsInfo(Resource):
    ...
    def get(self):
        ...
        for key in layouts.keys():
            i18n_layout = {}
            i18n_layout["description"] = str(gettext(layouts[key]["description"]))
...
def view_promotion_utility():
    ...
    return render_template("content/promotion_util.html", microsites=available_microsites, diff_counts=diff_counts)
...
def display_promotion_job_list(microsite):
    ...
    return render_template("content/promotion_requests.html", promotion_requests=promotion_requests, promotion_status_translations=PROMOTION_STATUS_TRANSLATIONS, microsite=microsite)
...
def display_promotion_job(microsite, promotion_id):
    ...
    if promotion_request:
        return render_template( "content/promotion_request.html", 
        ...
        return render_template("login/message.html", message=gettext("Promotion was not found"))
...
def view_differences(microsite, direction):
    ...
    return render_template( "content/microsite_differences.html", 
...
def sync_view_differences(microsite, direction):
    ...
    return render_template( "content/sync_microsite_differences.html", 
                            differences=differences, 
                            microsite=microsite, 
                            source_repo_desc=PROMOTION_REPO_TRANSLATIONS[source_repo], 
                            dest_repo_desc=PROMOTION_REPO_TRANSLATIONS[dest_repo])
