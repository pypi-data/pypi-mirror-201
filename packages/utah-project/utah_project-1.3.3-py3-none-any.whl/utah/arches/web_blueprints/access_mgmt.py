...
def list_groups():
    ...
    return render_template('access_mgmt/group_list.html', groups=groups)
...
def add_group():
    ...
    if not rendering:
        ...
        rendering = render_template('access_mgmt/group_edit.html', function="add", group=group, all_authorizations=all_authorizations, group_authorizations=group_authorizations, field_errors=field_errors, error=True, message=gettext("Error adding group"))
...
def display_group_update(group_name):
    ...
    for authorization in all_authorizations:
        if group.name in authorization.authorized_groups:
            group_authorizations.append(authorization.id)

    return render_template('access_mgmt/group_edit.html', 
                            function="update", 
...
def update_group(group_name):
    ...
    if len(field_errors) == 0:
        ...
        members = get_group_members(group_name)
        rendering = render_template('access_mgmt/group_edit.html', function="update", members=members, group=group, field_errors=field_errors, error=True, message=gettext("Error updating group"))
...
def get_users():
    ...
    return render_template('access_mgmt/user_list.html', profiles=profiles)
...
def get_group_enrollments(user_id):
    ...
    return render_template('access_mgmt/group_enrollments.html', profile=profile, groups=groups)
...
def get_uriaccess_rights():
    ...
    return render_template('access_mgmt/rights_list.html', uri_access_rights=uri_access_rights, render_env_col=render_env_col)
...
def edit_uriaccess_rights(id:str):
    ...
    if uri_access_right:
        ...
        return render_template('access_mgmt/right_form.html', uri_access_right=uri_access_right_bean, field_errors={}, function="update")
    else:
...
def update_uriaccess_rights(id:str):
    ...
    if len(field_errors) == 0:
        ...
        return render_template('access_mgmt/right_form.html', uri_access_right=uri_access_right_bean, field_errors=field_errors, function="update")
...
def add_uriaccess_rights_form():
    ...
    return render_template('access_mgmt/right_form.html', uri_access_right=uri_access_right_bean, field_errors={}, function="add")
...
def add_uriaccess_rights():
    ...
    if len(field_errors) == 0:
        try:
            ...
            rendering = render_template('access_mgmt/right_form.html', uri_access_right=uri_access_right_bean, field_errors=field_errors, function="add")
    else:
            uri_access_right_bean = build_access_right_bean(uri_access_right)
...
def promote_access_rights():
    ...
    return render_template('access_mgmt/sync_rights_results.html')
