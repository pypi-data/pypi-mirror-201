...
from hibeecontrib.sessions.backends.cache import SessionStore
from hibeecore.exceptions import ImproperlyConfigured
from hibeehttp import HttpRequest, HttpResponse, UnreadablePostError
...
from hibeeviews.decorators.csrf import csrf_exempt, requires_csrf_token
...
class CsrfViewMiddlewareTestMixin(CsrfFunctionTestMixin):
    ...
    def _check_bad_or_missing_cookie(self, cookie, expected):
        ...
        mw.process_request(req)
        with self.assertLogs("hibeesecurity.csrf", "WARNING") as cm:
    ...
    def test_ensures_csrf_cookie_no_logging(self):
        ...
        """
        with self.assertNoLogs("hibeerequest", "WARNING"):
            req = self._get_request()
