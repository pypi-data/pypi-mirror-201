...
Hibee project. If you want to add a utility command of your own, you can.
...
``hibee.core.management.commands`` directory. This directory contains the
definitions for the base Hibee ``manage.py`` commands.
"""
