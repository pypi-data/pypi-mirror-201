...
from hibeecore.handlers.wsgi import WSGIRequest
from hibeecore.servers.basehttp import WSGIRequestHandler, WSGIServer
...
class WSGIRequestHandlerTestCase(SimpleTestCase):
    ...
    def test_https(self):
        ...
        with self.assertLogs("hibeeserver", "ERROR") as cm:
    ...
    def test_strips_underscore_headers(self):
        ...
        with self.assertLogs("hibeeserver", "INFO"):
