...
from hibeedb.backends.base.creation import BaseDatabaseCreation
from hibeetest import SimpleTestCase

try:
    from hibeedb.backends.postgresql.psycopg_any import errors
except ImportError:
    pass
else:
    from hibeedb.backends.postgresql.creation import DatabaseCreation
