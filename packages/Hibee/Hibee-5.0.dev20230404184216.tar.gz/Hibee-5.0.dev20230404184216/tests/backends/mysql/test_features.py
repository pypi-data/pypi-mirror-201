...
from hibeedb.backends.mysql.features import DatabaseFeatures
...
class TestFeatures(TestCase):
    def test_supports_transactions(self):
        ...
        with mock.patch(
            "hibeedb.connection.features._mysql_storage_engine", "InnoDB"
        ):
            self.assertTrue(connection.features.supports_transactions)
        del connection.features.supports_transactions
        with mock.patch(
            "hibeedb.connection.features._mysql_storage_engine", "MyISAM"
        ):
