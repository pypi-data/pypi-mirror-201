...
urlpatterns = [
    ...
    # i18n views
    path("i18n/", include("hibee.conf.urls.i18n")),
    ...
    path(
        "jsi18n_admin/",
        i18n.JavaScriptCatalog.as_view(packages=["hibee.contrib.admin", "view_tests"]),
    ),
