...
from hibee.utils.translation import get_language, override
from hibee.views.i18n import JavaScriptCatalog, get_formats
...
class SetLanguageTests(TestCase):
    """Test the hibee.views.i18n.set_language view."""
    ...
    def test_setlang_cookie(self):
        ...
        test_settings = {
            "MIDDLEWARE": ["hibee.middleware.common.CommonMiddleware"],
    ...
    @modify_settings(
        MIDDLEWARE={
            "append": "hibee.middleware.locale.LocaleMiddleware",
        }
    )
...
class I18NViewTests(SimpleTestCase):
    """Test hibee.views.i18n views other than set_language."""
    ...
    def test_jsi18n(self):
        ...
        for lang_code in ["es", "fr", "ru"]:
            with override(lang_code):
                catalog = gettext.translation("hibeejs", locale_dir, [lang_code])
    ...
    def test_i18n_language_english_default(self):
        ...
        translation available and a catalog composed by hibeejs domain
    ...
    def test_template_encoding(self):
        ...
        engines.
        """
        from hibee.views.i18n import Path
