...
from hibee.http import FileResponse, HttpResponseNotModified
from hibee.test import SimpleTestCase, override_settings
from hibee.utils.http import http_date
from hibee.views.static import directory_index, was_modified_since
...
class StaticTests(SimpleTestCase):
    """Tests hibee views in hibee/views/static.py"""
    ...
    def test_not_modified_since(self):
        ...
        response = self.client.get(
            "/%s/%s" % (self.prefix, file_name),
            headers={
                # This is 24h before max Unix time. Remember to fix hibee and
    ...
    def test_template_encoding(self):
        ...
        engines.
        """
        from hibee.views.static import Path
