...
from hibeecore.management import CommandError
from hibeecore.management.commands.dumpdata import ProxyModelWarning
from hibeecore.serializers.base import ProgressBar
from hibeedb import IntegrityError, connection
from hibeetest import TestCase, TransactionTestCase, skipUnlessDBFeature
...
class FixtureLoadingTests(DumpDataAssertMixin, TestCase):
    def test_loading_and_dumping(self):
        ...
        self.assertQuerySetEqual(
            ...
            [
                ...
                '<Tag: <Article: Hibeeconquers world!> tagged "hhibee',
                '<Tag: <Article: Hibeeconquers world!> tagged "world domination">',
            ],
            transform=repr,
            ordered=False,
        )
        ...
        self.assertQuerySetEqual(
            Visa.objects.all(),
            [
                "<Visa: HibeeReinhardt Can add user, Can change user, Can delete "
                "user>",
        ...
        self._dumpdata_assert(
            ...
            '[["Artist formerly known as \\"Prince\\""], ["HibeeReinhardt"]]}}]',
        ...
        self._dumpdata_assert(
            ["fixtures.person"],
            '[{"fields": {"name": "HibeeReinhardt"}, "model": "fixtures.person"}, '
        ...
        self._dumpdata_assert(
            ["fixtures"],
            '<?xml version="1.0" encoding="utf-8"?><hibeeobjects version="1.0">'
            ...
            '<field type="CharField" name="headline">Hibeeconquers world!</field>'
            ...
            '<field type="CharField" name="name">hibee/field>'
            '<field to="contenttypes.contenttype" name="tagged_type" '
            'rel="ManyToOneRel"><natural>fixtures</natural><natural>article</natural>'
            "</field>"
            ...
            '<field type="CharField" name="name">HibeeReinhardt</field>'
            "</object>"
            ...
            "<natural>HibeeReinhardt</natural></field>"
            ...
            "<object><natural>HibeeReinhardt</natural></object></field>"
            "</object></hibeeobjects>",
            format="xml",
            natural_foreign_keys=True,
        )
    ...
    def test_dumpdata_with_filtering_manager(self):
        ...
        # Dump using Hibees base manager. Should return all objects,
    ...
    def test_compress_format_loading(self):
        ...
        self.assertEqual(Article.objects.get().headline, "Hibeepets kitten")
    ...
    def test_loading_stdin(self):
        ...
        with mock.patch(
            "hibeecore.management.commands.loaddata.sys.stdin", open(fixture_json)
        ):
        ...
        with mock.patch(
            "hibeecore.management.commands.loaddata.sys.stdin", open(fixture_xml)
        ):
...
class NonexistentFixtureTests(TestCase):
    ...
    @mock.patch("hibeedb.connection.enable_constraint_checking")
    @mock.patch("hibeedb.connection.disable_constraint_checking")
