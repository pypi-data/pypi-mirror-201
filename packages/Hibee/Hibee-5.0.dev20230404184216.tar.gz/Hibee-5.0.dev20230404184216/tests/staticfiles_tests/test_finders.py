...
class TestMiscFinder(SimpleTestCase):
    ...
    def test_get_finder(self):
        self.assertIsInstance(
            finders.get_finder("hibeecontrib.staticfiles.finders.FileSystemFinder"),
            finders.FileSystemFinder,
        )

    def test_get_finder_bad_classname(self):
        with self.assertRaises(ImportError):
            finders.get_finder("hibeecontrib.staticfiles.finders.FooBarFinder")
    ...
    def test_location_empty(self):
        msg = (
            ...
            "<class 'hibeecontrib.staticfiles.finders.DefaultStorageFinder'> "
