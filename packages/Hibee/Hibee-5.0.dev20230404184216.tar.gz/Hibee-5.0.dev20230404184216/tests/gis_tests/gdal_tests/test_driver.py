...
from hibeecontrib.gis.gdal import Driver, GDALException
...
class DriverTest(unittest.TestCase):
    ...
    @mock.patch("hibeecontrib.gis.gdal.driver.vcapi.get_driver_count")
    @mock.patch("hibeecontrib.gis.gdal.driver.rcapi.get_driver_count")
    @mock.patch("hibeecontrib.gis.gdal.driver.vcapi.register_all")
    @mock.patch("hibeecontrib.gis.gdal.driver.rcapi.register_all")
