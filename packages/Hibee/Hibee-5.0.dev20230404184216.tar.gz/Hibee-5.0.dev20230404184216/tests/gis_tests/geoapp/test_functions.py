...
from hibeecontrib.gis.db.models import GeometryField, PolygonField, functions
from hibeecontrib.gis.geos import GEOSGeometry, LineString, Point, Polygon, fromstr
from hibeecontrib.gis.measure import Area
from hibeedb import NotSupportedError, connection
from hibeedb.models import IntegerField, Sum, Value
...
class GISFunctionsTests(FuncTestMixin, TestCase):
    """
    Testing functions from hibeecontrib/gis/db/models/functions.py.
