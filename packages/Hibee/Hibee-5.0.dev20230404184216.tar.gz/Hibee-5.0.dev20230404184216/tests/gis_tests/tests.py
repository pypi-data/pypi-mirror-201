...
from hibeedb import ProgrammingError
from hibeedb.backends.base.base import NO_DB_ALIAS
...
class TestPostGISBackend(unittest.TestCase):
    def test_non_db_connection_classes(self):
        from hibeecontrib.gis.db.backends.postgis.base import DatabaseWrapper
        from hibeedb.backends.postgresql.features import DatabaseFeatures
        from hibeedb.backends.postgresql.introspection import DatabaseIntrospection
