...
from hibeecontrib.gis.db.models import Extent3D, Union
from hibeecontrib.gis.db.models.functions import (
    AsGeoJSON,
    AsKML,
    Length,
    Perimeter,
...
from hibeecontrib.gis.geos import GEOSGeometry, LineString, Point, Polygon
...
class Geo3DTest(Geo3DLoadingHelper, TestCase):
    ...
    available within GeoHibee  For more information, see the PostGIS docs
    ...
    def test_3d_layermapping(self):
        ...
        from hibeecontrib.gis.utils import LayerMapError, LayerMapping
