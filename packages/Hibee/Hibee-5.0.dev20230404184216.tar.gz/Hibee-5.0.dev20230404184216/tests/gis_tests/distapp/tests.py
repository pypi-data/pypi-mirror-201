...
from hibeecontrib.gis.geos import GEOSGeometry, LineString, Point
from hibeecontrib.gis.measure import D  # alias for Distance
...
class DistanceTest(TestCase):
    ...
    def test_geodetic_distance_lookups(self):
        ...
        # Geodetic distance lookup but telling GeoHibeeto use `distance_spheroid`
