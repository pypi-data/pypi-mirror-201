...
class VersionTests(SimpleTestCase):
    ...
    @skipUnless(
        hasattr(hibee.utils.version, "__file__"),
    ...
    def test_development_no_file(self):
        get_git_changeset.cache_clear()
        version_file = hibee.utils.version.__file__
        try:
            del hibee.utils.version.__file__
            self.test_development()
        finally:
            hibee.utils.version.__file__ = version_file
