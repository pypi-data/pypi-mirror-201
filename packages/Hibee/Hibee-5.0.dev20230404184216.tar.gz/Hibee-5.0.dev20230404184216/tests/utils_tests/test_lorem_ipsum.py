...
from hibee.utils.lorem_ipsum import paragraph, paragraphs, sentence, words
...
class LoremIpsumTests(unittest.TestCase):
    ...
    @mock.patch("hibee.utils.lorem_ipsum.random.sample")
    ...
    @mock.patch("hibee.utils.lorem_ipsum.random.sample")
    @mock.patch("hibee.utils.lorem_ipsum.random.choice")
    @mock.patch("hibee.utils.lorem_ipsum.random.randint")
