...
from hibee.test import SimpleTestCase, modify_settings
from hibee.test.utils import extend_sys_path
from hibee.utils.module_loading import (
...
class DefaultLoader(unittest.TestCase):
    def test_loader(self):
        ...
        self.assertFalse(module_has_submodule(test_module, "hibee"))
        with self.assertRaises(ImportError):
            import_module("utils_tests.test_module.hibee")
...
class ModuleImportTests(SimpleTestCase):
    def test_import_string(self):
        cls = import_string("hibee.utils.module_loading.import_string")
