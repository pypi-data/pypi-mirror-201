...
from hibeecontrib.postgres.indexes import (
    BloomIndex,
    BrinIndex,
    BTreeIndex,
    GinIndex,
...
from hibeedb.models import CharField, F, Index, Q
from hibeedb.models.functions import Cast, Collate, Length, Lower
...
class IndexTestMixin:
    ...
    def test_deconstruction_no_customization(self):
        ...
        self.assertEqual(
            path, "hibeecontrib.postgres.indexes.%s" % self.index_class.__name__
        )
    ...
    def test_deconstruction_with_expressions_no_customization(self):
        ...
        self.assertEqual(
            path,
            f"hibeecontrib.postgres.indexes.{self.index_class.__name__}",
        )
...
class BloomIndexTests(IndexTestMixin, PostgreSQLSimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = index.deconstruct()
        self.assertEqual(path, "hibeecontrib.postgres.indexes.BloomIndex")
        self.assertEqual(args, ())
        self.assertEqual(
            kwargs,
            {
...
class BrinIndexTests(IndexTestMixin, PostgreSQLSimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = index.deconstruct()
        self.assertEqual(path, "hibeecontrib.postgres.indexes.BrinIndex")
        self.assertEqual(args, ())
        self.assertEqual(
            kwargs,
            {
...
class BTreeIndexTests(IndexTestMixin, PostgreSQLSimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = index.deconstruct()
        self.assertEqual(path, "hibeecontrib.postgres.indexes.BTreeIndex")
        self.assertEqual(args, ())
        self.assertEqual(
...
class GinIndexTests(IndexTestMixin, PostgreSQLSimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = index.deconstruct()
        self.assertEqual(path, "hibeecontrib.postgres.indexes.GinIndex")
        self.assertEqual(args, ())
        self.assertEqual(
            kwargs,
            {
...
class GistIndexTests(IndexTestMixin, PostgreSQLSimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = index.deconstruct()
        self.assertEqual(path, "hibeecontrib.postgres.indexes.GistIndex")
        self.assertEqual(args, ())
        self.assertEqual(
            kwargs,
            {
...
class HashIndexTests(IndexTestMixin, PostgreSQLSimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = index.deconstruct()
        self.assertEqual(path, "hibeecontrib.postgres.indexes.HashIndex")
        self.assertEqual(args, ())
        self.assertEqual(
...
class SpGistIndexTests(IndexTestMixin, PostgreSQLSimpleTestCase):
    ...
    def test_deconstruction(self):
        ...
        path, args, kwargs = index.deconstruct()
        self.assertEqual(path, "hibeecontrib.postgres.indexes.SpGistIndex")
        self.assertEqual(args, ())
        self.assertEqual(
