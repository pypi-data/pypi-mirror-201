...
from hibeecontrib.admin.models import ADDITION, CHANGE, DELETION, LogEntry
from hibeecontrib.admin.options import (
    HORIZONTAL,
    VERTICAL,
    ModelAdmin,
    TabularInline,
...
from hibeecontrib.admin.widgets import (
    AdminDateWidget,
    AdminRadioSelect,
    AutocompleteSelect,
...
from hibeeforms.widgets import Select
