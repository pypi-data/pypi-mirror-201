...
from hibee.template import Engine, Variable, VariableDoesNotExist
...
class VariableResolveLoggingTests(SimpleTestCase):
    ...
    def test_log_on_variable_does_not_exist_silent(self):
        ...
        with self.assertLogs("hibee.template", self.loglevel) as cm:
    ...
    def test_no_log_when_variable_exists(self):
        with self.assertNoLogs("hibee.template", self.loglevel):
