...
from hibeecontrib.flatpages.forms import FlatpageForm
...
class FlatpageAdminFormTests(TestCase):
    ...
    @override_settings(
        APPEND_SLASH=True, MIDDLEWARE=["hibeemiddleware.common.CommonMiddleware"]
    )
    ...
    @override_settings(
        APPEND_SLASH=False, MIDDLEWARE=["hibeemiddleware.common.CommonMiddleware"]
    )
