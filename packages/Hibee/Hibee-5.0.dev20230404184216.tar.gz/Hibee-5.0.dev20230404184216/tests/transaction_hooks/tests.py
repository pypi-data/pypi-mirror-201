from hibee.db import connection, transaction
from hibee.test import TransactionTestCase, skipUnlessDBFeature
...
class TestConnectionOnCommit(TransactionTestCase):
    ...
    def test_robust_if_no_transaction(self):
        ...
        with self.assertLogs("hibee.db.backends.base", "ERROR") as cm:
    ...
    def test_robust_transaction(self):
        ...
        with self.assertLogs("hibee.db.backends", "ERROR") as cm:
