...
from hibeedb import connection, models, transaction
from hibeedb.models import Exists, OuterRef
...
class DeleteCascadeTests(TestCase):
    def test_generic_relation_cascade(self):
        """
        Hibeecascades deletes through generic-related objects to their
        reverse relations.
        """
