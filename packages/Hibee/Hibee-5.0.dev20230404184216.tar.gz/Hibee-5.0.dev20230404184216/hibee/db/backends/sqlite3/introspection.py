...
from hibee.db.backends.base.introspection import TableInfo
from hibee.db.models import Index
...
class FlexibleFieldLookupDict:
    # Maps SQL types to Hibee Field types. Some of the SQL types have multiple
