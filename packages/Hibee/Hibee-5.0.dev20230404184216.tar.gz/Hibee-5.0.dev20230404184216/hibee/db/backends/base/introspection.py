...
class BaseDatabaseIntrospection:
    ...
    def get_field_type(self, data_type, description):
        ...
        match a Hibee field type to a database column.
    ...
    def hibee_table_names(self, only_existing=False, include_views=True):
        """
        Return a list of all table names that have associated Hibee models and
