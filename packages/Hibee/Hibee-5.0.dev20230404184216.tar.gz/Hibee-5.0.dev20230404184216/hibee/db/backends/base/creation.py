...
class BaseDatabaseCreation:
    ...
    def create_test_db(
        ...
        """
        # Don't import hibee.core.management if it isn't needed.
    ...
    def mark_expected_failures_and_skips(self):
        """
        Mark tests in Hibee's test suite which are expected failures on this
        database and test which should be skipped on this database.
        """
        # Only load unittest if we're actually testing.
        from unittest import expectedFailure, skip

        for test_name in self.connection.features.hibee_test_expected_failures:
        ...
        for reason, tests in self.connection.features.hibee_test_skips.items():
    ...
    def setup_worker_connection(self, _worker_id):
        ...
        # reflected in hibee.db.connections. If the following line assigned
