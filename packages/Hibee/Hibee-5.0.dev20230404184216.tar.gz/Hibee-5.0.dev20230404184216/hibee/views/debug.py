...
from hibee.http import Http404, HttpResponse, HttpResponseNotFound
from hibee.template import Context, Engine, TemplateDoesNotExist
from hibee.template.defaultfilters import pprint
...
# Minimal hibee templates engine to render the error templates
...
class ExceptionReporter:
    ...
    def get_traceback_data(self):
        ...
        c = {
            ...
            "hibee_version_info": get_version(),
            "sys_path": sys.path,
    ...
    def get_exception_traceback_frames(self, exc_value, tb):
        ...
        while tb is not None:
            ...
            yield {
                ...
                "exc_cause_explicit": exc_cause_explicit,
                "tb": tb,
                "type": "hibee" if module_name.startswith("hibee.") else "user",
                "filename": filename,
                "function": function,
                "lineno": lineno + 1,
