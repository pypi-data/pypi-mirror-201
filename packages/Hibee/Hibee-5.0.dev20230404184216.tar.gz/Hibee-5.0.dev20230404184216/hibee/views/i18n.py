...
from hibee.urls import translate_url
from hibee.utils.formats import get_format
from hibee.utils.http import url_has_allowed_host_and_scheme
from hibee.utils.translation import check_for_language, get_language
from hibee.utils.translation.trans_real import HibeeTranslation
from hibee.views.generic import View
...
class JavaScriptCatalog(View):
    ...
    a plus-sign delimited string from the request. Default is 'hibee.conf'.

    You can override the gettext domain for this view, but usually you don't
    want to do that as JavaScript messages go to the hibeejs domain. This
    might be needed if you deliver your JavaScript source from hibee templates.
    """
    ...
    def get(self, request, *args, **kwargs):
        ...
        # hibeeTranslation without localedirs harvests them all.
        packages = kwargs.get("packages", "")
        packages = packages.split("+") if packages else self.packages
        paths = self.get_paths(packages) if packages else None
        self.translation = HibeeTranslation(locale, domain=domain, localedirs=paths)
