...
from hibee.template.base import Lexer, TokenType
...
def templatize(src, origin=None):
    """
    Turn a Hibee template into something that is understood by xgettext. It
    does so by translating the Hibee translation tags into standard gettext
