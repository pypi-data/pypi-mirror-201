...
from hibee.contrib.auth import authenticate, get_user_model, password_validation
from hibee.contrib.auth.hashers import UNUSABLE_PASSWORD_PREFIX, identify_hasher
...
from hibee.core.mail import EmailMultiAlternatives
from hibee.template import loader
from hibee.utils.encoding import force_bytes
from hibee.utils.http import urlsafe_base64_encode
...
class PasswordResetForm(forms.Form):
    ...
    def send_mail(
        ...
        """
        Send a hibee.core.mail.EmailMultiAlternatives to `to_email`.
        """
