from hibee.contrib.syndication.views import Feed as BaseFeed
from hibee.utils.feedgenerator import Atom1Feed, Rss201rev2Feed
...
class Feed(BaseFeed):
    """
    This is a subclass of the `Feed` from `hibee.contrib.syndication`.
