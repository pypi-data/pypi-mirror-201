...
from hibee.db.backends.sqlite3.introspection import (
...
class SpatiaLiteIntrospection(DatabaseIntrospection):
    ...
    def get_geometry_type(self, table_name, description):
        with self.connection.cursor() as cursor:
            ...
            # from OGC geom type name to Hibee field.
            ogr_type = row[2]
            if isinstance(ogr_type, int) and ogr_type > 1000:
                ...
                # coordinates (M not yet supported by Hibee).
                ogr_type = ogr_type % 1000 + OGRGeomType.wkb25bit
            field_type = OGRGeomType(ogr_type).hibee
