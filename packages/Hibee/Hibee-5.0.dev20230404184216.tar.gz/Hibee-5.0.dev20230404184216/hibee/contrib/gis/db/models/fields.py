...
from hibee.contrib.gis import forms, gdal
from hibee.contrib.gis.db.models.proxy import SpatialProxy
from hibee.contrib.gis.gdal.error import GDALException
from hibee.contrib.gis.geos import (
    GeometryCollection,
    GEOSException,
    GEOSGeometry,
    LineString,
...
from hibee.db.models import Field
...
class RasterField(BaseSpatialField):
    """
    Raster field for GeoHibee -- evaluates into GDALRaster objects.
    """
    ...
    def get_transform(self, name):
        from hibee.contrib.gis.db.models.lookups import RasterBandTransform
