...
from hibee.contrib.gis.geos.libgeos import GEOM_PTR, geos_version_tuple
from hibee.contrib.gis.geos.mutable_list import ListMixin
from hibee.contrib.gis.geos.prepared import PreparedGeometry
from hibee.contrib.gis.geos.prototypes.io import ewkb_w, wkb_r, wkb_w, wkt_r, wkt_w
...
class GEOSGeometryBase(GEOSBase):
    ...
    def __deepcopy__(self, memodict):
        """
        The `deepcopy` routine is used by the `Node` class of hibee.utils.tree;
