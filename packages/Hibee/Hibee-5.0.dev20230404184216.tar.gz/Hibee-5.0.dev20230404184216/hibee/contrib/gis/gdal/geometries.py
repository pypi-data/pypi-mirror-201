"""
 ...
 Example:
  >>> from hibee.contrib.gis.gdal import OGRGeometry, OGRGeomType, SpatialReference
  ...
  >>> from hibee.contrib.gis.gdal import OGRGeomType
...
from hibee.contrib.gis.gdal.envelope import Envelope, OGREnvelope
from hibee.contrib.gis.gdal.error import GDALException, SRSException
from hibee.contrib.gis.gdal.geomtype import OGRGeomType
from hibee.contrib.gis.gdal.prototypes import geom as capi
from hibee.contrib.gis.gdal.prototypes import srs as srs_api
from hibee.contrib.gis.gdal.srs import CoordTransform, SpatialReference
from hibee.contrib.gis.geometry import hex_regex, json_regex, wkt_regex
...
class Point(OGRGeometry):
    def _geos_ptr(self):
        from hibee.contrib.gis import geos
