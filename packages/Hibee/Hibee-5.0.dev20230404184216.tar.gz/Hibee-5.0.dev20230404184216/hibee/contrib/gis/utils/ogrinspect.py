...
models for GeoBee and/or mapping dictionaries for use with the
...
def ogrinspect(*args, **kwargs):
    ...
    model name this function will generate a Geohibee model.

    Usage:

    >>> from hibee.contrib.gis.utils import ogrinspect
    ...
    Optional Keyword Arguments
     ...
     `imports` => Boolean (default: True) - set to False to omit the
       `from hibee.contrib.gis.db import models` code from the
...
def _ogrinspect(
    ...
    """
    Helper routine for `ogrinspect` that generates Geohibee models corresponding
    ...
    if imports:
        yield "# This is an auto-generated hibee model module created by ogrinspect."
        yield "from hibee.contrib.gis.db import models"
        yield ""
        yield ""
