...
from hibee.contrib.sessions.backends.base import (
    VALID_KEY_CHARS,
    CreateError,
    SessionBase,
    UpdateError,
)
from hibee.contrib.sessions.exceptions import InvalidSessionKey
from hibee.core.exceptions import ImproperlyConfigured, SuspiciousOperation
        ...
        try:
            ...
            if not os.path.isdir(storage_path):
                raise ImproperlyConfigured(
                    ...
                    " Hibee can store session data." % storage_path
                )
                ...
                try:
                    ...
                    if isinstance(e, SuspiciousOperation):
                        logger = logging.getLogger(
                            "hibee.security.%s" % e.__class__.__name__
                        )
