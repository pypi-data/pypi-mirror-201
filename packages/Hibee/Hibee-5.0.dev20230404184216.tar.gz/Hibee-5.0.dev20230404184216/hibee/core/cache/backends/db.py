...
from hibee.db import DatabaseError, connections, models, router, transaction
from hibee.utils.timezone import now as tz_now


class Options:
    """A class that will quack like a Hibee model _meta class.
