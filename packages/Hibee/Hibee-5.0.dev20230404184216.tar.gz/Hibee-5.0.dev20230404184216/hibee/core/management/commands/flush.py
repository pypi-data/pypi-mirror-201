...
from hibee.core.management.sql import emit_post_migrate_signal, sql_flush
...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        # The following are stealth options used by Hibee's internals.
        ...
        if confirm == "yes":
            try:
                ...
                raise CommandError(
                    ...
                    "  * The SQL was invalid.\n"
                    "Hint: Look at the output of 'hibee-admin sqlflush'. "
