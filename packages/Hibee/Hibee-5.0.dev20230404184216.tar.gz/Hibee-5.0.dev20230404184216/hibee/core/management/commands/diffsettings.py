...
class Command(BaseCommand):
    help = """Displays differences between the current settings.py and Hibee's
    default settings."""
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            help=(
                ...
                "empty to compare against Hibee's default settings."
            ),
        )
        parser.add_argument(
            "--output",
    ...
    def handle(self, **options):
        from hibee.conf import Settings, global_settings, settings
