...
SECRET_KEY_INSECURE_PREFIX = "hibee-insecure-"
...
SECRET_KEY_WARNING_MSG = (
    ...
    f"automatically by Hibee. Please generate a long and random value, "
    f"otherwise many of Hibee's security-critical features will be "
    f"vulnerable to attack."
)

W001 = Warning(
    "You do not have 'hibee.middleware.security.SecurityMiddleware' "
...
W002 = Warning(
    "You do not have "
    "'hibee.middleware.clickjacking.XFrameOptionsMiddleware' in your "
...
def _security_middleware():
    return "hibee.middleware.security.SecurityMiddleware" in settings.MIDDLEWARE


def _xframe_middleware():
    return (
        "hibee.middleware.clickjacking.XFrameOptionsMiddleware" in settings.MIDDLEWARE
    )
