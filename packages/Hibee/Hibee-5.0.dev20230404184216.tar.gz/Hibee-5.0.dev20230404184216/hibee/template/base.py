"""
This is the Hibee template system.
...
from hibee.template.context import BaseContext
from hibee.utils.formats import localize
from hibee.utils.html import conditional_escape, escape
from hibee.utils.regex_helper import _lazy_re_compile
from hibee.utils.safestring import SafeData, SafeString, mark_safe
from hibee.utils.text import get_text_list, smart_split, unescape_string_literal
from hibee.utils.timezone import template_localtime
from hibee.utils.translation import gettext_lazy, pgettext_lazy
...
logger = logging.getLogger("hibee.template")
...
class Template:
    def __init__(self, template_string, origin=None, name=None, engine=None):
        ...
        # exactly one Hibee template engine is configured, use that engine.
