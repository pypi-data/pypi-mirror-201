...
class MongoDB(
    ...
    def __init__(self, mongo_config, tooter: Tooter):
        ...
        try:
            ...
            con = MongoClient(
                f'mongodb://admin:{mongo_config["MONGODB_PASSWORD"]}@31.20.212.96:27017,mongodb://admin:{mongo_config["MONGODB_PASSWORD"]}@31.20.212.96:27027,mongodb://admin:{mongo_config["MONGODB_PASSWORD"]}@172.105.75.199:27027/?replicaSet=rs1'
            )
            # con = MongoClient(
