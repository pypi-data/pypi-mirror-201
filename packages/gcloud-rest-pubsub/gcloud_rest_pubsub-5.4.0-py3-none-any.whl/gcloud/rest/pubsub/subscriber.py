...
if BUILD_GCLOUD_REST:
    ...
    from gcloud.rest.pubsub import metrics
        ...
        while True:
            ...
            try:
                ...
                if e.status == 400:
                    ...
                    def maybe_nack(ack_id: str) -> None:
                        try:
                            subscriber_client.modify_ack_deadline(
                                subscription,
                                ack_ids=[ack_id],
    ...
    def subscribe(
        ...
        *,
        ...
        for task in producer_tasks:
            task.cancel()
        asyncio.wait(producer_tasks, return_when=asyncio.ALL_COMPLETED)

        for task in consumer_tasks:
            task.cancel()
        asyncio.wait(consumer_tasks, return_when=asyncio.ALL_COMPLETED)
