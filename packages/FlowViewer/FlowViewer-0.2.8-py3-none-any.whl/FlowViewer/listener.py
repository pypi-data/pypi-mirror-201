...
class ResponseData(object):
    """返回的数据包管理类"""
    __slots__ = ('request_id', 'response', 'raw_body', 'tab', 'target', 'postData', '_json_body', 'url', 'status',
                 ...
                 'protocol', 'securityState', 'securityDetails', '_requestHeaders', 'postData')
    ...
    def __repr__(self):
        return f'<ResponseData target={self.target} request_id={self.request_id}>'
    ...
    def postData(self):
        ...
        return self.response.get('postData', None)
