...
from kofi.grapefruit import Color as GC
...
class Color(object):
    ...
    def from_html(cls, html_string):
        ...
        :rtype: Color
        :returns: A kofi.Color in the sRGB color space.
        """
    ...
    def to(self, space):
        ...
        :rtype: Color
        :returns: A new kofi.Color in the given color space.
        """
...
class Scale(object):
    ...
    def __init__(self, colors, domain=None):
        """
        :param list colors: List of two or more kofi.Colors, or web-color/hexcode strings.
    ...
    def range(self, count):
        ...
        :rtype: list
        :returns: A list of kofi.Color objects.
        """
        if count <= 1:
