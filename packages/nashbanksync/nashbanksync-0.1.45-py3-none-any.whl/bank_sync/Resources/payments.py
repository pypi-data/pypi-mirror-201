...
class Payments(Resource):
    ...
    def serialize(self, payload=None, operation=None):
        ...
        data.update({
            ...
            "account_number": payload.get("source", {}).get("account_number", "-1"),
    ...
    def standardize_response(self, response_data):
        ...
        try:
            ...
            if super().get_bank_id() == super().COOP:
                ...
                data["code"] = f'{response_data.get("MessageCode", "-1111111")}'
                ...
                data["code"] = f'{response_data.get("code", "-1111111")}'
            ...
            # If bank_id is DTB
                ...
                if super().get_operation() == super().IFT:
                    data["message"] = response_data.get("message", "")
                    data["code"] = f'{int(float(response_data.get("content", {}).get("response_code"," -1111111")))}'
                    data["transaction_id"] = response_data.get(
            ...
            # If bank_id is UBA
                ...
                if super().get_operation() == super().IFT:
                    ...
                    data["code"] = f'{int(float(resp_object.get("ACTION_CODE", "-1111111")))}'
