...
def fraction_reads(outdir:str, totalreads:int, threads:int = 1) -> None:
    """
...
def umi_saturation(ax: plt.axes, table: pd.DataFrame) -> None:
    """
...
def gene_saturation(ax: plt.axes, table: pd.DataFrame) -> None:
    """
