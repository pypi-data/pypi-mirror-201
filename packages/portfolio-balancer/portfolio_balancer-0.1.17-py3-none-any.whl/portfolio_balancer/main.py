...
class PortfolioBalancer(object):
    ...
    def load_config(self):
        ...
        self.lines = list()
        self.header = None
        with open(os.path.join(config['config_dir'],"portfolio.csv") , "r") as f:
    ...
    def write_log(self, date, cur1, cur2, base,  detail, fx_rate, p_value):
        if self.args.dry_run:
            ...
            with open(os.path.join(self.config['config_dir'], "portfolio.csv"), "a") as f:
                ...
                writer.writerow([date, dumb_round(cur1), dumb_round(cur2), base, detail, fx_rate, p_value, (p_value / self.actualizedHodl(fx_rate)) -1])
    ...
    def update_portfolio(self, cur1_amount, cur2_amount, detail, fx_rate):
        ...
        self.write_log(date, cur1_amount, cur2_amount, self.base_currency, detail, fx_rate, p_value)
