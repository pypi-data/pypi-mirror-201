...
def P2PPortResultTypes(result: int) -> str:
    return {
        0: "0:P2PSuccess",
...
def DeviceResultTypes(result: int) -> str:
    return {
...
def DeviceModeTypes(mode: int) -> str:
    return {
        0: "0:DevModeDisabled",
...
def RegisterResultTypes(result: int) -> str:
    return {
...
def RegisterDataTypes(datatype: int) -> str:
    return {
        0: "0:RegData_Unknown",
        1: "1:RegData_Array",
        2: "2:RegData_U8",
...
def DeviceStatusTypes(status: int) -> str:
    return {
...
def RegisterStatusTypes(status: int) -> str:
    return {
        0: "0:RegSuccess",
        1: "1:RegBusy",
        2: "2:RegNacked",
...
_getAllPorts = CFUNCTYPE(None, POINTER(c_char), POINTER(c_ushort))(
    ("getAllPorts", NKTPDLL)
)
...
_getOpenPorts = CFUNCTYPE(None, POINTER(c_char), POINTER(c_ushort))(
    ("getOpenPorts", NKTPDLL)
)


def getOpenPorts() -> str:
    maxLen = c_ushort(255)
    portnames = create_string_buffer(maxLen.value)
...
pointToPointPortData = namedtuple(
    "pointToPointPortData",
    "hostAddress, hostPort, clientAddress, clientPort, protocol, msTimeout",
)
...
_pointToPointPortAdd = CFUNCTYPE(
    c_ubyte, c_char_p, c_char_p, c_ushort, c_char_p, c_ushort, c_ubyte, c_ubyte
)(("pointToPointPortAdd", NKTPDLL))


def pointToPointPortAdd(portname, portdata):
    return _pointToPointPortAdd(
        portname.encode("ascii"),
        portdata.hostAddress.encode("ascii"),
        portdata.hostPort,
        portdata.clientAddress.encode("ascii"),
        portdata.clientPort,
        portdata.protocol,
        portdata.msTimeout,
    )
...
_pointToPointPortGet = CFUNCTYPE(
    c_ubyte,
    c_char_p,
    POINTER(c_char),
    POINTER(c_ubyte),
    ...
    POINTER(c_ubyte),
    POINTER(c_ubyte),
)(("pointToPointPortGet", NKTPDLL))


def pointToPointPortGet(
    portname,
):  # , hostAddress, hostPort, clientAddress, clientPort, protocol, msTimeout):
    ...
    return (
        result,
        pointToPointPortData(
            _hostAddress.value.decode("ascii"),
            _hostPort.value,
            _clientAddress.value.decode("ascii"),
            _clientPort.value,
            _protocol.value,
            _msTimeout.value,
        ),
...
def openPorts(portnames: str, autoMode: int, liveMode: int):
...
def closePorts(portnames: str) -> int:
...
_getPortStatus = CFUNCTYPE(c_ubyte, c_char_p, POINTER(c_ubyte))(
    ("getPortStatus", NKTPDLL)
)
...
_getPortErrorMsg = CFUNCTYPE(c_ubyte, c_char_p, POINTER(c_char), POINTER(c_ushort))(
    ("getPortErrorMsg", NKTPDLL)
)
...
_registerRead = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_char), POINTER(c_ubyte), c_short
)(("registerRead", NKTPDLL))


def registerRead(portname: str, devId: int, regId: int, index: int):
    _readSize = c_ubyte(255)
    _readData = create_string_buffer(_readSize.value)
    result = _registerRead(
        portname.encode("ascii"), devId, regId, _readData, _readSize, index
    )
    if result != 0:
        _readSize = c_ubyte(0)
...
_registerReadU8 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_ubyte), c_short
)(("registerReadU8", NKTPDLL))


def registerReadU8(portname: str, devId: int, regId: int, index: int):
...
_registerReadS8 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_byte), c_short
)(("registerReadS8", NKTPDLL))


def registerReadS8(
    portname: str, devId: int, regId: int, index: int
) -> Tuple[int, int]:
    _readValue = c_byte(0)
    result: int = _registerReadS8(
        portname.encode("ascii"), devId, regId, _readValue, index
    )
    return result, _readValue.value
...
_registerReadU16 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_ushort), c_short
)(("registerReadU16", NKTPDLL))
...
_registerReadS16 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_short), c_short
)(("registerReadS16", NKTPDLL))
...
_registerReadU32 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_ulong), c_short
)(("registerReadU32", NKTPDLL))
...
_registerReadS32 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_long), c_short
)(("registerReadS32", NKTPDLL))
...
_registerReadU64 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_ulonglong), c_short
)(("registerReadU64", NKTPDLL))
...
_registerReadS64 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_longlong), c_short
)(("registerReadS64", NKTPDLL))
...
_registerReadF32 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_float), c_short
)(("registerReadF32", NKTPDLL))
...
_registerReadF64 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_double), c_short
)(("registerReadF64", NKTPDLL))
...
_registerReadAscii = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_char), POINTER(c_ubyte), c_short
)(("registerReadAscii", NKTPDLL))


def registerReadAscii(
    portname: str, devId: int, regId: int, index: int
) -> Tuple[int, bytes]:
    _readSize = c_ubyte(255)
    _readData = create_string_buffer(_readSize.value)
    result: int = _registerReadAscii(
        portname.encode("ascii"), devId, regId, _readData, _readSize, index
    )
...
_registerWrite = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_char), c_ubyte, c_short
)(("registerWrite", NKTPDLL))


def registerWrite(
    portname: str, devId: int, regId: int, writeData, writeSize: int, index: int
) -> int:
    return _registerWrite(
        portname.encode("ascii"), devId, regId, writeData, writeSize, index
    )
...
_registerWriteU8 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ubyte, c_short)(
    ("registerWriteU8", NKTPDLL)
)


def registerWriteU8(
    portname: str, devId: int, regId: int, value: int, index: int
) -> int:
...
_registerWriteS8 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_byte, c_short)(
    ("registerWriteS8", NKTPDLL)
)
...
_registerWriteU16 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ushort, c_short)(
    ("registerWriteU16", NKTPDLL)
)


def registerWriteU16(
    portname: str, devId: int, regId: int, value: int, index: int
) -> int:
...
_registerWriteS16 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_short, c_short)(
    ("registerWriteS16", NKTPDLL)
)


def registerWriteS16(portname, devId, regId, value, index) -> int:
...
_registerWriteU32 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ulong, c_short)(
    ("registerWriteU32", NKTPDLL)
)


def registerWriteU32(
    portname: str, devId: int, regId: int, value: int, index: int
) -> int:
...
_registerWriteS32 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_long, c_short)(
    ("registerWriteS32", NKTPDLL)
)


def registerWriteS32(
    portname: str, devId: int, regId: int, value: int, index: int
) -> int:
...
_registerWriteU64 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ulonglong, c_short
)(("registerWriteU64", NKTPDLL))


def registerWriteU64(
    portname: str, devId: int, regId: int, value: int, index: int
) -> int:
...
_registerWriteS64 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_longlong, c_short)(
    ("registerWriteS64", NKTPDLL)
)


def registerWriteS64(
    portname: str, devId: int, regId: int, value: int, index: int
) -> int:
...
_registerWriteF32 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_float, c_short)(
    ("registerWriteF32", NKTPDLL)
)


def registerWriteF32(
    portname: str, devId: int, regId: int, value: float, index: int
) -> int:
...
_registerWriteF64 = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_double, c_short)(
    ("registerWriteF64", NKTPDLL)
)


def registerWriteF64(
    portname: str, devId: int, regId: int, value: float, index: int
) -> int:
...
_registerWriteAscii = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_char_p, c_ubyte, c_short
)(("registerWriteAscii", NKTPDLL))


def registerWriteAscii(
    portname: str, devId: int, regId: int, strValue: str, wrEOL: int, index: int
):
    _asciiValue = create_string_buffer(strValue.encode("ascii"))
    return _registerWriteAscii(
        portname.encode("ascii"), devId, regId, _asciiValue, wrEOL, index
    )
...
_registerWriteReadU8 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ubyte, POINTER(c_ubyte), c_short
)(("registerWriteReadU8", NKTPDLL))


def registerWriteReadU8(portname, devId, regId, writeValue, index):
    _readValue = c_ubyte(0)
    result = _registerWriteReadU8(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadS8 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ubyte, POINTER(c_byte), c_short
)(("registerWriteReadS8", NKTPDLL))


def registerWriteReadS8(portname, devId, regId, writeValue, index):
    _readValue = c_byte(0)
    result = _registerWriteReadS8(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadU16 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ubyte, POINTER(c_ushort), c_short
)(("registerWriteReadU16", NKTPDLL))


def registerWriteReadU16(portname, devId, regId, writeValue, index):
    _readValue = c_ushort(0)
    result = _registerWriteReadU16(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadS16 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ubyte, POINTER(c_short), c_short
)(("registerWriteReadS16", NKTPDLL))


def registerWriteReadS16(portname, devId, regId, writeValue, index):
    _readValue = c_short(0)
    result = _registerWriteReadS16(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadU32 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ulong, POINTER(c_ulong), c_short
)(("registerWriteReadU32", NKTPDLL))


def registerWriteReadU32(portname, devId, regId, writeValue, index):
    _readValue = c_ulong(0)
    result = _registerWriteReadU32(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadS32 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_long, POINTER(c_long), c_short
)(("registerWriteReadS32", NKTPDLL))


def registerWriteReadS32(portname, devId, regId, writeValue, index):
    _readValue = c_long(0)
    result = _registerWriteReadS32(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadU64 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ulonglong, POINTER(c_ulonglong), c_short
)(("registerWriteReadU64", NKTPDLL))


def registerWriteReadU64(portname, devId, regId, writeValue, index):
    _readValue = c_ulonglong(0)
    result = _registerWriteReadU64(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadS64 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_longlong, POINTER(c_longlong), c_short
)(("registerWriteReadS64", NKTPDLL))


def registerWriteReadS64(portname, devId, regId, writeValue, index):
    _readValue = c_longlong(0)
    result = _registerWriteReadS64(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadF32 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_float, POINTER(c_float), c_short
)(("registerWriteReadF32", NKTPDLL))


def registerWriteReadF32(portname, devId, regId, writeValue, index):
    _readValue = c_float(0)
    result = _registerWriteReadF32(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadF64 = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, c_ubyte, c_double, POINTER(c_double), c_short
)(("registerWriteReadF64", NKTPDLL))


def registerWriteReadF64(portname, devId, regId, writeValue, index):
    _readValue = c_double(0)
    result = _registerWriteReadF64(
        portname.encode("ascii"), devId, regId, writeValue, _readValue, index
    )
    return result, _readValue.value
...
_registerWriteReadAscii = CFUNCTYPE(
    c_ubyte,
    c_char_p,
    c_ubyte,
    c_ubyte,
    ...
    POINTER(c_ubyte),
    c_short,
)(("registerWriteReadAscii", NKTPDLL))
...
def registerWriteReadAscii(portname, devId, regId, strValue, wrEOL, index):
    ...
    _readSize = c_ubyte(255)
    _readData = create_string_buffer(_readSize.value)
    result = _registerWriteReadAscii(
        portname.encode("ascii"),
        devId,
        regId,
        _asciiValue,
...
_deviceGetType = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ubyte))(
    ("deviceGetType", NKTPDLL)
)
...
_deviceGetPartNumberStr = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, POINTER(c_char), POINTER(c_ubyte)
)(("deviceGetPartNumberStr", NKTPDLL))


def deviceGetPartNumberStr(portname, devId):
    _readSize = c_ubyte(255)
    _readStr = create_string_buffer(_readSize.value)
    result = _deviceGetPartNumberStr(
        portname.encode("ascii"), devId, _readStr, _readSize
    )
...
_deviceGetPCBVersion = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ubyte))(
    ("deviceGetPCBVersion", NKTPDLL)
)
...
_deviceGetStatusBits = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ushort))(
    ("deviceGetStatusBits", NKTPDLL)
)
...
_deviceGetErrorCode = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ushort))(
    ("deviceGetErrorCode", NKTPDLL)
)
...
_deviceGetBootloaderVersion = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ushort))(
    ("deviceGetBootloaderVersion", NKTPDLL)
)
...
_deviceGetBootloaderVersionStr = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, POINTER(c_char), POINTER(c_ubyte)
)(("deviceGetBootloaderVersionStr", NKTPDLL))


def deviceGetBootloaderVersionStr(portname, devId):
    _readSize = c_ubyte(255)
    _readStr = create_string_buffer(_readSize.value)
    result = _deviceGetBootloaderVersionStr(
        portname.encode("ascii"), devId, _readStr, _readSize
    )
    return result, _readStr.value
...
_deviceGetFirmwareVersion = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ushort))(
    ("deviceGetFirmwareVersion", NKTPDLL)
)
...
_deviceGetFirmwareVersionStr = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, POINTER(c_char), POINTER(c_ubyte)
)(("deviceGetFirmwareVersionStr", NKTPDLL))


def deviceGetFirmwareVersionStr(portname, devId):
    _readSize = c_ubyte(255)
    _readStr = create_string_buffer(_readSize.value)
    result = _deviceGetFirmwareVersionStr(
        portname.encode("ascii"), devId, _readStr, _readSize
    )
    return result, _readStr.value
...
_deviceGetModuleSerialNumberStr = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, POINTER(c_char), POINTER(c_ubyte)
)(("deviceGetModuleSerialNumberStr", NKTPDLL))


def deviceGetModuleSerialNumberStr(portname, devId):
    _readSize = c_ubyte(255)
    _readStr = create_string_buffer(_readSize.value)
    result = _deviceGetModuleSerialNumberStr(
        portname.encode("ascii"), devId, _readStr, _readSize
    )
    return result, _readStr.value
...
_deviceGetPCBSerialNumberStr = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, POINTER(c_char), POINTER(c_ubyte)
)(("deviceGetPCBSerialNumberStr", NKTPDLL))


def deviceGetPCBSerialNumberStr(portname, devId):
    _readSize = c_ubyte(255)
    _readStr = create_string_buffer(_readSize.value)
    result = _deviceGetPCBSerialNumberStr(
        portname.encode("ascii"), devId, _readStr, _readSize
    )
    return result, _readStr.value
...
_deviceCreate = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte)(
    ("deviceCreate", NKTPDLL)
)
...
_deviceExists = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ubyte))(
    ("deviceExists", NKTPDLL)
)
...
_deviceGetAllTypes = CFUNCTYPE(c_ubyte, c_char_p, POINTER(c_char), POINTER(c_ubyte))(
    ("deviceGetAllTypes", NKTPDLL)
)


def deviceGetAllTypes(portname: str) -> Tuple[int, bytes]:
    _maxTypes = c_ubyte(255)
    _types = create_string_buffer(_maxTypes.value)
    result: int = _deviceGetAllTypes(portname.encode("ascii"), _types, _maxTypes)
    if result != 0:
        _maxTypes = c_ubyte(0)
...
_deviceGetMode = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ubyte))(
    ("deviceGetMode", NKTPDLL)
)


def deviceGetMode(portname: str, devId: int) -> Tuple[int, int]:
    _devMode = c_ubyte(0)
    result: int = _deviceGetMode(portname.encode("ascii"), devId, _devMode)
...
_deviceGetLive = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, POINTER(c_ubyte))(
    ("deviceGetLive", NKTPDLL)
)


def deviceGetLive(portname: str, devId: int) -> Tuple[int, int]:
    _liveMode = c_ubyte(0)
    result: int = _deviceGetLive(portname.encode("ascii"), devId, _liveMode)
...
_deviceSetLive = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte)(
    ("deviceSetLive", NKTPDLL)
)


def deviceSetLive(portname: str, devId: int, liveMode: int) -> int:
...
_registerCreate = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, c_ubyte, c_ubyte)(
    ("registerCreate", NKTPDLL)
)
...
_registerExists = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte, POINTER(c_ubyte))(
    ("registerExists", NKTPDLL)
)
...
_registerRemove = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte, c_ubyte)(
    ("registerRemove", NKTPDLL)
)
...
_registerRemoveAll = CFUNCTYPE(c_ubyte, c_char_p, c_ubyte)(
    ("registerRemoveAll", NKTPDLL)
)
...
_registerGetAll = CFUNCTYPE(
    c_ubyte, c_char_p, c_ubyte, POINTER(c_char), POINTER(c_ubyte)
)(("registerGetAll", NKTPDLL))
...
portStatusCallbackFuncPtr = CFUNCTYPE(
...
deviceStatusCallbackFuncPtr = CFUNCTYPE(
...
_setCallbackPtrDeviceInfo = CFUNCTYPE(None, c_void_p)(
    ("setCallbackPtrDeviceInfo", NKTPDLL)
)
...
registerStatusCallbackFuncPtr = CFUNCTYPE(
...
_setCallbackPtrRegisterInfo = CFUNCTYPE(None, c_void_p)(
    ("setCallbackPtrRegisterInfo", NKTPDLL)
)
