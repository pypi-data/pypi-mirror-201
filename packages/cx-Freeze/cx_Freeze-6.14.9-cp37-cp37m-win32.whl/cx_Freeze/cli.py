...
def main():
    ...
    freezer: Freezer = Freezer(
        ...
        binIncludes=args.bin_includes,
        binExcludes=args.bin_excludes,
        binPathIncludes=args.bin_path_includes,
        binPathExcludes=args.bin_path_excludes,
        ...
        silent=args.silent,
        includeMSVCR=args.include_msvcr,
    )
    freezer.Freeze()
