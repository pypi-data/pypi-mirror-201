...
class LogoApi(object):
    ...
    def delete_default_logo(self, **kwargs):  # noqa: E501
        """Delete the default logo  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_default_logo(async_req=True)
        >>> result = thread.get()
        ...
        :return: DeleteLogoResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.delete_default_logo_with_http_info(**kwargs)  # noqa: E501

    def delete_default_logo_with_http_info(self, **kwargs):  # noqa: E501
        """Delete the default logo  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_default_logo_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(DeleteLogoResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method delete_default_logo" % key
                )
        ...
        return self.api_client.call_api(
            '/brands/default/logos/default', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='DeleteLogoResponse',  # noqa: E501
