...
class SubAccountApi(object):
    ...
    def confirm_account_with_http_info(self, account_id, confirm_account, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('account_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['account_id']) > 20):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `confirm_account`, length must be less than or equal to `20`")  # noqa: E501
        if self.api_client.client_side_validation and ('account_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['account_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `confirm_account`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'account_id' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['account_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `confirm_account`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def delete_account_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('account_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['account_id']) > 20):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `delete_account`, length must be less than or equal to `20`")  # noqa: E501
        if self.api_client.client_side_validation and ('account_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['account_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `delete_account`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'account_id' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['account_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `delete_account`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_account(self, account_id, **kwargs):  # noqa: E501
        """Show sub-account details  # noqa: E501
    ...
    def get_account_with_http_info(self, account_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('account_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['account_id']) > 20):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `get_account`, length must be less than or equal to `20`")  # noqa: E501
        if self.api_client.client_side_validation and ('account_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['account_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `get_account`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'account_id' in local_var_params and not re.search(r'^[a-zA-Z0-9]+$', local_var_params['account_id']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `account_id` when calling `get_account`, must conform to the pattern `/^[a-zA-Z0-9]+$/`")  # noqa: E501
        collection_formats = {}
