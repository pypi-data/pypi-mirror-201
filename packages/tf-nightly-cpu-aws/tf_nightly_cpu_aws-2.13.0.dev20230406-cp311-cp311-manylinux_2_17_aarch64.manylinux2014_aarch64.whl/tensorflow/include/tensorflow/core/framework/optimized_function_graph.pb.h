...
class OptimizedFunctionGraph final :
 ...
 public:
  ...
  enum : int {
    ...
    kOptimizationTimeSecsFieldNumber = 6,
  ...
  // optional uint64 optimization_time_secs = 6;
  bool has_optimization_time_secs() const;
  private:
  bool _internal_has_optimization_time_secs() const;
  public:
  void clear_optimization_time_secs();
  uint64_t optimization_time_secs() const;
  void set_optimization_time_secs(uint64_t value);
  private:
  uint64_t _internal_optimization_time_secs() const;
  void _internal_set_optimization_time_secs(uint64_t value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    uint64_t optimization_time_secs_;
...
// optional uint64 optimization_time_secs = 6;
inline bool OptimizedFunctionGraph::_internal_has_optimization_time_secs() const {
  bool value = (_impl_._has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool OptimizedFunctionGraph::has_optimization_time_secs() const {
  return _internal_has_optimization_time_secs();
}
inline void OptimizedFunctionGraph::clear_optimization_time_secs() {
  _impl_.optimization_time_secs_ = uint64_t{0u};
  _impl_._has_bits_[0] &= ~0x00000001u;
}
inline uint64_t OptimizedFunctionGraph::_internal_optimization_time_secs() const {
  return _impl_.optimization_time_secs_;
}
inline uint64_t OptimizedFunctionGraph::optimization_time_secs() const {
  // @@protoc_insertion_point(field_get:tensorflow.OptimizedFunctionGraph.optimization_time_secs)
  return _internal_optimization_time_secs();
}
inline void OptimizedFunctionGraph::_internal_set_optimization_time_secs(uint64_t value) {
  _impl_._has_bits_[0] |= 0x00000001u;
  _impl_.optimization_time_secs_ = value;
}
inline void OptimizedFunctionGraph::set_optimization_time_secs(uint64_t value) {
  _internal_set_optimization_time_secs(value);
  // @@protoc_insertion_point(field_set:tensorflow.OptimizedFunctionGraph.optimization_time_secs)
}
