...
def lazy_import():
    ...
    globals()['ObjectMetrics'] = ObjectMetrics


class TimeWindowViolations(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, before, after, *args, **kwargs):  
        """TimeWindowViolations - a model defined in OpenAPI
