...
class TripStatistics(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, trip_key, statistics, stop_statistics, total_load, max_load, max_transfer_load, *args, **kwargs):  
    ...
    @convert_js_args_to_python_args
    def __init__(self, trip_key, statistics, stop_statistics, total_load, max_load, max_transfer_load, *args, **kwargs):  
        """TripStatistics - a model defined in OpenAPI
