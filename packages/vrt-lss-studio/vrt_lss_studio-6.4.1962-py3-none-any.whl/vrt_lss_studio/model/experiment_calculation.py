...
class ExperimentCalculation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, progress, info, tracedata, *args, **kwargs):  
        """ExperimentCalculation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, progress, info, tracedata, *args, **kwargs):  
        """ExperimentCalculation - a model defined in OpenAPI
