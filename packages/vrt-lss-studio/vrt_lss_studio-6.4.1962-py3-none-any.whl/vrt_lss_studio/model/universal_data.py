...
def lazy_import():
    ...
    globals()['ReplanSettings'] = ReplanSettings
    globals()['RoutingTransportMatrixList'] = RoutingTransportMatrixList
    globals()['Transport'] = Transport
    globals()['Trip'] = Trip


class UniversalData(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'external_routing': (RoutingTransportMatrixList,),  
    ...
    def _from_openapi_data(cls, *args, **kwargs):  
        """UniversalData - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            locations ([Location]): List of locations used for orders and shifts.. [optional]  
            orders ([Order]): Orders list.. [optional]  
            performers ([Performer]): Available performers list.. [optional]  
            transports ([Transport]): Available transports list.. [optional]  
            hardlinks ([Hardlink]): Assignments list.. [optional]  
            trips ([Trip]): Existing routes.. [optional]  
            facts (Facts): [optional]  
            statistics (PlanStatistics): [optional]  
            external_routing (RoutingTransportMatrixList): [optional]  
            plan_settings (PlanSettings): [optional]  
            replan_settings (ReplanSettings): [optional]  
            actualize_settings (ActualizeSettings): [optional]  
        """
