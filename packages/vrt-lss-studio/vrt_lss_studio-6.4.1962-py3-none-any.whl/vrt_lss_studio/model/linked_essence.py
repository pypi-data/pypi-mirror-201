...
class LinkedEssence(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, essence_key, essence_type, *args, **kwargs):  
        """LinkedEssence - a model defined in OpenAPI

        Args:
            essence_key (BasicEssenceKey):
            essence_type (str): Essence type.
    ...
    @convert_js_args_to_python_args
    def __init__(self, essence_key, essence_type, *args, **kwargs):  
        """LinkedEssence - a model defined in OpenAPI
