...
def lazy_import():
    ...
    globals()['TableDataStats'] = TableDataStats
    globals()['UnplannedItems'] = UnplannedItems


class ExperimentStatistics(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, indicators, total_statistics, data_statistics, *args, **kwargs):  
        """ExperimentStatistics - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, indicators, total_statistics, data_statistics, *args, **kwargs):  
        """ExperimentStatistics - a model defined in OpenAPI
