...
class TableHardlinkFields(ModelNormal):
    ...
    def _from_openapi_data(cls, essence_key, *args, **kwargs):  
        """TableHardlinkFields - a model defined in OpenAPI

        Args:
            essence_key (BasicEssenceKey):

        Keyword Args:
            essence_type (str): Essence type.. defaults to "HARDLINK", must be one of ["HARDLINK", "ELEMENT", ]  
            ...
            element_type (str): Element type.. [optional] if omitted the server will use the default value of "ORDER"  
            elements_count (int): Elements count.. [optional] if omitted the server will use the default value of 0  
            trip_key (BasicEssenceKey): [optional]  
        """

        essence_type = kwargs.get('essence_type', "HARDLINK")
