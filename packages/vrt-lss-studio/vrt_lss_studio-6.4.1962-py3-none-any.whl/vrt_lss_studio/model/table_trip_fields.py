...
class TableTripFields(ModelNormal):
    ...
    def _from_openapi_data(cls, essence_key, *args, **kwargs):  
        """TableTripFields - a model defined in OpenAPI

        Args:
            essence_key (BasicEssenceKey):

        Keyword Args:
            essence_type (str): Essence type.. defaults to "TRIP", must be one of ["TRIP", "STOP", ]  
            ...
            orders_count (int): Count.. [optional] if omitted the server will use the default value of 0  
            name (str): Trip name.. [optional] if omitted the server will use the default value of ""  
            attributes (BasicAttributes): [optional]  
        """

        essence_type = kwargs.get('essence_type', "TRIP")
