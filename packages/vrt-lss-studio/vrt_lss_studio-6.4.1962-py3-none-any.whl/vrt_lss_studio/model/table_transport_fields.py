...
class TableTransportFields(ModelNormal):
    ...
    def _from_openapi_data(cls, essence_key, *args, **kwargs):  
        """TableTransportFields - a model defined in OpenAPI

        Args:
            essence_key (BasicEssenceKey):

        Keyword Args:
            essence_type (str): Essence type.. defaults to "TRANSPORT", must be one of ["TRANSPORT", "SHIFT", ]  
            ...
            trips_count (int): The number of trips in which the transport participates (for a shift - 0 or 1).. [optional] if omitted the server will use the default value of 0  
            attributes (BasicAttributes): [optional]  
        """

        essence_type = kwargs.get('essence_type', "TRANSPORT")
