...
class Demand(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, demand_type, possible_events, *args, **kwargs):  
        """Demand - a model defined in OpenAPI

        Args:
            key (str): Demand key, unique identifier.
        ...
        Keyword Args:
            ...
            target_cargos ([str]): Cargo keys list for `PICKUP`, one cargo key for  `DROP`, empty key for `WORK`.. [optional]  
            precedence_in_trip (int): Precedence within a trip, 0 - the precedence is not taken into account.. [optional] if omitted the server will use the default value of 0  
            precedence_in_order (int): Precedence within an order, 0 - the precedence is not taken into account.. [optional] if omitted the server will use the default value of 0  
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, demand_type, possible_events, *args, **kwargs):  
        """Demand - a model defined in OpenAPI
