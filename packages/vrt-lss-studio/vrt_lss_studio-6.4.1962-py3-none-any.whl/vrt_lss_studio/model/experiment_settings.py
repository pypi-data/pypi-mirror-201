...
class ExperimentSettings(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, plan_settings, replan_settings, actualize_settings, *args, **kwargs):  
        """ExperimentSettings - a model defined in OpenAPI
        ...
        self.replan_settings = replan_settings
    ...
    @convert_js_args_to_python_args
    def __init__(self, plan_settings, replan_settings, actualize_settings, *args, **kwargs):  
        """ExperimentSettings - a model defined in OpenAPI
