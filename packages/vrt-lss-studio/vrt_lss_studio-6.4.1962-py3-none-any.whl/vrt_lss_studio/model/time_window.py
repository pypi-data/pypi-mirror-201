...
class TimeWindow(ModelNormal):
    ...
    def _from_openapi_data(cls, _from, to, *args, **kwargs):  
        ...
        Args:
            _from (datetime): Date and time in the [RFC 3339, section 5.6 (ISO 8601)](https://tools.ietf.org/html/rfc3339#section-5.6) format. 
            to (datetime): Date and time in the [RFC 3339, section 5.6 (ISO 8601)](https://tools.ietf.org/html/rfc3339#section-5.6) format. 
