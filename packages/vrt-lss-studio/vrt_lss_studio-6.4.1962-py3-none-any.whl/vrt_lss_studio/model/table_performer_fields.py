...
def lazy_import():
    ...
    globals()['LocationKeyList'] = LocationKeyList


class TablePerformerFields(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'enabled': (bool,),  
            'pristine': (bool,),  
            'working_time': (BasicTimeWindow,),  
            'availability_time': (BasicTimeWindow,),  
            'trip_key': (BasicEssenceKey,),  
            'location_keys': (LocationKeyList,),  
            'trips_count': (int,),  
    ...
    def _from_openapi_data(cls, essence_key, *args, **kwargs):  
        """TablePerformerFields - a model defined in OpenAPI

        Args:
            essence_key (BasicEssenceKey):

        Keyword Args:
            essence_type (str): Essence type.. defaults to "PERFORMER", must be one of ["PERFORMER", "SHIFT", ]  
            ...
            working_time (BasicTimeWindow): [optional]  
            availability_time (BasicTimeWindow): [optional]  
            trip_key (BasicEssenceKey): [optional]  
            location_keys (LocationKeyList): [optional]  
            trips_count (int): The number of trips in which the performer participates (for a shift - 0 or 1).. [optional] if omitted the server will use the default value of 0  
            attributes (BasicAttributes): [optional]  
        """

        essence_type = kwargs.get('essence_type', "PERFORMER")
