...
class Waypoint(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, geopoint, *args, **kwargs):  
        ...
        Keyword Args:
            ...
            name (str, none_type): Name of the point.. [optional] if omitted the server will use the default value of "null"  
    ...
    @convert_js_args_to_python_args
    def __init__(self, geopoint, *args, **kwargs):  
        """Waypoint - a model defined in OpenAPI
