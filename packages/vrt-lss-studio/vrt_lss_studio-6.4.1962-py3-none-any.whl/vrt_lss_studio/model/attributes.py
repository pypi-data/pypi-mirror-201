...
class Attributes(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] ([Attribute]): Attributes. Used to add service information.. if omitted defaults to []  

        Keyword Args:
            value ([Attribute]): Attributes. Used to add service information.. if omitted defaults to []  
