...
def lazy_import():
    ...
    globals()['FolderStats'] = FolderStats
    globals()['FolderType'] = FolderType
    globals()['UniqueKey'] = UniqueKey


class Filesystem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, type, name, statistics, *args, **kwargs):  
        """Filesystem - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            elements ([Filesystem]): A list of child's elements.. [optional]  
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, type, name, statistics, *args, **kwargs):  
        """Filesystem - a model defined in OpenAPI
