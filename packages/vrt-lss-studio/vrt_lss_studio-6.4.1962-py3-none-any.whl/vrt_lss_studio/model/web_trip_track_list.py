...
def lazy_import():
    ...
    globals()['WebTripTrack'] = WebTripTrack


class WebTripTrackList(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tracks, statistics, *args, **kwargs):  
        """WebTripTrackList - a model defined in OpenAPI

        Args:
            tracks ([WebTripTrack]): A list of tracks.
            statistics (TableListStats):
    ...
    @convert_js_args_to_python_args
    def __init__(self, tracks, statistics, *args, **kwargs):  
        """WebTripTrackList - a model defined in OpenAPI
