...
class TableLocationFields(ModelNormal):
    ...
    def _from_openapi_data(cls, essence_key, *args, **kwargs):  
        """TableLocationFields - a model defined in OpenAPI

        Args:
            essence_key (BasicEssenceKey):

        Keyword Args:
            essence_type (str): Essence type.. defaults to "LOCATION", must be one of ["LOCATION", "WORK_WINDOW", ]  
        ...
        essence_type = kwargs.get('essence_type', "LOCATION")
