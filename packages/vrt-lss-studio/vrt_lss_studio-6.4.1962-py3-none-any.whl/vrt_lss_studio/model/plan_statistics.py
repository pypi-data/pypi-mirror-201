...
class PlanStatistics(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'trips_statistics': ([TripStatistics],),  
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, total_statistics, trips_statistics, *args, **kwargs):  
        """PlanStatistics - a model defined in OpenAPI

        Args:
            total_statistics (Statistics):
            trips_statistics ([TripStatistics]): List of statistics per trip, where. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, total_statistics, trips_statistics, *args, **kwargs):  
        """PlanStatistics - a model defined in OpenAPI
