...
class EntityType(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Entity type.., must be one of ["TASK", "SETTINGS", "ORDER", "ORDER_LINK", "PERFORMER", "PERFORMER_LINK", "TRANSPORT", "TRANSPORT_LINK", "HARDLINK", "HARDLINK_LINK", "LOCATION", "LOCATION_LINK", "BOX", "BOX_LINK", "TRIP", "TRIP_LINK", "CARGO", "CARGO_LINK", "DEMAND", "DEMAND_LINK", "EVENT", "EVENT_LINK", "PERFORMER_SHIFT", "PERFORMER_SHIFT_LINK", "TRANSPORT_SHIFT", "TRANSPORT_SHIFT_LINK", ]  

        Keyword Args:
            value (str): Entity type.., must be one of ["TASK", "SETTINGS", "ORDER", "ORDER_LINK", "PERFORMER", "PERFORMER_LINK", "TRANSPORT", "TRANSPORT_LINK", "HARDLINK", "HARDLINK_LINK", "LOCATION", "LOCATION_LINK", "BOX", "BOX_LINK", "TRIP", "TRIP_LINK", "CARGO", "CARGO_LINK", "DEMAND", "DEMAND_LINK", "EVENT", "EVENT_LINK", "PERFORMER_SHIFT", "PERFORMER_SHIFT_LINK", "TRANSPORT_SHIFT", "TRANSPORT_SHIFT_LINK", ]  
