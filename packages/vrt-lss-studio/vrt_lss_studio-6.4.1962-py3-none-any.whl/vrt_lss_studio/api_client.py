...
from vrt_lss_studio.exceptions import ApiTypeError, ApiValueError, ApiException
from vrt_lss_studio.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.create_experiment  # this is an instance of the class Endpoint
        api_instance.create_experiment()  # this invokes api_instance.create_experiment.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_experiment.callable or self.callable in this class
