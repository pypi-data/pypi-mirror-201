...
class PerformersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_performer_endpoint = _Endpoint(
            settings={
                'response_type': (WebPerformer,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/studio/experiments/{experiment_key}/performers',
        ...
        self.delete_performer_endpoint = _Endpoint(
            settings={
                'response_type': None,
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/studio/experiments/{experiment_key}/performers/{essence_key}',
        ...
        self.read_performer_endpoint = _Endpoint(
            settings={
                'response_type': (WebPerformer,),
                'auth': [
                    'ApiKeyAuth'
        ...
        self.read_performers_endpoint = _Endpoint(
            settings={
                'response_type': (TablePerformerList,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/studio/experiments/{experiment_key}/performers/batch/list',
                'operation_id': 'read_performers',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            root_map={
                ...
                'location_map': {
                    ...
                    'table_performer_filter_list': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.read_performers_geopoints_endpoint = _Endpoint(
            settings={
                'response_type': (WebPerformerGeopointList,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/studio/experiments/{experiment_key}/performers/batch/geopoints',
        ...
        self.update_performer_endpoint = _Endpoint(
            settings={
                'response_type': (WebPerformer,),
                'auth': [
                    'ApiKeyAuth'
    ...
    def create_performer(
        ...
        **kwargs
        ...
        Args:
            ...
            web_performer (WebPerformer): New essence creation request.
        ...
        kwargs['experiment_key'] = \
            experiment_key
        kwargs['web_performer'] = \
            web_performer
        return self.create_performer_endpoint.call_with_http_info(**kwargs)
    ...
    def delete_performer(
        ...
        **kwargs
        ...
        kwargs['essence_key'] = \
            essence_key
        return self.delete_performer_endpoint.call_with_http_info(**kwargs)
    ...
    def read_performer(
        ...
        **kwargs
        ...
        kwargs['essence_key'] = \
            essence_key
        return self.read_performer_endpoint.call_with_http_info(**kwargs)
    ...
    def read_performers(
        ...
        **kwargs
        ...
        >>> thread = api.read_performers(experiment_key, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            sort_field (TablePerformerColumnType): Performers table column name. . [optional]
            sort_direction (str): Sort direction.. [optional] if omitted the server will use the default value of "ASC"
            table_performer_filter_list (TablePerformerFilterList): Performers filter.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['experiment_key'] = \
            experiment_key
        return self.read_performers_endpoint.call_with_http_info(**kwargs)
    ...
    def read_performers_geopoints(
        ...
        **kwargs
        ...
        >>> thread = api.read_performers_geopoints(experiment_key, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['experiment_key'] = \
            experiment_key
        return self.read_performers_geopoints_endpoint.call_with_http_info(**kwargs)
    ...
    def update_performer(
        ...
        **kwargs
        ...
        Args:
            experiment_key (UniqueKey): Key, unique identifier.
            web_performer (WebPerformer): Essence update request.
        ...
        kwargs['web_performer'] = \
            web_performer
        return self.update_performer_endpoint.call_with_http_info(**kwargs)
