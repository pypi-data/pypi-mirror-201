...
class OrdersApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.create_order_endpoint = _Endpoint(
            settings={
                'response_type': (WebOrder,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/studio/experiments/{experiment_key}/orders',
        ...
        self.delete_order_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/studio/experiments/{experiment_key}/orders/{essence_key}',
        ...
        self.read_order_endpoint = _Endpoint(
            settings={
                'response_type': (WebOrder,),
                'auth': [
                    'ApiKeyAuth'
        ...
        self.read_orders_endpoint = _Endpoint(
            settings={
                'response_type': (TableOrderList,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/studio/experiments/{experiment_key}/orders/batch/list',
        ...
        self.read_orders_geopoints_endpoint = _Endpoint(
            settings={
                'response_type': (WebOrderGeopointList,),
                'auth': [
                    'ApiKeyAuth'
                ],
                'endpoint_path': '/studio/experiments/{experiment_key}/orders/batch/geopoints',
    ...
    def create_order(
        ...
        **kwargs
        ...
        Args:
            ...
            web_order (WebOrder): New essence creation request.
    ...
    def read_order(
        ...
        **kwargs
        ...
        kwargs['essence_key'] = \
            essence_key
        return self.read_order_endpoint.call_with_http_info(**kwargs)
    ...
    def read_orders(
        ...
        **kwargs
        ...
        >>> thread = api.read_orders(experiment_key, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            sort_field (TableOrderColumnType): Order table column name. . [optional]
            sort_direction (str): Sort direction.. [optional] if omitted the server will use the default value of "ASC"
            table_order_filter_list (TableOrderFilterList): Essence filter.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['experiment_key'] = \
            experiment_key
        return self.read_orders_endpoint.call_with_http_info(**kwargs)
    ...
    def read_orders_geopoints(
        ...
        **kwargs
        ...
        >>> thread = api.read_orders_geopoints(experiment_key, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            table_order_filter_list (TableOrderFilterList): Orders filter.. [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['experiment_key'] = \
            experiment_key
        return self.read_orders_geopoints_endpoint.call_with_http_info(**kwargs)
    ...
    def update_order(
        ...
        **kwargs
        ...
        Args:
            experiment_key (UniqueKey): Key, unique identifier.
            web_order (WebOrder): Essence update request.
