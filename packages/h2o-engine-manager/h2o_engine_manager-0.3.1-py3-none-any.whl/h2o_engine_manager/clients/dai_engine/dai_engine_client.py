...
from h2o_engine_manager.gen.dai_service import ApiException as DAIEngineApiException
from h2o_engine_manager.gen.dai_service.api.dai_engine_service_api import (
    DAIEngineServiceApi,
)
from h2o_engine_manager.gen.dai_service.configuration import Configuration
from h2o_engine_manager.gen.dai_service.model.v1_dai_engine import (
        ...
        try:
            api_engine = (
                self.client_info.api_instance.d_ai_engine_service_get_dai_engine(
                    name=self.__build_api_engine_name(
