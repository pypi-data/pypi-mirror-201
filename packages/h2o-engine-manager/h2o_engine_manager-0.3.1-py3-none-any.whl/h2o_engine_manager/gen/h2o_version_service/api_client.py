...
from h2o_engine_manager.gen.h2o_version_service.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_engine_manager.gen.h2o_version_service.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = H2OVersionServiceApi()
        api_instance.h2_o_version_service_list_h2_o_versions  # this is an instance of the class Endpoint
        api_instance.h2_o_version_service_list_h2_o_versions()  # this invokes api_instance.h2_o_version_service_list_h2_o_versions.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.h2_o_version_service_list_h2_o_versions.callable or self.callable in this class
