...
from h2o_engine_manager.gen.dai_service.api_client import ApiClient, Endpoint as _Endpoint
from h2o_engine_manager.gen.dai_service.model_utils import (  # noqa: F401
...
class DAIEngineServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.d_ai_engine_service_upgrade_version_endpoint = _Endpoint(
            settings={
                'response_type': (V1DAIEngineServiceUpgradeVersionResponse,),
                'auth': [],
                'endpoint_path': '/v1/{daiEngine}:upgradeVersion',
                'operation_id': 'd_ai_engine_service_upgrade_version',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def d_ai_engine_service_delete_dai_engine(
        ...
        **kwargs
        ...
        >>> thread = api.d_ai_engine_service_delete_dai_engine(name, async_req=True)
        >>> result = thread.get()

        Args:
            name (str): DAIEngine resource name. Format: workspaces/{workspace}/daiEngines/{dai_engine}
    ...
    def d_ai_engine_service_download_logs(
        ...
        **kwargs
        ...
        Args:
            dai_engine (str): DAIEngine resource name. Format: workspaces/{workspace}/daiEngines/{dai_engine}
    ...
    def d_ai_engine_service_get_dai_engine(
        ...
        **kwargs
        ...
        >>> thread = api.d_ai_engine_service_get_dai_engine(name, async_req=True)
        >>> result = thread.get()
    ...
    def d_ai_engine_service_update_dai_engine(
        ...
        **kwargs
        ...
        Args:
            ...
            update_mask (str): The list of paths referencing which fields to update. Update mask must be non-empty.  Allowed field paths are: {\"cpu\", \"gpu\", \"memory_bytes\", \"config\", \"annotations\", \"display_name\", \"max_idle_duration\", \"max_running_duration\"}. Paths are case sensitive (must match exactly).  To update all allowed fields, specify exactly one path with value \"*\".
    ...
    def d_ai_engine_service_upgrade_version(
        self,
        dai_engine,
        body,
        **kwargs
        ...
        >>> thread = api.d_ai_engine_service_upgrade_version(dai_engine, body, async_req=True)
        >>> result = thread.get()

        Args:
            dai_engine (str): DAIEngine resource name. Format: workspaces/{workspace}/daiEngines/{dai_engine}
            body (DAIEngineServiceUpgradeVersionRequest):
        ...
        kwargs['body'] = \
            body
        return self.d_ai_engine_service_upgrade_version_endpoint.call_with_http_info(**kwargs)
