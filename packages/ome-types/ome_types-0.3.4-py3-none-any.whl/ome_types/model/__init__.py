...
_lists = {
    ...
    "Pixels": {"BinData", "Channel", "Plane", "TiffData"},
    "Plane": {"AnnotationRef"},
    "Channel": {"AnnotationRef"},
    "MicrobeamManipulation": {"Type", "LightSourceSettings", "ROIRef"},
    "Instrument": {
        "Dichroic",
        "Objective",
        "Detector",
    ...
    "Folder": {"AnnotationRef", "ImageRef", "ROIRef", "FolderRef"},
    ...
    "LightPath": {"AnnotationRef", "ExcitationFilterRef", "EmissionFilterRef"},
    "ROI": {"AnnotationRef"},
    "Plate": {"Well", "PlateAcquisition", "AnnotationRef"},
