...
:func:`retiming_handle_add`

:func:`retiming_handle_move`

:func:`retiming_handle_remove`
...
def change_scene(scene: str = '') -> None:
...
def crossfade_sounds() -> None:
  ...
  :file:`startup/bl_operators/sequencer.py\:26 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py#L26>`_
...
def deinterlace_selected_movies() -> None:
  ...
  :file:`startup/bl_operators/sequencer.py\:114 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py#L114>`_

  """

  ...

def delete(delete_data: bool = False) -> None:
...
def effect_strip_add(type: str = 'CROSS', frame_start: int = 0, frame_end: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, color: mathutils.Color = (0.0, 0.0, 0.0)) -> None:
...
def fades_add(duration_seconds: float = 1.0, type: str = 'IN_OUT') -> None:
  ...
  :file:`startup/bl_operators/sequencer.py\:190 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py#L190>`_
...
def fades_clear() -> None:
  ...
  :file:`startup/bl_operators/sequencer.py\:133 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py#L133>`_
...
def mask_strip_add(frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, mask: str = '') -> None:
...
def movieclip_strip_add(frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, clip: str = '') -> None:
...
def retiming_handle_add(timeline_frame: int = 0) -> None:
...
def retiming_handle_move(handle_index: int = 0) -> None:
...
def retiming_handle_remove(handle_index: int = 0) -> None:
...
def scene_strip_add(frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, scene: str = '') -> None:
...
def scene_strip_add_new(frame_start: int = 0, channel: int = 1, replace_sel: bool = True, overlap: bool = False, overlap_shuffle_override: bool = False, type: str = 'NEW') -> None:
...
def select(wait_to_deselect_others: bool = False, mouse_x: int = 0, mouse_y: int = 0, extend: bool = False, deselect: bool = False, toggle: bool = False, deselect_all: bool = False, select_passthrough: bool = False, center: bool = False, linked_handle: bool = False, linked_time: bool = False, side_of_frame: bool = False) -> None:
...
def split_multicam(camera: int = 1) -> None:
  ...
  :file:`startup/bl_operators/sequencer.py\:81 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/sequencer.py#L81>`_
