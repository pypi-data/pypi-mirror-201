...
:func:`stroke_start_set`

:func:`stroke_subdivide`

:func:`stroke_trim`

:func:`time_segment_add`

:func:`time_segment_move`

:func:`time_segment_remove`
...
def interpolate(shift: float = 0.0, layers: str = 'ACTIVE', interpolate_selected_only: bool = False, exclude_breakdowns: bool = False, flip: str = 'AUTO', smooth_steps: int = 1, smooth_factor: float = 0.0, release_confirm: bool = False) -> None:
...
def interpolate_sequence(step: int = 1, layers: str = 'ACTIVE', interpolate_selected_only: bool = False, exclude_breakdowns: bool = False, flip: str = 'AUTO', smooth_steps: int = 1, smooth_factor: float = 0.0, type: str = 'LINEAR', easing: str = 'AUTO', back: float = 1.702, amplitude: float = 0.15, period: float = 0.15) -> None:
...
def layer_add(layer: int = 0, new_layer_name: str = '') -> None:
...
def layer_merge(mode: str = 'ACTIVE') -> None:
...
def move_to_layer(layer: int = 0, new_layer_name: str = '') -> None:
...
def primitive_box(subdivision: int = 3, edges: int = 1, type: str = 'BOX', wait_for_input: bool = True) -> None:
...
def primitive_circle(subdivision: int = 94, edges: int = 1, type: str = 'CIRCLE', wait_for_input: bool = True) -> None:
...
def primitive_curve(subdivision: int = 62, edges: int = 1, type: str = 'CURVE', wait_for_input: bool = True) -> None:
...
def primitive_line(subdivision: int = 6, edges: int = 1, type: str = 'LINE', wait_for_input: bool = True) -> None:
...
def primitive_polyline(subdivision: int = 6, edges: int = 1, type: str = 'POLYLINE', wait_for_input: bool = True) -> None:
...
def reproject(type: str = 'VIEW', keep_original: bool = False, offset: float = 0.0) -> None:
...
def select(extend: bool = False, deselect: bool = False, toggle: bool = False, deselect_all: bool = False, select_passthrough: bool = False, entire_strokes: bool = False, location: typing.Tuple[int, int] = (0, 0), use_shift_extend: bool = False) -> None:
...
def stroke_outline(view_mode: str = 'VIEW', material_mode: str = 'ACTIVE', thickness: int = 1, keep: bool = True, subdivisions: int = 3, length: float = 0.0) -> None:
...
def stroke_sample(length: float = 0.1, sharp_threshold: float = 0.1) -> None:
...
def stroke_smooth(repeat: int = 2, factor: float = 1.0, only_selected: bool = True, smooth_position: bool = True, smooth_thickness: bool = True, smooth_strength: bool = False, smooth_uv: bool = False) -> None:
...
def time_segment_add(modifier: str = '') -> None:
...
def time_segment_move(modifier: str = '', type: str = 'UP') -> None:
...
def time_segment_remove(modifier: str = '', index: int = 0) -> None:
...
def tint_flip() -> None:
  ...
  :file:`startup/bl_ui/properties_grease_pencil_common.py\:871 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_ui/properties_grease_pencil_common.py#L871>`_

  """

  ...

def transform_fill(mode: str = 'ROTATE', location: mathutils.Vector = (0.0, 0.0), rotation: float = 0.0, scale: float = 0.0, release_confirm: bool = False) -> None:
