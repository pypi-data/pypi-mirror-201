...
class GptChatSession:
  ...
  def create_new(cls, configs: GptChatSessionConfigs):
    system_prompt = 'You are a helpful assistant who helps me write code. ' \
                    'If I ask you a question about coding, only answer with code. ' \
                    'When answering with code, if  you need to write any explication, write it in a code comment. '
    message = GptSystemMessage.from_system_message(system_prompt)
