...
class FunctionResource(
    ...
    def __init__(
        ...
        *,
        ...
        :param is_secure: Specifies that the function is secure. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/r/function#is_secure FunctionResource#is_secure}
