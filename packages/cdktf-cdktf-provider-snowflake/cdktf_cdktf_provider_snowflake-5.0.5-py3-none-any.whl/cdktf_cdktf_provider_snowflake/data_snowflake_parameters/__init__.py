...
class DataSnowflakeParameters(
    ...
    def __init__(
        ...
        *,
        ...
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/d/parameters#id DataSnowflakeParameters#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param object_name: If parameter_type is set to "OBJECT" then object_name is the name of the object to display object parameters for. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/d/parameters#object_name DataSnowflakeParameters#object_name}
        :param object_type: If parameter_type is set to "OBJECT" then object_type is the type of object to display object parameters for. Valid values are any object supported by the IN clause of the `SHOW PARAMETERS <https://docs.snowflake.com/en/sql-reference/sql/show-parameters.html#parameters>`_ statement, including: WAREHOUSE | DATABASE | SCHEMA | TASK | TABLE Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/d/parameters#object_type DataSnowflakeParameters#object_type}
        :param parameter_type: The type of parameter to filter by. Valid values are: "ACCOUNT", "SESSION", "OBJECT". Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/d/parameters#parameter_type DataSnowflakeParameters#parameter_type}
        :param pattern: Allows limiting the list of parameters by name using LIKE clause. Refer to `Limiting the List of Parameters by Name <https://docs.snowflake.com/en/sql-reference/parameters.html#limiting-the-list-of-parameters-by-name>`_ Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/d/parameters#pattern DataSnowflakeParameters#pattern}
        :param user: If parameter_type is set to "SESSION" then user is the name of the user to display session parameters for. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/d/parameters#user DataSnowflakeParameters#user}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
