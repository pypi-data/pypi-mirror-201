...
class TagMaskingPolicyAssociation(
    ...
    def __init__(
        ...
        *,
        ...
        :param masking_policy_id: The resource id of the masking policy. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/r/tag_masking_policy_association#masking_policy_id TagMaskingPolicyAssociation#masking_policy_id}
