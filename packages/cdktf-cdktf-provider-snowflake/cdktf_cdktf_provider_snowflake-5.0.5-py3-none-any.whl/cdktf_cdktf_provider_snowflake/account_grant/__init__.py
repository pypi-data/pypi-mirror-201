...
class AccountGrant(
    ...
    def __init__(
        ...
        *,
        ...
        :param privilege: The account privilege to grant. Valid privileges are those in `globalPrivileges <https://docs.snowflake.com/en/sql-reference/sql/grant-privilege.html>`_. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/r/account_grant#privilege AccountGrant#privilege}
...
class AccountGrantConfig(_cdktf_9a9027ec.TerraformMetaArguments):
    ...
    def privilege(self) -> typing.Optional[builtins.str]:
        '''The account privilege to grant. Valid privileges are those in `globalPrivileges <https://docs.snowflake.com/en/sql-reference/sql/grant-privilege.html>`_.
