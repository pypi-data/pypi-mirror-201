...
class Procedure(
    ...
    def __init__(
        ...
        *,
        ...
        :param statement: Specifies the code used to create the procedure. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/r/procedure#statement Procedure#statement}
        ...
        :param handler: The handler method for Java / Python procedures. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/r/procedure#handler Procedure#handler}
        ...
        :param imports: Imports for Java / Python procedures. For Java this a list of jar files, for Python this is a list of Python files. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/r/procedure#imports Procedure#imports}
        ...
        :param runtime_version: Required for Python procedures. Specifies Python runtime version. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/snowflake/r/procedure#runtime_version Procedure#runtime_version}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
