...
from ..models.event_query_event_types_item import EventQueryEventTypesItem
from ..models.event_query_severities_item import EventQuerySeveritiesItem
from ..models.event_query_types_item import EventQueryTypesItem
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.event_sort import EventSort


T = TypeVar("T", bound="EventQuery")
...
class EventQuery:
    ...
    Attributes:
        ...
        event_types (Union[Unset, List[EventQueryEventTypesItem]]):
        ...
        severities (Union[Unset, List[EventQuerySeveritiesItem]]):
    """

    offset: Union[Unset, int] = UNSET
    count: Union[Unset, int] = UNSET
    sort: Union[Unset, "EventSort"] = UNSET
    agent_ids: Union[Unset, List[str]] = UNSET
    device_ids: Union[Unset, List[str]] = UNSET
    names: Union[Unset, List[str]] = UNSET
    types: Union[Unset, List[EventQueryTypesItem]] = UNSET
    ...
    event_types: Union[Unset, List[EventQueryEventTypesItem]] = UNSET
    ...
    severities: Union[Unset, List[EventQuerySeveritiesItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_sort, Unset):
            ...
            sort = EventSort.from_dict(_sort)
        ...
        for types_item_data in _types or []:
            types_item = EventQueryTypesItem(types_item_data)
        ...
        for event_types_item_data in _event_types or []:
            event_types_item = EventQueryEventTypesItem(event_types_item_data)
        ...
        for severities_item_data in _severities or []:
            severities_item = EventQuerySeveritiesItem(severities_item_data)
        ...
        event_query.additional_properties = d
        return event_query
