...
from ..models.event_filter_event_types_item import EventFilterEventTypesItem
from ..models.event_filter_severities_item import EventFilterSeveritiesItem
from ..models.event_filter_types_item import EventFilterTypesItem
...
class EventFilter:
    ...
    Attributes:
        ...
        event_types (Union[Unset, List[EventFilterEventTypesItem]]):
        ...
        severities (Union[Unset, List[EventFilterSeveritiesItem]]):
        agent_ids (Union[Unset, List[str]]):
        device_ids (Union[Unset, List[str]]):
        names (Union[Unset, List[str]]):
        types (Union[Unset, List[EventFilterTypesItem]]):
    ...
    event_types: Union[Unset, List[EventFilterEventTypesItem]] = UNSET
    ...
    severities: Union[Unset, List[EventFilterSeveritiesItem]] = UNSET
    agent_ids: Union[Unset, List[str]] = UNSET
    device_ids: Union[Unset, List[str]] = UNSET
    names: Union[Unset, List[str]] = UNSET
    types: Union[Unset, List[EventFilterTypesItem]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for event_types_item_data in _event_types or []:
            event_types_item = EventFilterEventTypesItem(event_types_item_data)
        ...
        for severities_item_data in _severities or []:
            severities_item = EventFilterSeveritiesItem(severities_item_data)
        ...
        for types_item_data in _types or []:
            types_item = EventFilterTypesItem(types_item_data)
