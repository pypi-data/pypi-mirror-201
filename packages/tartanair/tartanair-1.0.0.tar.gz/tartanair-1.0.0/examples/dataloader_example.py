...
subset_framenum = 64 # This is the number of frames in a subset. Notice that this is an upper bound on the batch size. Ideally, make this number large to utilize your RAM efficiently. Information about the allocated memory will be provided in the console.
...
for i in range(1000):    
    ...
    img1 = batch['rgb_lcam_front'][11][0]
    img2 = batch['rgb_lcam_front'][22][0]


    # Visualize the images.
    outimg = np.concatenate((img0, img1, img2), axis = 1)
