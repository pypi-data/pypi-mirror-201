...
cam_model_2 = {'name': 'linearsphere',
                ...
                'params':
                        ...
                        'width': 256, 
                        'fov_degree': 195},
                'R_raw_new': Rotation.identity().as_matrix().tolist()}

ta.customize(env = 'SewerageExposure', difficulty = 'hard', trajectory_id = ['P000'], modality = ['image'], new_camera_models_params=[cam_model_2], num_workers = 2, device='cuda') # Or cpu.
