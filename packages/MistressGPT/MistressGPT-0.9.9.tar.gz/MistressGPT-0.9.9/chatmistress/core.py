...
def init_chat_components(role_info: RoleInfo, temperature, top_p, max_token_limit, debug=False):
    logger.info(f"初始化对话 role_info={role_info}")
...
def interact(
    ...
    logger.info(f"对话交互 top_p={top_p},temperature={temperature},openai_api_key={openai_api_key}")
