...
:func:`tree_socket_change_subtype`
...
def add_group(name: str = '', session_uuid: int = 0) -> None:
...
def add_node(type: str = '', use_transform: bool = False, settings: typing.Union[typing.Sequence[NodeSetting], typing.Mapping[str, NodeSetting], bpy.types.bpy_prop_collection] = None) -> None:
  ...
  :file:`startup/bl_operators/node.py\:115 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L115>`_
...
def collapse_hide_unused_toggle() -> None:
  ...
  :file:`startup/bl_operators/node.py\:165 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L165>`_
...
def new_geometry_node_group_assign() -> None:
  ...
  :file:`startup/bl_operators/geometry_nodes.py\:229 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L229>`_
...
def new_geometry_nodes_modifier() -> None:
  ...
  :file:`startup/bl_operators/geometry_nodes.py\:207 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/geometry_nodes.py#L207>`_
...
def tree_path_parent() -> None:
  ...
  :file:`startup/bl_operators/node.py\:195 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/node.py#L195>`_
...
def tree_socket_change_subtype(socket_subtype: str = 'DEFAULT') -> None:
