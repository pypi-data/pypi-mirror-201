...
def add_marker(location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def bundles_to_mesh() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:281 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L281>`_
...
def constraint_to_fcurve() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:519 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L519>`_
...
def delete_proxy() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:348 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L348>`_
...
def dopesheet_select_channel(location: mathutils.Vector = (0.0, 0.0), extend: bool = False) -> None:
...
def filter_tracks(track_threshold: float = 5.0) -> None:
  ...
  :file:`startup/bl_operators/clip.py\:195 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L195>`_
...
def graph_select(location: mathutils.Vector = (0.0, 0.0), extend: bool = False) -> None:
...
def select(extend: bool = False, deselect_all: bool = False, location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def set_active_clip() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:210 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L210>`_
...
def set_viewport_background() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:409 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L409>`_
...
def setup_tracking_scene() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:971 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L971>`_

  """

  ...

def slide_marker(offset: mathutils.Vector = (0.0, 0.0)) -> None:
...
def track_settings_as_default() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:1000 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L1000>`_
...
def track_settings_to_track() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:1049 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L1049>`_
...
def track_to_empty() -> None:
  ...
  :file:`startup/bl_operators/clip.py\:257 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/clip.py#L257>`_
...
def view_pan(offset: mathutils.Vector = (0.0, 0.0)) -> None:
...
def view_zoom_in(location: mathutils.Vector = (0.0, 0.0)) -> None:
...
def view_zoom_out(location: mathutils.Vector = (0.0, 0.0)) -> None:
