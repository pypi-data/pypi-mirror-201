...
def align_rotation(method: str = 'AUTO', axis: str = 'X') -> None:

  """

  Align the UV island's rotation

  :file:`startup/bl_operators/uvcalc_transform.py\:275 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/uvcalc_transform.py#L275>`_
...
def follow_active_quads(mode: str = 'LENGTH_AVERAGE') -> None:
  ...
  :file:`startup/bl_operators/uvcalc_follow_active.py\:257 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/uvcalc_follow_active.py#L257>`_
...
def lightmap_pack(PREF_CONTEXT: str = 'SEL_FACES', PREF_PACK_IN_ONE: bool = True, PREF_NEW_UVLAYER: bool = False, PREF_APPLY_IMAGE: bool = False, PREF_IMG_PX_SIZE: int = 512, PREF_BOX_DIV: int = 12, PREF_MARGIN_DIV: float = 0.1) -> None:
  ...
  :file:`startup/bl_operators/uvcalc_lightmap.py\:661 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/uvcalc_lightmap.py#L661>`_
...
def pack_islands(udim_source: str = 'CLOSEST_UDIM', rotate: bool = True, margin_method: str = 'SCALED', margin: float = 0.001, shape_method: str = 'CONCAVE') -> None:
...
def randomize_uv_transform(random_seed: int = 0, use_loc: bool = True, loc: mathutils.Vector = (0.0, 0.0), use_rot: bool = True, rot: float = 0.0, use_scale: bool = True, scale_even: bool = False, scale: typing.Tuple[float, float] = (1.0, 1.0)) -> None:
  ...
  :file:`startup/bl_operators/uvcalc_transform.py\:449 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/uvcalc_transform.py#L449>`_
