...
def drop_world(name: str = '', session_uuid: int = 0) -> None:
...
def edit_mesh_extrude_individual_move() -> None:
  ...
  :file:`startup/bl_operators/view3d.py\:21 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L21>`_
...
def edit_mesh_extrude_manifold_normal() -> None:
  ...
  :file:`startup/bl_operators/view3d.py\:154 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L154>`_
...
def edit_mesh_extrude_move_normal(dissolve_and_intersect: bool = False) -> None:
  ...
  :file:`startup/bl_operators/view3d.py\:120 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L120>`_
...
def edit_mesh_extrude_move_shrink_fatten() -> None:
  ...
  :file:`startup/bl_operators/view3d.py\:137 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L137>`_
...
def select(extend: bool = False, deselect: bool = False, toggle: bool = False, deselect_all: bool = False, select_passthrough: bool = False, center: bool = False, enumerate: bool = False, object: bool = False, vert_without_handles: bool = False, location: typing.Tuple[int, int] = (0, 0)) -> None:
...
def transform_gizmo_set(extend: bool = False, type: typing.Set[str] = {}) -> None:
  ...
  :file:`startup/bl_operators/view3d.py\:196 <https://projects.blender.org/blender/blender/src/branch/main/scripts/startup/bl_operators/view3d.py#L196>`_
