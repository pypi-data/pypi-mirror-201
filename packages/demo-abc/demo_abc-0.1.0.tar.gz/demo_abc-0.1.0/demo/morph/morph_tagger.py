import pickle
from demo.morph import settings 
import re
from demo.morph.lemmatizeSentence import lemmatize_sentence
from demo.morph.tokenizers_words import simple_word_tokenize
from demo.parser import arStrip
...
def tagger(sentence: str, task = 'full', lang = 'MSA') -> list:
    ...
    #     settings.flag = False
    settings.div_dic = load_ALMA_dic(r'~\demo\dic_data\ALMA_dic_first_500records_with_language_and_task.pickle')
