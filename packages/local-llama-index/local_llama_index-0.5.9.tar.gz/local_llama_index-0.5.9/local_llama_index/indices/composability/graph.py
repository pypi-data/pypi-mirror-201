...
from local_llama_index.data_structs.data_structs_v2 import CompositeIndex
from local_llama_index.data_structs.data_structs_v2 import V2IndexStruct
from local_llama_index.data_structs.data_structs_v2 import V2IndexStruct as IndexStruct
from local_llama_index.data_structs.node_v2 import IndexNode, DocumentRelationship
from local_llama_index.docstore import DocumentStore
from local_llama_index.indices.base import BaseGPTIndex
from local_llama_index.indices.query.query_runner import QueryRunner
from local_llama_index.indices.query.query_transform.base import BaseQueryTransform
from local_llama_index.indices.query.schema import QueryBundle, QueryConfig
from local_llama_index.indices.service_context import ServiceContext
from local_llama_index.response.schema import RESPONSE_TYPE
...
class ComposableGraph:
    ...
    def load_from_string(cls, index_string: str, **kwargs: Any) -> "ComposableGraph":
        ...
        """
        # lazy load registry
        from local_llama_index.indices.registry import load_index_struct_from_dict
