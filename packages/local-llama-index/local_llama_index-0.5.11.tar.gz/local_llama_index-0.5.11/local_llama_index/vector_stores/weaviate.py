...
from local_llama_index.readers.weaviate.data_structs import WeaviateNode
from local_llama_index.readers.weaviate.utils import get_default_class_prefix
from local_llama_index.vector_stores.types import (
    NodeEmbeddingResult,
    VectorStore,
...
class WeaviateVectorStore(VectorStore):
    ...
    def add(
        ...
        WeaviateNode.from_local_llama_index_batch(
    ...
    def query(
        ...
        """
        nodes = WeaviateNode.to_local_llama_index_list(
            self.client,
            self._class_prefix,
