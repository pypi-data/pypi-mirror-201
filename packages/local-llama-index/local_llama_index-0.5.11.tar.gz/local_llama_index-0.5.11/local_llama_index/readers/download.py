...
def download_loader(
    ...
    use_local_llama_index_import: bool = False,
) -> Type[BaseReader]:
    ...
    Args:
        ...
        use_local_llama_index_import: If true, the loader files will use
            local_llama_index as the base dependency. By default (False),
    ...
    if refresh_cache or not os.path.exists(loader_path):
        ...
        if use_local_llama_index_import:
            basepy_raw_content = basepy_raw_content.replace(
                "import llama_index", "import local_llama_index"
            )
            basepy_raw_content = basepy_raw_content.replace(
                "from llama_index", "from local_llama_index"
            )
