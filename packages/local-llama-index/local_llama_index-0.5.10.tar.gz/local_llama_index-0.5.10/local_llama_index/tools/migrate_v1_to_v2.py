...
from local_llama_index.constants import DOCSTORE_KEY, INDEX_STRUCT_KEY
from local_llama_index.data_structs.table import SQLStructTable
...
from local_llama_index.data_structs.data_structs import (
    KG,
    ChromaIndexDict,
    EmptyIndex,
    FaissIndexDict,
...
from local_llama_index.data_structs.data_structs_v2 import KG as V2KG
from local_llama_index.data_structs.data_structs_v2 import ChromaIndexDict as V2ChromaIndexDict
from local_llama_index.data_structs.data_structs_v2 import FaissIndexDict as V2FaissIndexDict
from local_llama_index.data_structs.data_structs_v2 import IndexDict as V2IndexDict
from local_llama_index.data_structs.data_structs_v2 import IndexGraph as V2IndexGraph
from local_llama_index.data_structs.data_structs_v2 import IndexList as V2IndexList
from local_llama_index.data_structs.data_structs_v2 import KeywordTable as V2KeywordTable
from local_llama_index.data_structs.data_structs_v2 import (
    OpensearchIndexDict as V2OpensearchIndexDict,
)
from local_llama_index.data_structs.data_structs_v2 import (
    PineconeIndexDict as V2PineconeIndexDict,
)
from local_llama_index.data_structs.data_structs_v2 import QdrantIndexDict as V2QdrantIndexDict
from local_llama_index.data_structs.data_structs_v2 import SimpleIndexDict as V2SimpleIndexDict
from local_llama_index.data_structs.data_structs_v2 import V2IndexStruct
from local_llama_index.data_structs.data_structs_v2 import (
    WeaviateIndexDict as V2WeaviateIndexDict,
)
from local_llama_index.data_structs.node_v2 import DocumentRelationship
from local_llama_index.data_structs.node_v2 import ImageNode as V2ImageNode
from local_llama_index.data_structs.node_v2 import Node as V2Node
from local_llama_index.data_structs.struct_type import IndexStructType
from local_llama_index.old_docstore import V1DocumentStore
from local_llama_index.docstore import DocumentStore as V2DocumentStore
from local_llama_index.tools.file_utils import add_prefix_suffix_to_file_path
