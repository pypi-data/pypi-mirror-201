...
## Set up Local Development Environment for Azure

### Install Azure Client

Run Install Azure Client on Ubuntu or WSL (Primary)

```sh
curl -sL https://aka.ms/InstallAzureCLIDeb | sudo bash
```

Run Install Azure Client on Windows

1. Read Docs and Option at [Azure Client-CLI](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli)
2. Run Install
...
[Azure Cloud Shell Instructions](https://microsoft.Github.io/AzureTipsAndTricks/blog/tip49.html)
