...
class AdvancedLabellingInterface(object):
    ...
    def __init__(self,
        ...
        self.last_absent_forward_btn = Button(self.buttons_frm, text="LAST ABSENT", fg='red', command=lambda: self.find_last_next_annotation(forwards=False, present=False))
        self.last_present_forward_btn = Button(self.buttons_frm, text="LAST PRESENT", fg='blue', command=lambda: self.find_last_next_annotation(forwards=False, present=True))
