...
class Explainer(shap.Explainer):
    ...
    def __init__(self, model: object, *args, **kwargs):
        ...
        Args:
            ...
            **upload_error_qiis: Argument needed for `upload_project`
        ...
        if self.connection_string is None or self.token is None:
            ...
            upload_project_kwargs = _filter_kwargs(
                kwargs, [
                    "virtual_models", "upload_strategy", "upload_error_qiis",
    ...
    def __call__(self, *args, **kwargs) -> pd.DataFrame:
        ...
        for data in args:
            ret.append(
                self.shap_explainer(data, **shap_explainer_shap_values_kwargs)
            )
