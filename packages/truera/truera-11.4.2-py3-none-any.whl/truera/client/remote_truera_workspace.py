...
class RemoteTrueraWorkspace(BaseTrueraWorkspace):
    ...
    def add_production_data_split(self, data_split_name: str):
        self._ensure_project()
        self._ensure_data_collection()
        self.data_service_client.create_empty_split(
    ...
    def _infer_model_output_context(self, schema, model_output_context):
    ...
    def add_extra_data(
        ...
        add_data(
            ...
            split_name=data_split_name,
            schema=Schema(
                id_col_name=id_col_name, extra_data_col_names=extras_col_names
            )
        )
