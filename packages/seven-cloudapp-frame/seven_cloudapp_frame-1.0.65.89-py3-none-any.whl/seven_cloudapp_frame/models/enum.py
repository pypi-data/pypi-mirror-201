...
@LastEditTime: 2023-03-30 17:22:44
...
class TaskType(Enum):
    ...
    browse_goods = 9
    # 浏览店铺(进店逛逛)，格式：{"reward_value":0,"stay_time":0,"asset_object_id":""} 字段说明：reward_value:奖励值 asset_object_id:资产对象标识 stay_time:停留时间
    browse_store = 10
    # 浏览直播间(观看直播间)，格式：{"reward_value":0,"link_url":"","stay_time":0,"asset_object_id":""}  字段说明：reward_value:奖励值 link_url:链接地址 asset_object_id:资产对象标识 stay_time:停留时间
    browse_live_room = 11
    ...
    # 累计签到，格式：{"day_list":[{'day': 1, 'reward_value': 1}, {'day': 2, 'reward_value': 1}],"asset_object_id":"","is_loop":1} 字段说明： day_array:每天奖励配置列表 asset_object_id:资产对象标识 is_loop:是否循环1是0否
    cumulative_sign = 13
