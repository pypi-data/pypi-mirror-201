...
class Route(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, legs, statistics, *args, **kwargs):  
        """Route - a model defined in OpenAPI

        Args:
            legs ([RouteLeg]): Route segments between locations specified in the parameter 'waypoints'.
            statistics (RouteStatistics):
    ...
    @convert_js_args_to_python_args
    def __init__(self, legs, statistics, *args, **kwargs):  
        """Route - a model defined in OpenAPI
