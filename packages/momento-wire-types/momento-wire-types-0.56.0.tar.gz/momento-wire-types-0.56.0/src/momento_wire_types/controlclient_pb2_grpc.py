...
class ScsControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GenerateApiToken = channel.unary_unary(
                '/control_client.ScsControl/GenerateApiToken',
                request_serializer=controlclient__pb2._GenerateApiTokenRequest.SerializeToString,
                response_deserializer=controlclient__pb2._GenerateApiTokenResponse.FromString,
                )
...
def add_ScsControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GenerateApiToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=controlclient__pb2._GenerateApiTokenRequest.FromString,
                    response_serializer=controlclient__pb2._GenerateApiTokenResponse.SerializeToString,
            ),
    }
...
class ScsControl(object):
    ...
    def GenerateApiToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/control_client.ScsControl/GenerateApiToken',
            controlclient__pb2._GenerateApiTokenRequest.SerializeToString,
            controlclient__pb2._GenerateApiTokenResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
