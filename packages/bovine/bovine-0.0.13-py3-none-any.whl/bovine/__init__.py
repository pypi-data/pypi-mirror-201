...
from .utils.crypto import content_digest_sha256
from .utils.http_signature import HttpSignature
from .utils.signature_checker import SignatureChecker
...
async def validate_moo_auth_signature(request, domain):
