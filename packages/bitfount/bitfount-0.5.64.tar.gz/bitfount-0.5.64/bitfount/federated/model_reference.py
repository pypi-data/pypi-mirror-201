...
class BitfountModelReference(_BaseModelRegistryMixIn, _BaseSerializableObjectMixIn):
    ...
    def _upload_model_to_hub(self) -> None:
        ...
        self.model_ref = cast(Path, self.model_ref)
        try:
            self.hub.send_model(self.model_ref, self.private)
    ...
    def get_weights(self) -> Optional[bytes]:
        ...
        return self.hub.get_weights(self.username, self.model_ref, self.model_version)
