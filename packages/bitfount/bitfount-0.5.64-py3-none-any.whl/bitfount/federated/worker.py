...
class _Worker:
        ...
        if self._pod_db:
            ...
            if isinstance(results, list):
                ...
                _save_results_to_db(
                    ...
                    table=self._get_pod_db_table_name(table),
                    datasource=self.datasource,
    ...
    def _load_data_for_worker(
        ...
        if self._pod_db and self.run_on_new_data_only:
            ...
            target_table = self._get_pod_db_table_name(table)
    ...
    def _get_pod_db_table_name(self, base_table_name: str) -> str:
