...
class Pod:
    ...
    async def _create_and_run_worker(self, message: _BitfountMessage) -> None:
        ...
        # Establish worker datasource
        worker_datasource = self._get_target_datasource(message)
    ...
    def _get_target_datasource(self, message: _BitfountMessage) -> BaseSource:
        ...
        if isinstance(target_datasource_container.datasource, _ViewDatasourceConfig):
            ...
            try:
                ...
                return target_datasource_container.datasource.build(base_datasource)
        else:
            # Otherwise, if not a view, must be a datasource itself
            return target_datasource_container.datasource
