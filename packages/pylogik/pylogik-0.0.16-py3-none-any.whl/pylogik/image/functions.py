...
def find_arc(mask):
    ...
    #print(left_pointy, right_pointy)
    ...
    tip = round(np.argmin(mask[:,round(center[x])]))
    if (tip - center[y]) > 10:
        notch_radius = round(tip - center[y])
    else:
        notch_radius = 0
