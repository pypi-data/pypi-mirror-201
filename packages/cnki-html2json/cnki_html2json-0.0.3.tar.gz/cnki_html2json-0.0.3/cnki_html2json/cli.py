...
def main():
    ...
    parser.add_argument('-log','--log',type=bool,default=True,help='是否记录日志, 默认为True')
    parser.add_argument('-wait','--wait_time',type=int,default=120,help='为检索预留的等待时间, 默认为120秒')
    parser.add_argument('-b','--browser_type',type=str,default='Chrome',help='浏览器类型: Chrome(default)|Firefox|Edge|Safari')
