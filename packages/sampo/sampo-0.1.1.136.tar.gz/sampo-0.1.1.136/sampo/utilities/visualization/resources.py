...
def resource_employment_fig(schedule: Union[DataFrame, Schedule],
                            ...
                            converter: Callable[[Dict[str, tuple[timedelta, timedelta, str, int]]], list] = None) \
...
def convert_schedule_df(schedule: DataFrame, fig_type: EmploymentFigType,
                        converter: Callable[[Dict[str, tuple[timedelta, timedelta, str, int]]], list] = None) -> DataFrame:
