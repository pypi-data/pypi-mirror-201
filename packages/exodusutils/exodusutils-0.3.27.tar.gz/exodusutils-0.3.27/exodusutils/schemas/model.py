...
class ModelAttributeSummary(BaseModel):
    ...
    variable_importance: Optional[List[Attribute]] = None

    auc: Dict[str, str] = {"_typeHint": "core.bagelml.attribute.EmptyAUCMetric$"}
    """
...
class SingleModel(BaseModel):
    ...
    def get_option(self, key: ArtifactKey) -> Optional[str]:
