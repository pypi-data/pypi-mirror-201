...
from vrt_lss_agro.exceptions import ApiTypeError, ApiValueError, ApiException
from vrt_lss_agro.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.cancel_plan_calculation  # this is an instance of the class Endpoint
        api_instance.cancel_plan_calculation()  # this invokes api_instance.cancel_plan_calculation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_plan_calculation.callable or self.callable in this class
