...
def lazy_import():
    ...
    globals()['ProductivityForecast'] = ProductivityForecast


class Chamber(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, crop_key, capacity_forecast, productivity_forecast, *args, **kwargs):  
        """Chamber - a model defined in OpenAPI

        Args:
            crop_key (str): Target key.
            capacity_forecast (CapacityForecast):
            productivity_forecast (ProductivityForecast):
        ...
        self.productivity_forecast = productivity_forecast
    ...
    @convert_js_args_to_python_args
    def __init__(self, crop_key, capacity_forecast, productivity_forecast, *args, **kwargs):  
        """Chamber - a model defined in OpenAPI
