...
class PriceForecastElement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date_window, price, *args, **kwargs):  
        """PriceForecastElement - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, date_window, price, *args, **kwargs):  
        """PriceForecastElement - a model defined in OpenAPI
