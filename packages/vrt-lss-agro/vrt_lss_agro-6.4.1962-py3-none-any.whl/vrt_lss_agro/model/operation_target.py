...
def lazy_import():
    ...
    globals()['CropType'] = CropType
    globals()['Humidity'] = Humidity
    globals()['ObjectType'] = ObjectType


class OperationTarget(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'humidity': (Humidity,),  
            'mass': (float,),  
            'target_detail_key': (str, none_type,),  
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date, target_key, target_type, crop_type, humidity, mass, *args, **kwargs):  
        """OperationTarget - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            target_detail_key (str, none_type): Target storage key.. [optional] if omitted the server will use the default value of "null"  
    ...
    @convert_js_args_to_python_args
    def __init__(self, date, target_key, target_type, crop_type, humidity, mass, *args, **kwargs):  
        """OperationTarget - a model defined in OpenAPI
