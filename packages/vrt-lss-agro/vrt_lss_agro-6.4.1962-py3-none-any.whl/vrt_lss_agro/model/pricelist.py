...
def lazy_import():
    ...
    globals()['PriceForecast'] = PriceForecast


class Pricelist(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, crop_key, price_forecast, *args, **kwargs):  
    ...
    @convert_js_args_to_python_args
    def __init__(self, crop_key, price_forecast, *args, **kwargs):  
        """Pricelist - a model defined in OpenAPI
