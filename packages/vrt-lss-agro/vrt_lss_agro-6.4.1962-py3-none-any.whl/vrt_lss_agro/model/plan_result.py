...
class PlanResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tracedata, project, statistics, progress, info, *args, **kwargs):  
    ...
    @convert_js_args_to_python_args
    def __init__(self, tracedata, project, statistics, progress, info, *args, **kwargs):  
        """PlanResult - a model defined in OpenAPI
