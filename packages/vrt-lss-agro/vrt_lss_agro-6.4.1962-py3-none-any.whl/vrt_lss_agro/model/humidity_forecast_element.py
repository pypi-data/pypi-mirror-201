...
class HumidityForecastElement(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, date_window, humidity, *args, **kwargs):  
        """HumidityForecastElement - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, date_window, humidity, *args, **kwargs):  
        """HumidityForecastElement - a model defined in OpenAPI
