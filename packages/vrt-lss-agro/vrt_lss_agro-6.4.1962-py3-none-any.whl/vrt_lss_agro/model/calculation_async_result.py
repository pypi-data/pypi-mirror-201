...
class CalculationAsyncResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tracedata, id, *args, **kwargs):  
        """CalculationAsyncResult - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, tracedata, id, *args, **kwargs):  
        """CalculationAsyncResult - a model defined in OpenAPI
