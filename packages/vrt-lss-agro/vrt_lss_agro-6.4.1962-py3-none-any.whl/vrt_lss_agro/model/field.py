...
def lazy_import():
    ...
    globals()['HumidityForecast'] = HumidityForecast
...
class Field(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, crop_key, amount, *args, **kwargs):  
        ...
        Keyword Args:
            ...
            capacity_forecast (CapacityForecast): [optional]  
            humidity_forecast (HumidityForecast): [optional]  
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, crop_key, amount, *args, **kwargs):  
        """Field - a model defined in OpenAPI
