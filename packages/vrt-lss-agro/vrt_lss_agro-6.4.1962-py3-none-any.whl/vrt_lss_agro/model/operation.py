...
def lazy_import():
    ...
    globals()['OperationMeasurements'] = OperationMeasurements
    globals()['OperationTarget'] = OperationTarget
...
class Operation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, type, crop_key, source, destination, measurements, *args, **kwargs):  
    ...
    @convert_js_args_to_python_args
    def __init__(self, type, crop_key, source, destination, measurements, *args, **kwargs):  
        """Operation - a model defined in OpenAPI
