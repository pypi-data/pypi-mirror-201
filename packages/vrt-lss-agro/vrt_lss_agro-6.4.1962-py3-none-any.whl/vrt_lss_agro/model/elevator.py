...
class Elevator(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, gate, *args, **kwargs):  
        """Elevator - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            storages ([Storage]): List of storages.. [optional]  
            silos ([Silo]): List of storages.. [optional]  
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, gate, *args, **kwargs):  
        """Elevator - a model defined in OpenAPI
