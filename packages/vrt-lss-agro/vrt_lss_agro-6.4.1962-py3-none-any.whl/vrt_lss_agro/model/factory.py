...
def lazy_import():
    ...
    globals()['Bunker'] = Bunker
    globals()['Consumer'] = Consumer
    globals()['Dryer'] = Dryer
    globals()['Gate'] = Gate


class Factory(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, gate, bunkers, consumers, *args, **kwargs):  
        """Factory - a model defined in OpenAPI

        Args:
            key (str): Key, unique identifier.
            gate (Gate):
            bunkers ([Bunker]): List of bunkers.
            consumers ([Consumer]): List of consumption.
        ...
        Keyword Args:
            ...
            dryers ([Dryer]): List of dryers.. [optional]  
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, gate, bunkers, consumers, *args, **kwargs):  
        """Factory - a model defined in OpenAPI
