...
class Bunker(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, capacity_forecast, *args, **kwargs):  
        """Bunker - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, capacity_forecast, *args, **kwargs):  
        """Bunker - a model defined in OpenAPI
