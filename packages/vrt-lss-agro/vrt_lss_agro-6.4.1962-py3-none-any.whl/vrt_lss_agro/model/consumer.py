...
def lazy_import():
    ...
    globals()['StockForecast'] = StockForecast
...
class Consumer(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, crop_key, consumption_forecast, stock_forecast, *args, **kwargs):  
        ...
        self.consumption_forecast = consumption_forecast
        self.stock_forecast = stock_forecast
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, crop_key, consumption_forecast, stock_forecast, *args, **kwargs):  
        """Consumer - a model defined in OpenAPI
