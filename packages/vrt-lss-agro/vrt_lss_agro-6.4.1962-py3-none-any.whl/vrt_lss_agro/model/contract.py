...
def lazy_import():
    ...
    globals()['ContractTargetKeys'] = ContractTargetKeys
    globals()['ContractType'] = ContractType
    globals()['Pricelist'] = Pricelist
...
class Contract(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, type, target_keys, pricelist, *args, **kwargs):  
        ...
        Args:
            ...
            type (ContractType):
            target_keys (ContractTargetKeys):
            pricelist ([Pricelist]): List of prices for the purchase and sale of agricultural crops. 
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, type, target_keys, pricelist, *args, **kwargs):  
        """Contract - a model defined in OpenAPI
