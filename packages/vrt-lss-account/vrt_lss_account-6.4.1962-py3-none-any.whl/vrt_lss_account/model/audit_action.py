...
def lazy_import():
    ...
    globals()['AuditActionStatistics'] = AuditActionStatistics
...
class AuditAction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, username, company_key, tracedata, method_group, statistics, *args, **kwargs):  
        """AuditAction - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, username, company_key, tracedata, method_group, statistics, *args, **kwargs):  
        """AuditAction - a model defined in OpenAPI
