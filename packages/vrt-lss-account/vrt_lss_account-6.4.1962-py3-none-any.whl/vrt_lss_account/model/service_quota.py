...
class ServiceQuota(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, service, methods, *args, **kwargs):  
        """ServiceQuota - a model defined in OpenAPI

        Args:
            service (ServiceName):
            methods ([MethodQuota]): List of quotas for a group of methods.
    ...
    @convert_js_args_to_python_args
    def __init__(self, service, methods, *args, **kwargs):  
        """ServiceQuota - a model defined in OpenAPI
