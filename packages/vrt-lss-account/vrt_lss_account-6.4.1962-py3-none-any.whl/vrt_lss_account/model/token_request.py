...
class TokenRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, username, password, *args, **kwargs):  
        ...
        Keyword Args:
            ...
            ttl_seconds (int): Token validity time, in seconds.. [optional] if omitted the server will use the default value of 86400  
        """
