...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = AuditApi()
        api_instance.read_audit  # this is an instance of the class Endpoint
        api_instance.read_audit()  # this invokes api_instance.read_audit.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.read_audit.callable or self.callable in this class
