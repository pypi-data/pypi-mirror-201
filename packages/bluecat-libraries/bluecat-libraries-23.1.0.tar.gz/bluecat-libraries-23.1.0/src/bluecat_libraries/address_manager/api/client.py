...
from bluecat_libraries.address_manager.api.models import (
    APIEntity,
    APIUserDefinedField,
    UDLDefinition,
    UDLRelationship,
...
from bluecat_libraries.address_manager.api.rest.auto.client import Client as RawClient
from bluecat_libraries.address_manager.api.rest.auto import _wadl_parser
...
from bluecat_libraries.address_manager.api._version import Version as _Version
from bluecat_libraries.address_manager.constants import _version
from bluecat_libraries.address_manager.constants.numeric import DEFAULT_COUNT
from bluecat_libraries.http_client import ClientError, ErrorResponse
...
class Client:
    ...
    does not automatically call the ``logout`` method. If not used as a context manager, we
    recommend you call the ``close`` method a single time.

    :param url: URL with a scheme that indicates how to connect to the BlueCat Address Manager.
    :param verify: If true (the default), BAM's TLS certificate is verified when using HTTPS
    ...
    .. versionchanged:: 22.4.1
        Use ``https`` as fallback if the passed BAM URL does not have a scheme. Previously,
        ``http`` was used.
    """
    ...
    def __init__(self, url: str, *, verify: Union[bool, str] = True) -> None:
        self._raw_api = RawClient(url, verify=verify)
        self.__bam_url = str(
            parse_url(self._raw_api._service.url)._replace(
                auth=None, path=None, query=None, fragment=None
            )
        )
    ...
    def raw_api(self) -> RawClient:
        """
        The underlying automatically generated client for the endpoints specified by the BAM REST
        API v1 service.
        """
    ...
    def login(self, username: str, password: str) -> str:
        ...
        :param username: The username of a BAM user. They must be configured as an API user in BAM.
        :param password: The password of the BAM user.
        :return: The authentication token returned by BAM, including the authentication scheme.
        :rtype: str
        """
    ...
    def logout(self) -> str:
        ...
        :return: The message from BAM for the logout request.
        """
        self._require_auth()
    ...
    def set_token(self, token: str) -> None:
        ...
        :param token: Value of the token, including the scheme, e.g. ``BAMAuthToken``. The value
            is used verbatim for header ``Authorization``.
    ...
    def get_token(self) -> Optional[str]:
        ...
        .. versionadded:: 23.1.0
        """
        return self._raw_api.session.headers.get("Authorization")
    ...
    def update_entity(self, entity: APIEntity) -> None:
        """
    ...
    def update_entity_with_options(self, entity: APIEntity, options: dict) -> None:
        """
    ...
    def delete_entity_with_options(self, id: int, options: dict = None) -> None:
        """
    ...
    def get_parent(self, entity_id: int, include_ha: Optional[bool] = None) -> APIEntity:
        """
        ...
        :type entity_id: int
        :param include_ha: A boolean value. This parameter is supported Address Manager from v9.4.0.
            Allows to include or exclude HA information when getting properties from a server.
            If set to ``False``, the query for HA status will be skipped.
            The default value is ``True``.
        :type include_ha: bool, optional
        ...
        """
        self._require_auth()
        entity = self.raw_api.getParent(entity_id, include_ha)
        return APIEntity.from_raw_model(entity)

    def get_entity_by_id(self, id: int, include_ha: Optional[bool] = None) -> APIEntity:
        """
        ...
        """
        self._require_auth()
        entity = self._raw_api.getEntityById(id, include_ha)
        return APIEntity.from_raw_model(entity)

    def get_entity_by_name(
        self, parent_id: int, name: str, type: str, include_ha: Optional[bool] = None
    ) -> APIEntity:
        """
        ...
        """
        self._require_auth()
        entity = self.raw_api.getEntityByName(parent_id, name, type, include_ha)
        return APIEntity.from_raw_model(entity)
    ...
    def get_entities(
        ...
        """
        self._require_auth()
        entities = self.raw_api.getEntities(parent_id, type, start, count, include_ha)
    ...
    def get_entities_by_name(
        ...
        :param include_ha: A boolean value. This parameter is supported Address Manager from v9.4.0.
            ...
            set to ``False``, the query for HA status will be skipped. The default value is ``True``.
        :type include_ha: bool, optional
        :return: A list of entities. The list is empty if there are no matching entities.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        entities = self.raw_api.getEntitiesByName(parent_id, name, type, start, count, include_ha)
        return list(map(APIEntity.from_raw_model, entities))

    def export_entities(self, select_criteria: dict, start: int = 0, count: int = 1000) -> iter:
        """
        Export an octet stream of entities.

        :param select_criteria: A dictionary specifying how you want to choose the entities to export.
            Possible keys: `selector`, `keyword`, `startEntityId`, `children_only`, or `types`.
            For more details, see **Export entities** in the **Address Manager Administration Guide**.
        :type select_criteria: dict
        :param start: Indicates where in the list of returned objects to start returning objects.
            The list begins at an index of 0. The default value is **0**.
        :type start: int, optional
        :param count: Indicate the maximum number of entities to return.
            The default value is **1000**.
        :type count: int, optional
        :return: An iterator object that uses a generator to return a dictionary of an entity for every
            loop.
        :rtype: iterator
        ...
        """
        self._require_auth()
        self._require_minimal_version(_version.V9_4_0)
        select_criteria = json.dumps(select_criteria)
        parameters = {"selectCriteria": select_criteria, "start": start, "count": count}
        response = self._raw_api.session.get(
            self._raw_api._service.url + "/exportEntities",
            params=parameters,
    ...
    def import_entities(
        ...
        *,
        ...
        :param configuration_name: The name of the configuration that the entities will be
            imported into.
        :param data: A string, two-dimensional list, list of dictionaries or file in CSV or NDJSON
            format containing entities to be imported.
        :param data_type: The type of data that is being imported. Supported data types are
            *IP4Address*, *IP4Block*, *IP4DHCPRange*, *IP4Network*, and *MACAddress*.
        :param commit: Indicates if the Address Manager database will be updated after processing
            the input file. Set to **False** for validation purposes to view results without
            updating the database. The default value is **True**.
        :param max_size: The maximum number of entities allowed in a single *Import Entities* call.
            The default value is **1000**.
        :param max_failures: The number of failures allowed before *Import entities* stops processing.
            When the value is **0**, all entities will be processed in one transaction and any
            failure will stop the process and rollback any updates made to the database. When the
            value is greater than **0**, each entity will be processed individually in a separate
            transaction until the maximum number of failures is reached (therefore entities
            processed before reaching the max failure limit will remain in database). The default
            value is **0**.
        :param user_comment: The user comment that will be added to the transaction history.
        :param ignore_fields: The fields that will be skipped during validation of entities. The
            parameter is useful when an input entity contains fields that are not supported for
            processing. When importing content that was exported using Export entities, ensure
            that extra fields such as *id*, *parentid*, *type*, and *state* are ignored.
        :return: An iterator object that uses a generator to return a dictionary of the raw entity
            input for each loop. Each dictionary detail whether the entities were processed
            successfully, object IDs if processed successfully, the transaction history ID if
            processed in one transaction (``max_failures = 0``), and the total number of entities
        ...
        """
        self._require_auth()
        self._require_minimal_version(_version.V9_5_0)
        raw_data = data
        if isinstance(data, list):
            tmp_list = []
            for inner in data:
                if isinstance(inner, list):
                    converted_string = ",".join(str(x) if x else "" for x in inner)
                    tmp_list.append(converted_string)
                elif isinstance(inner, dict):
                    converted_string = json.dumps(inner)
                    tmp_list.append(converted_string)
            raw_data = "\n".join(tmp_list)
        parameters = {
            ...
            "ignoreFields": ",".join(ignore_fields) if ignore_fields else ignore_fields,
        }
        with self._raw_api.session.post(
            self._raw_api._service.url + "/importEntities",
            params=parameters,
            verify=self._raw_api.session.verify,
            stream=True,
            files={"data": raw_data},
    ...
    def get_entities_by_name_using_options(
        ...
        entities = self.raw_api.getEntitiesByNameUsingOptions(
            parent_id, name, type, start, count, options, include_ha
        )
        return list(map(APIEntity.from_raw_model, entities))
    ...
    def link_entities(self, entity1_id: int, entity2_id: int, properties: dict = None) -> None:
        """
    ...
    def get_linked_entities(
        ...
        """
        self._require_auth()
        raw_data = self.raw_api.getLinkedEntities(entity_id, linked_type, start, count, include_ha)
        entities = list(map(APIEntity.from_raw_model, raw_data))
        return entities

    def get_linked_entities_by_udl(self, link_type: str, entity_id: Optional[int] = None) -> list:
        """
        Return a list of objects detailing entities currently linked by a given UDL type,
        with an optional parameter to qualify results by source or destination entity ID.

        :param link_type: The unique name for the user-defined link.
        :type link_type: str
        :param entity_id: The source or destination entity ID. If an ID is not provided or is **0**,
            all linked entities matching the specified link type will be returned.
        :type entity_id: int, optional
        :return: By giving an existing UDL type:

            * A list of objects detailing entities currently linked if it was found. For example:
            ...
            * An empty list if it was not found.
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_4_0)
        return self.raw_api.getLinkedEntitiesByUDL(
            json.dumps({"linkType": link_type, "entityId": entity_id})
        )

    def unlink_entities(self, entity1_id: int, entity2_id: int, properties: dict = None) -> None:
        """
    ...
    def update_configuration_setting(self, entity_id, setting, properties) -> None:
        """
    ...
    def search_by_object_types(
        ...
        self._require_auth()
        types = ",".join(types)
        entities = self.raw_api.searchByObjectTypes(keyword, types, start, count, include_ha)
        return list(map(APIEntity.from_raw_model, entities))
    ...
    def search_by_category(
        ...
        """
        self._require_auth()
        entities = self.raw_api.searchByCategory(keyword, category, start, count, include_ha)
        return list(map(APIEntity.from_raw_model, entities))
    ...
    def custom_search(
        ...
        entities = self.raw_api.customSearch(filters, type, options, start, count, include_ha)
        return list(map(APIEntity.from_raw_model, entities))
    ...
    def add_zone(
        ...
        :type absolute_name: str
        :param properties: Object properties, including user-defined fields, and the following flags:

            * **template** - An optional network template association.
            * **deployable** - A boolean value. Set to ``true`` to make the zone deployable.
              The default value is ``false``.
            * These properties are supported by Address Manager v9.4.0:

                * **dynamicUpdate** - A boolean value. If set to ``true``, any resource records that
                  are added, updated, or deleted within the zone will be selectively deployed to the
                  associated primary DNS/DHCP Server of that zone. The default value is ``false``.
                * **moveDottedResourceRecords** - A boolean value. If set to ``false``, existing
                  dotted-name resource records matching the new subdomain will not be moved into the
                  new subdomain. The default value is ``true``.

            .. note::

                * If the **deployable** flag is set to ``true``, the **dynamicUpdate** flag can
                  only be set to ``true``.
                * Once the **dynamicUpdate** feature is enabled, a full DNS deployment must perform
                  before resource record changes are automatically deployed.
                * If a deployment option within the zone is updated, deployment is not performed
                  automatically.
                * If a deployment option followed by a resource record change is updated, only the
                  resource record change is deployed. The deployment option change must be
                  performed by a manual deployment.
    ...
    def assign_or_update_template(self, zone_id: int, template_id: int, properties: dict) -> None:
        """
    ...
    def reapply_template(self, id: int, properties: dict) -> None:
        """
    ...
    def add_access_right(
        ...
        :param properties: A dictionary including the following options:
            ...
            * **deploymentAllowed** - A boolean value indicating whether or not the user
              or group can perform a full deployment of data from the configuration to a managed
              server.
            * **quickDeploymentAllowed** - A boolean value indicating whether or not the user
              or group can instantly deploy changed DNS resource records.
            * **selectiveDeploymentAllowed** -  A boolean value indicating whether a user or group
              can perform a selective deployment of data to a managed server, and dynamically
              deploy resource records that are added, updated, and deleted within a DNS zone that
              has the **dynamicUpdate** parameter enabled. This property is supported from Address
              Manager v9.4.0

            .. note::

                * All of these properties are optional.
                * The **deploymentAllowed** property applies only to configuration, server,
                  or root entities with Full access rights.
                * The **selectiveDeploymentAllowed** property can only be configured at the root
                  level.
                * The **workflowLevel** property applies only to Change, Add, or Full access
                  rights.
    ...
    def get_access_right(self, entity_id: int, user_id: int) -> APIAccessRight:
        ...
        :param entity_id: The object ID of the entity to which the access rights is assigned.
        :type entity_id: int
        :param user_id: The object ID of the user to whom the access right applies.
        :type user_id: int
    ...
    def update_access_right(
        ...
        :param entity_id: The object ID of the entity to which the access right is assigned.
            Set to zero (0) to add the access right to the default root level.
        :type entity_id: int
        ...
        :param properties: A dictionary including the following options:
            ...
            * **selectiveDeploymentAllowed** - A boolean value indicating whether a user or group
              can perform a selective deployment of data to a managed server, and dynamically
              deploy resource records that are added, updated, and deleted within a DNS zone that
              has the **dynamicUpdate** parameter enabled. This option supports from Address
              Manager v9.4.0.
    ...
    def delete_access_right(self, entity_id: int, user_id: int) -> None:
        """
    ...
    def update_dns_deployment_role(self, role: APIDeploymentRole) -> None:
        """
    ...
    def delete_dns_deployment_role(self, entity_id: int, server_interface_id: int) -> None:
        """
    ...
    def update_dhcp_deployment_role(self, role: APIDeploymentRole) -> None:
        """
    ...
    def delete_dhcp_deployment_role(self, entity_id: int, server_interface_id: int) -> None:
        """
    ...
    def update_dns_deployment_option(self, option: APIDeploymentOption) -> None:
        """
        Update a DNS option.
    ...
    def delete_dns_deployment_option(
        self, entity_id: int, server_id: int, option_name: str
    ) -> None:
        """
        Delete a DNS option.
    ...
    def update_raw_deployment_option(self, option: APIDeploymentOption) -> None:
        """
    ...
    def update_dhcp6_service_deployment_option(self, option: APIDeploymentOption) -> None:
        """
    ...
    def update_dhcp6_client_deployment_option(self, option: APIDeploymentOption) -> None:
        """
    ...
    def update_dhcp_client_deployment_option(self, option: APIDeploymentOption) -> None:
        """
    ...
    def update_dhcp_service_deployment_option(self, option: APIDeploymentOption) -> None:
        """
    ...
    def update_dhcp_vendor_deployment_option(self, option: APIDeploymentOption) -> None:
        """
    ...
    def delete_dhcp_vendor_deployment_option(
        self, entity_id: int, server_id: int, option_id: int
    ) -> None:
        """
    ...
    def add_user_defined_field(self, object_type: str, udf: APIUserDefinedField) -> None:
        """
    ...
    def update_user_defined_field(self, object_type: str, udf: APIUserDefinedField) -> None:
        """
    ...
    def delete_user_defined_field(self, object_type: str, udf_name: str) -> None:
        """
    ...
    def add_user_defined_link(self, definition: UDLDefinition) -> None:
        """
    ...
    def update_user_defined_link(self, definition: UDLDefinition) -> None:
        """
    ...
    def delete_user_defined_link(self, link_type: str) -> None:
        """
    ...
    def link_entities_ex(self, relationship: UDLRelationship) -> None:
        """
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_3_0)
        self.raw_api.linkEntitiesEx(UDLRelationship.to_raw_model(relationship))

    def unlink_entities_ex(self, relationship: UDLRelationship) -> None:
        """
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_3_0)
        self.raw_api.unlinkEntitiesEx(UDLRelationship.to_raw_model(relationship))
    ...
    def upload_docker_image(self, server_id: int, file_name: str, data: IO) -> str:
        """
        Upload a Docker image file to a BlueCat DNS/DHCP Server for configuration of the Gateway
        service via the ``configureServerServices`` method.

        :param server_id: The object ID of the BlueCat DNS/DHCP Server.
        :param file_name: The name of the file to be uploaded.
        :param data: The Docker image file to be uploaded. The file is passed to Address Manager
            as an octet-stream.

            .. note:: The Docker image file must be packaged in tar or tar.gz format.

        :return: The image name of the Docker image file.
        ...
        self._require_auth()
        self._require_minimal_version(_version.V9_5_0)
        return self.raw_api.uploadDockerImage(file_name, server_id, data)
    ...
    def assign_ip4_template(
        self, object_id: int, template_id: int, properties: dict = None
    ) -> None:
        """
    ...
    def configure_audit_log_export(self, audit_log_settings: dict) -> None:
        """
    ...
    def update_retention_settings(
        ...
        settings = (
            ...
            if settings
            else RetentionSettings.to_raw_model({})
        )
    ...
    def delete_response_policy_item(
        ...
        response = self._raw_api.session.delete(
            self._raw_api._service.url + "/deleteResponsePolicyItem",
            params=parameters,
            verify=self._raw_api.session.verify,
        )
    ...
    def update_user_password(
        self, user_id: int, password: str, options: Optional[list] = None
    ) -> None:
        """
    ...
    def terminate_user_sessions(self, username: str, properties: Optional[dict] = None) -> None:
        """
    ...
    def deny_mac_address(self, configuration_id: int, mac_address: str) -> None:
        """
    ...
    def clear_ip6_address(self, id: int) -> None:
        """
        ...
        self._require_auth()
        response = self._raw_api.session.delete(
            self._raw_api._service.url + "/clearIP6Address",
            params={"addressId": id},
            verify=self._raw_api.session.verify,
        )
        status = _wadl_parser.process_rest_response(response)
    ...
    def add_server(
        ...
        :param configuration_id: The object ID of the configuration to which the server is being
            added.
        :type configuration_id: int
        :param name: The name of the server to add.
        :type name: str
        :param default_interface_address: The physical IP address for the server within Address
            Manager.
        ...
        :param properties: Object properties, a dictionary including the following options:
            ...
            * **connected** - either true or false; indicates whether or not to connect to a server.
              In order to add and configure multi-port DNS/DHCP Servers, this option must be set to
              true. If false, other interface property options will be ignored.
            * **upgrade** - indicates whether or not to apply the latest version of DNS/DHCP Server
              software once the appliance is under Address Manager control. The value is either
              true or false, by default, false.
            * **password** - the server password. For more information on the default server
              password, refer to BlueCat default login credentials (This must be authenticated to
              view this topic).
            * **servicesIPv4Address** - IPv4 address used only for services traffic such as DNS,
              DHCP, DHCPv6, and TFTP. If dedicated management is enabled, this option must be
              specified.
            * **servicesIPv4Netmask** - IPv4 netmask used only for services traffic such as DNS,
              DHCP, DHCPv6, and TFTP.
              If dedicated management is enabled, this option must be specified.
            * **servicesIPv6Address** - IPv6 address used only for services traffic such as DNS,
              DHCP, DHCPv6, and TFTP. This is optional.
            * **servicesIPv6Subnet** - IPv6 subnet used only for services traffic such as DNS, DHCP,
              DHCPv6, and TFTP. This is optional.
            * **xhaIPv4Address** - IPv4 address used for XHA. This is optional.
            * **xhaIPv4Netmask** - IPv4 netmask used for XHA. This is optional.
            * **redundancyScenario** - networking redundancy scenarios. The possible values are
              ACTIVE_BACKUP Failover and IEEE_802_3AD Load Balancing.
            * **encryptedNotification** - A boolean value. If true, encrypted notfications between
              Address Manager and BlueCat DNS/DHCP Servers are enabled. If false (the default), those encrypted
              communications are disabled. This property is optional and supported only by
              Address Manager v9.4.0 or greater.

            .. note:: For DNS/DHCP Servers without multi-port support, the interface-related
                property options will be ignored.
    ...
    def deploy_server_config(self, server_id: int, properties: dict) -> None:
        """
    ...
    def deploy_server_services(self, server_id: int, services: list) -> None:
        """
    ...
    def deploy_server(self, id: int) -> None:
        """
    ...
    def quick_deploy(self, entity_id: int, properties: Optional[dict] = None) -> None:
        """
    ...
    def replace_server(
        ...
        :type password: str
        :param upgrade: Flag indicating that server needs to be upgraded or not. True means server
        ...
        :param properties: A dictionary containing the following options:
            ...
            * **servicesIPv4Address** - IPv4 address used only for services traffic such as DNS,
              DHCP, DHCPv6 and TFTP. If dedicated management is enabled, this option must be
              specified. If dedicated management is disabled, this address must be the same as
              defaultInterfaceAddress which is management interface address.
            * **servicesIPv4Netmask** - IPv4 netmask used only for services traffic such as DNS,
              DHCP, DHCPv6 and TFTP. If dedicated management is enabled, this option must be
              specified. If dedicated management is disabled, this netmask address must be the same
              as the management interface netmask address.
            * **servicesIPv6Address** - IPv6 address used only for services traffic such as DNS,
              DHCP, DHCPv6 and TFTP. This is optional.
            * **servicesIPv6Subnet** - IPv6 subnet used only for services traffic such as DNS, DHCP,
              DHCPv6 and TFTP. This is optional.
            ...
            * **redundancyScenario** - networking redundancy scenarios. The possible values are
              ACTIVE_BACKUP Failover and IEEE_802_3AD Load Balancing.
            * **resetServices** - allow for replacing the DNS/DHCP Server while maintaining existing
              configurations for DNS, DHCP, and TFTP services. Define this option only if the IPv4
              or IPv6 addresses of the Services interface have been modified or the configurations
              needs to be reset for DNS, DHCP, and TFTP services on the DNS/DHCP Server. The value
              is either true or false by default, false.
            * **encryptedNotification** - A boolean value. It enables or disables encrypted
              notifications between Address Manager and BlueCat DNS/DHCP Servers. This property is
              optional and supported from Address Manager v9.4.0. The default value is false.

              .. note:: For DNS/DHCP Servers without multi-port support, the interface-related
                property options will be ignored.

              .. note:: Resetting DNS/DHCP Servers will result in a service outage. This service
                outage will last until services have been deployed to the replacement system. Only
                reset DNS/DHCP Server services if the DNS/DHCP Server are being replaced with a new
                appliance of a different type or reconfiguring the IPv4 or IPv6 addresses of the
                Services interface on the appliance. BlueCat recommends that a maintenance window is
                scheduled before performing a reset of DNS/DHCP Server services.
    ...
    def add_additional_ip_addresses(
        self, server_id: int, ips: list[str], properties: Optional[dict] = None
    ) -> None:
        """
        Add additional IPv4 addresses and loopback addresses to the Service interface
        for DNS service.

        :param server_id: The object ID of the server to which the additional IP addresses is
            being added.
        :type server_id: int
        :param ips: A list of the IPs addresses to add. The supported format is
            ["IP,serviceType", "IP,serviceType"].
        :type ips: list[str]
        :param properties: Object properties. This is reserved for future use.
        :type properties: dict, optional
        ...
        properties = serialize_joined_key_value_pairs(properties)
        self.raw_api.addAdditionalIPAddresses(server_id, ips, properties)
    ...
    def get_discovered_device_vlans(self, policy_id: int, device_id: int) -> list[APIEntity]:
        """
        Return all VLANs of a specific device, discovered by running an IPv4 reconciliation policy.

        :param policy_id: The object ID of the IPv4 reconciliation policy.
        :type policy_id: int
        :param device_id: The object ID of the device.
        :type device_id: int
        :return: All VLANs of the specified device.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        devices = self.raw_api.getDiscoveredDeviceVlans(policy_id, device_id)
        return [APIEntity.from_raw_model(device) for device in devices]

    def get_discovered_device_mac_address_entries(
        self, policy_id: int, device_id: int
    ) -> list[APIEntity]:
        """
        Return all MAC address entries of a specific device, discovered by running an IPv4
        ...
        :param device_id: The object ID of the device.
        :type device_id: int
        :return: All MAC address entries of the specified device.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        entries = self.raw_api.getDiscoveredDeviceMacAddressEntries(policy_id, device_id)
        return [APIEntity.from_raw_model(entry) for entry in entries]

    def get_discovered_device_interfaces(self, policy_id: int, device_id: int) -> List[APIEntity]:
        """
        Return all interfaces of a specific device, by running an IPv4 reconciliation
        policy.
        ...
        :param device_id: The object ID of the device.
        :type device_id: int
        :return: All interfaces of the specified device.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        interfaces = self.raw_api.getDiscoveredDeviceInterfaces(policy_id, device_id)
        return [APIEntity.from_raw_model(interface) for interface in interfaces]

    def get_discovered_device(self, policy_id: int, device_id: int) -> APIEntity:
        """
        ...
        :param device_id: The object ID of the device.
        :type device_id: int
        :return: The discovered device object.
        :rtype: APIEntity
        ...
        """
        self._require_auth()
        return APIEntity.from_raw_model(self.raw_api.getDiscoveredDevice(policy_id, device_id))

    def get_discovered_device_hosts(self, policy_id: int, device_id: int) -> List[APIEntity]:
        """
        ...
        :param device_id: The object ID of the device.
        :type device_id: int
        :return: All hosts of the specified device.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        hosts = self.raw_api.getDiscoveredDeviceHosts(policy_id, device_id)
        return [APIEntity.from_raw_model(host) for host in hosts]

    def get_discovered_device_arp_entries(self, policy_id: int, device_id: int) -> List[APIEntity]:
        """
        Return all ARP entries of a specific device by running an IPv4 reconciliation
        policy.
        ...
        :param device_id: The object ID of the device.
        :type device_id: int
        :return: All ARP entries of a specific device.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        arp_entries = self.raw_api.getDiscoveredDeviceArpEntries(policy_id, device_id)
        return [APIEntity.from_raw_model(arp_entry) for arp_entry in arp_entries]

    def get_discovered_devices(self, policy_id: int) -> list[APIEntity]:
        """
        Return a list of discovered Layer 2 or Layer 3 devices, discovered by running an IPv4 reconciliation
        policy.

        :param policy_id: The object ID of the IPv4 reconciliation policy.
        :type policy_id: int
        :return: A list of discovered Layer 2 or Layer 3 devices.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        devices = self.raw_api.getDiscoveredDevices(policy_id)
        return [APIEntity.from_raw_model(device) for device in devices]

    def get_discovered_device_networks(self, policy_id: int, device_id: int) -> list[APIEntity]:
        """
        Return a list of all networks of a specific device, discovered by running an IPv4 reconciliation
        policy.
        ...
        :param device_id: The object ID of the device.
        :type device_id: int
        :return: All networks of the specified device.
        :rtype: list[APIEntity]
        ...
        """
        self._require_auth()
        networks = self.raw_api.getDiscoveredDeviceNetworks(policy_id, device_id)
        return [APIEntity.from_raw_model(network) for network in networks]
    ...
    def purge_history_now(
        self,
        number_of_days_to_keep: int = -1,
        number_of_months_to_keep: int = -1,
        until_when_timestamp: str = None,
        wait_option: bool = False,
    ) -> int:
        """
        Run the history purge function.

        :param number_of_days_to_keep: The number of days to preserve the data in
            the database. Valid values for this parameter are between 1 and 3650. Set to -1
            if using either **until_when_timestamp** or **number_of_months_to_keep**.
            Using this parameter will archive all history that will be purged and overwrite existing
            archive files in the **/data/archive** directory.
        :type number_of_days_to_keep: int
        :param number_of_months_to_keep: The number of months to preserve data
            in the database. Valid values are integers of 0 or greater.
            Set to -1 if using either **until_when_timestamp** or
            **number_of_days_to_keep**. Using this parameter will not archive any data.
        :type number_of_months_to_keep: int
        :param until_when_timestamp: A string specifying a point in time after which history is
            will be preserved. The valid timestamp pattern is YYYY-MM[-DD[ HH:MM:SS[.mmm]]]. Set this
            parameter is **None** if using either **number_of_days_to_keep** or
            **number_of_months_to_keep**. Using this parameter will not archive any data.
        :type until_when_timestamp: str
        :param wait_option: If set to **True**, the purge will be performed and
            the result will be returned when completed. The default value is **False**.
        :type wait_option: bool
        :return: Returns 0 (zero) when the purge service has successfully completed, otherwise -1.
        :rtype: int
        ...
        """
        self._require_auth()
        return self.raw_api.purgeHistoryNow(
            until_when_timestamp, number_of_days_to_keep, number_of_months_to_keep, wait_option
        )
