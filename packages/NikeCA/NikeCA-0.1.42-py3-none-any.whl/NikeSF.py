...
class Snowflake(_SnowflakeDependencies.SnowflakeDependencies
                , _SnowflakeData.SnowflakeData
                , _IMPSummaryDashboard.IMPSummaryDashboard
    ...
    def __init__(self, username: str, warehouse: str, role: str, database: str = None, schema: str = None,
                 ...
                 date_max: str | None = None, column_filters: list | None = None):
        """
        Parameters:
    ...
    def snowflake_pull(self,
        ...
        return _SnowflakeData.SnowflakeData.snowflake_pull(self, query, un=username, wh=warehouse, db=database,
                                                           ...
                                                           separate_dataframes=separate_dataframes)
    ...
    def imp_summary_dashboard(self
        ...
        return _IMPSummaryDashboard.IMPSummaryDashboard.imp_summary_dashboard(self
                                                                              , username=username
                                                                              , warehouse=warehouse
                                                                              , database=database
                                                                              , role=role
