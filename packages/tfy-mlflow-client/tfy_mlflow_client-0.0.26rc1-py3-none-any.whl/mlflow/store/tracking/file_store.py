...
class FileStore(AbstractStore):
    ...
    def create_experiment(self, name, storage_root=None, tags=None, description=None):
        self._check_root_dir()
        ...
        return self._create_experiment_with_id(name, str(experiment_id), storage_root, tags)
