...
class RsInstrument:
	"""Root class for remote-controlling instrument with SCPI commands."""
	_driver_version_const = '1.53.1.97'
	...
	def __init__(
		...
		Parameter options tokens examples:
			...
			- ``Profile = HM8123``, Setting profile fitting the specific non-standard instruments. Available values: HM8123, CMQ, Minimal. Default: ``none``
