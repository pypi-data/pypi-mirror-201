...
def get_error_from_simul(counts, counts_err, method, n_simul=100, use_poisson=False, background=None,
...
def get_fourier_coeff_error( counts, counts_err, n_simul=1000, use_poisson=False, n=2, debug=False):
...
def get_cross_correlation_with_error(pp, dpp, ee_pulsed=[], dee_pulsed=[], n_simul=100, 
    ...
    Args:
        ...
        debug_plot (bool, optional): if making debug plots. Defaults to False.
