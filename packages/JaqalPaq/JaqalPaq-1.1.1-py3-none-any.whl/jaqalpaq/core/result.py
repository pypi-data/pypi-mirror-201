...
class RelativeFrequencySubcircuit(Subcircuit):
    ...
    def relative_frequency_by_str(self):
        ...
        return _format_probabilities_by_string(qubits, rf)
...
class ProbabilisticSubcircuit(Subcircuit):
    ...
    def simulated_probability_by_str(self):
        ...
        return _format_probabilities_by_string(qubits, p)
...
def _format_probabilities_by_string(qubits, probabilities):
    return OrderedDict(
        [(f"{n:b}".zfill(qubits)[::-1], v) for n, v in enumerate(probabilities)]
    )
