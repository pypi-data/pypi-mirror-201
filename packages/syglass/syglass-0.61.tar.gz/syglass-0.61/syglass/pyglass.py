...
class IReader(object):
    ...
    def HasWindow(self) -> "bool":
        return _pyglass.IReader_HasWindow(self)
...
class DataProvider(object):
    ...
    def HasWindow(self) -> "bool":
        return _pyglass.DataProvider_HasWindow(self)
...
class DICOMReader(IReader):
    ...
    def HasWindow(self) -> "bool":
        return _pyglass.DICOMReader_HasWindow(self)
...
class HDF5Reader(IReader):
    ...
    def GetUnits(self) -> "std::string":
        return _pyglass.HDF5Reader_GetUnits(self)
...
class NNGDialer(object):
    ...
    def SendMessage(self, *args) -> "int":
        return _pyglass.NNGDialer_SendMessage(self, *args)
...
class Operator(IReader):
    ...
    def HasWindow(self) -> "bool":
        return _pyglass.Operator_HasWindow(self)
...
class Project(object):
    ...
    def GetPathToSygFile(self) -> "fs::path":
    ...
    def GetMaskRaster(self, dir: "std::string const &", roiDims: "ivec3", roiIndex: "int") -> "Raster":
        return _pyglass.Project_GetMaskRaster(self, dir, roiDims, roiIndex)
...
class Service(object):
    ...
    def AddRequest(self, request: "WebUtils::UrlRequest", payload: "WebUtils::Service::CustomPayloadPtr"=0) -> "WebUtils::UrlResponsePtr":
        return _pyglass.Service_AddRequest(self, request, payload)
...
class FileSystem(object):
    ...
    @staticmethod
    def GetInstallationPath() -> "boost::filesystem::path":
        return _pyglass.FileSystem_GetInstallationPath()
...
def FileSystem_GetInstallationPath() -> "boost::filesystem::path":
    return _pyglass.FileSystem_GetInstallationPath()
