...
class ArcherAuth:
  def __init__(self, ins: str,
    ...
    ins -- Name of Archer instance. (e.g.'Prod', 'Test', etc.)
    usr -- Username of account to authenticate and request against.
    pwd -- Password of account to authenticate and request against.
    url -- Base url of Archer instance. (e.g 'https://optstest.uscis.dhs.gov')
    Keyword arguments:
    dom -- Userdomain. Almost always blank.
    """
    self.ins = ins
    self.dom = dom
    self.usr = usr
