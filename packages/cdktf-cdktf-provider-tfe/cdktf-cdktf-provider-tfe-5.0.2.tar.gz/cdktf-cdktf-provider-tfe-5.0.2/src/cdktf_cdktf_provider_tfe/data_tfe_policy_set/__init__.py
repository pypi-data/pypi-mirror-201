...
class DataTfePolicySet(
    ...
    def __init__(
        ...
        *,
        ...
        :param kind: The policy-as-code framework for the policy. Valid values are sentinel and opa. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/d/policy_set#kind DataTfePolicySet#kind}
        ...
        :param overridable: Whether users can override this policy when it fails during a run. Only valid for OPA policies. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/d/policy_set#overridable DataTfePolicySet#overridable}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
