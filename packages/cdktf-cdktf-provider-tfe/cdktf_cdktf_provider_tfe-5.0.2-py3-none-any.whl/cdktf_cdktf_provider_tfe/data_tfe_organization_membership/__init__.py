...
class DataTfeOrganizationMembership(
    ...
    def __init__(
        ...
        *,
        ...
        :param username: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/d/organization_membership#username DataTfeOrganizationMembership#username}.
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
