...
class Policy(
    ...
    def __init__(
        ...
        *,
        ...
        :param name: The name of the policy. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#name Policy#name}
        :param policy: Text of a valid Sentinel or OPA policy. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#policy Policy#policy}
        :param description: Text describing the policy's purpose. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#description Policy#description}
        :param enforce_mode: The enforcement configuration of the policy. For Sentinel, valid values are ``hard-mandatory``, ``soft-mandatory`` and ``advisory``. For OPA, Valid values are ``mandatory` and `advisory`` Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#enforce_mode Policy#enforce_mode}
        :param id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#id Policy#id}. Please be aware that the id field is automatically added to all resources in Terraform providers using a Terraform provider SDK version below 2. If you experience problems setting this value it might not be settable. Please take a look at the provider documentation to ensure it should be settable.
        :param kind: The policy-as-code framework for the policy. Valid values are sentinel and opa. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#kind Policy#kind}
        :param organization: Name of the organization that this policy belongs to. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#organization Policy#organization}
        :param query: The OPA query to run. Required for OPA policies. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe/r/policy#query Policy#query}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
