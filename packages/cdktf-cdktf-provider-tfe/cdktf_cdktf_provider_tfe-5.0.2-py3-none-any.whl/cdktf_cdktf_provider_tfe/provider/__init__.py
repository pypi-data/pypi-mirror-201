...
class TfeProvider(
    ...
    def __init__(
        ...
        *,
        ...
        :param organization: The organization to apply to a resource if one is not defined on the resource itself. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/tfe#organization TfeProvider#organization}
