...
class ServerGroup(
    ...
    def __init__(
        ...
        *,
        ...
        :param labels: Key-value pairs to classify the server group. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/upcloud/r/server_group#labels ServerGroup#labels}
