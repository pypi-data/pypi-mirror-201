...
class Loadbalancer(
    ...
    def __init__(
        ...
        *,
        ...
        :param plan: Plan which the service will have. You can list available loadbalancer plans with ``upctl loadbalancer plans``. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/upcloud/r/loadbalancer#plan Loadbalancer#plan}
        ...
        :param labels: Key-value pairs to classify the load balancer. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/upcloud/r/loadbalancer#labels Loadbalancer#labels}
