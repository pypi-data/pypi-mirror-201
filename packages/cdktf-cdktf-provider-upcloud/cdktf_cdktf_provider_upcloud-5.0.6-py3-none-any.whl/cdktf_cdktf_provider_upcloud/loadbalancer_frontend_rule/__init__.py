...
class LoadbalancerFrontendRuleActionsHttpRedirect:
    def __init__(
        ...
        *,
        ...
        :param scheme: Target scheme. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/upcloud/r/loadbalancer_frontend_rule#scheme LoadbalancerFrontendRule#scheme}
        '''
        if __debug__:
