...
enum : int {
    ...
    SBK_QVIDEOFRAMEFORMAT_PIXELFORMAT_IDX                    = 67,
    SBK_QVIDEOFRAMEFORMAT_DIRECTION_IDX                      = 66,
    SBK_QVIDEOFRAMEFORMAT_YCBCRCOLORSPACE_IDX                = 68,
    SBK_QVIDEOFRAMEFORMAT_COLORSPACE_IDX                     = 64,
    SBK_QVIDEOFRAMEFORMAT_COLORTRANSFER_IDX                  = 65,
    SBK_QVIDEOFRAMEFORMAT_COLORRANGE_IDX                     = 63,
    SBK_QVIDEOFRAMEFORMAT_IDX                                = 62,
    SBK_QVIDEOSINK_IDX                                       = 69,
    SBK_QtMultimedia_IDX_COUNT                               = 70
};
