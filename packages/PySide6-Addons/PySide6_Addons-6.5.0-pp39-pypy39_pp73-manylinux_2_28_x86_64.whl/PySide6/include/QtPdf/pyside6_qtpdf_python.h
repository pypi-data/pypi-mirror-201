...
// Type indices
enum : int {
    SBK_QPDFBOOKMARKMODEL_ROLE_IDX                           = 3,
    SBK_QPDFBOOKMARKMODEL_IDX                                = 2,
    SBK_QPDFDOCUMENT_STATUS_IDX                              = 8,
    SBK_QPDFDOCUMENT_ERROR_IDX                               = 5,
    SBK_QPDFDOCUMENT_METADATAFIELD_IDX                       = 6,
    SBK_QPDFDOCUMENT_PAGEMODELROLE_IDX                       = 7,
    SBK_QPDFDOCUMENT_IDX                                     = 4,
    SBK_QPDFDOCUMENTRENDEROPTIONS_ROTATION_IDX               = 11,
    SBK_QPDFDOCUMENTRENDEROPTIONS_RENDERFLAG_IDX             = 10,
    SBK_QFLAGS_QPDFDOCUMENTRENDEROPTIONS_RENDERFLAG_IDX      = 0,
    SBK_QPDFDOCUMENTRENDEROPTIONS_IDX                        = 9,
    SBK_QPDFLINK_IDX                                         = 12,
    SBK_QPDFPAGENAVIGATOR_IDX                                = 13,
    SBK_QPDFPAGERENDERER_RENDERMODE_IDX                      = 15,
    SBK_QPDFPAGERENDERER_IDX                                 = 14,
    SBK_QPDFSEARCHMODEL_ROLE_IDX                             = 17,
    SBK_QPDFSEARCHMODEL_IDX                                  = 16,
    SBK_QPDFSELECTION_IDX                                    = 18,
    SBK_QtPdf_IDX_COUNT                                      = 19
};
