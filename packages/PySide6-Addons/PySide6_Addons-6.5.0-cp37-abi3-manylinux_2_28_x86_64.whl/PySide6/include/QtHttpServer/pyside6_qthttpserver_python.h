...
enum : int {
    ...
    SBK_QTHTTPSERVER_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX         = 3, // QPair<QByteArray,QByteArray >
    SBK_QTHTTPSERVER_QLIST_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX   = 4, // QList<QPair< QByteArray,QByteArray > >
