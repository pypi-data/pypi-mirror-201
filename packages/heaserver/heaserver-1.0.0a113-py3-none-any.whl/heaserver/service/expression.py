...
def get_eval_for(obj: HEAObject, extra_names: dict[str, Any] | None = None) -> EvalProtocol:
    """
    ...
    return Evaluator(SimpleEval(functions={'isheaobject': isheaobject}, names=names))
