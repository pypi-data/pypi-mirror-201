...
function GetOciSubcommands_opsi() {
    $ociSubcommands = @{
        'opsi' = 'awr-hubs database-insights enterprise-manager-bridges exadata-insights host-insights operations-insights-warehouse-users operations-insights-warehouses opsi-configurations opsi-data-objects opsi-private-endpoint work-requests'
        ...
        'opsi database-insights' = 'change change-autonomous-database-insight-advanced-features-credential-by-vault change-pe-comanaged-database-detail create-em-external-db create-pe-comanged-database delete disable disable-autonomous-database-insight-advanced-features enable-autonomous-database-insight-advanced-features-credential-by-vault enable-em-external-db enable-pe-comanaged-database get ingest-database-configuration ingest-sql-bucket ingest-sql-plan-lines ingest-sql-stats ingest-sql-text list list-database-configurations list-sql-plans list-sql-searches list-sql-texts summarize-database-insight-resource-capacity-trend summarize-database-insight-resource-forecast-trend summarize-database-insight-resource-statistics summarize-database-insight-resource-usage summarize-database-insight-resource-usage-trend summarize-database-insight-resource-utilization-insight summarize-database-insight-tablespace-usage-trend summarize-sql-insights summarize-sql-plan-insights summarize-sql-response-time-distributions summarize-sql-statistics summarize-sql-statistics-time-series summarize-sql-statistics-time-series-by-plan update-autonomous-db update-em-external-db update-macs-external-db update-pe-comanaged-database'
        'opsi enterprise-manager-bridges' = 'change create delete get list list-importable-enterprise-manager-entities update'
        'opsi exadata-insights' = 'add-em-external-exadata-members add-pe-comanaged-exadata-members change create-em-external-exadata create-pe-comanaged-exadata delete disable enable-em-external-exadata enable-pe-comanaged-exadata get list list-exadata-configurations summarize-exadata-insight-resource-capacity-trend summarize-exadata-insight-resource-capacity-trend-aggregated summarize-exadata-insight-resource-forecast-trend summarize-exadata-insight-resource-forecast-trend-aggregated summarize-exadata-insight-resource-statistics summarize-exadata-insight-resource-usage summarize-exadata-insight-resource-usage-aggregated summarize-exadata-insight-resource-utilization-insight summarize-exadata-members update-em-external-exadata update-pe-comanaged-exadata'
        'opsi host-insights' = 'change create-em-external-host create-macs-cloud-host create-macs-external-host delete disable enable-em-external-host enable-macs-cloud-host enable-macs-external-host get ingest-host-configuration ingest-host-metrics list list-host-configurations list-hosted-entities list-importable-agent-entities list-macs-cloud-hosts summarize-host-insight-resource-capacity-trend summarize-host-insight-resource-forecast-trend summarize-host-insight-resource-statistics summarize-host-insight-resource-usage summarize-host-insight-resource-usage-trend summarize-host-insight-resource-utilization-insight summarize-network-usage-trend summarize-storage-usage-trend summarize-top-processes-usage-trend update-em-external-host update-macs-cloud-host update-macs-external-host'
        'opsi operations-insights-warehouse-users' = 'create delete get list update'
        'opsi operations-insights-warehouses' = 'create delete download-warehouse-wallet get list rotate-warehouse-wallet summarize-operations-insights-warehouse-resource-usage update'
        ...
        'opsi opsi-data-objects' = 'get list query-data-templatized-query'
...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi database-insights change-autonomous-database-insight-advanced-features-credential-by-vault' = 'connection-details credential-source-name database-insight-id from-json help if-match max-wait-seconds opsi-private-endpoint-id password-secret-id role user-name wait-for-state wait-interval-seconds'
        'opsi database-insights change-pe-comanaged-database-detail' = 'credential-details-credential-source-name credential-details-password-secret-id credential-details-role credential-details-user-name database-insight-id from-json help if-match max-wait-seconds opsi-private-endpoint-id service-name wait-for-state wait-interval-seconds'
        ...
        'opsi database-insights enable-autonomous-database-insight-advanced-features-credential-by-vault' = 'connection-details credential-source-name database-insight-id from-json help if-match max-wait-seconds opsi-private-endpoint-id password-secret-id role user-name wait-for-state wait-interval-seconds'
        ...
        'opsi database-insights enable-pe-comanaged-database' = 'compartment-id credential-details database-insight-id defined-tags freeform-tags from-json help if-match max-wait-seconds opsi-private-endpoint-id service-name system-tags wait-for-state wait-interval-seconds'
        ...
        'opsi exadata-insights list-exadata-configurations' = 'all compartment-id defined-tag-equals defined-tag-exists exadata-insight-id exadata-type freeform-tag-equals freeform-tag-exists from-json help limit page page-size sort-by sort-order'
        ...
        'opsi exadata-insights summarize-exadata-insight-resource-usage' = 'analysis-time-interval cdb-name compartment-id defined-tag-equals defined-tag-exists exadata-insight-id exadata-type freeform-tag-equals freeform-tag-exists from-json help host-name limit page percentile resource-metric resource-type sort-by sort-order time-interval-end time-interval-start'
        'opsi exadata-insights summarize-exadata-insight-resource-usage-aggregated' = 'analysis-time-interval cdb-name compartment-id defined-tag-equals defined-tag-exists exadata-insight-id exadata-type freeform-tag-equals freeform-tag-exists from-json help host-name page percentile resource-metric resource-type time-interval-end time-interval-start'
        'opsi exadata-insights summarize-exadata-insight-resource-utilization-insight' = 'analysis-time-interval cdb-name compartment-id defined-tag-equals defined-tag-exists exadata-insight-id exadata-type forecast-days forecast-start-day freeform-tag-equals freeform-tag-exists from-json help host-name limit page resource-metric resource-type time-interval-end time-interval-start'
        ...
        'opsi host-insights list-host-configurations' = 'all compartment-id compartment-id-in-subtree defined-tag-equals defined-tag-exists em-bridge-id exadata-insight-id freeform-tag-equals freeform-tag-exists from-json help host-id host-type id limit page page-size platform-type sort-by sort-order vmcluster-name'
        'opsi host-insights list-hosted-entities' = 'all analysis-time-interval compartment-id exadata-insight-id from-json help host-id host-type id limit page page-size platform-type sort-by sort-order time-interval-end time-interval-start'
        ...
        'opsi host-insights summarize-host-insight-resource-utilization-insight' = 'analysis-time-interval compartment-id compartment-id-in-subtree defined-tag-equals defined-tag-exists exadata-insight-id forecast-days freeform-tag-equals freeform-tag-exists from-json help host-id host-type id page platform-type resource-metric time-interval-end time-interval-start vmcluster-name'
        'opsi host-insights summarize-network-usage-trend' = 'analysis-time-interval compartment-id from-json help host-id id limit page statistic time-interval-end time-interval-start'
        'opsi host-insights summarize-storage-usage-trend' = 'analysis-time-interval compartment-id from-json help host-id id limit page statistic time-interval-end time-interval-start'
        'opsi host-insights summarize-top-processes-usage-trend' = 'analysis-time-interval compartment-id from-json help host-id host-type id limit page resource-metric statistic time-interval-end time-interval-start'
        ...
        'opsi opsi-data-objects list' = 'all compartment-id data-object-type display-name from-json help limit page page-size sort-by sort-order'
        'opsi opsi-data-objects query-data-templatized-query' = 'compartment-id data-object-identifier from-json help limit page query-group-by-list query-having-conditions-list query-order-by-list query-select-list query-time-filters query-where-conditions-list resource-filters'
