...
class ProgressiveKMeansRun(_BaseKMeans, ProgressiveClusteringRun):
    ...
    def executeNextIteration(self):
        ...
        if self._iteration == self.max_iter or self._converged:
            ...
            return self.composePartialResult(self._iteration, self._completed, inertia, self._centers, self._labels, t0)
    ...
    def composePartialResult(self, iteration, completed, inertia, centers, labels, t0):
        elapsedTime = time.time() - t0
        info = RunPartialResultInfo(iteration, completed, elapsedTime)
