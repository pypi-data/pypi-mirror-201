...
from .resampling import read_calib_tuple, calib_transform, data_transform, get_or_create_template, get_or_create_mc_template, resample_data, correct_data
...
def correct(
  ...
  input_df = uproot.concatenate(input, input_branches, library = "pd")
