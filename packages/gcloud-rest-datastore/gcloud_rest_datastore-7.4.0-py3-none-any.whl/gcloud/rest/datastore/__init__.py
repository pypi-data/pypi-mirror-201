...
`gcloud-rest-datastore` provides class interfaces mirroring all official Google
...
We can then configure `gcloud-rest-datastore` to serialize/deserialize from this
