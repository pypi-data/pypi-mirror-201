...
def init(http_host: str ,exp_name: str="", team_name: str="", run_name: str="", config: Dict=None) -> Dict:
    ...
    sys_info = {
        "os": security.get_os(),
        "python": security.get_python_version(),
        "gpu": security.get_gpu(),
        "gpuCount": security.get_gpu_count(),
        "cpuCount": security.get_cpu_count(),
        "hostname": security.get_hostname(),
    }
    ...
    data = {
        ...
        "expName": exp_name,
        "runName": run_name,
        "config": {"cliVer": version.__version__, "pythonVer": security.get_python_version(), "_custom": _custom},
        "sysInfo": sys_info,
        "createRun": "Y",
    }
...
def create_hpo(http_host:str, exp_name: str="", team_name: str="", hpo_config: Dict=None) -> Dict:
    ...
    data ={
        "teamName": team_name,
        "expName": exp_name,
        "config":  {"cliVer": version.__version__, "pythonVer": security.get_python_version(), "hpoConfig": hpo_config},
        "sysInfo": {
            "os": security.get_os(),
            "python": security.get_python_version(),
            "gpu": security.get_gpu(),
