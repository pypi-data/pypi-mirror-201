...
def hist_3d_time(FileName: str, FileNum: int, InitialTime: float, FinalTime: float,
    ...
    """Takes in a histogram.dat file from NERDSS, and creates a 3D histogram that represents the probability of monomers combining over time.
    ...
    Returns:
        Returns a 3D histogram representing the number of monomers in a single complex over time. X-axis = number of monomers. Y-axis = averaged time. Z-axis = relative occurance probabilities.
    """
