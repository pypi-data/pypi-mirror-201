...
def hist_time_heatmap_mono_count(FileName: str, FileNum: int, InitialTime: float, FinalTime: float,
    ...
    """Creates a 2D Heatmap from a histogram.dat file that shows total mumber of monomers in N-mers vs. time.
    ...
    Returns:
        2D heatmap. X-axis = number of monomers in a single complex. Y-axis = time. Color = total number of corresponding monomers in N-mers.
    """
