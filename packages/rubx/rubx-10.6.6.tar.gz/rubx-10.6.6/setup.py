...
with RubikaClient('session', platform='rubx',
    proxy={'socks5':'127.0.0.1'}) as client: # please show all params
   client.send_message('Hey There!', '@username') # username is all type
...
setup(
    name="rubx",
    version=version,
    description="Iranina rubx library",
