    ...
    def set_content_image(self, *args, **kwargs):
        ...
        if 'content_image_id' in kwargs:
            ...
            if self.ContentImageClass == ServerContentImage:
                self.object_content_type = get_public_schema_content_type(self.content_image.content_type_id)
                self.content_image.content = self.object_content_type.get_object_for_this_type(pk=self.content_image.object_id)
            else:
