...
from fxiqoption.http.login import Login
from fxiqoption.http.loginv2 import Loginv2
from fxiqoption.http.logout import Logout
from fxiqoption.http.getprofile import Getprofile
from fxiqoption.http.auth import Auth
from fxiqoption.http.token import Token
from fxiqoption.http.appinit import Appinit
from fxiqoption.http.billing import Billing
from fxiqoption.http.buyback import Buyback
from fxiqoption.http.changebalance import Changebalance
from fxiqoption.http.events import Events
from fxiqoption.ws.client import WebsocketClient
from fxiqoption.ws.chanels.get_balances import *

from fxiqoption.ws.chanels.ssid import Ssid
from fxiqoption.ws.chanels.subscribe import *
from fxiqoption.ws.chanels.unsubscribe import *
from fxiqoption.ws.chanels.setactives import SetActives
from fxiqoption.ws.chanels.candles import GetCandles
from fxiqoption.ws.chanels.buyv2 import Buyv2
from fxiqoption.ws.chanels.buyv3 import *
from fxiqoption.ws.chanels.user import *
from fxiqoption.ws.chanels.api_game_betinfo import Game_betinfo
from fxiqoption.ws.chanels.instruments import Get_instruments
from fxiqoption.ws.chanels.get_financial_information import GetFinancialInformation
from fxiqoption.ws.chanels.strike_list import Strike_list
from fxiqoption.ws.chanels.leaderboard import Leader_Board

from fxiqoption.ws.chanels.traders_mood import Traders_mood_subscribe
from fxiqoption.ws.chanels.traders_mood import Traders_mood_unsubscribe
from fxiqoption.ws.chanels.buy_place_order_temp import Buy_place_order_temp
from fxiqoption.ws.chanels.get_order import Get_order
from fxiqoption.ws.chanels.get_deferred_orders import GetDeferredOrders
from fxiqoption.ws.chanels.get_positions import *
 
from fxiqoption.ws.chanels.get_available_leverages import Get_available_leverages
from fxiqoption.ws.chanels.cancel_order import Cancel_order
from fxiqoption.ws.chanels.close_position import Close_position
from fxiqoption.ws.chanels.get_overnight_fee import Get_overnight_fee
from fxiqoption.ws.chanels.heartbeat import Heartbeat

 
from fxiqoption.ws.chanels.digital_option import *
from fxiqoption.ws.chanels.api_game_getoptions import *
from fxiqoption.ws.chanels.sell_option import Sell_Option
from fxiqoption.ws.chanels.change_tpsl import Change_Tpsl
from fxiqoption.ws.chanels.change_auto_margin_call import ChangeAutoMarginCall

from fxiqoption.ws.objects.timesync import TimeSync
from fxiqoption.ws.objects.profile import Profile
from fxiqoption.ws.objects.candles import Candles
from fxiqoption.ws.objects.listinfodata import ListInfoData
from fxiqoption.ws.objects.betinfo import Game_betinfo_data
import fxiqoption.global_value as global_value
...
class IQOptionAPI(object):  # pylint: disable=too-many-instance-attributes
    ...
    def prepare_http_url(self, resource):
        ...
        :param resource: The instance of
            :class:`Resource <fxiqoption.http.resource.Resource>`.
    ...
    def loginv2(self):
        ...
        :returns: The instance of :class:`Loginv2
            <fxiqoption.http.loginv2.Loginv2>`.
        """
        return Loginv2(self)
    ...
    def appinit(self):
        ...
        :returns: The instance of :class:`Appinit
            <fxiqoption.http.appinit.Appinit>`.
        """
        return Appinit(self)
    ...
    #         <fxiqoption.http.profile.Profile>`.
    #     """
    #     return Profile(self)
    ...
    def changebalance(self):
        ...
        :returns: The instance of :class:`Changebalance
            <fxiqoption.http.changebalance.Changebalance>`.
        """
    ...
    def billing(self):
        ...
        :returns: The instance of :class:`Billing
            <fxiqoption.http.billing.Billing>`.
        """
        return Billing(self)
    ...
    def buyback(self):
        ...
        :returns: The instance of :class:`Buyback
            <fxiqoption.http.buyback.Buyback>`.
        """
        return Buyback(self)
# ------------------------------------------------------------------------
    ...
    def getprofile(self):
        ...
        :returns: The instance of :class:`Login
            <fxiqoption.http.getprofile.Getprofile>`.
        """
...
# ----------------------------------------------------------------------------
    ...
    def ssid(self):
        ...
        :returns: The instance of :class:`Ssid
            <fxiqoption.ws.chanels.ssid.Ssid>`.
        """
        return Ssid(self)
# --------------------------------------------------------------------------------
    @property
...
# --------------------------------------------------------------------------------
    ...
    def subscribe(self):
        ...
        :returns: The instance of :class:`Subscribe
            <fxiqoption.ws.chanels.subscribe.Subscribe>`.
        """
    ...
    def unsubscribe(self):
        ...
        :returns: The instance of :class:`Unsubscribe
            <fxiqoption.ws.chanels.unsubscribe.Unsubscribe>`.
        """
...
# -----------------------------------------------------------------------------------
    ...
    def setactives(self):
        ...
        :returns: The instance of :class:`SetActives
            <fxiqoption.ws.chanels.setactives.SetActives>`.
        """
    ...
    def getcandles(self):
        ...
        :returns: The instance of :class:`GetCandles
            <fxiqoption.ws.chanels.candles.GetCandles>`.
        """
...
# ____________for_______binary_______option_____________
    ...
    def buy(self):
        ...
        :returns: The instance of :class:`Buyv2
            <fxiqoption.ws.chanels.buyv2.Buyv2>`.
        """
        self.buy_successful = None
        return Buyv2(self)
