...
class SOLRewardByDay(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SOLRewardByDay:
        """Create an instance of SOLRewardByDay from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SOLRewardByDay:
        """Create an instance of SOLRewardByDay from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SOLRewardByDay.parse_obj(obj)

        _obj = SOLRewardByDay.parse_obj({
