...
class SOLBroadcastTx(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SOLBroadcastTx:
        """Create an instance of SOLBroadcastTx from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SOLBroadcastTx:
        """Create an instance of SOLBroadcastTx from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SOLBroadcastTx.parse_obj(obj)

        _obj = SOLBroadcastTx.parse_obj({
