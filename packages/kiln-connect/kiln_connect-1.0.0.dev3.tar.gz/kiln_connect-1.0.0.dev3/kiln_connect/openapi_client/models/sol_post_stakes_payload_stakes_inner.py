...
class SOLPostStakesPayloadStakesInner(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SOLPostStakesPayloadStakesInner:
        """Create an instance of SOLPostStakesPayloadStakesInner from a JSON string"""
    ...
    def to_dict(self):
        ...
        if self.stake_account is None:
            _dict['stakeAccount'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> SOLPostStakesPayloadStakesInner:
        """Create an instance of SOLPostStakesPayloadStakesInner from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SOLPostStakesPayloadStakesInner.parse_obj(obj)

        _obj = SOLPostStakesPayloadStakesInner.parse_obj({
            "stake_account": obj.get("stakeAccount"),
