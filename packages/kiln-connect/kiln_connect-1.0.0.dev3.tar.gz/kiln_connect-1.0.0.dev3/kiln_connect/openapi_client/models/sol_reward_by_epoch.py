...
class SOLRewardByEpoch(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SOLRewardByEpoch:
        """Create an instance of SOLRewardByEpoch from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SOLRewardByEpoch:
        """Create an instance of SOLRewardByEpoch from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SOLRewardByEpoch.parse_obj(obj)

        _obj = SOLRewardByEpoch.parse_obj({
            "epoch": obj.get("epoch"),
            "epoch_ts": obj.get("epoch_ts"),
            "rewards": obj.get("rewards"),
            "active_balance": obj.get("active_balance"),
