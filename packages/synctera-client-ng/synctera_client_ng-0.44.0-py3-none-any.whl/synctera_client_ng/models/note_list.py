...
class NoteList(BaseModel):
    ...
    __properties = ["notes", "next_page_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NoteList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NoteList:
        """Create an instance of NoteList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return NoteList.parse_obj(obj)

        _obj = NoteList.parse_obj({
