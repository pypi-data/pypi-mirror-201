...
class TemplateFields(BaseModel):
    ...
    oneof_schema_1_validator: Optional[TemplateFieldsDepository] = None
    # data type: TemplateFieldsLineOfCredit
    oneof_schema_2_validator: Optional[TemplateFieldsLineOfCredit] = None
    # data type: TemplateFieldsChargeSecured
    oneof_schema_3_validator: Optional[TemplateFieldsChargeSecured] = None
    actual_instance: Any
