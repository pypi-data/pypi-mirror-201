...
class AccountIdentifiers(BaseModel):
    ...
    Do not edit the class manually.
    """
    iban: Optional[StrictStr] = Field(None, description="The IBAN of the account. Value may be masked, in which case only the last four digits are returned. ")
    number: StrictStr = Field(..., description="The account number. Value may be masked, in which case only the last four digits are returned. ")
    __properties = ["iban", "number"]
