...
class TransferRequestPull(BaseModel):
    ...
    __properties = ["amount", "currency", "external_card_id", "merchant", "originating_account_id", "type", "id_3ds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferRequestPull:
        """Create an instance of TransferRequestPull from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferRequestPull:
        """Create an instance of TransferRequestPull from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TransferRequestPull.parse_obj(obj)

        _obj = TransferRequestPull.parse_obj({
