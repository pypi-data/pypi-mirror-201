...
class BasePerson1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BasePerson1:
        """Create an instance of BasePerson1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BasePerson1:
        """Create an instance of BasePerson1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BasePerson1.parse_obj(obj)

        _obj = BasePerson1.parse_obj({
