...
class AccountDepository(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountDepository:
        """Create an instance of AccountDepository from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountDepository:
        """Create an instance of AccountDepository from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccountDepository.parse_obj(obj)

        _obj = AccountDepository.parse_obj({
