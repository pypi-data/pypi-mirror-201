...
class PhysicalCardResponseStatus(BaseModel):
    ...
    __properties = ["card_status", "memo", "status_reason", "card_fulfillment_status", "fulfillment_details", "tracking_number"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalCardResponseStatus:
        """Create an instance of PhysicalCardResponseStatus from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalCardResponseStatus:
        """Create an instance of PhysicalCardResponseStatus from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PhysicalCardResponseStatus.parse_obj(obj)

        _obj = PhysicalCardResponseStatus.parse_obj({
