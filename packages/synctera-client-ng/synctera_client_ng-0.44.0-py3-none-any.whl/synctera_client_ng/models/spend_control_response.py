...
class SpendControlResponse(BaseModel):
    ...
    creation_time: datetime = Field(..., description="The timestamp representing when the spend control was created")
    direction: Optional[SpendControlDirection] = None
    id: StrictStr = Field(..., description="Spend Control ID")
    is_active: StrictBool = Field(..., description="Indicates if spend control is active")
    last_modified_time: datetime = Field(..., description="The timestamp representing when the spend control was last modified")
    ...
    __properties = ["action_case", "action_decline", "amount_limit", "creation_time", "direction", "id", "is_active", "last_modified_time", "name", "payment_types", "time_range", "number_of_related_accounts"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SpendControlResponse:
        """Create an instance of SpendControlResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SpendControlResponse:
        """Create an instance of SpendControlResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SpendControlResponse.parse_obj(obj)

        _obj = SpendControlResponse.parse_obj({
