...
class PendingTransactionHistory(BaseModel):
    ...
    data: Optional[PendingTransactionHistoryData] = None
    id: StrictInt = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PendingTransactionHistory:
        """Create an instance of PendingTransactionHistory from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PendingTransactionHistory:
        """Create an instance of PendingTransactionHistory from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PendingTransactionHistory.parse_obj(obj)

        _obj = PendingTransactionHistory.parse_obj({
            "account_id": obj.get("account_id"),
            "account_no": obj.get("account_no"),
            "created": obj.get("created"),
            "data": PendingTransactionHistoryData.from_dict(obj.get("data")) if obj.get("data") is not None else None,
            "id": obj.get("id"),
