...
class AccountLineOfCredit(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountLineOfCredit:
        """Create an instance of AccountLineOfCredit from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountLineOfCredit:
        """Create an instance of AccountLineOfCredit from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccountLineOfCredit.parse_obj(obj)

        _obj = AccountLineOfCredit.parse_obj({
