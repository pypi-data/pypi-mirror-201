...
class TransactionList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionList:
        """Create an instance of TransactionList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TransactionList.parse_obj(obj)

        _obj = TransactionList.parse_obj({
