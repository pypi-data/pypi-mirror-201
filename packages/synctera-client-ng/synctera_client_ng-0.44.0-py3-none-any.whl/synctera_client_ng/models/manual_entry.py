...
class ManualEntry(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManualEntry:
        """Create an instance of ManualEntry from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManualEntry:
        """Create an instance of ManualEntry from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ManualEntry.parse_obj(obj)

        _obj = ManualEntry.parse_obj({
