...
class CardProduct(BaseModel):
    ...
    __properties = ["form", "active", "card_program_id", "color", "creation_time", "digital_wallet_tokenization", "end_date", "id", "image", "image_mode", "issue_without_kyc", "last_modified_time", "name", "orientation", "package_id", "physical_card_format", "return_address", "start_date", "three_ds_policy", "txn_enhancer"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardProduct:
        """Create an instance of CardProduct from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardProduct:
        """Create an instance of CardProduct from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CardProduct.parse_obj(obj)

        _obj = CardProduct.parse_obj({
            "form": obj.get("form"),
