...
class PaymentList(BaseModel):
    ...
    __properties = ["payments", "next_page_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaymentList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaymentList:
        """Create an instance of PaymentList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PaymentList.parse_obj(obj)

        _obj = PaymentList.parse_obj({
