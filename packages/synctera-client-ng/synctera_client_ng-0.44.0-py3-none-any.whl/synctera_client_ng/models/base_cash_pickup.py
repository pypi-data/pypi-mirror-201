...
class BaseCashPickup(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseCashPickup:
        """Create an instance of BaseCashPickup from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseCashPickup:
        """Create an instance of BaseCashPickup from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BaseCashPickup.parse_obj(obj)

        _obj = BaseCashPickup.parse_obj({
