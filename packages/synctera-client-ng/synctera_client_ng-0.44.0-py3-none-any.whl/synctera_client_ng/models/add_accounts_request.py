...
class AddAccountsRequest(BaseModel):
    ...
    __properties = ["account_identifiers", "account_owner_names", "business_id", "customer_id", "customer_type", "metadata", "nickname", "routing_identifiers", "type", "vendor_account_id", "verification"]
