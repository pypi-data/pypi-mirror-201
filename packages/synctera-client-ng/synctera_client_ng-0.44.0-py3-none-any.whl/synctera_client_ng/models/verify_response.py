...
class VerifyResponse(BaseModel):
    ...
    __properties = ["verification_status", "verifications", "next_page_token"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyResponse:
        """Create an instance of VerifyResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VerifyResponse.parse_obj(obj)

        _obj = VerifyResponse.parse_obj({
