...
class ResponsePersonalId(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponsePersonalId:
        """Create an instance of ResponsePersonalId from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponsePersonalId:
        """Create an instance of ResponsePersonalId from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ResponsePersonalId.parse_obj(obj)

        _obj = ResponsePersonalId.parse_obj({
            "id": obj.get("id"),
