...
class AuthRequestModel(BaseModel):
    ...
    cash_back_amount: Optional[StrictInt] = None
    ...
    __properties = ["amount", "card_acceptor", "card_id", "card_options", "cash_back_amount", "is_pre_auth", "mid", "network_fees", "pin", "transaction_options"]
