...
class TransactionLine(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransactionLine:
        """Create an instance of TransactionLine from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransactionLine:
        """Create an instance of TransactionLine from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TransactionLine.parse_obj(obj)

        _obj = TransactionLine.parse_obj({
