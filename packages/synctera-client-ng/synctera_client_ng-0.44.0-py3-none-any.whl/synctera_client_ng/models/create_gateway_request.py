...
class CreateGatewayRequest(BaseModel):
    ...
    Do not edit the class manually.
    """
    active: Optional[StrictBool] = Field(True, description="Current status of the Authorization gateway")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateGatewayRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateGatewayRequest:
        """Create an instance of CreateGatewayRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateGatewayRequest.parse_obj(obj)

        _obj = CreateGatewayRequest.parse_obj({
