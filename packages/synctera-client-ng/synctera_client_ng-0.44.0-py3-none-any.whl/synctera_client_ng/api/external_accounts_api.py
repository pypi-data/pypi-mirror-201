...
class ExternalAccountsApi(object):
    ...
    def add_external_accounts(self, add_accounts_request : AddAccountsRequest, idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, **kwargs) -> ExternalAccount:  # noqa: E501
        ...
        >>> thread = api.add_external_accounts(add_accounts_request, idempotency_key, partner_ownership, async_req=True)
        >>> result = thread.get()
        ...
        return self.add_external_accounts_with_http_info(add_accounts_request, idempotency_key, partner_ownership, **kwargs)  # noqa: E501
    ...
    def add_external_accounts_with_http_info(self, add_accounts_request : AddAccountsRequest, idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.add_external_accounts_with_http_info(add_accounts_request, idempotency_key, partner_ownership, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_external_account(self, external_account_id : Annotated[StrictStr, Field(..., description="External Account ID")], partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, **kwargs) -> ExternalAccount:  # noqa: E501
        ...
        >>> thread = api.get_external_account(external_account_id, partner_ownership, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_external_account_with_http_info(external_account_id, partner_ownership, **kwargs)  # noqa: E501

    @validate_arguments
    def get_external_account_with_http_info(self, external_account_id : Annotated[StrictStr, Field(..., description="External Account ID")], partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, **kwargs):  # noqa: E501
        """Get an external account  # noqa: E501
        ...
        >>> thread = api.get_external_account_with_http_info(external_account_id, partner_ownership, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def get_external_account_balance_with_http_info(self, external_account_id : Annotated[StrictStr, Field(..., description="External Account ID")], max_age : Annotated[Optional[conint(strict=True, ge=1)], Field(description="Optional relative age of a balance in seconds. If the balance is older than the requested seconds it will fail. This field is optional for most financial institutions, but required for some, so you should probably send it. ")] = None, **kwargs):  # noqa: E501
        """Get an external account balance  # noqa: E501
    ...
    @validate_arguments
    def get_external_account_transactions(self, external_account_id : Annotated[StrictStr, Field(..., description="External Account ID")], start_date : Annotated[date, Field(..., description="Date range filtering for transactions. Date is inclusive. Date must be in UTC.")], end_date : Annotated[date, Field(..., description="Date range filtering for transactions. Date is exclusive. Date must be in UTC.")], **kwargs) -> ExternalAccountsTransactionList:  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_external_account_transactions_with_http_info(external_account_id, start_date, end_date, **kwargs)  # noqa: E501

    @validate_arguments
    def get_external_account_transactions_with_http_info(self, external_account_id : Annotated[StrictStr, Field(..., description="External Account ID")], start_date : Annotated[date, Field(..., description="Date range filtering for transactions. Date is inclusive. Date must be in UTC.")], end_date : Annotated[date, Field(..., description="Date range filtering for transactions. Date is exclusive. Date must be in UTC.")], **kwargs):  # noqa: E501
        """List transactions of a given external account  # noqa: E501
        ...
        >>> thread = api.get_external_account_transactions_with_http_info(external_account_id, start_date, end_date, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def list_external_accounts(self, customer_id : Annotated[Optional[conlist(StrictStr)], Field(description="A list of customer unique identifiers, with a comma separating any values.")] = None, business_id : Annotated[Optional[conlist(StrictStr)], Field(description="A list of business unique identifiers, with a comma separating any values.")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, include_history : Annotated[Optional[StrictBool], Field(description="If true, include old (inactive) records as well.")] = None, **kwargs) -> ExternalAccountsList:  # noqa: E501
        ...
        >>> thread = api.list_external_accounts(customer_id, business_id, limit, page_token, partner_ownership, include_history, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_external_accounts_with_http_info(customer_id, business_id, limit, page_token, partner_ownership, include_history, **kwargs)  # noqa: E501

    @validate_arguments
    def list_external_accounts_with_http_info(self, customer_id : Annotated[Optional[conlist(StrictStr)], Field(description="A list of customer unique identifiers, with a comma separating any values.")] = None, business_id : Annotated[Optional[conlist(StrictStr)], Field(description="A list of business unique identifiers, with a comma separating any values.")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, include_history : Annotated[Optional[StrictBool], Field(description="If true, include old (inactive) records as well.")] = None, **kwargs):  # noqa: E501
        """List external accounts  # noqa: E501
        ...
        >>> thread = api.list_external_accounts_with_http_info(customer_id, business_id, limit, page_token, partner_ownership, include_history, async_req=True)
        >>> result = thread.get()
