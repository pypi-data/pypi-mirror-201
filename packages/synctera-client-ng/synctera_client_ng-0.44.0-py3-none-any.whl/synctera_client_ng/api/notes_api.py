...
class NotesApi(object):
    ...
    @validate_arguments
    def list_notes(self, id : Annotated[Optional[conlist(StrictStr)], Field(description="Return the note with the specified id. Multiple IDs can be provided as a comma-separated list. ")] = None, related_resource_id : Annotated[Optional[conlist(StrictStr)], Field(description="Only return notes that have a related resource with the specified ID.")] = None, related_resource_type : Annotated[Optional[RelatedResourceType1], Field(description="Only return notes that have a related resource with the specified type.")] = None, author_user_id : Optional[StrictStr] = None, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, **kwargs) -> NoteList:  # noqa: E501
        ...
        >>> thread = api.list_notes(id, related_resource_id, related_resource_type, author_user_id, tenant, limit, page_token, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_notes_with_http_info(id, related_resource_id, related_resource_type, author_user_id, tenant, limit, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_notes_with_http_info(self, id : Annotated[Optional[conlist(StrictStr)], Field(description="Return the note with the specified id. Multiple IDs can be provided as a comma-separated list. ")] = None, related_resource_id : Annotated[Optional[conlist(StrictStr)], Field(description="Only return notes that have a related resource with the specified ID.")] = None, related_resource_type : Annotated[Optional[RelatedResourceType1], Field(description="Only return notes that have a related resource with the specified type.")] = None, author_user_id : Optional[StrictStr] = None, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """List notes  # noqa: E501
        ...
        >>> thread = api.list_notes_with_http_info(id, related_resource_id, related_resource_type, author_user_id, tenant, limit, page_token, async_req=True)
        >>> result = thread.get()
