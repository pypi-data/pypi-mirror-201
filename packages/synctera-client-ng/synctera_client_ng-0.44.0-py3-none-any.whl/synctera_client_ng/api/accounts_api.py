...
class AccountsApi(object):
    ...
    @validate_arguments
    def get_account_relationship(self, account_id : Annotated[StrictStr, Field(..., description="Unique identifier for the account.")], relationship_id : Annotated[StrictStr, Field(..., description="Relationship ID of the account associate with the account entity")], **kwargs) -> RelationshipResponse:  # noqa: E501
    ...
    def list_account_resource_products(self, product_type : Annotated[StrictStr, Field(..., description="Type of account product")], limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, start_date : Annotated[Optional[date], Field(description="Date range filtering for type INTEREST. All rates in interest resource have to have valid_from later or equal to start_date.")] = None, end_date : Annotated[Optional[date], Field(description="Date range filtering for type INTEREST. All rates in interest resource have to have valid_to earlier or equal to end_date.")] = None, id : Annotated[Optional[StrictStr], Field(description="ID of account product. Multiple IDs can be provided as a comma-separated list.")] = None, **kwargs) -> AccountProductList:  # noqa: E501
        ...
        >>> thread = api.list_account_resource_products(product_type, limit, page_token, start_date, end_date, id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_account_resource_products_with_http_info(product_type, limit, page_token, start_date, end_date, id, **kwargs)  # noqa: E501
    ...
    def list_account_resource_products_with_http_info(self, product_type : Annotated[StrictStr, Field(..., description="Type of account product")], limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, start_date : Annotated[Optional[date], Field(description="Date range filtering for type INTEREST. All rates in interest resource have to have valid_from later or equal to start_date.")] = None, end_date : Annotated[Optional[date], Field(description="Date range filtering for type INTEREST. All rates in interest resource have to have valid_to earlier or equal to end_date.")] = None, id : Annotated[Optional[StrictStr], Field(description="ID of account product. Multiple IDs can be provided as a comma-separated list.")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_account_resource_products_with_http_info(product_type, limit, page_token, start_date, end_date, id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def list_accounts(self, id : Annotated[Optional[conlist(StrictStr)], Field(description="Account ID(s). Multiple IDs can be provided as a comma-separated list. ")] = None, account_type : Annotated[Optional[AccountType], Field(description="The type of the account ")] = None, linked_account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Return only resources that are linked to the specified backing account in balance_floor or balance_ceiling. Multiple IDs can be provided as a comma-separated list. ")] = None, overdraft_account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Overdraft account ID(s). Multiple IDs can be provided as a comma-separated list. This parameter is deprecated and will be removed in a future API version. Use linked_account_id instead. ")] = None, overflow_account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Overflow account ID(s). Multiple IDs can be provided as a comma-separated list. This parameter is deprecated and will be removed in a future API version. Use linked_account_id instead. ")] = None, account_number : Annotated[Optional[conlist(StrictStr)], Field(description="Account number(s). Multiple account numbers can be provided as a comma-separated list. When only a single account number is provided, any * characters in the string are wildcards, and match any characters. ")] = None, status : Optional[Status] = None, interest_product_id : Annotated[Optional[StrictStr], Field(description="Interest product ID that accounts associate with. Multiple IDs can be provided as a comma-separated list.")] = None, customer_type : Annotated[Optional[CustomerType], Field(description="Customer type of the account, BUSINESS or PERSONAL ")] = None, spend_control_ids : Annotated[Optional[conlist(StrictStr, max_items=10)], Field(description="Spend Control ID(s). Multiple IDs can be provided as a comma-separated list. Return only resources that use the specified Spend Controls. ")] = None, nickname : Annotated[Optional[StrictStr], Field(description="Nickname of the account ")] = None, customer_id : Annotated[Optional[StrictStr], Field(description="The customer's unique identifier")] = None, business_id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique identifier for the business. Multiple IDs can be provided as a comma-separated list. ")] = None, person_id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique identifier for the person. Multiple IDs can be provided as a comma-separated list. ")] = None, first_name : Optional[StrictStr] = None, last_name : Optional[StrictStr] = None, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for the returned accounts. ")] = None, **kwargs) -> AccountList:  # noqa: E501
        ...
        >>> thread = api.list_accounts(id, account_type, linked_account_id, overdraft_account_id, overflow_account_id, account_number, status, interest_product_id, customer_type, spend_control_ids, nickname, customer_id, business_id, person_id, first_name, last_name, tenant, limit, page_token, sort_by, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_accounts_with_http_info(id, account_type, linked_account_id, overdraft_account_id, overflow_account_id, account_number, status, interest_product_id, customer_type, spend_control_ids, nickname, customer_id, business_id, person_id, first_name, last_name, tenant, limit, page_token, sort_by, **kwargs)  # noqa: E501

    @validate_arguments
    def list_accounts_with_http_info(self, id : Annotated[Optional[conlist(StrictStr)], Field(description="Account ID(s). Multiple IDs can be provided as a comma-separated list. ")] = None, account_type : Annotated[Optional[AccountType], Field(description="The type of the account ")] = None, linked_account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Return only resources that are linked to the specified backing account in balance_floor or balance_ceiling. Multiple IDs can be provided as a comma-separated list. ")] = None, overdraft_account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Overdraft account ID(s). Multiple IDs can be provided as a comma-separated list. This parameter is deprecated and will be removed in a future API version. Use linked_account_id instead. ")] = None, overflow_account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Overflow account ID(s). Multiple IDs can be provided as a comma-separated list. This parameter is deprecated and will be removed in a future API version. Use linked_account_id instead. ")] = None, account_number : Annotated[Optional[conlist(StrictStr)], Field(description="Account number(s). Multiple account numbers can be provided as a comma-separated list. When only a single account number is provided, any * characters in the string are wildcards, and match any characters. ")] = None, status : Optional[Status] = None, interest_product_id : Annotated[Optional[StrictStr], Field(description="Interest product ID that accounts associate with. Multiple IDs can be provided as a comma-separated list.")] = None, customer_type : Annotated[Optional[CustomerType], Field(description="Customer type of the account, BUSINESS or PERSONAL ")] = None, spend_control_ids : Annotated[Optional[conlist(StrictStr, max_items=10)], Field(description="Spend Control ID(s). Multiple IDs can be provided as a comma-separated list. Return only resources that use the specified Spend Controls. ")] = None, nickname : Annotated[Optional[StrictStr], Field(description="Nickname of the account ")] = None, customer_id : Annotated[Optional[StrictStr], Field(description="The customer's unique identifier")] = None, business_id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique identifier for the business. Multiple IDs can be provided as a comma-separated list. ")] = None, person_id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique identifier for the person. Multiple IDs can be provided as a comma-separated list. ")] = None, first_name : Optional[StrictStr] = None, last_name : Optional[StrictStr] = None, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for the returned accounts. ")] = None, **kwargs):  # noqa: E501
        """List accounts  # noqa: E501
        ...
        >>> thread = api.list_accounts_with_http_info(id, account_type, linked_account_id, overdraft_account_id, overflow_account_id, account_number, status, interest_product_id, customer_type, spend_control_ids, nickname, customer_id, business_id, person_id, first_name, last_name, tenant, limit, page_token, sort_by, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def update_account(self, account_id : Annotated[StrictStr, Field(..., description="Unique identifier for the account.")], account_depository : Annotated[AccountDepository, Field(..., description="Account to update")], **kwargs) -> AccountGenericResponse:  # noqa: E501
        ...
        >>> thread = api.update_account(account_id, account_depository, async_req=True)
        >>> result = thread.get()

        :param account_id: Unique identifier for the account. (required)
        :type account_id: str
        :param account_depository: Account to update (required)
        :type account_depository: AccountDepository
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_account_with_http_info(account_id, account_depository, **kwargs)  # noqa: E501

    @validate_arguments
    def update_account_with_http_info(self, account_id : Annotated[StrictStr, Field(..., description="Unique identifier for the account.")], account_depository : Annotated[AccountDepository, Field(..., description="Account to update")], **kwargs):  # noqa: E501
        """Update account  # noqa: E501
        ...
        >>> thread = api.update_account_with_http_info(account_id, account_depository, async_req=True)
        >>> result = thread.get()
        ...
        # process the body parameter
        _body_params = None
        if _params['account_depository']:
            _body_params = _params['account_depository']
