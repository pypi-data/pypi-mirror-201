...
class DocumentsApi(object):
    ...
    @validate_arguments
    def create_document_with_http_info(self, file : Annotated[StrictStr, Field(..., description="The file contents")], description : Annotated[Optional[StrictStr], Field(description="A description of the attached document")] = None, encryption : Optional[Encryption] = None, is_restricted : Annotated[Optional[StrictBool], Field(description="whether this document should be restricted (special permissions will be used to access restricted documents)")] = None, metadata : Annotated[Optional[Dict[str, Any]], Field(description="Optional field to store additional information about the resource. Intended to be used by the integrator to store non-sensitive data. ")] = None, name : Annotated[Optional[StrictStr], Field(description="A user-friendly name for the document")] = None, related_resource_id : Annotated[Optional[StrictStr], Field(description="The ID of the resource related to the document")] = None, related_resource_type : Optional[RelatedResourceType] = None, tenant : Annotated[Optional[StrictStr], Field(description="The id of the tenant containing the resource. ")] = None, type : Optional[DocumentType] = None, **kwargs):  # noqa: E501
        """Create a document  # noqa: E501
    ...
    @validate_arguments
    def get_document_version_contents(self, document_id : Annotated[StrictStr, Field(..., description="The unique identifier of the document.")], document_version : Annotated[StrictInt, Field(..., description="The document version.")], **kwargs) -> bytearray:  # noqa: E501
    ...
    def list_documents(self, id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique resource identifier")] = None, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, related_resource_type : Annotated[Optional[RelatedResourceType], Field(description="Return documents that are related to resources of the specified type")] = None, related_resource_id : Annotated[Optional[StrictStr], Field(description="Return documents that are related to resources with the specified ID")] = None, encryption : Annotated[Optional[StrictStr], Field(description="Whether the file should be encrypted and access restricted, e.g. if the file contains PII")] = None, type : Annotated[Optional[DocumentType], Field(description="The type of documents")] = None, **kwargs) -> DocumentList:  # noqa: E501
        ...
        >>> thread = api.list_documents(id, tenant, limit, page_token, related_resource_type, related_resource_id, encryption, type, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_documents_with_http_info(id, tenant, limit, page_token, related_resource_type, related_resource_id, encryption, type, **kwargs)  # noqa: E501

    @validate_arguments
    def list_documents_with_http_info(self, id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique resource identifier")] = None, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, related_resource_type : Annotated[Optional[RelatedResourceType], Field(description="Return documents that are related to resources of the specified type")] = None, related_resource_id : Annotated[Optional[StrictStr], Field(description="Return documents that are related to resources with the specified ID")] = None, encryption : Annotated[Optional[StrictStr], Field(description="Whether the file should be encrypted and access restricted, e.g. if the file contains PII")] = None, type : Annotated[Optional[DocumentType], Field(description="The type of documents")] = None, **kwargs):  # noqa: E501
        """List documents  # noqa: E501
        ...
        >>> thread = api.list_documents_with_http_info(id, tenant, limit, page_token, related_resource_type, related_resource_id, encryption, type, async_req=True)
        >>> result = thread.get()
