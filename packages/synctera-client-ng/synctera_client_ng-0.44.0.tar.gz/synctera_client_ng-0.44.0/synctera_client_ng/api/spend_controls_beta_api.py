...
class SpendControlsBetaApi(object):
    ...
    @validate_arguments
    def create_spend_control(self, spend_control : Annotated[SpendControl, Field(..., description="Details of the spend control to create")], tenant : Optional[StrictStr] = None, **kwargs) -> SpendControlResponse:  # noqa: E501
        ...
        >>> thread = api.create_spend_control(spend_control, tenant, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_spend_control_with_http_info(spend_control, tenant, **kwargs)  # noqa: E501

    @validate_arguments
    def create_spend_control_with_http_info(self, spend_control : Annotated[SpendControl, Field(..., description="Details of the spend control to create")], tenant : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """Create Spend Control  # noqa: E501
        ...
        >>> thread = api.create_spend_control_with_http_info(spend_control, tenant, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def list_spend_controls(self, account_id : Annotated[Optional[StrictStr], Field(description="return results matching this account ID")] = None, payment_type : Optional[PaymentType] = None, amount_limit : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results matching this amount limit")] = None, amount_limit_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit greater than or equal to this")] = None, amount_limit_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit less than or equal to this")] = None, num_related_accounts : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with this many accounts")] = None, num_related_accounts_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at least this many accounts")] = None, num_related_accounts_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at most this many accounts")] = None, is_active : Annotated[Optional[StrictBool], Field(description="return results that match this active status")] = None, name : Annotated[Optional[StrictStr], Field(description="return results that match this name")] = None, direction : Optional[SpendControlDirection] = None, tenant : Optional[StrictStr] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="return results with these comma-separated IDs")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for returned Spend Controls. ")] = None, **kwargs) -> SpendControlResponseList:  # noqa: E501
        ...
        >>> thread = api.list_spend_controls(account_id, payment_type, amount_limit, amount_limit_gte, amount_limit_lte, num_related_accounts, num_related_accounts_gte, num_related_accounts_lte, is_active, name, direction, tenant, id, sort_by, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_spend_controls_with_http_info(account_id, payment_type, amount_limit, amount_limit_gte, amount_limit_lte, num_related_accounts, num_related_accounts_gte, num_related_accounts_lte, is_active, name, direction, tenant, id, sort_by, **kwargs)  # noqa: E501
    ...
    def list_spend_controls_with_http_info(self, account_id : Annotated[Optional[StrictStr], Field(description="return results matching this account ID")] = None, payment_type : Optional[PaymentType] = None, amount_limit : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results matching this amount limit")] = None, amount_limit_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit greater than or equal to this")] = None, amount_limit_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results with an amount limit less than or equal to this")] = None, num_related_accounts : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with this many accounts")] = None, num_related_accounts_gte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at least this many accounts")] = None, num_related_accounts_lte : Annotated[Optional[conint(strict=True, ge=0)], Field(description="return results that are associated with at most this many accounts")] = None, is_active : Annotated[Optional[StrictBool], Field(description="return results that match this active status")] = None, name : Annotated[Optional[StrictStr], Field(description="return results that match this name")] = None, direction : Optional[SpendControlDirection] = None, tenant : Optional[StrictStr] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="return results with these comma-separated IDs")] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for returned Spend Controls. ")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_spend_controls_with_http_info(account_id, payment_type, amount_limit, amount_limit_gte, amount_limit_lte, num_related_accounts, num_related_accounts_gte, num_related_accounts_lte, is_active, name, direction, tenant, id, sort_by, async_req=True)
        >>> result = thread.get()
