...
class KYCKYBVerificationsApi(object):
    ...
    @validate_arguments
    def list_verifications1_with_http_info(self, id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique identifier for the resource. Multiple IDs can be provided as a comma-separated list. ")] = None, person_id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique identifier for the person. Multiple IDs can be provided as a comma-separated list. ")] = None, business_id : Annotated[Optional[conlist(StrictStr)], Field(description="Unique identifier for the business. Multiple IDs can be provided as a comma-separated list. ")] = None, verification_type : Annotated[Optional[conlist(VerificationType1)], Field(description="The type of verification run. Multiple values can be provided as a comma-separated list. ")] = None, result : Annotated[Optional[conlist(VerificationResult)], Field(description="The result of the verification that was run on the party. Multiple values can be provided as a comma-separated list. ")] = None, include_history : Annotated[Optional[StrictBool], Field(description="If true, include old (inactive) records as well.")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """List verifications  # noqa: E501
    ...
    def verify(self, verification_request : VerificationRequest, idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, **kwargs) -> VerifyResponse:  # noqa: E501
        ...
        >>> thread = api.verify(verification_request, idempotency_key, partner_ownership, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.verify_with_http_info(verification_request, idempotency_key, partner_ownership, **kwargs)  # noqa: E501
    ...
    def verify_with_http_info(self, verification_request : VerificationRequest, idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, partner_ownership : Annotated[Optional[StrictStr], Field(description="Return ownership resources for the specified partner. ")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.verify_with_http_info(verification_request, idempotency_key, partner_ownership, async_req=True)
        >>> result = thread.get()
