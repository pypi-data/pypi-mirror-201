...
class RelationshipList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipList:
        """Create an instance of RelationshipList from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RelationshipList.parse_obj(obj)

        _obj = RelationshipList.parse_obj({
