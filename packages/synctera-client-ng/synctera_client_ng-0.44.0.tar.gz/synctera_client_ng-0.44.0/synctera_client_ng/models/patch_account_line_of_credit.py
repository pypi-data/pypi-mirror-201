...
class PatchAccountLineOfCredit(BaseModel):
    ...
    __properties = ["access_status", "account_number", "account_number_masked", "account_purpose", "account_type", "application_id", "balances", "bank_routing", "creation_time", "currency", "customer_ids", "customer_type", "exchange_rate_type", "iban", "id", "is_account_pool", "is_ach_enabled", "is_card_enabled", "is_external_card_enabled", "is_p2p_enabled", "is_sar_enabled", "is_wire_enabled", "last_updated_time", "metadata", "nickname", "status", "swift_code", "tenant", "chargeoff_period", "credit_limit", "delinquency_period", "grace_period", "minimum_payment", "note"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchAccountLineOfCredit:
        """Create an instance of PatchAccountLineOfCredit from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchAccountLineOfCredit:
        """Create an instance of PatchAccountLineOfCredit from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchAccountLineOfCredit.parse_obj(obj)

        _obj = PatchAccountLineOfCredit.parse_obj({
