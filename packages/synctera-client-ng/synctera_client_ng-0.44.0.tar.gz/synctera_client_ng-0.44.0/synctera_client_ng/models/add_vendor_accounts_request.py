...
class AddVendorAccountsRequest(BaseModel):
    ...
    vendor_account_ids: Optional[conlist(constr(strict=True, min_length=1), min_items=1)] = Field(None, description="The list of vendor account IDs that the customer chose to link. For Plaid, these are `account_id`s. ")
