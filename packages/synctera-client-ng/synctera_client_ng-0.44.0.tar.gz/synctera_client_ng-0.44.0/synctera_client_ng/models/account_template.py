...
class AccountTemplate(BaseModel):
    ...
    description: Optional[StrictStr] = Field(None, description="User provided account template description")
    ...
    def from_dict(cls, obj: dict) -> AccountTemplate:
        ...
        _obj = AccountTemplate.parse_obj({
            ...
            "name": obj.get("name"),
            "template": TemplateFields.from_dict(obj.get("template")) if obj.get("template") is not None else None,
