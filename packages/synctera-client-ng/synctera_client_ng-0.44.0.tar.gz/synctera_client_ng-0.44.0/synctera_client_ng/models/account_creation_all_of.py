...
class AccountCreationAllOf(BaseModel):
    ...
    __properties = ["account_template_id", "relationships"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountCreationAllOf:
        """Create an instance of AccountCreationAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountCreationAllOf:
        """Create an instance of AccountCreationAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccountCreationAllOf.parse_obj(obj)

        _obj = AccountCreationAllOf.parse_obj({
