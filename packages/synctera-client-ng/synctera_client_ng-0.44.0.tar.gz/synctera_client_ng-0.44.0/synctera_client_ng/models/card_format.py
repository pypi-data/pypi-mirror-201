...
class CardFormat(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CardFormat:
        """Create an instance of CardFormat from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CardFormat:
        """Create an instance of CardFormat from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CardFormat.parse_obj(obj)

        _obj = CardFormat.parse_obj({
            "form": obj.get("form")
        })
        return _obj
