...
class AccountChargeSecured(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AccountChargeSecured:
        """Create an instance of AccountChargeSecured from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AccountChargeSecured:
        """Create an instance of AccountChargeSecured from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AccountChargeSecured.parse_obj(obj)

        _obj = AccountChargeSecured.parse_obj({
