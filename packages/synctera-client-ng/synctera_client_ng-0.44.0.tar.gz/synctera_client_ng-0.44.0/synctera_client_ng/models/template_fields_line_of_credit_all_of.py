...
class TemplateFieldsLineOfCreditAllOf(BaseModel):
    ...
    __properties = ["chargeoff_period", "delinquency_period", "grace_period", "interest_product_id", "minimum_payment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateFieldsLineOfCreditAllOf:
        """Create an instance of TemplateFieldsLineOfCreditAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateFieldsLineOfCreditAllOf:
        """Create an instance of TemplateFieldsLineOfCreditAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TemplateFieldsLineOfCreditAllOf.parse_obj(obj)

        _obj = TemplateFieldsLineOfCreditAllOf.parse_obj({
