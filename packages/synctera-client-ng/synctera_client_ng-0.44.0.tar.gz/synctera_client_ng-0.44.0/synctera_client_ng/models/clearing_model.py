...
class ClearingModel(BaseModel):
    ...
    original_transaction_id: StrictStr = Field(..., description="When you simulated a clearing the synchronous response would have included a `transaction.token`. That value should be used here.")
