...
class FinancialRequestModel(BaseModel):
    ...
    card_id: StrictStr = ...
    cash_back_amount: Optional[StrictInt] = Field(None, description="Cash back amount in the smallest whole denomination of the applicable currency (eg. For USD use cents)")
    ...
    __properties = ["amount", "card_acceptor", "card_id", "cash_back_amount", "is_pre_auth", "mid", "pin", "transaction_options"]
