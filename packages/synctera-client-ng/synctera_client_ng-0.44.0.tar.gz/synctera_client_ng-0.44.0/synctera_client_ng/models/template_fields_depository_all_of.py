...
class TemplateFieldsDepositoryAllOf(BaseModel):
    ...
    is_external_card_enabled: Optional[StrictBool] = Field(False, description="Enable external card transaction.")
    ...
    __properties = ["balance_ceiling", "balance_floor", "fee_product_ids", "interest_product_id", "is_ach_enabled", "is_card_enabled", "is_external_card_enabled", "is_p2p_enabled", "is_sar_enabled", "is_wire_enabled", "overdraft_limit", "spend_control_ids", "spending_limits"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemplateFieldsDepositoryAllOf:
        """Create an instance of TemplateFieldsDepositoryAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemplateFieldsDepositoryAllOf:
        """Create an instance of TemplateFieldsDepositoryAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TemplateFieldsDepositoryAllOf.parse_obj(obj)

        _obj = TemplateFieldsDepositoryAllOf.parse_obj({
