...
class Verification(BaseModel):
    ...
    verification_type: VerificationType1 = ...
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Verification:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Verification:
        """Create an instance of Verification from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Verification.parse_obj(obj)

        _obj = Verification.parse_obj({
