...
class ResponsePerson(BaseModel):
    ...
    creation_time: datetime = Field(..., description="The date and time the resource was created.")
    ...
    id: StrictStr = Field(..., description="Person's unique identifier.")
    ...
    last_updated_time: datetime = Field(..., description="The date and time the resource was last updated.")
    ...
    personal_ids: Optional[conlist(ResponsePersonalId)] = Field(None, description="> 🚧 Beta > This is a Beta property. Feedback from the community is welcome. We may make breaking changes to this property. Array of personal identifiers ")
    __properties = ["ban_status", "chosen_name", "creation_time", "dob", "email", "first_name", "id", "is_customer", "last_name", "last_updated_time", "legal_address", "metadata", "middle_name", "phone_number", "shipping_address", "ssn", "ssn_source", "status", "tenant", "verification_last_run", "verification_status", "personal_ids"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponsePerson:
        """Create an instance of ResponsePerson from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponsePerson:
        """Create an instance of ResponsePerson from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ResponsePerson.parse_obj(obj)

        _obj = ResponsePerson.parse_obj({
            ...
            "personal_ids": [ResponsePersonalId.from_dict(_item) for _item in obj.get("personal_ids")] if obj.get("personal_ids") is not None else None
        })
        return _obj
