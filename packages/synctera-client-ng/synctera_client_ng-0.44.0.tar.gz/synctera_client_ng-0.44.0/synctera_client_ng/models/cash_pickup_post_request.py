...
class CashPickupPostRequest(BaseModel):
    ...
    __properties = ["account_id", "amount", "business_id", "creation_time", "currency", "employee_customer_id", "id", "last_updated_time", "metadata", "pickup_time", "posted_amount", "posted_date", "reference_id", "scheduled_pickup_date", "transaction_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CashPickupPostRequest:
        """Create an instance of CashPickupPostRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CashPickupPostRequest:
        """Create an instance of CashPickupPostRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CashPickupPostRequest.parse_obj(obj)

        _obj = CashPickupPostRequest.parse_obj({
