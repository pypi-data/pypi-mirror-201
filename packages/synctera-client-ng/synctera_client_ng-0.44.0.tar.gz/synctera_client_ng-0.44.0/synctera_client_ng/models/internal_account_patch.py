...
class InternalAccountPatch(BaseModel):
    ...
    __properties = ["account_type", "description", "purpose"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalAccountPatch:
        """Create an instance of InternalAccountPatch from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalAccountPatch:
        """Create an instance of InternalAccountPatch from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return InternalAccountPatch.parse_obj(obj)

        _obj = InternalAccountPatch.parse_obj({
