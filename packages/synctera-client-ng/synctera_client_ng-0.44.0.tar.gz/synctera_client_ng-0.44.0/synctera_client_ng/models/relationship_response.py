...
class RelationshipResponse(BaseModel):
    ...
    __properties = ["business_id", "customer_id", "id", "person_id", "relationship_type", "account_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipResponse:
        """Create an instance of RelationshipResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return RelationshipResponse.parse_obj(obj)

        _obj = RelationshipResponse.parse_obj({
