...
class Business1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Business1:
        """Create an instance of Business1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Business1:
        """Create an instance of Business1 from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return Business1.parse_obj(obj)

        _obj = Business1.parse_obj({
