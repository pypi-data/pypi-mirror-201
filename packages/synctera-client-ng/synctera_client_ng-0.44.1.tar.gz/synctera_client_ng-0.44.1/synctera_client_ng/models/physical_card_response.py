...
class PhysicalCardResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalCardResponse:
        """Create an instance of PhysicalCardResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalCardResponse:
        """Create an instance of PhysicalCardResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PhysicalCardResponse.parse_obj(obj)

        _obj = PhysicalCardResponse.parse_obj({
            "form": obj.get("form"),
