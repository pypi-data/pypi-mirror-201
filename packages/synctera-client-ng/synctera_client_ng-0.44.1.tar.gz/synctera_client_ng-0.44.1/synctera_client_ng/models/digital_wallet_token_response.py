...
class DigitalWalletTokenResponse(BaseModel):
    ...
    def device_type_validate_enum(cls, v):
        ...
        if v not in ('MOBILE_PHONE', 'WATCH', 'TABLET', 'MOBILE_PHONE_OR_TABLET', 'VEHICLE', 'APPLIANCE', 'LAPTOP', 'GAMING_DEVICE', 'UNKNOWN'):
            raise ValueError("must be one of enum values ('MOBILE_PHONE', 'WATCH', 'TABLET', 'MOBILE_PHONE_OR_TABLET', 'VEHICLE', 'APPLIANCE', 'LAPTOP', 'GAMING_DEVICE', 'UNKNOWN')")
        return v
    ...
    def type_validate_enum(cls, v):
        ...
        if v not in ('APPLE_PAY', 'ANDROID_PAY', 'SAMSUNG_PAY'):
            raise ValueError("must be one of enum values ('APPLE_PAY', 'ANDROID_PAY', 'SAMSUNG_PAY')")
        return v
