...
class BusinessBusinessOwnerRelationship(BaseModel):
    """
    ...
    from_business_id: StrictStr = Field(..., description="Unique ID for the subject business. ")
    ...
    to_business_id: StrictStr = Field(..., description="Unique ID for the related business. ")
    __properties = ["additional_data", "creation_time", "from_business_id", "id", "last_updated_time", "metadata", "relationship_type", "to_business_id"]

    @validator('relationship_type')
    def relationship_type_validate_enum(cls, v):
        if v not in ('BENEFICIAL_OWNER_OF', 'MANAGING_PERSON_OF', 'OWNER_OF'):
            raise ValueError("must be one of enum values ('BENEFICIAL_OWNER_OF', 'MANAGING_PERSON_OF', 'OWNER_OF')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BusinessBusinessOwnerRelationship:
        """Create an instance of BusinessBusinessOwnerRelationship from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BusinessBusinessOwnerRelationship:
        """Create an instance of BusinessBusinessOwnerRelationship from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BusinessBusinessOwnerRelationship.parse_obj(obj)

        _obj = BusinessBusinessOwnerRelationship.parse_obj({
            "additional_data": AdditionalOwnerData.from_dict(obj.get("additional_data")) if obj.get("additional_data") is not None else None,
