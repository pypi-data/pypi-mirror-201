...
class PatchPersonBusinessOwnerRelationshipAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchPersonBusinessOwnerRelationshipAllOf:
        """Create an instance of PatchPersonBusinessOwnerRelationshipAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchPersonBusinessOwnerRelationshipAllOf:
        """Create an instance of PatchPersonBusinessOwnerRelationshipAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchPersonBusinessOwnerRelationshipAllOf.parse_obj(obj)

        _obj = PatchPersonBusinessOwnerRelationshipAllOf.parse_obj({
