...
class VirtualCardPlusStatus(BaseModel):
    """
    ...
    __properties = ["form", "account_id", "card_product_id", "creation_time", "customer_id", "emboss_name", "expiration_month", "expiration_time", "expiration_year", "id", "is_pin_set", "last_four", "last_modified_time", "metadata", "reissue_reason", "reissued_from_id", "reissued_to_id", "type", "card_status", "memo", "status_reason"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VirtualCardPlusStatus:
        """Create an instance of VirtualCardPlusStatus from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VirtualCardPlusStatus:
        """Create an instance of VirtualCardPlusStatus from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return VirtualCardPlusStatus.parse_obj(obj)

        _obj = VirtualCardPlusStatus.parse_obj({
            "form": obj.get("form"),
