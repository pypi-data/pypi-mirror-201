...
class InternalAccountPost(BaseModel):
    """
    InternalAccountPost
    """
    tenant: Optional[StrictStr] = Field(None, description="The id of the tenant containing the resource. Not included in external documentation. ")
    ...
    def gl_type_validate_enum(cls, v):
        ...
        if v not in ('ASSET', 'LIABILITY', 'EXPENSE', 'REVENUE'):
            raise ValueError("must be one of enum values ('ASSET', 'LIABILITY', 'EXPENSE', 'REVENUE')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalAccountPost:
        """Create an instance of InternalAccountPost from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalAccountPost:
        """Create an instance of InternalAccountPost from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return InternalAccountPost.parse_obj(obj)

        _obj = InternalAccountPost.parse_obj({
