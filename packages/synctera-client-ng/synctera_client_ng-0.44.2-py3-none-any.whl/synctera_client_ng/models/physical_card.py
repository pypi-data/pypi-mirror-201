...
class PhysicalCard(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalCard:
        """Create an instance of PhysicalCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalCard:
        """Create an instance of PhysicalCard from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PhysicalCard.parse_obj(obj)

        _obj = PhysicalCard.parse_obj({
            "form": obj.get("form"),
