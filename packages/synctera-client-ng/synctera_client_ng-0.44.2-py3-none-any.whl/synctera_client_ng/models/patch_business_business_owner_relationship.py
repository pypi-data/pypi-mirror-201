...
class PatchBusinessBusinessOwnerRelationship(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchBusinessBusinessOwnerRelationship:
        """Create an instance of PatchBusinessBusinessOwnerRelationship from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchBusinessBusinessOwnerRelationship:
        """Create an instance of PatchBusinessBusinessOwnerRelationship from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchBusinessBusinessOwnerRelationship.parse_obj(obj)

        _obj = PatchBusinessBusinessOwnerRelationship.parse_obj({
