...
class Disclosure1(BaseModel):
    ...
    def type_validate_enum(cls, v):
        if v not in ('ACH_AUTHORIZATION', 'CARDHOLDER_AGREEMENT', 'E_SIGN', 'KYC_DATA_COLLECTION', 'PRIVACY_NOTICE', 'REG_CC', 'REG_DD', 'REG_E', 'TERMS_AND_CONDITIONS'):
            raise ValueError("must be one of enum values ('ACH_AUTHORIZATION', 'CARDHOLDER_AGREEMENT', 'E_SIGN', 'KYC_DATA_COLLECTION', 'PRIVACY_NOTICE', 'REG_CC', 'REG_DD', 'REG_E', 'TERMS_AND_CONDITIONS')")
        return v
