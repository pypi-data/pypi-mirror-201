...
class PatchBusiness(BaseModel):
    ...
    def status_validate_enum(cls, v):
        ...
        if v not in ('PROSPECT', 'ACTIVE', 'FROZEN', 'SANCTION', 'DISSOLVED', 'CANCELLED', 'SUSPENDED', 'MERGED', 'INACTIVE', 'CONVERTED'):
            raise ValueError("must be one of enum values ('PROSPECT', 'ACTIVE', 'FROZEN', 'SANCTION', 'DISSOLVED', 'CANCELLED', 'SUSPENDED', 'MERGED', 'INACTIVE', 'CONVERTED')")
        return v
    ...
    def structure_validate_enum(cls, v):
        ...
        if v not in ('SOLE_PROPRIETORSHIP', 'PARTNERSHIP', 'LLC', 'CORPORATION', 'S_CORPORATION', 'NON_PROFIT', 'OTHER'):
            raise ValueError("must be one of enum values ('SOLE_PROPRIETORSHIP', 'PARTNERSHIP', 'LLC', 'CORPORATION', 'S_CORPORATION', 'NON_PROFIT', 'OTHER')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchBusiness:
        """Create an instance of PatchBusiness from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchBusiness:
        """Create an instance of PatchBusiness from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchBusiness.parse_obj(obj)

        _obj = PatchBusiness.parse_obj({
