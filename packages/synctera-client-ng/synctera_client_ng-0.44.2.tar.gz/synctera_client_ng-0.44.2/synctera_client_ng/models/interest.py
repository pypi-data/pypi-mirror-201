...
class Interest(BaseModel):
    ...
    rates: conlist(RateDetails) = Field(..., description="A list of interest rate. Date intervals between valid_from and valid_to expect to have no overlap. ")
    ...
    def product_type_validate_enum(cls, v):
        if v not in ('INTEREST', 'FEE'):
            raise ValueError("must be one of enum values ('INTEREST', 'FEE')")
        return v
