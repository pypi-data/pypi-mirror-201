...
class PhysicalCardIssuanceRequest(BaseModel):
    """
    ...
    __properties = ["form", "account_id", "card_product_id", "creation_time", "customer_id", "emboss_name", "expiration_month", "expiration_time", "expiration_year", "id", "is_pin_set", "last_four", "last_modified_time", "metadata", "reissue_reason", "reissued_from_id", "reissued_to_id", "type", "card_image_id", "shipping"]

    @validator('form')
    def form_validate_enum(cls, v):
        if v not in ('PHYSICAL'):
            raise ValueError("must be one of enum values ('PHYSICAL')")
        return v
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalCardIssuanceRequest:
        """Create an instance of PhysicalCardIssuanceRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalCardIssuanceRequest:
        """Create an instance of PhysicalCardIssuanceRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PhysicalCardIssuanceRequest.parse_obj(obj)

        _obj = PhysicalCardIssuanceRequest.parse_obj({
            "form": obj.get("form"),
