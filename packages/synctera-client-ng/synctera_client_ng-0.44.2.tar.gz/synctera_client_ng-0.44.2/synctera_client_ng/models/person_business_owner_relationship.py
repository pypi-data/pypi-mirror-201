...
class PersonBusinessOwnerRelationship(BaseModel):
    """
    ...
    from_person_id: StrictStr = Field(..., description="Unique ID for the subject person. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonBusinessOwnerRelationship:
        """Create an instance of PersonBusinessOwnerRelationship from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonBusinessOwnerRelationship:
        """Create an instance of PersonBusinessOwnerRelationship from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PersonBusinessOwnerRelationship.parse_obj(obj)

        _obj = PersonBusinessOwnerRelationship.parse_obj({
