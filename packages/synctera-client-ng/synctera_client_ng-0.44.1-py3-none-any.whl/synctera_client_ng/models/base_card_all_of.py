...
class BaseCardAllOf(BaseModel):
    ...
    __properties = ["account_id", "card_product_id", "creation_time", "customer_id", "emboss_name", "expiration_month", "expiration_time", "expiration_year", "id", "is_pin_set", "last_four", "last_modified_time", "metadata", "reissue_reason", "reissued_from_id", "reissued_to_id", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseCardAllOf:
        """Create an instance of BaseCardAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseCardAllOf:
        """Create an instance of BaseCardAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BaseCardAllOf.parse_obj(obj)

        _obj = BaseCardAllOf.parse_obj({
