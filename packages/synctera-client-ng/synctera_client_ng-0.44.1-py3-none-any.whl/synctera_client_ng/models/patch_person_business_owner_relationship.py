...
class PatchPersonBusinessOwnerRelationship(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchPersonBusinessOwnerRelationship:
        """Create an instance of PatchPersonBusinessOwnerRelationship from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchPersonBusinessOwnerRelationship:
        """Create an instance of PatchPersonBusinessOwnerRelationship from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchPersonBusinessOwnerRelationship.parse_obj(obj)

        _obj = PatchPersonBusinessOwnerRelationship.parse_obj({
