...
class PersonBusinessRelationship(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PersonBusinessRelationship:
        """Create an instance of PersonBusinessRelationship from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PersonBusinessRelationship:
        """Create an instance of PersonBusinessRelationship from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PersonBusinessRelationship.parse_obj(obj)

        _obj = PersonBusinessRelationship.parse_obj({
