...
class PatchBusinessBusinessOwnerRelationshipAllOf(BaseModel):
    """
    PatchBusinessBusinessOwnerRelationshipAllOf
    """
    additional_data: Optional[AdditionalOwnerData] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PatchBusinessBusinessOwnerRelationshipAllOf:
        """Create an instance of PatchBusinessBusinessOwnerRelationshipAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PatchBusinessBusinessOwnerRelationshipAllOf:
        """Create an instance of PatchBusinessBusinessOwnerRelationshipAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PatchBusinessBusinessOwnerRelationshipAllOf.parse_obj(obj)

        _obj = PatchBusinessBusinessOwnerRelationshipAllOf.parse_obj({
