...
class BaseCard(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseCard:
        """Create an instance of BaseCard from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseCard:
        """Create an instance of BaseCard from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return BaseCard.parse_obj(obj)

        _obj = BaseCard.parse_obj({
            "form": obj.get("form"),
