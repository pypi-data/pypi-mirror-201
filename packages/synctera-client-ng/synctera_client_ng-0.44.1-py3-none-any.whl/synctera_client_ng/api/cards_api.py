...
class CardsApi(object):
    ...
    @validate_arguments
    def get_client_single_use_token(self, single_use_token_request : Annotated[SingleUseTokenRequest, Field(..., description="User token details")], idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, **kwargs) -> SingleUseTokenResponse:  # noqa: E501
        ...
        >>> thread = api.get_client_single_use_token(single_use_token_request, idempotency_key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_client_single_use_token_with_http_info(single_use_token_request, idempotency_key, **kwargs)  # noqa: E501

    @validate_arguments
    def get_client_single_use_token_with_http_info(self, single_use_token_request : Annotated[SingleUseTokenRequest, Field(..., description="User token details")], idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, **kwargs):  # noqa: E501
        """Get single-use token  # noqa: E501
        ...
        >>> thread = api.get_client_single_use_token_with_http_info(single_use_token_request, idempotency_key, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def issue_card(self, card_issuance_request : Annotated[CardIssuanceRequest, Field(..., description="Card to issue")], force : Optional[StrictBool] = None, idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, **kwargs) -> CardResponse:  # noqa: E501
        ...
        >>> thread = api.issue_card(card_issuance_request, force, idempotency_key, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.issue_card_with_http_info(card_issuance_request, force, idempotency_key, **kwargs)  # noqa: E501

    @validate_arguments
    def issue_card_with_http_info(self, card_issuance_request : Annotated[CardIssuanceRequest, Field(..., description="Card to issue")], force : Optional[StrictBool] = None, idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, **kwargs):  # noqa: E501
        """Issue a Card  # noqa: E501
        ...
        >>> thread = api.issue_card_with_http_info(card_issuance_request, force, idempotency_key, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def list_card_products(self, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, tenant : Optional[StrictStr] = None, form : Annotated[Optional[Form], Field(description="The format of the card")] = None, **kwargs) -> CardProductListResponse:  # noqa: E501
        """List Card Products  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_card_products(limit, page_token, tenant, form, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_card_products_with_http_info(limit, page_token, tenant, form, **kwargs)  # noqa: E501

    @validate_arguments
    def list_card_products_with_http_info(self, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, tenant : Optional[StrictStr] = None, form : Annotated[Optional[Form], Field(description="The format of the card")] = None, **kwargs):  # noqa: E501
        """List Card Products  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_card_products_with_http_info(limit, page_token, tenant, form, async_req=True)
        >>> result = thread.get()
    ...
    def list_cards(self, tenant : Optional[StrictStr] = None, customer_id : Optional[StrictStr] = None, account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Account ID(s). Multiple IDs can be provided as a comma-separated list.")] = None, emboss_name : Annotated[Optional[StrictStr], Field(description="emboss name")] = None, last_four : Annotated[Optional[constr(strict=True)], Field(description="The last 4 digits of the card PAN")] = None, expiration_date : Annotated[Optional[date], Field(description="The date representing when the card would expire at")] = None, card_type : Annotated[Optional[StrictStr], Field(description="Indicates the type of card")] = None, card_brand : Annotated[Optional[CardBrand], Field(description="The brand of a card product")] = None, form : Annotated[Optional[Form], Field(description="The format of the card")] = None, card_product_id : Optional[StrictStr] = None, card_status : Annotated[Optional[CardStatus], Field(description="The status of a card")] = None, postal_code : Annotated[Optional[StrictStr], Field(description="The postal code of a card user")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for the returned cards. ")] = None, **kwargs) -> CardListResponse:  # noqa: E501
        ...
        >>> thread = api.list_cards(tenant, customer_id, account_id, emboss_name, last_four, expiration_date, card_type, card_brand, form, card_product_id, card_status, postal_code, limit, page_token, sort_by, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_cards_with_http_info(tenant, customer_id, account_id, emboss_name, last_four, expiration_date, card_type, card_brand, form, card_product_id, card_status, postal_code, limit, page_token, sort_by, **kwargs)  # noqa: E501

    @validate_arguments
    def list_cards_with_http_info(self, tenant : Optional[StrictStr] = None, customer_id : Optional[StrictStr] = None, account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Account ID(s). Multiple IDs can be provided as a comma-separated list.")] = None, emboss_name : Annotated[Optional[StrictStr], Field(description="emboss name")] = None, last_four : Annotated[Optional[constr(strict=True)], Field(description="The last 4 digits of the card PAN")] = None, expiration_date : Annotated[Optional[date], Field(description="The date representing when the card would expire at")] = None, card_type : Annotated[Optional[StrictStr], Field(description="Indicates the type of card")] = None, card_brand : Annotated[Optional[CardBrand], Field(description="The brand of a card product")] = None, form : Annotated[Optional[Form], Field(description="The format of the card")] = None, card_product_id : Optional[StrictStr] = None, card_status : Annotated[Optional[CardStatus], Field(description="The status of a card")] = None, postal_code : Annotated[Optional[StrictStr], Field(description="The postal code of a card user")] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, sort_by : Annotated[Optional[conlist(StrictStr)], Field(description="Specifies the sort order for the returned cards. ")] = None, **kwargs):  # noqa: E501
        """List Cards  # noqa: E501
        ...
        >>> thread = api.list_cards_with_http_info(tenant, customer_id, account_id, emboss_name, last_four, expiration_date, card_type, card_brand, form, card_product_id, card_status, postal_code, limit, page_token, sort_by, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('card_type') is not None:  # noqa: E501
            _query_params.append(('card_type', _params['card_type'].value))
    ...
    @validate_arguments
    def list_gateways(self, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, **kwargs) -> GatewayListResponse:  # noqa: E501
        ...
        >>> thread = api.list_gateways(tenant, limit, page_token, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_gateways_with_http_info(tenant, limit, page_token, **kwargs)  # noqa: E501

    @validate_arguments
    def list_gateways_with_http_info(self, tenant : Optional[StrictStr] = None, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, **kwargs):  # noqa: E501
        """List Gateways  # noqa: E501
        ...
        >>> thread = api.list_gateways_with_http_info(tenant, limit, page_token, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def upload_card_image_data(self, card_image_id : StrictStr, body : Annotated[StrictStr, Field(..., description="Binary image data")], idempotency_key : Annotated[Optional[StrictStr], Field(description="An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.")] = None, **kwargs) -> CardImageDetails:  # noqa: E501
