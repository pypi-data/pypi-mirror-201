...
class PaymentSchedulesApi(object):
    ...
    @validate_arguments
    def list_payment_schedules(self, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="IDs. Multiple IDs can be provided as a comma-separated list.")] = None, description : Annotated[Optional[StrictStr], Field(description="Payment schedule description. String can be provided with wildcard.")] = None, account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Originating account IDs. Multiple IDs can be provided as a comma-separated list.")] = None, customer_id : Annotated[Optional[conlist(StrictStr)], Field(description="The IDs of customers who created the payment schedules. Multiple IDs can be provided as a comma-separated list.")] = None, **kwargs) -> PaymentScheduleList:  # noqa: E501
        ...
        >>> thread = api.list_payment_schedules(limit, page_token, id, description, account_id, customer_id, async_req=True)
        >>> result = thread.get()
        ...
        :type id: List[str]
        :param description: Payment schedule description. String can be provided with wildcard.
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_payment_schedules_with_http_info(limit, page_token, id, description, account_id, customer_id, **kwargs)  # noqa: E501
    ...
    def list_payment_schedules_with_http_info(self, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="IDs. Multiple IDs can be provided as a comma-separated list.")] = None, description : Annotated[Optional[StrictStr], Field(description="Payment schedule description. String can be provided with wildcard.")] = None, account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Originating account IDs. Multiple IDs can be provided as a comma-separated list.")] = None, customer_id : Annotated[Optional[conlist(StrictStr)], Field(description="The IDs of customers who created the payment schedules. Multiple IDs can be provided as a comma-separated list.")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_payment_schedules_with_http_info(limit, page_token, id, description, account_id, customer_id, async_req=True)
        >>> result = thread.get()
    ...
    @validate_arguments
    def list_payments(self, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="IDs. Multiple IDs can be provided as a comma-separated list.")] = None, description : Annotated[Optional[StrictStr], Field(description="Payment schedule description. String can be provided with wildcard.")] = None, schedule_id : Annotated[Optional[conlist(StrictStr)], Field(description="Payment schedule IDs. Multiple IDs can be provided as a comma-separated list.")] = None, payment_type : Annotated[Optional[StrictStr], Field(description="Payment type")] = None, account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Originating account IDs. Multiple IDs can be provided as a comma-separated list.")] = None, customer_id : Annotated[Optional[conlist(StrictStr)], Field(description="The IDs of customers who created the payment schedules. Multiple IDs can be provided as a comma-separated list.")] = None, start_date : Annotated[Optional[date], Field(description="Payments that the execution date is later than the start date (inclusvie)")] = None, end_date : Annotated[Optional[date], Field(description="Payments that the execution date is earlier than the end date (exclusvie)")] = None, **kwargs) -> PaymentList:  # noqa: E501
        ...
        >>> thread = api.list_payments(limit, page_token, id, description, schedule_id, payment_type, account_id, customer_id, start_date, end_date, async_req=True)
        >>> result = thread.get()
        ...
        :param customer_id: The IDs of customers who created the payment schedules. Multiple IDs can be provided as a comma-separated list.
        :type customer_id: List[str]
        :param start_date: Payments that the execution date is later than the start date (inclusvie)
        :type start_date: date
        :param end_date: Payments that the execution date is earlier than the end date (exclusvie)
        :type end_date: date
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_payments_with_http_info(limit, page_token, id, description, schedule_id, payment_type, account_id, customer_id, start_date, end_date, **kwargs)  # noqa: E501
    ...
    def list_payments_with_http_info(self, limit : Optional[conint(strict=True, ge=1)] = None, page_token : Optional[StrictStr] = None, id : Annotated[Optional[conlist(StrictStr)], Field(description="IDs. Multiple IDs can be provided as a comma-separated list.")] = None, description : Annotated[Optional[StrictStr], Field(description="Payment schedule description. String can be provided with wildcard.")] = None, schedule_id : Annotated[Optional[conlist(StrictStr)], Field(description="Payment schedule IDs. Multiple IDs can be provided as a comma-separated list.")] = None, payment_type : Annotated[Optional[StrictStr], Field(description="Payment type")] = None, account_id : Annotated[Optional[conlist(StrictStr)], Field(description="Originating account IDs. Multiple IDs can be provided as a comma-separated list.")] = None, customer_id : Annotated[Optional[conlist(StrictStr)], Field(description="The IDs of customers who created the payment schedules. Multiple IDs can be provided as a comma-separated list.")] = None, start_date : Annotated[Optional[date], Field(description="Payments that the execution date is later than the start date (inclusvie)")] = None, end_date : Annotated[Optional[date], Field(description="Payments that the execution date is earlier than the end date (exclusvie)")] = None, **kwargs):  # noqa: E501
        ...
        >>> thread = api.list_payments_with_http_info(limit, page_token, id, description, schedule_id, payment_type, account_id, customer_id, start_date, end_date, async_req=True)
        >>> result = thread.get()
        ...
        if _params.get('payment_type') is not None:  # noqa: E501
            _query_params.append(('payment_type', _params['payment_type'].value))
