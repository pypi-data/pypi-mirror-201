...
from query_tool.services.register import init, register_callback, get_component_rerender_count, set_component_rerender_count
...
def query_tool(key:str = "query-tool", query: str = "", databases: List[str] = [], tables: List[dict] = [], columns: List[dict] = [], on_database_change=None, on_table_change=None, on_generate_query=None, on_copy_query=None ):
