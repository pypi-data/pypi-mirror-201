...
with open('./PPshare/futures/exchange_symbol_list.pk', 'wb') as f:
    pickle.dump(exchange_symbol_list, f)

with open('./PPshare/futures/exchange_symbol_value_list.pk', 'wb') as f:
    pickle.dump(exchange_symbol_value_list, f)

with open('./PPshare/futures/code_exchange_name_dict.pk', 'wb') as f:
