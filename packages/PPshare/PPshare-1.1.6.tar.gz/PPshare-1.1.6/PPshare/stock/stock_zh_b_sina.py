...
from PPshare.utils import demjson
from py_mini_racer import py_mini_racer
import pandas as pd
import requests
from tqdm import tqdm

from PPshare.stock.cons import (
    zh_sina_a_stock_url,
...
if __name__ == "__main__":
    stock_zh_b_daily_hfq_df_one = stock_zh_b_daily(symbol="sh900901", start_date="20171103", end_date="20210908", adjust="")
    print(stock_zh_b_daily_hfq_df_one)

    stock_zh_b_daily_hfq_df_three = stock_zh_b_daily(symbol="sh900901", start_date="19900103", end_date="20210118", adjust="qfq")
    print(stock_zh_b_daily_hfq_df_three)

    stock_zh_b_daily_hfq_df_two = stock_zh_b_daily(symbol="sh900901", start_date="20101103", end_date="20210510")
    ...
    stock_zh_b_daily_hfq_factor_df = stock_zh_b_daily(symbol="sh900901", adjust="hfq-factor")
    ...
    stock_zh_b_daily_qfq_df = stock_zh_b_daily(symbol="sh900901", start_date="20101103", end_date="20201116", adjust="qfq")
    print(stock_zh_b_daily_qfq_df)

    stock_zh_b_daily_hfq_df = stock_zh_b_daily(symbol="sh900901", start_date='20201103', end_date='20201116', adjust="hfq")
    ...
    stock_zh_b_minute_df = stock_zh_b_minute(symbol='sh900901', period='1', adjust="qfq")
    print(stock_zh_b_minute_df)
