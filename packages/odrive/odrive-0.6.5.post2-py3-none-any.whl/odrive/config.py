...
class MotorCalibration(Action):
    ...
    def run(self):
        ...
        self.motor_config['phase_resistance'] = axis.config.motor.phase_resistance
        self.motor_config['phase_inductance'] = axis.config.motor.phase_inductance
    ...
    def get_status(self, odrives):
        ...
        for net in self.get_nets(NetType.RS485):
            ...
            for enc_ref in enc_refs:
                ...
                if encoder_config.protocol() not in ('amt21', 'amt21o'):
                ...
                amt21_encoder_group_config['config']['event_driven_mode'] = True if encoder_config.protocol() == 'amt21o' else False
