...
class GetStorageSpecifierOp(_ods_ir.OpView):
  ...
  def __init__(self, result, specifier, specifierKind, *, dim=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
  ...
  @builtins.property
  def dim(self):
    if "dim" not in self.operation.attributes:
      return None
  ...
  def dim(self, value):
    ...
    elif "dim" in self.operation.attributes:
      del self.operation.attributes["dim"]
...
class PackOp(_ods_ir.OpView):
  ...
  def __init__(self, result, data, indices, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class SetStorageSpecifierOp(_ods_ir.OpView):
  ...
  def __init__(self, specifier, specifierKind, value, *, dim=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
@_ods_cext.register_operation(_Dialect)
@_ods_extend_opview_class(_ods_ext_module)
class ToIndicesBufferOp(_ods_ir.OpView):
  OPERATION_NAME = "sparse_tensor.indices_buffer"
...
class UnpackOp(_ods_ir.OpView):
  ...
  def __init__(self, data, indices, nnz, tensor, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
