...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='deepproto.proto.common.v1',
  syntax='proto3',
...
_ANYVALUE = _descriptor.Descriptor(
  name='AnyValue',
  full_name='deepproto.proto.common.v1.AnyValue',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='string_value', full_name='deepproto.proto.common.v1.AnyValue.string_value', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='bool_value', full_name='deepproto.proto.common.v1.AnyValue.bool_value', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='int_value', full_name='deepproto.proto.common.v1.AnyValue.int_value', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='double_value', full_name='deepproto.proto.common.v1.AnyValue.double_value', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='array_value', full_name='deepproto.proto.common.v1.AnyValue.array_value', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='kvlist_value', full_name='deepproto.proto.common.v1.AnyValue.kvlist_value', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='bytes_value', full_name='deepproto.proto.common.v1.AnyValue.bytes_value', index=6,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='value', full_name='deepproto.proto.common.v1.AnyValue.value',
...
_ARRAYVALUE = _descriptor.Descriptor(
  name='ArrayValue',
  full_name='deepproto.proto.common.v1.ArrayValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='values', full_name='deepproto.proto.common.v1.ArrayValue.values', index=0,
...
_KEYVALUELIST = _descriptor.Descriptor(
  name='KeyValueList',
  full_name='deepproto.proto.common.v1.KeyValueList',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='values', full_name='deepproto.proto.common.v1.KeyValueList.values', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYVALUE = _descriptor.Descriptor(
  name='KeyValue',
  full_name='deepproto.proto.common.v1.KeyValue',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='deepproto.proto.common.v1.KeyValue.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='value', full_name='deepproto.proto.common.v1.KeyValue.value', index=1,
...
AnyValue = _reflection.GeneratedProtocolMessageType('AnyValue', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:deepproto.proto.common.v1.AnyValue)
  })
...
ArrayValue = _reflection.GeneratedProtocolMessageType('ArrayValue', (_message.Message,), {
  ...
  '__module__' : 'deepproto.proto.common.v1.common_pb2'
  # @@protoc_insertion_point(class_scope:deepproto.proto.common.v1.ArrayValue)
  })
...
KeyValueList = _reflection.GeneratedProtocolMessageType('KeyValueList', (_message.Message,), {
  ...
  '__module__' : 'deepproto.proto.common.v1.common_pb2'
  # @@protoc_insertion_point(class_scope:deepproto.proto.common.v1.KeyValueList)
  })
...
KeyValue = _reflection.GeneratedProtocolMessageType('KeyValue', (_message.Message,), {
  ...
  '__module__' : 'deepproto.proto.common.v1.common_pb2'
  # @@protoc_insertion_point(class_scope:deepproto.proto.common.v1.KeyValue)
  })
