...
class GeographicCounts(object):
    ...
    """
    swagger_types = {
        'outcome_count_by_zip': 'list[ZipData]',
        'outcome_count_by_state': 'list[StateData]',
        'intervention_count_by_zip': 'list[ZipData]',
        'intervention_count_by_state': 'list[StateData]',
        'cohort_count_by_zip': 'list[ZipData]',
        'cohort_count_by_state': 'list[StateData]'
    }
