...
class ModelJobsApi(object):
    ...
    def model_job_controller_generate_odhq(self, id, **kwargs):  # noqa: E501
        """Execute Outcome Distribution Histogram Query  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_job_controller_generate_odhq(id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.model_job_controller_generate_odhq_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.model_job_controller_generate_odhq_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def model_job_controller_generate_odhq_with_http_info(self, id, **kwargs):  # noqa: E501
        """Execute Outcome Distribution Histogram Query  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.model_job_controller_generate_odhq_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method model_job_controller_generate_odhq" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `model_job_controller_generate_odhq`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/model-jobs/{id}/generate-odhq', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
