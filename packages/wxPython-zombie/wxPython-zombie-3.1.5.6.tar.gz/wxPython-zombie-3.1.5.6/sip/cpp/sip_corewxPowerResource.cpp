...
#include "sipAPI_core.h"
        ...
        #include <wx/power.h>
    #line 14 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpxydly97o\\build\\_core/sip_corewxPowerResource.cpp"
...
extern "C" {static void array_delete_wxPowerResource(void *);}
static void array_delete_wxPowerResource(void *sipCpp)
{
    delete[] reinterpret_cast< ::wxPowerResource *>(sipCpp);
}
...
sipClassTypeDef sipTypeDef__core_wxPowerResource = {
    ...
    SIP_NULLPTR,
    SIP_NULLPTR,
    array_delete_wxPowerResource,
    sizeof ( ::wxPowerResource),
};
