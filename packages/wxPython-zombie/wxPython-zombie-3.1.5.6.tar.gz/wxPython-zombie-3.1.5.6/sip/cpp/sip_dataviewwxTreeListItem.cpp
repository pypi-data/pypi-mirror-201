...
#include "sipAPI_dataview.h"
    ...
    #line 14 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpap80_al5\\build\\_dataview/sip_dataviewwxTreeListItem.cpp"

    int _wxTreeListItem___nonzero__(wxTreeListItem* self)
    {
        return self->IsOk();
    }
    #line 92 "C:\\Users\\stephan\\Desktop\\wxPython-zombie\\sip\\gen\\treelist.sip"
    int _wxTreeListItem___bool__(wxTreeListItem* self)
    {
        return self->IsOk();
    }
    #line 110 "C:\\Users\\stephan\\Desktop\\wxPython-zombie\\sip\\gen\\treelist.sip"
    long _wxTreeListItem___hash__(wxTreeListItem* self)
    {
        return (long)self->GetID();
    }
    #line 128 "C:\\Users\\stephan\\Desktop\\wxPython-zombie\\sip\\gen\\treelist.sip"
    bool _wxTreeListItem___eq__(wxTreeListItem* self, wxTreeListItem* other)
    {
        return other ? (self->GetID() == other->GetID()) : false;
    }
    #line 146 "C:\\Users\\stephan\\Desktop\\wxPython-zombie\\sip\\gen\\treelist.sip"
    bool _wxTreeListItem___ne__(wxTreeListItem* self, wxTreeListItem* other)
    {
        return other ? (self->GetID() != other->GetID()) : true;
    }
    #line 41 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpap80_al5\\build\\_dataview/sip_dataviewwxTreeListItem.cpp"
...
PyDoc_STRVAR(doc_wxTreeListItem___nonzero__, "__nonzero__() -> int");
...
static PyObject *meth_wxTreeListItem___nonzero__(PyObject *sipSelf, PyObject *sipArgs)
{
    ...
    #line 100 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpap80_al5\\build\\_dataview/sip_dataviewwxTreeListItem.cpp"
...
static PyObject *slot_wxTreeListItem___ne__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        Py_END_ALLOW_THREADS
        if (PyErr_Occurred()) sipIsErr = 1;
    #line 139 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpap80_al5\\build\\_dataview/sip_dataviewwxTreeListItem.cpp"
...
static PyObject *slot_wxTreeListItem___eq__(PyObject *sipSelf,PyObject *sipArg)
{
...

    {
        ...
        Py_END_ALLOW_THREADS
        if (PyErr_Occurred()) sipIsErr = 1;
    #line 181 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpap80_al5\\build\\_dataview/sip_dataviewwxTreeListItem.cpp"
...
static long slot_wxTreeListItem___hash__(PyObject *sipSelf)
{
...

    {
        ...
        Py_END_ALLOW_THREADS
        if (PyErr_Occurred()) sipIsErr = 1;
    #line 219 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpap80_al5\\build\\_dataview/sip_dataviewwxTreeListItem.cpp"
...
static int slot_wxTreeListItem___bool__(PyObject *sipSelf)
{
...

    {
        ...
        Py_END_ALLOW_THREADS
        if (PyErr_Occurred()) sipIsErr = 1;
    #line 252 "C:\\Users\\stephan\\AppData\\Local\\Temp\\tmpap80_al5\\build\\_dataview/sip_dataviewwxTreeListItem.cpp"
