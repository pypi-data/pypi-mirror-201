...
released on 1 Jan 2023, `waf 2.0.25`__. Also the latest version of, a Python
bindings generator for C/C++ libraries, SIP is used, released on 6 Feb 2023,
`sip 6.7.7`__. The source distribution format that is now used, is specified
...
glu, sdl2 and pyenv. With pyenv, Python 3.11.2 was installed and used. The build
