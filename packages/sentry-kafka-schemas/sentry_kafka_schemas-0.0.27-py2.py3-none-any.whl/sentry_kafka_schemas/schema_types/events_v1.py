from typing import Any, Dict, Union, TypedDict, List, Tuple, Literal
...
class _BaseGen348818(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
