from typing import List, Any, Literal, Dict, TypedDict, Tuple, Union
...
class _BaseGen251897(TypedDict, total=False):
    transaction_id: str
    project_id: Required[int]
    """Required property"""
