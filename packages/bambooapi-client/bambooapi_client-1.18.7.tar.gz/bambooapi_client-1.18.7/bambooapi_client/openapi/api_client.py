...
from bambooapi_client.openapi import rest
from bambooapi_client.openapi.configuration import Configuration
from bambooapi_client.openapi.exceptions import ApiTypeError, ApiValueError, ApiException
from bambooapi_client.openapi.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ActivationsApi()
        api_instance.create_activation  # this is an instance of the class Endpoint
        api_instance.create_activation()  # this invokes api_instance.create_activation.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.create_activation.callable or self.callable in this class
