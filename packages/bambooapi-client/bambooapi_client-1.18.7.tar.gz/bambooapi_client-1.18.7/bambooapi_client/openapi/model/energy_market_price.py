...
class EnergyMarketPrice(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, energy_price, *args, **kwargs):  # noqa: E501
        """EnergyMarketPrice - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, energy_price, *args, **kwargs):  # noqa: E501
        """EnergyMarketPrice - a model defined in OpenAPI
