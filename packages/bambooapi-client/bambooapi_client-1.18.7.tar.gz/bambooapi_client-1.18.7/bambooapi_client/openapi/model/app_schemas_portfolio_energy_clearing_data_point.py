...
class AppSchemasPortfolioEnergyClearingDataPoint(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, price, energy, *args, **kwargs):  # noqa: E501
        """AppSchemasPortfolioEnergyClearingDataPoint - a model defined in OpenAPI

        Args:
            time (datetime):
            price (float): €/kWh (usually >0)
            energy (float): kWh (>0 buying, <0 selling)
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, price, energy, *args, **kwargs):  # noqa: E501
        """AppSchemasPortfolioEnergyClearingDataPoint - a model defined in OpenAPI
