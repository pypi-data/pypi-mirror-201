...
def lazy_import():
    ...
    globals()['SiteAvailabilityEnum'] = SiteAvailabilityEnum


class SiteAvailabilityListItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'available': (SiteAvailabilityEnum,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_id, available, *args, **kwargs):  # noqa: E501
        """SiteAvailabilityListItem - a model defined in OpenAPI

        Args:
            site_id (int):
            available (SiteAvailabilityEnum):
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_id, available, *args, **kwargs):  # noqa: E501
        """SiteAvailabilityListItem - a model defined in OpenAPI
