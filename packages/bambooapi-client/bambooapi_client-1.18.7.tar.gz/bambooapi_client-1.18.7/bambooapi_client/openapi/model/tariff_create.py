...
class TariffCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tariff_name, display_name, country_code, *args, **kwargs):  # noqa: E501
        """TariffCreate - a model defined in OpenAPI

        Args:
            tariff_name (str):
            display_name (str): For example, '3.0TD', '6.1TD', etc.
    ...
    @convert_js_args_to_python_args
    def __init__(self, tariff_name, display_name, country_code, *args, **kwargs):  # noqa: E501
        """TariffCreate - a model defined in OpenAPI
