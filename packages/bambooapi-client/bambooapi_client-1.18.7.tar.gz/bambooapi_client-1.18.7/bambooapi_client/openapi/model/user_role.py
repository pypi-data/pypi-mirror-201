...
class UserRole(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'ASSETINTEGRATOR': "AssetIntegrator",
            'AGGREGATOR': "Aggregator",
            'ENERGYMANAGER': "EnergyManager",
            'FLEXUMER': "Flexumer",
            'SITEMANAGER': "SiteManager",
            'PLATFORMSERVICERUNNER': "PlatformServiceRunner",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["PlatformAdmin", "AssetIntegrator", "Aggregator", "EnergyManager", "Flexumer", "SiteManager", "PlatformServiceRunner", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["PlatformAdmin", "AssetIntegrator", "Aggregator", "EnergyManager", "Flexumer", "SiteManager", "PlatformServiceRunner", ]  # noqa: E501
