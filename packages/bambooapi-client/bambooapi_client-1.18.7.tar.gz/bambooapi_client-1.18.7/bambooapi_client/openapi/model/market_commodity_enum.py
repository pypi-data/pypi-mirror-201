...
class MarketCommodityEnum(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'FLEXIBILITY_MARKET': "flexibility_market",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        """MarketCommodityEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): An enumeration.., must be one of ["energy_market", "flexibility_market", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["energy_market", "flexibility_market", ]  # noqa: E501
