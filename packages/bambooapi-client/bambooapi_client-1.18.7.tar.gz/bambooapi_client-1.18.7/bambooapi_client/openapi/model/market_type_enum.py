...
class MarketTypeEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["spot", "intraday_one", "continuous_intraday", "secondary_reserve", "tertiary_reserve", "replacement_reserve", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["spot", "intraday_one", "continuous_intraday", "secondary_reserve", "tertiary_reserve", "replacement_reserve", ]  # noqa: E501
