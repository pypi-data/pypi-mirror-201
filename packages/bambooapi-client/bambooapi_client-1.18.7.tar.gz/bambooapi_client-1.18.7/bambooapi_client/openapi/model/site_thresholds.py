...
def lazy_import():
    ...
    globals()['MeasurementThreshold'] = MeasurementThreshold


class SiteThresholds(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'devices': ({str: ({str: (MeasurementThreshold,)},)},),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, devices, *args, **kwargs):  # noqa: E501
        """SiteThresholds - a model defined in OpenAPI

        Args:
            devices ({str: ({str: (MeasurementThreshold,)},)}):
    ...
    @convert_js_args_to_python_args
    def __init__(self, devices, *args, **kwargs):  # noqa: E501
        """SiteThresholds - a model defined in OpenAPI
