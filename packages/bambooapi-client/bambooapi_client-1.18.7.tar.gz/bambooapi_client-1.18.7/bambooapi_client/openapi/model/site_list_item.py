...
class SiteListItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_id, site_name, country_code, timezone, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_id, site_name, country_code, timezone, *args, **kwargs):  # noqa: E501
        """SiteListItem - a model defined in OpenAPI
