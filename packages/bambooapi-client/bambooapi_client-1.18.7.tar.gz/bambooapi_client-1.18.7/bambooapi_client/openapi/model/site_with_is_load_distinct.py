...
class SiteWithIsLoadDistinct(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'is_load_distinct': (bool,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'is_load_distinct': 'is_load_distinct',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_name, flexumer_id, timezone, microgrid, site_id, available, is_load_distinct, *args, **kwargs):  # noqa: E501
        """SiteWithIsLoadDistinct - a model defined in OpenAPI
        ...
        Args:
            ...
            site_id (int):
            available (bool):
            is_load_distinct (bool): `true` for sites where load series are calculated. `false` otherwise. Load is distinct from meter if the site has generation systems or batteries.
        ...
        self.is_load_distinct = is_load_distinct
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_name, flexumer_id, timezone, microgrid, site_id, available, is_load_distinct, *args, **kwargs):  # noqa: E501
        """SiteWithIsLoadDistinct - a model defined in OpenAPI
