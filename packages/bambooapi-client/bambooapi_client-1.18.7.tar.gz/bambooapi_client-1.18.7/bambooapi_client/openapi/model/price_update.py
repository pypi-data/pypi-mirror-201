...
class PriceUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, price, *args, **kwargs):  # noqa: E501
        """PriceUpdate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, price, *args, **kwargs):  # noqa: E501
        """PriceUpdate - a model defined in OpenAPI
