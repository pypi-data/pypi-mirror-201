...
class EnergyMarketPricesUpdate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, prices, *args, **kwargs):  # noqa: E501
        """EnergyMarketPricesUpdate - a model defined in OpenAPI

        Args:
            prices ([PriceUpdate]): €/MWh
    ...
    @convert_js_args_to_python_args
    def __init__(self, prices, *args, **kwargs):  # noqa: E501
        """EnergyMarketPricesUpdate - a model defined in OpenAPI
