...
class ContractScheduleItem(ModelNormal):
    ...
    attribute_map = {
        'time': 'time',  # noqa: E501
        'period_name': 'period_name',  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, period_name, power, energy_price, injection_price, *args, **kwargs):  # noqa: E501
        """ContractScheduleItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, period_name, power, energy_price, injection_price, *args, **kwargs):  # noqa: E501
        """ContractScheduleItem - a model defined in OpenAPI
