...
def lazy_import():
    ...
    globals()['VariableActivationItem'] = VariableActivationItem


class DeviceActivationItem(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'activations': ([VariableActivationItem],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, device, activations, *args, **kwargs):  # noqa: E501
        """DeviceActivationItem - a model defined in OpenAPI

        Args:
            device (str):
            activations ([VariableActivationItem]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, device, activations, *args, **kwargs):  # noqa: E501
        """DeviceActivationItem - a model defined in OpenAPI
