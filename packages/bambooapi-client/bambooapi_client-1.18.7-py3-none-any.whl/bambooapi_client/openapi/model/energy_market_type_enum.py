...
class EnergyMarketTypeEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """EnergyMarketTypeEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): An enumeration.., must be one of ["spot", "intraday_one", "continuous_intraday", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["spot", "intraday_one", "continuous_intraday", ]  # noqa: E501
