...
class MediumEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """MediumEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): An enumeration.. if omitted defaults to "email", must be one of ["email", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.. if omitted defaults to "email", must be one of ["email", ]  # noqa: E501
