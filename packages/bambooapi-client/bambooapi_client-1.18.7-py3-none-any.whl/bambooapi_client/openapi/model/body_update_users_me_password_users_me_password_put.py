...
class BodyUpdateUsersMePasswordUsersMePasswordPut(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, current_password, new_password, *args, **kwargs):  # noqa: E501
        """BodyUpdateUsersMePasswordUsersMePasswordPut - a model defined in OpenAPI
