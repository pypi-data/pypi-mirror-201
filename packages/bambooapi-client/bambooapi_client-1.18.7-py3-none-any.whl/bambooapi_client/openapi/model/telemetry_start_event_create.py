...
class TelemetryStartEventCreate(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_id, time, *args, **kwargs):  # noqa: E501
        """TelemetryStartEventCreate - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_id, time, *args, **kwargs):  # noqa: E501
        """TelemetryStartEventCreate - a model defined in OpenAPI
