...
class AvailabilityScheduleItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, time, available, *args, **kwargs):  # noqa: E501
        """AvailabilityScheduleItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, time, available, *args, **kwargs):  # noqa: E501
        """AvailabilityScheduleItem - a model defined in OpenAPI
