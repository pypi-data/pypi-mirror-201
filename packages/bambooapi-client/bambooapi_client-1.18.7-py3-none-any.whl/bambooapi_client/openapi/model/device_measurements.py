...
def lazy_import():
    ...
    globals()['SiteDataPoint'] = SiteDataPoint


class DeviceMeasurements(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'measurements': ([SiteDataPoint],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, site_id, device_type, device_name, measurements, *args, **kwargs):  # noqa: E501
        """DeviceMeasurements - a model defined in OpenAPI

        Args:
            site_id (int):
            device_type (str):
            device_name (str):
            measurements ([SiteDataPoint]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, site_id, device_type, device_name, measurements, *args, **kwargs):  # noqa: E501
        """DeviceMeasurements - a model defined in OpenAPI
