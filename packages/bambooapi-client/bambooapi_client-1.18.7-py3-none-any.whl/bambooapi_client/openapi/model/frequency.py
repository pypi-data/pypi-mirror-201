...
class Frequency(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["minute", "five_minutes", "quarter", "half", "hour", "day", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["minute", "five_minutes", "quarter", "half", "hour", "day", ]  # noqa: E501
