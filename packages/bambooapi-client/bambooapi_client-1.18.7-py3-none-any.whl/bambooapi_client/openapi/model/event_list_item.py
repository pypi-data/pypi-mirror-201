...
class EventListItem(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, time, site_id, *args, **kwargs):  # noqa: E501
        """EventListItem - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, time, site_id, *args, **kwargs):  # noqa: E501
        """EventListItem - a model defined in OpenAPI
