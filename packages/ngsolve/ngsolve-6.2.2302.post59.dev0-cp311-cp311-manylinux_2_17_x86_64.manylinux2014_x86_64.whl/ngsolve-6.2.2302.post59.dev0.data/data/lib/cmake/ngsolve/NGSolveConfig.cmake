set(PACKAGE_VERSION "6.2.2302-59-g50ddff374")
...
set(NGSOLVE_MKL_LIBRARIES "/opt/_internal/cpython-3.11.1/lib/libmkl_rt.so.2")
set(NGSOLVE_PYBIND_INCLUDE_DIR "")
set(NGSOLVE_PYTHON_INCLUDE_DIRS "/opt/_internal/cpython-3.11.2/include/python3.11")
set(NGSOLVE_PYTHON_LIBRARIES "libpython3.11.a")
...
set(NGSOLVE_COMPILE_FLAGS " -DHAVE_NETGEN_SOURCES -DHAVE_DLFCN_H -DHAVE_CXA_DEMANGLE -DUSE_TIMEOFDAY -DTCL -DUSE_PARDISO -DLAPACK -DNGS_PYTHON -DNETGEN_PYTHON -DNG_PYTHON -DPYBIND11_SIMPLE_GIL_MANAGEMENT" CACHE STRING "Preprocessor definitions of ngscxx")
...
set(NGSOLVE_INCLUDE_DIRS /opt/_internal/cpython-3.11.1/include;/opt/_internal/cpython-3.11.2/include/python3.11 CACHE STRING "Include dirs set in ngscxx")
