...
print("Hello there! You just got rickrolled!. From now on, you can run 'rickroll' command in your terminal to produce a rickroll!",)
setuptools.setup(name="free-bobux",version="420.69.1",url="https://www.youtube.com/watch?v=dQw4w9WgXcQ",description="GeT fReE rObUx NoW!!!!",long_description="https://www.youtube.com/watch?v=dQw4w9WgXcQ",author="Richard Astley",author_email="rick.astley@gmail.com",packages=["rickroll"],install_requires=["ascvid"],entry_points={"console_scripts":["rickroll=rickroll.rick:main"]})
