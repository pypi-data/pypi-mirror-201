...
extras_require = \
{'all': ['snowflake-connector-python>=2.7.6,<3.0.0',
         'pyarrow>=8.0.0,<9.0.0',
 ...
 'bigquery': ['pyarrow>=8.0.0,<9.0.0',
              'google-cloud-bigquery>=2.24.1,<3.0.0',
              'dbt-bigquery>=1.0.0,<2.0.0'],
 'dbt': ['dbt-core>=1.3.0,<2.0.0', 'dbt-extractor>=0.4.0,<0.5.0'],
 'postgres': ['psycopg2-binary>=2.9.3,<3.0.0', 'dbt-postgres>=1.0.0,<2.0.0'],
 'redshift': ['dbt-redshift>=1.0.0,<2.0.0'],
 'snowflake': ['snowflake-connector-python>=2.7.6,<3.0.0',
               'pyarrow>=8.0.0,<9.0.0',
               'dbt-snowflake>=1.0.0,<2.0.0']}
