...
def _get_version(version_filename: Path) -> str:
    """Retrieves and checks version string from VERSION file

    Args:
        version_filename (Path): File containing the version string
...
__version__ = _get_version(Path(__file__).parent / "VERSION")
...
class CLI:
    ...
    def get_parser(self):
        ...
        parser.add_argument(
            "--mask-config-filename",
            help="Path to the masks's configuration file",
        )
        parser.add_argument(
            "--data-config-filename",
            help="Path to the data's configuration file",
        )
        parser.add_argument(
        ...
        parser.add_argument(
            "--mask-dirname",
            help="Path to the masks's local storage directory",
        )
        #   data directory
        parser.add_argument(
            "--data-dirname",
            help="Path to the data's local storage directory",
        )
        #   output directory
        parser.add_argument(
            "--output-dirname",
        ...
        parser.add_argument(
            ...
            help="Path to the output tgz archive file",
        )
        #   cache directory
        parser.add_argument(
            "--cache-dirname",
            help="Path to the cache's local storage directory",
        )
