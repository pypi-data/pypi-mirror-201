...
_DeviceInterface = Literal["USB", "PCIe", "1GbE"]
...
class ModuleBase:
    ...
    def listNodes(
        self,
        path: str,
        flags: Union[ziListEnum, int] = None,
    ...
    def set() -> None:
        ...
        1: Set multiple nodes.
        A transaction is used to optimize the data transfer.

        Args:
            items (List[Tuple[str, Any]]): A list of path/value pairs.

        2: Set the specified parameter node value.

        Args:
            path (str):  Path string of the node.
...
class ziDAQServer:
    ...
    def __init__(self, host: str, port: int, api_level: _APILevel) -> None: ...
    ...
    def connectDevice(
        self, dev: str, interface: _DeviceInterface, params: str = None
    ) -> None:
...
def compile_seqc(
    ...
    This function is a purely static function that does not require an active
    connection to a Data Server.
