...
class ItemSource(object):
    ...
    def __init__(self, id=None, part_number=None, cost=None, description=None, is_vendor=None, is_manufacturer=None, contact_info=None, url=None, source=None, target_url=None, display_url=None, is_vendor_string=None, is_manufacturer_string=None, local_vars_configuration=None):  # noqa: E501
