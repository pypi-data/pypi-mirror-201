...
class Source(object):
    ...
    def __init__(self, id=None, name=None, description=None, contact_info=None, url=None, target_url=None, display_url=None, local_vars_configuration=None):  # noqa: E501
