...
def _gen(s: str):
    ...
    for attr in dir(module):
        ...
        if inspect.isclass(attribute) and issubclass(attribute, BaseModel):
            ...
            if 'read' in md_layout:
                md_layout['read_fields'] = list(iterate_layout(md_layout['read'], md_layout['groups']))
            if 'form' in md_layout:
                md_layout['form_fields'] = list(iterate_layout(md_layout['form'], md_layout['groups']))
