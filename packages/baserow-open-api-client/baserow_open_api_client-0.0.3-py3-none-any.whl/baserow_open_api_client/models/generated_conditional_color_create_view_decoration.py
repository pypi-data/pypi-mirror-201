...
T = TypeVar("T", bound="GeneratedConditionalColorCreateViewDecoration")
...
class GeneratedConditionalColorCreateViewDecoration:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        generated_conditional_color_create_view_decoration = cls(
            type=type,
        ...
        generated_conditional_color_create_view_decoration.additional_properties = d
        return generated_conditional_color_create_view_decoration
