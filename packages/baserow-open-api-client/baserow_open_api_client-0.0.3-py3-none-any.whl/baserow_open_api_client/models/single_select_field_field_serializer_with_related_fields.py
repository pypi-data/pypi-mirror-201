...
T = TypeVar("T", bound="SingleSelectFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class SingleSelectFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        single_select_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        single_select_field_field_serializer_with_related_fields.additional_properties = d
        return single_select_field_field_serializer_with_related_fields
