...
T = TypeVar("T", bound="PagePathParams")


@attr.s(auto_attribs=True)
class PagePathParams:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        page_path_params.additional_properties = additional_properties
        return page_path_params
