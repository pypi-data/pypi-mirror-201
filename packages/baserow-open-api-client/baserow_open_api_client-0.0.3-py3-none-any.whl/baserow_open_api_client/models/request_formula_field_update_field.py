...
T = TypeVar("T", bound="RequestFormulaFieldUpdateField")


@attr.s(auto_attribs=True)
class RequestFormulaFieldUpdateField:
    """
    Attributes:
        error (str):
        nullable (bool):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        request_formula_field_update_field = cls(
            error=error,
            nullable=nullable,
            formula=formula,
            name=name,
        ...
        request_formula_field_update_field.additional_properties = d
        return request_formula_field_update_field
