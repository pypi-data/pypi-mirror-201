...
T = TypeVar("T", bound="SingleSelectFieldField")


@attr.s(auto_attribs=True)
class SingleSelectFieldField:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        single_select_field_field.additional_properties = d
        return single_select_field_field
