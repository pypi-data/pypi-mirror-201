...
) -> Optional[Union[Any, DeleteGroupResponse400, DeleteGroupResponse404]]:
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, DeleteGroupResponse400, DeleteGroupResponse404]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    [delete_workspace](#tag/Workspaces/operation/delete_workspace).**

    **Support for this endpoint will end in 2024.**

     Deletes an existing group if the authorized user belongs to the group. All the applications,
    databases, tables etc that were in the group are going to be deleted also.
...
def sync(
    ...
    **Support for this endpoint will end in 2024.**
    ...
    Returns:
        Union[Any, DeleteGroupResponse400, DeleteGroupResponse404]
    """
