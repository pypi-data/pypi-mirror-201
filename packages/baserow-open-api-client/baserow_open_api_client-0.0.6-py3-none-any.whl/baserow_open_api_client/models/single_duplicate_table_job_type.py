...
T = TypeVar("T", bound="SingleDuplicateTableJobType")


@attr.s(auto_attribs=True)
class SingleDuplicateTableJobType:
    """
    Attributes:
        id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        single_duplicate_table_job_type = cls(
            id=id,
            type=type,
            progress_percentage=progress_percentage,
            state=state,
        ...
        single_duplicate_table_job_type.additional_properties = d
        return single_duplicate_table_job_type
