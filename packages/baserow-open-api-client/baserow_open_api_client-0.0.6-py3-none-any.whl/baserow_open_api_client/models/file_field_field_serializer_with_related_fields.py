...
T = TypeVar("T", bound="FileFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class FileFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        file_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        file_field_field_serializer_with_related_fields.additional_properties = d
        return file_field_field_serializer_with_related_fields
