...
T = TypeVar("T", bound="MultipleCollaboratorsFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class MultipleCollaboratorsFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        multiple_collaborators_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        multiple_collaborators_field_field_serializer_with_related_fields.additional_properties = d
        return multiple_collaborators_field_field_serializer_with_related_fields
