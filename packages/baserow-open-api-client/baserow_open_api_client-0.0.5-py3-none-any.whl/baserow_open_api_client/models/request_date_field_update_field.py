...
T = TypeVar("T", bound="RequestDateFieldUpdateField")


@attr.s(auto_attribs=True)
class RequestDateFieldUpdateField:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        request_date_field_update_field = cls(
            name=name,
            type=type,
        ...
        request_date_field_update_field.additional_properties = d
        return request_date_field_update_field
