...
T = TypeVar("T", bound="FormulaFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class FormulaFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        formula_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        formula_field_field_serializer_with_related_fields.additional_properties = d
        return formula_field_field_serializer_with_related_fields
