...
T = TypeVar("T", bound="OpenIdConnectAuthProviderModelAuthProvider")
...
class OpenIdConnectAuthProviderModelAuthProvider:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        open_id_connect_auth_provider_model_auth_provider = cls(
            id=id,
            type=type,
            name=name,
            base_url=base_url,
        ...
        open_id_connect_auth_provider_model_auth_provider.additional_properties = d
        return open_id_connect_auth_provider_model_auth_provider
