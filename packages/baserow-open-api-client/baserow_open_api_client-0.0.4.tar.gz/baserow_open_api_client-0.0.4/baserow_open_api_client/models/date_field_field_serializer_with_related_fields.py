...
T = TypeVar("T", bound="DateFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class DateFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        date_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            order=order,
            type=type,
        ...
        date_field_field_serializer_with_related_fields.additional_properties = d
        return date_field_field_serializer_with_related_fields
