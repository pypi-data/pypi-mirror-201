...
T = TypeVar("T", bound="GridViewFieldOptionsWrapperFieldOptions")


@attr.s(auto_attribs=True)
class GridViewFieldOptionsWrapperFieldOptions:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        grid_view_field_options_wrapper_field_options = cls()
        ...
        grid_view_field_options_wrapper_field_options.additional_properties = additional_properties
        return grid_view_field_options_wrapper_field_options
