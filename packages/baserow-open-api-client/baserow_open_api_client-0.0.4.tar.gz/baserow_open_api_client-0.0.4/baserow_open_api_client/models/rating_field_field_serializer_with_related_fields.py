...
T = TypeVar("T", bound="RatingFieldFieldSerializerWithRelatedFields")
...
class RatingFieldFieldSerializerWithRelatedFields:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rating_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        rating_field_field_serializer_with_related_fields.additional_properties = d
        return rating_field_field_serializer_with_related_fields
