...
T = TypeVar("T", bound="SingleFileImportJobSerializerClass")


@attr.s(auto_attribs=True)
class SingleFileImportJobSerializerClass:
    """
    Attributes:
        id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        single_file_import_job_serializer_class = cls(
            id=id,
            type=type,
            progress_percentage=progress_percentage,
            state=state,
        ...
        single_file_import_job_serializer_class.additional_properties = d
        return single_file_import_job_serializer_class
