...
T = TypeVar("T", bound="MultipleCollaboratorsFieldField")


@attr.s(auto_attribs=True)
class MultipleCollaboratorsFieldField:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        multiple_collaborators_field_field = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        multiple_collaborators_field_field.additional_properties = d
        return multiple_collaborators_field_field
