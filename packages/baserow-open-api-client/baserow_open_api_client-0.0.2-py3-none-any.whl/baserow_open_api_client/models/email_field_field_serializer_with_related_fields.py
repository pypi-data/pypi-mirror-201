...
T = TypeVar("T", bound="EmailFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class EmailFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        email_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        email_field_field_serializer_with_related_fields.additional_properties = d
        return email_field_field_serializer_with_related_fields
