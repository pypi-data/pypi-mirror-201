...
T = TypeVar("T", bound="GalleryViewCreateView")


@attr.s(auto_attribs=True)
class GalleryViewCreateView:
    """
    Attributes:
        name (str):
        type (ViewTypesEnum):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        gallery_view_create_view.additional_properties = d
        return gallery_view_create_view
