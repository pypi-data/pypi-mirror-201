...
T = TypeVar("T", bound="LookupFieldCreateField")
...
class LookupFieldCreateField:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        lookup_field_create_field.additional_properties = d
        return lookup_field_create_field
