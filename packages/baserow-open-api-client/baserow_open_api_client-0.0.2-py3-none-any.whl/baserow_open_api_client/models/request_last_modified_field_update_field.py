...
T = TypeVar("T", bound="RequestLastModifiedFieldUpdateField")


@attr.s(auto_attribs=True)
class RequestLastModifiedFieldUpdateField:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        request_last_modified_field_update_field = cls(
            name=name,
            type=type,
        ...
        request_last_modified_field_update_field.additional_properties = d
        return request_last_modified_field_update_field
