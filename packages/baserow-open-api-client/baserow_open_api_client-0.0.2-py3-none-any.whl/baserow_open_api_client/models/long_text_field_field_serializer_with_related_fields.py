...
T = TypeVar("T", bound="LongTextFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class LongTextFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        long_text_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        long_text_field_field_serializer_with_related_fields.additional_properties = d
        return long_text_field_field_serializer_with_related_fields
