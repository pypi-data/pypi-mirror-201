...
T = TypeVar("T", bound="CreatedOnFieldCreateField")
...
class CreatedOnFieldCreateField:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        created_on_field_create_field = cls(
            type=type,
            name=name,
        ...
        created_on_field_create_field.additional_properties = d
        return created_on_field_create_field
