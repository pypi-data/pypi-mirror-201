...
from ...models.delete_database_table_row_response_400 import DeleteDatabaseTableRowResponse400
from ...models.delete_database_table_row_response_404 import DeleteDatabaseTableRowResponse404
...
) -> Optional[Union[Any, DeleteDatabaseTableRowResponse400, DeleteDatabaseTableRowResponse404]]:
    if response.status_code == HTTPStatus.NO_CONTENT:
        response_204 = cast(Any, None)
        return response_204
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = DeleteDatabaseTableRowResponse400.from_dict(response.json())

        return response_400
    if response.status_code == HTTPStatus.NOT_FOUND:
        response_404 = DeleteDatabaseTableRowResponse404.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[Union[Any, DeleteDatabaseTableRowResponse400, DeleteDatabaseTableRowResponse404]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, DeleteDatabaseTableRowResponse400, DeleteDatabaseTableRowResponse404]
    """
