...
T = TypeVar("T", bound="LastModifiedFieldCreateField")


@attr.s(auto_attribs=True)
class LastModifiedFieldCreateField:
    """
    Attributes:
        type (Type77BEnum):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        last_modified_field_create_field = cls(
            type=type,
            name=name,
        ...
        last_modified_field_create_field.additional_properties = d
        return last_modified_field_create_field
