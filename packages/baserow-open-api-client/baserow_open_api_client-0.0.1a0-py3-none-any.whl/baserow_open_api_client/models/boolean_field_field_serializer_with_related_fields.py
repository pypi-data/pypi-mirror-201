...
T = TypeVar("T", bound="BooleanFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class BooleanFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        boolean_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        boolean_field_field_serializer_with_related_fields.additional_properties = d
        return boolean_field_field_serializer_with_related_fields
