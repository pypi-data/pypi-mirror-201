...
T = TypeVar("T", bound="CreateUserResponse200User")


@attr.s(auto_attribs=True)
class CreateUserResponse200User:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_user_response_200_user = cls(
            first_name=first_name,
            username=username,
            language=language,
        )

        create_user_response_200_user.additional_properties = d
        return create_user_response_200_user
