...
T = TypeVar("T", bound="FieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class FieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        field_serializer_with_related_fields.additional_properties = d
        return field_serializer_with_related_fields
