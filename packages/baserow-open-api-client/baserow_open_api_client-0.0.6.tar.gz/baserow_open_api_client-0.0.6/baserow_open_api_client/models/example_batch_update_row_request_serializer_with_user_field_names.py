...
T = TypeVar("T", bound="ExampleBatchUpdateRowRequestSerializerWithUserFieldNames")
...
class ExampleBatchUpdateRowRequestSerializerWithUserFieldNames:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        example_batch_update_row_request_serializer_with_user_field_names = cls(
            id=id,
            field_1=field_1,
            field_2=field_2,
            field_3=field_3,
        ...
        example_batch_update_row_request_serializer_with_user_field_names.additional_properties = d
        return example_batch_update_row_request_serializer_with_user_field_names
