...
T = TypeVar("T", bound="DuplicateApplicationJobJob")


@attr.s(auto_attribs=True)
class DuplicateApplicationJobJob:
    """
    Attributes:
        id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        duplicate_application_job_job = cls(
            id=id,
            type=type,
            progress_percentage=progress_percentage,
            state=state,
        ...
        duplicate_application_job_job.additional_properties = d
        return duplicate_application_job_job
