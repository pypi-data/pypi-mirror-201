...
T = TypeVar("T", bound="GoogleAuthProviderModelAuthProvider")
...
class GoogleAuthProviderModelAuthProvider:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        google_auth_provider_model_auth_provider = cls(
            id=id,
            type=type,
            name=name,
            client_id=client_id,
        ...
        google_auth_provider_model_auth_provider.additional_properties = d
        return google_auth_provider_model_auth_provider
