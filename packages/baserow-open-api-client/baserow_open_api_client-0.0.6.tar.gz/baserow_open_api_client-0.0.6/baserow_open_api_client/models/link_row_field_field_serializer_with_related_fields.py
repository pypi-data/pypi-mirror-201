...
T = TypeVar("T", bound="LinkRowFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class LinkRowFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        link_row_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        link_row_field_field_serializer_with_related_fields.additional_properties = d
        return link_row_field_field_serializer_with_related_fields
