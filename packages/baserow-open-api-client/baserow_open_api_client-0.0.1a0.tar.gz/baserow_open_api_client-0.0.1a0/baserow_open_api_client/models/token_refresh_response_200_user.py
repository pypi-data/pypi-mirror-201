...
T = TypeVar("T", bound="TokenRefreshResponse200User")


@attr.s(auto_attribs=True)
class TokenRefreshResponse200User:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        token_refresh_response_200_user = cls(
            first_name=first_name,
            username=username,
            language=language,
        )

        token_refresh_response_200_user.additional_properties = d
        return token_refresh_response_200_user
