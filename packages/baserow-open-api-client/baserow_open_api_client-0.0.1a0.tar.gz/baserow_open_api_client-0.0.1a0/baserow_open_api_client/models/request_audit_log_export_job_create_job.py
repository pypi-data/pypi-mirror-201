...
T = TypeVar("T", bound="RequestAuditLogExportJobCreateJob")


@attr.s(auto_attribs=True)
class RequestAuditLogExportJobCreateJob:
    """
    Attributes:
        type (Type7F3Enum):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        request_audit_log_export_job_create_job = cls(
            type=type,
            created_on=created_on,
        ...
        request_audit_log_export_job_create_job.additional_properties = d
        return request_audit_log_export_job_create_job
