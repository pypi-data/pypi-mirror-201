...
T = TypeVar("T", bound="PhoneNumberFieldField")


@attr.s(auto_attribs=True)
class PhoneNumberFieldField:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        phone_number_field_field.additional_properties = d
        return phone_number_field_field
