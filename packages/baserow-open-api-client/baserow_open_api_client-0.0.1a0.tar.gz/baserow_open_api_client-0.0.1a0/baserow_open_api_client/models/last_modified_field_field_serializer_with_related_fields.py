...
T = TypeVar("T", bound="LastModifiedFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class LastModifiedFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        last_modified_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            order=order,
            type=type,
        ...
        last_modified_field_field_serializer_with_related_fields.additional_properties = d
        return last_modified_field_field_serializer_with_related_fields
