...
from ...models.group_install_template_response_400 import GroupInstallTemplateResponse400
from ...models.group_install_template_response_404 import GroupInstallTemplateResponse404
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/templates/install/{group_id}/{template_id}/".format(
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = GroupInstallTemplateResponse400.from_dict(response.json())

        return response_400
    if response.status_code == HTTPStatus.NOT_FOUND:
        response_404 = GroupInstallTemplateResponse404.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    [workspace_install_template](#tag/Templates/operation/workspace_install_template).**

    **Support for this endpoint will end in 2024.**

     Installs the applications of the given template into the given group if the user has access to that
    group. The response contains those newly created applications.
    ...
    Returns:
        Response[Union[GroupInstallTemplateResponse400, GroupInstallTemplateResponse404, List[Union['BuilderApplication', 'DatabaseApplication']]]]
    """
...
def sync(
    ...
    **Support for this endpoint will end in 2024.**
    ...
    Returns:
        Union[GroupInstallTemplateResponse400, GroupInstallTemplateResponse404, List[Union['BuilderApplication', 'DatabaseApplication']]]
    """
