...
T = TypeVar("T", bound="NumberFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class NumberFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        number_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        number_field_field_serializer_with_related_fields.additional_properties = d
        return number_field_field_serializer_with_related_fields
