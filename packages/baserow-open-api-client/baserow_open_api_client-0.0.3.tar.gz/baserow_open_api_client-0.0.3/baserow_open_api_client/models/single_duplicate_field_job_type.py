...
if TYPE_CHECKING:
    ...
    from ..models.field_serializer_with_related_fields import FieldSerializerWithRelatedFields


T = TypeVar("T", bound="SingleDuplicateFieldJobType")


@attr.s(auto_attribs=True)
class SingleDuplicateFieldJobType:
    """
    Attributes:
        id (int):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        state = self.state
        original_field = self.original_field.to_dict()

        duplicated_field = self.duplicated_field.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        original_field = Field.from_dict(d.pop("original_field"))

        duplicated_field = FieldSerializerWithRelatedFields.from_dict(d.pop("duplicated_field"))

        human_readable_error = d.pop("human_readable_error", UNSET)

        single_duplicate_field_job_type = cls(
            id=id,
            type=type,
            progress_percentage=progress_percentage,
            state=state,
        ...
        single_duplicate_field_job_type.additional_properties = d
        return single_duplicate_field_job_type
