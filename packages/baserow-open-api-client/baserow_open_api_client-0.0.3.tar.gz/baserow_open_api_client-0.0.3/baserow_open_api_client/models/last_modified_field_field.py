...
T = TypeVar("T", bound="LastModifiedFieldField")


@attr.s(auto_attribs=True)
class LastModifiedFieldField:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        last_modified_field_field.additional_properties = d
        return last_modified_field_field
