...
T = TypeVar("T", bound="ExampleRowRequestSerializerWithUserFieldNames")


@attr.s(auto_attribs=True)
class ExampleRowRequestSerializerWithUserFieldNames:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        example_row_request_serializer_with_user_field_names = cls(
            field_1=field_1,
            field_2=field_2,
            field_3=field_3,
            field_4=field_4,
        ...
        example_row_request_serializer_with_user_field_names.additional_properties = d
        return example_row_request_serializer_with_user_field_names
