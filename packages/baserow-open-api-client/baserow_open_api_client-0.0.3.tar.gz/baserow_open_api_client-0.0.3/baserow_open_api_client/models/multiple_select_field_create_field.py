...
T = TypeVar("T", bound="MultipleSelectFieldCreateField")
...
class MultipleSelectFieldCreateField:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        multiple_select_field_create_field = cls(
            name=name,
            type=type,
            select_options=select_options,
        )

        multiple_select_field_create_field.additional_properties = d
        return multiple_select_field_create_field
