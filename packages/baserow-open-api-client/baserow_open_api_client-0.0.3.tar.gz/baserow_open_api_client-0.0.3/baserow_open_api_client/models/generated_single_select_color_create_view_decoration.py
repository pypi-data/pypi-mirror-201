...
if TYPE_CHECKING:
    from ..models.select_color_value_provider_conf import SelectColorValueProviderConf


T = TypeVar("T", bound="GeneratedSingleSelectColorCreateViewDecoration")


@attr.s(auto_attribs=True)
class GeneratedSingleSelectColorCreateViewDecoration:
    """
    Attributes:
        type (TypeFc4Enum):
        ...
        value_provider_conf (Union[Unset, SelectColorValueProviderConf]):
    ...
    value_provider_conf: Union[Unset, "SelectColorValueProviderConf"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_value_provider_conf, Unset):
            ...
            value_provider_conf = SelectColorValueProviderConf.from_dict(_value_provider_conf)

        order = d.pop("order", UNSET)

        generated_single_select_color_create_view_decoration = cls(
            type=type,
        ...
        generated_single_select_color_create_view_decoration.additional_properties = d
        return generated_single_select_color_create_view_decoration
