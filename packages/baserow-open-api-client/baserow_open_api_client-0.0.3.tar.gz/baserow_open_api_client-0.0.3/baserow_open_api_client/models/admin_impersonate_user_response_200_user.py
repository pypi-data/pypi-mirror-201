...
T = TypeVar("T", bound="AdminImpersonateUserResponse200User")


@attr.s(auto_attribs=True)
class AdminImpersonateUserResponse200User:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        admin_impersonate_user_response_200_user = cls(
            first_name=first_name,
            username=username,
            language=language,
        )

        admin_impersonate_user_response_200_user.additional_properties = d
        return admin_impersonate_user_response_200_user
