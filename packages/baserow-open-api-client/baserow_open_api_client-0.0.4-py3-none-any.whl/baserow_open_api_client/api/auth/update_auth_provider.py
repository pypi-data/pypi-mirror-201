...
from ...models.update_auth_provider_response_400 import UpdateAuthProviderResponse400
from ...models.update_auth_provider_response_404 import UpdateAuthProviderResponse404
...
def _parse_response(
    *, client: Client, response: httpx.Response
    ...
    if response.status_code == HTTPStatus.BAD_REQUEST:
        response_400 = UpdateAuthProviderResponse400.from_dict(response.json())

        return response_400
    if response.status_code == HTTPStatus.NOT_FOUND:
        response_404 = UpdateAuthProviderResponse404.from_dict(response.json())
...
def sync_detailed(
    auth_provider_id: int, *, client: AuthenticatedClient, httpx_client=None
) -> Response[
    Union[
        Union[
            "FacebookAuthProviderModelAuthProvider",
    ...
    """Updates a new authentication provider. This can be used to enable authentication with a third party
    ...
    Returns:
        Response[Union[Union['FacebookAuthProviderModelAuthProvider', 'GitHubAuthProviderModelAuthProvider', 'GitLabAuthProviderModelAuthProvider', 'GoogleAuthProviderModelAuthProvider', 'OpenIdConnectAuthProviderModelAuthProvider', 'PasswordAuthProviderModelAuthProvider', 'SamlAuthProviderModelAuthProvider'], UpdateAuthProviderResponse400, UpdateAuthProviderResponse404]]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Union['FacebookAuthProviderModelAuthProvider', 'GitHubAuthProviderModelAuthProvider', 'GitLabAuthProviderModelAuthProvider', 'GoogleAuthProviderModelAuthProvider', 'OpenIdConnectAuthProviderModelAuthProvider', 'PasswordAuthProviderModelAuthProvider', 'SamlAuthProviderModelAuthProvider'], UpdateAuthProviderResponse400, UpdateAuthProviderResponse404]
    """
