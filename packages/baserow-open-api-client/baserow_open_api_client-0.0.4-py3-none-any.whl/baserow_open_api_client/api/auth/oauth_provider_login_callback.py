...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/sso/oauth2/callback/{provider_id}/".format(client.base_url, provider_id=provider_id)
...
def sync_detailed(
    provider_id: int, *, client: Client, code: Union[Unset, None, int] = UNSET, httpx_client=None
) -> Response[Any]:
