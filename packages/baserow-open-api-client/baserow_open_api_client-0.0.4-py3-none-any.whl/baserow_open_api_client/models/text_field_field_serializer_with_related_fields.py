...
T = TypeVar("T", bound="TextFieldFieldSerializerWithRelatedFields")


@attr.s(auto_attribs=True)
class TextFieldFieldSerializerWithRelatedFields:
    """
    Attributes:
        id (int):
        table_id (int):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        text_field_field_serializer_with_related_fields = cls(
            id=id,
            table_id=table_id,
            name=name,
            order=order,
        ...
        text_field_field_serializer_with_related_fields.additional_properties = d
        return text_field_field_serializer_with_related_fields
