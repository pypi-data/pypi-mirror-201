...
class GenericModelTflite(BaseModel_tflite):
    def __init__(self,input_shape=[28, 28, 1],path_tf_file="/home/filippo/Git/PhD_AdversarialAttack/Models/ResNet8-quantized.tflite",input_no_normalizate=True):
        ...
        for i in range(graf.OperatorsLength()-2):
            op=graf.Operators(i)           
        ...
        layers[-1].end_layer =True
        layers[-1].gpu_output_memory = False
