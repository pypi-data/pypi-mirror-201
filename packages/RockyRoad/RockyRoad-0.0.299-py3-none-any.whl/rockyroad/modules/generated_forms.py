...
class Generated_Forms(Consumer):
    ...
    class __Groups(Consumer):
        ...
        def assign_field_to_group(
            ...
            group_uid: str,
            field_uid: str,
            field_instance_visible: Query(type=bool) = None,
            z_index: Query(type=int) = None,
        ):
    ...
    class __Forms(Consumer):
        ...
        def get_form_by_machine_catalog(
            ...
            form_type: str,
            include_assigned_fields: Query(type=bool) = None,
        ):
        ...
        def get(
            ...
            uid: str,
            include_assigned_fields: Query(type=bool) = None,
            include_assigned_groups: Query(type=bool) = None,
        ):
        ...
        def assign_group_to_form(
            self, group_uid: str, form_uid: str, z_index: Query(type=int) = None
        ):
    ...
    class __Results(Consumer):
        ...
        def list(
            self, form_type: Query(type=str) = None, form_uid: Query(type=str) = None
        ):
        ...
        def get_all_for_dealer(
            self, dealer_uid: str, form_type: Query(type=str) = None
        ):
