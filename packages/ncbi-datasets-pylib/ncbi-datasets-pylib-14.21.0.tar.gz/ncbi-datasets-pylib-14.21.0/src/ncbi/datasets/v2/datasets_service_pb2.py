...
_VIRUSDOWNLOAD = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_protobuf_dot_wrappers__pb2._BYTESVALUE,
    serialized_options=b'\302\360\031\345\003\n\344\001\010\001\0226/v2alpha/virus/taxon/sars2/protein/{proteins}/download*<Download SARS-CoV-2 protein and CDS datasets by protein name2$Download SARS-CoV-2 protein datasets:\026sars2_protein_downloadB\005VirusJ\014table_fieldsJ\006formatr\017application/zip\n\373\001\010\002\022+/v2alpha/virus/taxon/sars2/protein/download*LDownload SARS-CoV-2 protein and CDS datasets by protein name by POST request21Download SARS-CoV-2 protein datasets POST request:\033sars2_protein_download_postB\005VirusJ\014table_fieldsJ\006formatr\017application/zip',
    create_key=_descriptor._internal_create_key,
  ),
])
...
_VIRUSDATASET = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\302\360\031\276\t\n\242\003\010\001\0225/v2alpha/virus/taxon/{filter.taxon}/annotation_report*$Get virus annotation report by taxon2\235\001Get virus annotation report by taxon. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):!virus_annotation_reports_by_taxonB\005VirusJ\021filter.accessionsR\025\n\014filter.taxon\022\005taxonZ\036v2reportsVirusAnnotationReporth\001r\020application/jsonr\031text/tab-separated-values\n\273\003\010\001\022>/v2alpha/virus/accession/{filter.accessions}/annotation_report*(Get virus annotation report by accession2\240\001Get virus annotation report by accesion. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):%virus_annotation_reports_by_acessionsB\005VirusJ\014filter.taxonR\037\n\021filter.accessions\022\naccessionsZ\036v2reportsVirusAnnotationReporth\001r\020application/jsonr\031text/tab-separated-values\n\330\002\010\002\022 /v2alpha/virus/annotation_report*#Get virus annotation report by POST2\224\001Get virus annotation report. By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines): virus_annotation_reports_by_postB\005VirusZ\036v2reportsVirusAnnotationReporth\001r\020application/jsonr\031text/tab-separated-values',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
...
_FEATUREDATASET = _descriptor.ServiceDescriptor(
  name='FeatureDataset',
  full_name='ncbi.datasets.v2.FeatureDataset',
  file=DESCRIPTOR,
  index=7,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='GetFeatures',
    full_name='ncbi.datasets.v2.FeatureDataset.GetFeatures',
    index=0,
    containing_service=None,
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._FEATUREREQUEST,
    output_type=ncbi_dot_datasets_dot_v2_dot_reports_dot_feature__pb2._FEATUREDATAREPORTPAGE,
    serialized_options=b'\302\360\031\320\005\n\347\002\010\001\"./v2alpha/genome/accession/{accession}/features*\'Get feature reports by genome accession2\241\001Get feature reports by genome accession.  By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\026feature_dataset_reportB\006GenomeZ\027v2reportsGeneDataReporth\001r\020application/jsonr\031text/tab-separated-values\n\343\002\010\002\"\"/v2alpha/genome/accession/features*\'Get feature reports by genome accession2\241\001Get feature reports by genome accession.  By default, in paged JSON format, but also available as tabular (accept: x-tabular) or json-lines (accept: x-jsonlines):\036feature_dataset_report_by_postB\006GenomeZ\027v2reportsGeneDataReporth\001r\020application/jsonr\031text/tab-separated-values',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetFeaturesSummary',
    full_name='ncbi.datasets.v2.FeatureDataset.GetFeaturesSummary',
    index=1,
    containing_service=None,
    input_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._FEATUREREQUEST,
    output_type=ncbi_dot_datasets_dot_v2_dot_datasets__pb2._FEATURETABLESUMMARYREPLY,
    serialized_options=b'\302\360\031\311\004\n\315\002\010\001\"5/v2alpha/genome/accession/{accession}/feature_summary*&Get feature report summary information2pGet feature report summary information by genome accession. The return facets can be used in subsequent queries.:\035feature_dataset_report_facetsB\006GenomeJ\007symbolsJ\013chromosomesJ\ngene_typesJ\013search_textJ\005queryJ\004sortJ\tpage_sizeJ\npage_token\n\366\001\010\002\")/v2alpha/genome/accession/feature_summary*&Get feature report summary information2pGet feature report summary information by genome accession. The return facets can be used in subsequent queries.:%feature_dataset_report_facets_by_postB\006Genome',
    create_key=_descriptor._internal_create_key,
  ),
])
_sym_db.RegisterServiceDescriptor(_FEATUREDATASET)

DESCRIPTOR.services_by_name['FeatureDataset'] = _FEATUREDATASET
