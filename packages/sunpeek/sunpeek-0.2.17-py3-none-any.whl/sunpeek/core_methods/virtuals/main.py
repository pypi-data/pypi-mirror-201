...
class CalcPowerFromVolumeFlow(VirtualSensorCalculation):
    ...
    def _core(self):
        ...
        """
        tp = self.calc_tp_from_vf_pos(fluid=self.comp.plant.fluid_solar,
    ...
    def _do_assert(self, check_mode):
        ...
        # assert self.comp.vf.info is not None
        # assert 'position' in self.comp.vf.info
...
class CalcMassFlowFromPower(VirtualSensorCalculation):
    ...
    def _core(self):
        ...
        """
        mf = self.calc_mf_from_tp(fluid=self.comp.plant.fluid_solar,
