...
def lazy_import():
    ...
    globals()['CalculationInfo'] = CalculationInfo
    globals()['CalculationProgress'] = CalculationProgress
    globals()['EntityWarningList'] = EntityWarningList
    globals()['PackStatistics'] = PackStatistics
    globals()['Tracedata'] = Tracedata
    globals()['UnpackedItems'] = UnpackedItems


class PackResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, tracedata, blueprint, statistics, progress, info, *args, **kwargs):  
        """PackResult - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            warnings (EntityWarningList): [optional]  
            unpacked_items (UnpackedItems): [optional]  
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, tracedata, blueprint, statistics, progress, info, *args, **kwargs):  
        """PackResult - a model defined in OpenAPI
