...
class ProductLayout(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, product_key, coordinates, dimensions, *args, **kwargs):  
        """ProductLayout - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, product_key, coordinates, dimensions, *args, **kwargs):  
        """ProductLayout - a model defined in OpenAPI
