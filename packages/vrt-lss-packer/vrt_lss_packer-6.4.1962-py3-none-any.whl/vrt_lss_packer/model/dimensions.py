...
class Dimensions(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, length, width, height, mass, *args, **kwargs):  
        """Dimensions - a model defined in OpenAPI

        Args:
            length (int): Length in millimeters.
            width (int): Width in millimeters.
            height (int): Height in millimeters.
            mass (int): Weight in grams.
    ...
    @convert_js_args_to_python_args
    def __init__(self, length, width, height, mass, *args, **kwargs):  
        """Dimensions - a model defined in OpenAPI
