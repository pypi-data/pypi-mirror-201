...
class Package(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, type, body_dimensions, container_dimensions, container_coordinates, *args, **kwargs):  
        """Package - a model defined in OpenAPI

        Args:
            key (str): Package key, unique identifier.
            type (PackageType):
            body_dimensions (Dimensions):
            container_dimensions (Dimensions):
            container_coordinates (Coordinates):
        ...
        self.container_coordinates = container_coordinates
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, type, body_dimensions, container_dimensions, container_coordinates, *args, **kwargs):  
        """Package - a model defined in OpenAPI
