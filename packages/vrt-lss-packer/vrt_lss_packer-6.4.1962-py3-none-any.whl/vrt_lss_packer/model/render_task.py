...
class RenderTask(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, products, packages, blueprint, *args, **kwargs):  
        """RenderTask - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, products, packages, blueprint, *args, **kwargs):  
        """RenderTask - a model defined in OpenAPI
