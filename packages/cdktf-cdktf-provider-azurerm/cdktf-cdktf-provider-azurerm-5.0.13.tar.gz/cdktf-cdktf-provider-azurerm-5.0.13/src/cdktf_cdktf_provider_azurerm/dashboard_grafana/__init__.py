...
class DashboardGrafana(
    ...
    def __init__(
        ...
        *,
        ...
        :param azure_monitor_workspace_integrations: azure_monitor_workspace_integrations block. Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dashboard_grafana#azure_monitor_workspace_integrations DashboardGrafana#azure_monitor_workspace_integrations}
...
class DashboardGrafanaAzureMonitorWorkspaceIntegrations:
    def __init__(self, *, resource_id: builtins.str) -> None:
        '''
        :param resource_id: Docs at Terraform Registry: {@link https://www.terraform.io/docs/providers/azurerm/r/dashboard_grafana#resource_id DashboardGrafana#resource_id}.
        '''
        if __debug__:
