...
class SenFiatAccountCreationRequest(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["idempotencyKey", "accountNumber", "currency", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["idempotencyKey", "accountNumber", "currency", ], str]):
