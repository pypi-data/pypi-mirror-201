...
class SenInstruction(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["trackingRef", "accountNumber", "currency", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["trackingRef", "accountNumber", "currency", ], str]):
