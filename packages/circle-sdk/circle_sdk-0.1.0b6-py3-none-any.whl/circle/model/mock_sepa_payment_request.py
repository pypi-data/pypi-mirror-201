...
class MockSepaPaymentRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["trackingRef", "amount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["trackingRef", "amount", ], str]):
