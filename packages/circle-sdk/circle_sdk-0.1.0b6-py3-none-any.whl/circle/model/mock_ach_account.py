...
class MockAchAccount(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountNumber", "routingNumber", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountNumber", "routingNumber", "description", ], str]):
