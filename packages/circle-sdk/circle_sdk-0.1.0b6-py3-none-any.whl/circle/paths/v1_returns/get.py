...
SchemaFor200ResponseBodyApplicationJson = ListReturnsResponse
...
class ListReturns(BaseApi):
    ...
    def list_returns(
        ...
        return self._list_returns_oapg(
