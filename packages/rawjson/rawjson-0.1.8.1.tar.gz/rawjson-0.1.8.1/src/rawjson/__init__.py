...
class Entity:
    ...
    def setName(self, name: RawJSON):
        self.__raw__['name'] = name.forValue()
    def setUUID(self, id: str):
        self.__raw__['id'] = id
...
class RawJSON:
    ...
    def setInsertion(self, insertion: str, index: int = None):
        index = self.__indexcheck__(index)
        self.__raw__[index]['insertion'] = insertion

        return self
    
    def removeInsertion(self, index: int = None):
        index = self.__indexcheck__(index)
        if 'insertion' in self.__raw__[index]:
            self.__raw__[index].pop('insertion')
