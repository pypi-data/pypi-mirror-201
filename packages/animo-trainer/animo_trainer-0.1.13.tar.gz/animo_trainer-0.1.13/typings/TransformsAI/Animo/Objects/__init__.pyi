...
class Character(GridObject, IAgent):
    ...
    def CreatedObject(self, gridObject: GridObject) -> None: ...
    def Destroy(self) -> None: ...
    def DestroyedBlock(self, blockPosition: Vector3Int) -> None: ...
    def DestroyedObject(self, gridObject: GridObject) -> None: ...
    ...
    class UsedItem_MethodGroup:
        @typing.overload
        def __call__(self, item: Item, target: GridObject = ...) -> None:...
        @typing.overload
