import typing
from TransformsAI.Animo.Data.Database.Tables import ITableItem_1
...
class AgentData(ITableItem_1[int]):
    ...
    @property
    def CheckpointTimestamps(self) -> List_1[int]: ...
    @CheckpointTimestamps.setter
    def CheckpointTimestamps(self, value: List_1[int]) -> List_1[int]: ...
    @property
    ...
    def RecalculateAffinitySlots(self) -> None: ...


class CheckpointData(ITableItem_1[CheckpointId]):
    def __init__(self) -> None: ...
    @property
    ...
    @staticmethod
    def CreateDefault(agentId: int) -> CheckpointData: ...
...
class LevelData(ITableItem_1[str]):
    def __init__(self) -> None: ...
    @property
    def Id(self) -> str: ...
    @Id.setter
