...
FilePath     : /wheel/manifast/manifast/iostream/pltstream.py
Description  : 
LastEditTime : 2023-02-24 23:12:46
...
def pltDistributHist(data_list, x_names, save_name, x_label='Classes', y_label='Number of Anchors', save_dir='./'):
    '''
