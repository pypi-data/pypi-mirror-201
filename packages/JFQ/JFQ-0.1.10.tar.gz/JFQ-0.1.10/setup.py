...
setuptools.setup(
    ...
    version='v0.1.10',  # important for updates
    ...
    install_requires=['requests','pandas','matplotlib','xlsxwriter','anytree','blpapi','openpyxl'],  # list all packages that your package uses
