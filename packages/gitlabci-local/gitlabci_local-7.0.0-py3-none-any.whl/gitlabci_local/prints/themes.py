...
try:
    ...
    from typing import Any as prompt_toolkit_styles_Style
...
class Themes:
    ...
    # Checkbox
    @staticmethod
    def checkbox_style() -> prompt_toolkit_styles_Style:
    ...
    # Configuration
    @staticmethod
    def configuration_style() -> prompt_toolkit_styles_Style:
