...
class ScriptsFile:
    ...
    # Constants
    __SEPARATOR: str = '\n'
    __SHEBANG_MARKER_BASH: str = '__GITLAB_CI_LOCAL_SHEBANG_MARKER_BASH__'
    ...
    # Constructor
    def __init__(self, paths: Dict[str, str], prefix: str = '.tmp.') -> None:
    ...
    # Configure
    def configure(self, errors: bool = True, verbose: bool = True) -> None:
    ...
    # Subshell start
    def subshell_start(self, section: str) -> None:
    ...
    # Subshell stop
    def subshell_stop(self, section: str) -> None:
